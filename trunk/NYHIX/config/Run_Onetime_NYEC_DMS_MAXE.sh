...
$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/Load_NYEC_DMS_Lookups.kjb" -log="$MAXDAT_ETL_LOGS/Load_NYEC_DMS_Lookups_$(date +%Y%m%d_%H%M%S).LOG" -level="$DETAIL_LOG_LEVEL"
