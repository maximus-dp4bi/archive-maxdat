...
KJB_LOG_ROWLEVEL="Rowlevel"
	...
	$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/MailFaxDocV2/Onetime_load_APP_DOC_INDV.kjb" -level="$KJB_LOG_LEVEL"  >> $MAXDAT_ETL_LOGS/Onetime_load_APP_DOC_INDV$(date +%Y%m%d_%H%M%S).log &
