...
$MAXDAT_KETTLE_DIR/kitchen.sh -file=$MAXDAT_ETL_PATH/ProcessLetters/ProcessLetters_RUNALL_ONCE_A_DAY.kjb  $KJB_LOG_LEVEL  >> $MAXDAT_ETL_LOGS/ProcessLetters_RUNALL_ONCE_A_DAY$(date +%Y%m%d_%H%M%S).log &
