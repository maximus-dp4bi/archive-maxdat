...
KJB_LOG_ROWLEVEL="Rowlevel"
	...
	$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/MailFaxDocV2/Run_onetime_MFD_update_stg.kjb" -level="$KJB_LOG_LEVEL"  >> $MAXDAT_ETL_LOGS/Run_onetime_MFD_update_stg_$(date +%Y%m%d_%H%M%S).log &
