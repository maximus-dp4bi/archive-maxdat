...
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/corp/scripts/run_test_job.sh $
# $Revision: 25047 $
# $Date: 2018-09-27 11:15:13 -0700 (Thu, 27 Sep 2018) $
# $Author: gt83345 $
# ================================================================================
#!/bin/bash
#set -x
...
if [[ -e $INIT_OK ]] ; then
   ...
   echo "Starting ${STCODE} ${JOB}.sh in ${ENV_CODE}."
   rm -f $EMAIL_MESSAGE $CHILD_FAIL
   touch $INIT_OK
fi

#init check
sh -c  './run_test_job2.sh'
rc=$?
if [[ $rc != 0 ]] ; then
