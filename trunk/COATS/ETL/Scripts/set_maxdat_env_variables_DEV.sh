...
export MAXDAT_ETL_PATH="/u01/maximus/maxdat-dev/CO/ETL/scripts"
export MAXDAT_ETL_LOGS="/u01/maximus/maxdat-dev/CO/ETL/logs"
export KETTLE_HOME="/u01/maximus/maxdat-dev/CO/config"
