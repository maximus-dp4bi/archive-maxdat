...
export MAXDAT_ETL_PATH="/u01/maximus/maxdat-uat/CO/ETL/scripts"
export MAXDAT_ETL_LOGS="/u01/maximus/maxdat-uat/CO/ETL/logs"
export KETTLE_HOME="/u01/maximus/maxdat-uat/CO/config"
