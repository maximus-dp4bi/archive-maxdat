...
# $Revision: 26603 $
# $Date: 2019-03-21 19:50:26 -0400 (Thu, 21 Mar 2019) $
# $Author: aa24065 $
...
# Set the RUN_FILE to the kjb name (minus .kjb) and the MODULE the appropriate MODULE name.
    ...
    wait
    #     MODULE=${MODULE_IS}; RUN_FILE=CAHCO_run_information_systems; LOG_NAME=${RUN_FILE}_$(date +%Y%m%d_%H%M%S).log; LOG_FILE="${MAXDAT_ETL_LOGS}/${MODULE}/${LOG_NAME}"; ${MAXDAT_ETL_PATH}/CAHCO_run_information_systems.sh >> ${LOG_FILE} &
    #wait
