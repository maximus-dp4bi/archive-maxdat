...
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/Kettle8/CAHCO/scripts/CAHCO_run_emrs_client.sh $
# $Revision: 26603 $
...
INIT_OK=${MAXDAT_ETL_PATH}/${STCODE}_run_emrs_client_check.txt
