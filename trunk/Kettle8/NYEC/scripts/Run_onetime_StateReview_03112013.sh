...
CUSTOM_DIR=$MAXDAT_ETL_DIR/StateReview
LOG_DIR=$MAXDAT_LOG_DIR
LOG_LEVEL="Basic"

                                                                                                   
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ProcessStateReview_RUNALL.kjb" -log="$LOG_DIR/ProcessStateReview_RUNALL.log" -level="$LOG_LEVEL" 
