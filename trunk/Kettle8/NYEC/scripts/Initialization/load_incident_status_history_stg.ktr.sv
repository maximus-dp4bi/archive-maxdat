...
<transformation>
  <info>
    <name>load_incident_status_history_stg_finaL</name>
    <description/>
    <extended_description>----------------------------------------------------------------
Do not edit these four SVN_* variable values.  They are populated when you commit code to SVN and used later to identify deployed code.
----------------------------------------------------------------
---------------------------------
SVN_FILE_URL        = $URL: svn://rcmxapp1d.maximus.com/maxdat/trunk/NYEC/ETL/scripts/load_incident_status_history_stg.ktr $ 
SVN_REVISION        = $Revision: 11894 $ 
SVN_REVISION_DATE   = $Date: 2014-09-11 15:44:15 -0400 (Thu, 11 Sep 2014) $
SVN_REVISION_AUTHOR = $Author: dd27179 $</extended_description>
    <trans_version/>
...
<field><id>ID_BATCH</id><enabled>Y</enabled><name>ID_BATCH</name></field><field><id>CHANNEL_ID</id><enabled>Y</enabled><name>CHANNEL_ID</name></field><field><id>LOG_DATE</id><enabled>Y</enabled><name>LOG_DATE</name></field><field><id>TRANSNAME</id><enabled>Y</enabled><name>TRANSNAME</name></field><field><id>STEPNAME</id><enabled>Y</enabled><name>STEPNAME</name></field><field><id>STEP_COPY</id><enabled>Y</enabled><name>STEP_COPY</name></field><field><id>LINES_READ</id><enabled>Y</enabled><name>LINES_READ</name></field><field><id>LINES_WRITTEN</id><enabled>Y</enabled><name>LINES_WRITTEN</name></field><field><id>LINES_UPDATED</id><enabled>Y</enabled><name>LINES_UPDATED</name></field><field><id>LINES_INPUT</id><enabled>Y</enabled><name>LINES_INPUT</name></field><field><id>LINES_OUTPUT</id><enabled>Y</enabled><name>LINES_OUTPUT</name></field><field><id>LINES_REJECTED</id><enabled>Y</enabled><name>LINES_REJECTED</name></field><field><id>ERRORS</id><enabled>Y</enabled><name>ERRORS</name></field><field><id>LOG_FIELD</id><enabled>N</enabled><name>LOG_FIELD</name></field></step-log-table>
  ...
  <created_date>2014&#47;01&#47;20 16:00:08.407</created_date>
  <modified_user>-</modified_user>
  <modified_date>2014&#47;01&#47;20 16:00:08.407</modified_date>
  </info>
  <notepads>
  </notepads>
  <connection>
  ...
  <connection>
    <name>KOFAX_ARS</name>
    <server>${DB_KOFAX_ARS_HOSTNAME}</server>
    <type>MSSQL</type>
    <access>Native</access>
    <database>${DB_KOFAX_ARS_DB}</database>
    <port>${DB_KOFAX_ARS_PORT}</port>
    <username>${DB_KOFAX_ARS_USER}</username>
    <password>${DB_KOFAX_ARS_PASSWORD}</password>
    <servername/>
    <data_tablespace/>
    <index_tablespace/>
    <attributes>
      <attribute><code>EXTRA_OPTION_MSSQL.instance</code><attribute>${DB_KOFAX_ARS_INSTANCE}</attribute></attribute>
      <attribute><code>FORCE_IDENTIFIERS_TO_LOWERCASE</code><attribute>N</attribute></attribute>
      <attribute><code>FORCE_IDENTIFIERS_TO_UPPERCASE</code><attribute>N</attribute></attribute>
      <attribute><code>IS_CLUSTERED</code><attribute>N</attribute></attribute>
      <attribute><code>MSSQL_DOUBLE_DECIMAL_SEPARATOR</code><attribute>N</attribute></attribute>
      <attribute><code>PORT_NUMBER</code><attribute>${DB_KOFAX_ARS_PORT}</attribute></attribute>
  ...
  <connection>
    ...
    <index_tablespace/>
    <attributes>
      <attribute><code>EXTRA_OPTION_MSSQL.instance</code><attribute>${DB_KOFAX_CENTRAL_INSTANCE}</attribute></attribute>
      <attribute><code>FORCE_IDENTIFIERS_TO_LOWERCASE</code><attribute>N</attribute></attribute>
      <attribute><code>FORCE_IDENTIFIERS_TO_UPPERCASE</code><attribute>N</attribute></attribute>
      <attribute><code>IS_CLUSTERED</code><attribute>N</attribute></attribute>
      <attribute><code>MSSQL_DOUBLE_DECIMAL_SEPARATOR</code><attribute>N</attribute></attribute>
      <attribute><code>PORT_NUMBER</code><attribute>${DB_KOFAX_CENTRAL_PORT}</attribute></attribute>
      <attribute><code>QUOTE_ALL_FIELDS</code><attribute>Y</attribute></attribute>
      <attribute><code>SUPPORTS_BOOLEAN_DATA_TYPE</code><attribute>Y</attribute></attribute>
      <attribute><code>USE_POOLING</code><attribute>N</attribute></attribute>
    </attributes>
  ...
  <connection>
    <name>KOFAX_REMOTE</name>
    <server>${DB_KOFAX_REMOTE_HOSTNAME}</server>
    <type>MSSQL</type>
    <access>Native</access>
    <database>${DB_KOFAX_REMOTE_DB}</database>
    <port>${DB_KOFAX_REMOTE_PORT}</port>
    <username>${DB_KOFAX_REMOTE_USER}</username>
    <password>${DB_KOFAX_REMOTE_PASSWORD}</password>
    <servername/>
    <data_tablespace/>
    <index_tablespace/>
    <attributes>
      <attribute><code>EXTRA_OPTION_MSSQL.instance</code><attribute>${DB_KOFAX_REMOTE_INSTANCE}</attribute></attribute>
      <attribute><code>FORCE_IDENTIFIERS_TO_LOWERCASE</code><attribute>N</attribute></attribute>
      <attribute><code>FORCE_IDENTIFIERS_TO_UPPERCASE</code><attribute>N</attribute></attribute>
      <attribute><code>IS_CLUSTERED</code><attribute>N</attribute></attribute>
      <attribute><code>MSSQL_DOUBLE_DECIMAL_SEPARATOR</code><attribute>N</attribute></attribute>
      <attribute><code>PORT_NUMBER</code><attribute>${DB_KOFAX_REMOTE_PORT}</attribute></attribute>
      <attribute><code>QUOTE_ALL_FIELDS</code><attribute>N</attribute></attribute>
      <attribute><code>SUPPORTS_BOOLEAN_DATA_TYPE</code><attribute>N</attribute></attribute>
      <attribute><code>USE_POOLING</code><attribute>N</attribute></attribute>
    </attributes>
  ...
  <connection>
    ...
    <attributes>
      ...
      <attribute><code>POOLING_testOnBorrow</code><attribute>true</attribute></attribute>
      <attribute><code>POOLING_validationQuery</code><attribute>select 1 from dual</attribute></attribute>
      <attribute><code>PORT_NUMBER</code><attribute>1574</attribute></attribute>
      <attribute><code>PREFERRED_SCHEMA_NAME</code><attribute>$DB_MAXDAT_SCHEMA</attribute></attribute>
      <attribute><code>QUOTE_ALL_FIELDS</code><attribute>N</attribute></attribute>
      <attribute><code>SQL_CONNECT</code><attribute>ALTER SESSION SET CURRENT_SCHEMA = maxdat_cadr;</attribute></attribute>
      <attribute><code>SUPPORTS_BOOLEAN_DATA_TYPE</code><attribute>N</attribute></attribute>
      <attribute><code>USE_POOLING</code><attribute>Y</attribute></attribute>
    </attributes>
  </connection>
  ...
  <connection>
    ...
    <attributes>
      ...
      <attribute><code>QUOTE_ALL_FIELDS</code><attribute>N</attribute></attribute>
      <attribute><code>SQL_CONNECT</code><attribute>ALTER SESSION SET CURRENT_SCHEMA = etk_maximus_wc_uatest;</attribute></attribute>
      <attribute><code>SUPPORTS_BOOLEAN_DATA_TYPE</code><attribute>N</attribute></attribute>
      <attribute><code>USE_POOLING</code><attribute>N</attribute></attribute>
    </attributes>
  </connection>
  <order>
  <hop> <from>Add constants 2 3 2</from><to>Table output-CORP_ETL_ERROR_LOG 2</to><enabled>Y</enabled> </hop>  <hop> <from>Get Variables 2 3 2</from><to>Add constants 2 3 2</to><enabled>Y</enabled> </hop>  <hop> <from>Insert &#47; Update - INCIDENT_HEADER_STG</from><to>Get Variables 2 3 2</to><enabled>Y</enabled> </hop>  <hop> <from>Database join</from><to>Insert &#47; Update - INCIDENT_HEADER_STG</to><enabled>Y</enabled> </hop>  <hop> <from>Table input</from><to>Database join</to><enabled>Y</enabled> </hop>  </order>
  <step>
    <name>Add constants 2 3 2</name>
    <type>Constant</type>
    <description/>
    ...
    <fields>
      <field>
        ...
        <decimal/>
        <group/>
        <nullif>INCIDENT_HEADER_STG</nullif>
        <length>-1</length>
      ...
      <field>
        ...
        <decimal/>
        <group/>
        <nullif>NYHIX MAIL FAX DOC</nullif>
        <length>-1</length>
        <precision>-1</precision>
      </field>
    </fields>
 ...
 <remotesteps>   <input>   </input>   <output>   </output> </remotesteps>    <GUI>
  ...
  <step>
	...
	CREATE_TS, 
	CREATED_BY_STAFF_ID
FROM INCIDENT_HEADER_STAT_HIST hs
WHERE create_ts &gt;=?
    ...
    <parameter>
      <field>
        <name>last_successful_run_date</name>
        <type>Date</type>
      </field>
    </parameter>
     <cluster_schema/>
 ...
 <remotesteps>   <input>   </input>   <output>   </output> </remotesteps>    <GUI>
  ...
  <step>
    <name>Insert &#47; Update - INCIDENT_HEADER_STG</name>
    ...
    <lookup>
      <schema/>
      <table>INCIDENT_HEADER_STAT_HIST_STG</table>
      <key>
        <name>INCIDENT_HEADER_ID</name>
        <field>INCIDENT_HEADER_ID</field>
        <condition>=</condition>
        <name2/>
      </key>
      <key>
        <name>INCIDENT_HEADER_STAT_HIST_ID</name>
        <field>INCIDENT_HEADER_STAT_HIST_ID</field>
        <condition>=</condition>
        <name2/>
      </key>
      <value>
        <name>INCIDENT_HEADER_STAT_HIST_ID</name>
        <rename>INCIDENT_HEADER_STAT_HIST_ID</rename>
        <update>Y</update>
      </value>
      <value>
        <name>INCIDENT_HEADER_ID</name>
        <rename>INCIDENT_HEADER_ID</rename>
        <update>Y</update>
      </value>
      <value>
        <name>STATUS_CD</name>
        <rename>STATUS_CD</rename>
        <update>Y</update>
      </value>
      <value>
      ...
      <value>
        <name>CREATE_TS</name>
        <rename>CREATE_TS</rename>
        <update>Y</update>
      </value>
      <value>
        <name>CREATED_BY_STAFF_ID</name>
        <rename>CREATED_BY_STAFF_ID</rename>
        <update>N</update>
      </value>
      <value>
        <name>INCIDENT_STATUS</name>
        <rename>INCIDENT_STATUS</rename>
        <update>N</update>
      </value>
    </lookup>
     <cluster_schema/>
...
where name = &apos;MAX_UPDATE_TS_INCIDENT_STATUS_HIST&apos;</sql>
    <limit>0</limit>
    <lookup/>
  ...
  <step>
    ...
    <fields>
        ...
        <field>
          ...
          <stream_name>ERROR_FIELD</stream_name>
        </field>
        <field>
        ...
        <field>
          ...
          <stream_name>INCIDENT_HEADER_ID</stream_name>
        </field>
    </fields>
     <cluster_schema/>
 <remotesteps>   <input>   </input>   <output>   </output> </remotesteps>    <GUI>
  ...
  <step_error_handling>
      <error>
        <source_step>Insert &#47; Update - INCIDENT_HEADER_STG</source_step>
        <target_step>Get Variables 2 3 2</target_step>
        <is_enabled>Y</is_enabled>
        <nr_valuename>NR_OF_ERROR</nr_valuename>
