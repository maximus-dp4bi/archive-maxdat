...
VALUES ('LAEB', 'ETL_AUDIT_DATA_RETENTION_DAYS', 365);

INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('LAEB', 'ETL_RUN_DATA_RETENTION_DAYS', 365);
        
INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('LAEB', 'ETL_LOG_DATA_RETENTION_DAYS', 365);

INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('LAEB', 'MAX_PARALLEL_JOBS_ALLOWED', 7);

INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('LAEB', 'JOB_TIMEOUT_SEC', 3000);
...
VALUES (
	...
	'/u01/maximus/maxdat-prd/LAEBCC8/ETLJobControl/logs',
	SYSDATE,
	USER
);
...
VALUES (
	'LAEB',
	'LOAD NEW QUEUE FLAG FOR ALERTS',
	'STANDALONE',
	'0 9 * * *',
	'Y',
