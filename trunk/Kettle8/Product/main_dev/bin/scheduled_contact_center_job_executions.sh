...
# $URL: svn://rcmxapp1d.maximus.com/maxdat/ContactCenter/trunk/kettle/MAXDAT/product/main/bin/scheduled_contact_center_job_executions.sh $
# $Revision: 10689 $
# $Date: 2015-12-09 16:24:52 -0700 (Wed, 09 Dec 2015) $
# $Author: sk51922 $
