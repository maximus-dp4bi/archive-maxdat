...
ksh $MAXDAT_ETL_PATH/run_kjb.sh $MAXDAT_ETL_PATH/run_load_survey_lkups_2.kjb $KJB_LOG_LEVEL >> $MAXDAT_ETL_LOGS/survey_lkup_load2_$(date +%Y%m%d_%H%M%S).log
