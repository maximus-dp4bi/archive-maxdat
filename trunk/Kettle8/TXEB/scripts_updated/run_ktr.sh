...
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/TX/ETL/scripts/run_ktr.sh $
# $Revision: 5269 $
# $Date: 2013-09-10 17:00:40 -0700 (Tue, 10 Sep 2013) $
# $Author: dd27179 $
PROGNAME=$(basename $0)
pan_status()
{
...
then
	...
	ksh $MAXDAT_KETTLE_DIR/pan.sh -file="$1"  -level="$LOG_LEVEL" 
	ktrrc=$?
	if [[ $ktrrc != 0 ]]
	then #failure
