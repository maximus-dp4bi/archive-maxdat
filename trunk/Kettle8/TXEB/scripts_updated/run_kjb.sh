...
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/TX/ETL/scripts/run_kjb.sh $
# $Revision: 5154 $
# $Date: 2013-09-06 12:35:45 -0700 (Fri, 06 Sep 2013) $
# $Author: dd27179 $
PROGNAME=$(basename $0)
kitchen_status()
{
...
then
   ...
   ksh $MAXDAT_KETTLE_DIR/kitchen.sh -file="$1"  -level="$LOG_LEVEL"
   kjbrc=$?
      if [[ $kjbrc != 0 ]]
      then
          #failure
