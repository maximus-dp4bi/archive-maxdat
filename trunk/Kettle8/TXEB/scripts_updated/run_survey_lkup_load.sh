...
ksh $MAXDAT_ETL_PATH/run_kjb.sh $MAXDAT_ETL_PATH/run_load_survey_lkups.kjb $KJB_LOG_LEVEL >> $MAXDAT_ETL_LOGS/survey_lkup_load_$(date +%Y%m%d_%H%M%S).log
