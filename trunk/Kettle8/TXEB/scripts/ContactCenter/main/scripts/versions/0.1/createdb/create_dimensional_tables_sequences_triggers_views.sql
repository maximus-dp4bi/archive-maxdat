...
CREATE TABLE CC_F_AGENT_BY_DATE
  (
    ...
    D_GROUP_ID              NUMBER (19) NOT NULL ,
    D_SITE_ID               NUMBER (19) NOT NULL ,
    HANDLE_CALLS_COUNT      NUMBER (7) NOT NULL ,
    HANDLE_TIME_SECONDS     NUMBER (7,2) NOT NULL ,
    INTERNAL_CALLS_COUNT    NUMBER (7) NOT NULL ,
    INTERNAL_SECONDS        NUMBER (7,2) NOT NULL ,
    EXTERNAL_CALLS_COUNT    NUMBER (7) NOT NULL ,
    EXTERNAL_SECONDS        NUMBER (7,2) NOT NULL ,
    HOLD_SECONDS            NUMBER (7,2) NOT NULL ,
    RING_SECONDS            NUMBER (7,2) NOT NULL ,
    TALK_SECONDS            NUMBER (7,2) NOT NULL ,
    WRAP_SECONDS            NUMBER (7,2) NOT NULL ,
    FIRST_LOGIN             DATE ,
    LAST_LOGOUT             DATE ,
    LOGIN_SECONDS           NUMBER (7,2) DEFAULT 0 NOT NULL ,
    SCHEDULED_SHIFT_MINUTES NUMBER (6,2) ,
    ACTUAL_SHIFT_MINUTES    NUMBER (6,2) ,
    ACTUAL_OVERTIME_MINUTES NUMBER (6,2) ,
    IDLE_SECONDS            NUMBER (7,2) DEFAULT 0 NOT NULL ,
    NOT_READY_SECONDS       NUMBER (7,2) DEFAULT 0 NOT NULL ,
    TALK_RESERVE_SECONDS    NUMBER (7,2) ,
    PREDICTIVE_TALK_SECONDS NUMBER (7,2) ,
    PREVIEW_TALK_SECONDS    NUMBER (7,2) ,
    PREDICTIVE_CALLS_COUNT  NUMBER (7) ,
    PREVIEW_CALLS_COUNT     NUMBER (7)
  )
  LOGGING ENABLE ROW MOVEMENT ;
