...
ALTER TABLE CC_D_ACTIVITY_TYPE 
    ADD CONSTRAINT CC_D_ACTIVITY_TYPE__UN UNIQUE ( ACTIVITY_TYPE_NAME , RECORD_EFF_DT ) ;
...
ALTER TABLE CC_D_AGENT 
    ADD CONSTRAINT CC_D_AGENT__UN UNIQUE ( LOGIN_ID , RECORD_EFF_DT ) ;
...
ALTER TABLE CC_D_CONTACT_QUEUE 
    ADD CONSTRAINT CC_D_CONTACT_QUEUE__UN UNIQUE ( QUEUE_NUMBER , RECORD_EFF_DT ) ;
...
ALTER TABLE CC_D_GEOGRAPHY_MASTER 
    ADD CONSTRAINT CC_D_GEOGRAPHY_MASTER_PK PRIMARY KEY ( GEOGRAPHY_MASTER_ID ) ;


ALTER TABLE CC_D_GEOGRAPHY_MASTER 
    ADD CONSTRAINT CC_D_GEOGRAPHY_LKUP_NAME_UN UNIQUE ( GEOGRAPHY_NAME ) ;


ALTER TABLE CC_D_GEOGRAPHY_MASTER 
    ADD CONSTRAINT CC_D_GEOGRAPHY_MASTER__UN UNIQUE ( COUNTRY_ID , STATE_ID , PROVINCE_ID , DISTRICT_ID , REGION_ID ) ;
...
ALTER TABLE CC_D_GROUP 
    ADD CONSTRAINT CC_D_GROUP__UN UNIQUE ( GROUP_NAME , RECORD_EFF_DT ) ;
...
ALTER TABLE CC_D_IVR_SELF_SERVICE_PATH 
    ADD CONSTRAINT CC_D_SELF_SERVICE_PATH__UN UNIQUE ( BEGIN_NODE , END_NODE , RECORD_EFF_DT ) ;
...
ALTER TABLE CC_D_PROGRAM 
    ADD CONSTRAINT CC_D_PROGRAM_PK PRIMARY KEY ( PROGRAM_ID ) ;


ALTER TABLE CC_D_PROGRAM 
    ADD CONSTRAINT CC_D_PROGRAM_UNK UNIQUE ( PROGRAM_NAME ) ;
...
ALTER TABLE CC_D_PROJECT 
    ADD CONSTRAINT CC_D_PROJECT_PK PRIMARY KEY ( PROJECT_ID ) ;


ALTER TABLE CC_D_PROJECT 
    ADD CONSTRAINT CC_D_PROJECT_UNK UNIQUE ( PROJECT_NAME ) ;
...
ALTER TABLE CC_D_UNIT_OF_WORK 
    ADD CONSTRAINT CC_D_UNIT_OF_WORK_UK1 UNIQUE ( UNIT_OF_WORK_NAME , PRODUCTION_PLAN_ID ) ;
...
CREATE SEQUENCE SEQ_CC_D_GEOGRAPHY_MASTER 
    START WITH 1 
    INCREMENT BY 1 
    MAXVALUE 9999999999999999999 
    MINVALUE 1 
...
CREATE SEQUENCE SEQ_CC_D_PROGRAM 
    START WITH 1 
    INCREMENT BY 1 
    MAXVALUE 9999999999999999999 
    MINVALUE 1 
...
CREATE SEQUENCE SEQ_CC_D_PROJECT 
    START WITH 1 
    INCREMENT BY 1 
    MAXVALUE 9999999999999999999 
    MINVALUE 1 
