...
CREATE TABLE CC_S_TMP_AVY_SKILLSET 
    ( 
     SKILLSETID NUMBER (10)  NOT NULL , 
     SKILLSET VARCHAR2 (30 CHAR) , 
     "COMMENT" VARCHAR2 (127 CHAR) , 
     ACTIVITYCODE VARCHAR2 (32 CHAR) , 
     TARGETSERVICELEVEL NUMBER (5) , 
...
ALTER TABLE CC_S_TMP_AVY_SKILLSET 
    ADD CONSTRAINT CC_S_TMP_AVY_SKILLSET_PK PRIMARY KEY ( SKILLSETID ) ;



CREATE TABLE CC_S_TMP_AVY_SKILLSETBYAGENT 
    ( 
     SKILLSETID NUMBER (10)  NOT NULL , 
     USERID VARCHAR2 (32 CHAR)  NOT NULL , 
     SKILLSETSTATE VARCHAR2 (80 CHAR) , 
     PRIORITY NUMBER (5) 
    ) 
    LOGGING 
;
...
ALTER TABLE CC_S_TMP_AVY_SKILLSETBYAGENT 
    ADD CONSTRAINT CC_S_TMP_AVY_SKILLBYAGENT_PK PRIMARY KEY ( USERID, SKILLSETID ) ;
...
CREATE TABLE CC_S_TMP_PIPKINS_EVENT_INFO 
    ( 
     EVENT_ID NUMBER (38) , 
...
CREATE TABLE CC_S_TMP_PIPKINS_QUEUE_INFO 
    ( 
     QUEUE_ID NUMBER (38) , 
     NAME VARCHAR2 (250 BYTE) , 
     DESCRIPTION VARCHAR2 (250 BYTE) , 
     EVENT_TYPE_ID NUMBER (38) , 
     PROCESS_DEFINITION_ID NUMBER (38) , 
     DELETE_DATE DATE , 
     PRIORITY NUMBER (38) , 
     QUEUE_TYPE_GROUP_ID NUMBER (38) , 
     QUEUE_TYPE_ID NUMBER (38) , 
     OWNER_USER NUMBER (38) , 
     MODIFY_USER NUMBER (38) , 
     OWNER_DATE DATE , 
     MODIFY_DATE DATE , 
     ESCALATION_QUEUE_ID NUMBER (38) , 
     WORK_CLASSIFICATION_ID NUMBER (38) , 
     OWNER_NAME VARCHAR2 (250 BYTE) 
    ) 
    LOGGING 
;
...
CREATE TABLE CC_S_TMP_PIPKINS_STAFF_INFO 
    ( 
     STAFF_ID NUMBER (38) , 
     ...
     HIRE_DATE DATE , 
     LOCAL_HIRE_DATE DATE , 
     TERMINATION_DATE DATE , 
     LOCAL_TERMINATION_DATE DATE , 
     SCHEDULE_TYPE NUMBER (38) , 
     DELETE_DATE DATE , 
     SENIORITY_EFFECTIVE_DATE DATE , 
     OWNER_USER NUMBER (38) , 
     OWNER_DATE DATE , 
     JC_CODE_ID NUMBER (38) , 
     JC_CODE VARCHAR2 (50 BYTE) , 
     OFFICE_ID NUMBER (38) , 
     OFFICE_NAME VARCHAR2 (50 BYTE) , 
     DEPT_ID NUMBER (38) , 
     DEPT_NAME VARCHAR2 (50 BYTE) , 
     SUP_ID NUMBER (38) , 
     SUP_NAME VARCHAR2 (105 BYTE) , 
     SECONDARY_ID VARCHAR2 (250 BYTE) , 
     STAFF_NAME VARCHAR2 (457 BYTE) , 
...
ALTER TABLE CC_S_WFM_AGENT_ACTIVITY 
    ADD CONSTRAINT CC_S_WFM_AGENT_ACTIVITY__UN UNIQUE ( AGENT_ID , ACTIVITY_END_TIME , ACTIVITY_TYPE_ID ) ;
