...
CREATE TABLE CC_D_ACTIVITY_TYPE
  (
    ...
    ACTIVITY_TYPE_CATEGORY VARCHAR2 (50) NOT NULL ,
    IS_PAID_FLAG           CHAR (1) NOT NULL ,
    IS_AVAILABLE_FLAG      CHAR (1) NOT NULL ,
...
CREATE INDEX CC_D_DATES_D_WEEK_OF_MONTH_IX ON CC_D_DATES
  ...
  LOGGING ;
CREATE UNIQUE INDEX CC_D_DATES_PK ON CC_D_DATES
  (
    D_DATE ASC
  )
  LOGGING ;
  ...
  ;
  ALTER TABLE CC_D_DATES ADD CONSTRAINT CC_D_DATES__UNv1 UNIQUE
  (
    D_DAY_OF_WEEK , D_WEEK_OF_YEAR , D_YEAR
  )
  ;
  ...
  ;
  ALTER TABLE CC_D_DATES ADD CONSTRAINT CC_D_DATES__UNv3 UNIQUE
  (
    D_MONTH_NAME , D_YEAR
  )
  ;
...
(
  COUNTRY_ID , STATE_ID , PROVINCE_ID , DISTRICT_ID , REGION_ID , SITE_ID
)
;
...
CREATE TABLE CC_D_INTERVAL
  (
    ...
    INTERVAL_MINUTES             NUMBER (2) DEFAULT 30 NOT NULL ,
...
(
  D_DATE , D_PROJECT_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_UNIT_OF_WORK_ID , D_INTERVAL_ID
)
;
...
(
  D_DATE , D_PROJECT_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_UNIT_OF_WORK_ID , D_INTERVAL_ID , D_CONTACT_QUEUE_ID , D_AGENT_ID
)
;
...
CREATE UNIQUE INDEX CC_F_AGNT_AVL_DT_D_DT_IDX ON CC_F_AGENT_ACTIVITY_BY_DATE
  ...
  (
    D_DATE , D_AGENT_ID , D_ACTIVITY_TYPE_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_GROUP_ID , D_PROJECT_ID
  )
  ;
...
CREATE TABLE CC_F_AGENT_BY_DATE
  (
    ...
    HANDLE_TIME             NUMBER (7,2) NOT NULL ,
    ...
    HOLD_TIME               NUMBER (7,2) NOT NULL ,
    RING_TIME               NUMBER (7,2) NOT NULL ,
    TALK_TIME               NUMBER (7,2) NOT NULL ,
    WRAP_TIME               NUMBER (7,2) NOT NULL ,
    FIRST_LOGIN             DATE NOT NULL ,
    LAST_LOGOUT             DATE NOT NULL ,
    LOGIN_SECONDS           NUMBER (7,2) DEFAULT 0 NOT NULL ,
    SCHEDULED_SHIFT_MINUTES NUMBER (6,2) NOT NULL ,
    ACTUAL_SHIFT_MINUTES    NUMBER (6,2) NOT NULL ,
    ACTUAL_OVERTIME_MINUTES NUMBER (6,2) NOT NULL
  )
  LOGGING ENABLE ROW MOVEMENT ;
CREATE UNIQUE INDEX CC_F_AGNT_BY_DT_D_DT_ID_IDX ON CC_F_AGENT_BY_DATE
  ...
  (
    D_DATE , D_AGENT_ID , SUPERVISOR_D_AGENT_ID , MANAGER_D_AGENT_ID , D_PROJECT_TARGETS_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_GROUP_ID
  )
  ;
...
(
  D_PRODUCTION_PLAN_HORIZON_ID , D_DATE , D_UNIT_OF_WORK_ID , D_INTERVAL_ID , FORECAST_VERSION
)
;
...
(
  D_IVR_SELF_SERVICE_PATH_ID , D_PROJECT_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_UNIT_OF_WORK_ID , D_INTERVAL_ID , D_DATE
)
;

ALTER TABLE CC_D_GEOGRAPHY_MASTER ADD CONSTRAINT CC_D_GEO_MASTER_D_SITE_FK FOREIGN KEY ( SITE_ID ) REFERENCES CC_D_SITE ( D_SITE_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_AGENT_BY_DATE ADD CONSTRAINT CC_F_AGENT_DATE_D_DATES_FK FOREIGN KEY ( D_DATE ) REFERENCES CC_D_DATES ( D_DATE ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_AGENT_ACTIVITY_BY_DATE ADD CONSTRAINT CC_F_AGNT_ACT_D_DATES_FK FOREIGN KEY ( D_DATE ) REFERENCES CC_D_DATES ( D_DATE ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_ACTUALS_IVR_INTERVAL ADD CONSTRAINT F_ACTLS_IVR_INTRVL_D_DATES_FK FOREIGN KEY ( D_DATE ) REFERENCES CC_D_DATES ( D_DATE ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_ACTUALS_QUEUE_INTERVAL ADD CONSTRAINT F_ACTLS_Q_INTRVL_D_DATES_FK FOREIGN KEY ( D_DATE ) REFERENCES CC_D_DATES ( D_DATE ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_FORECAST_INTERVAL ADD CONSTRAINT F_FORECAST_INT_D_DATES_FK FOREIGN KEY ( D_DATE ) REFERENCES CC_D_DATES ( D_DATE ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT F_IVR_SELF_SVC_D_DATE_FK FOREIGN KEY ( D_DATE ) REFERENCES CC_D_DATES ( D_DATE ) NOT DEFERRABLE ;
...
CREATE OR REPLACE TRIGGER BI_CC_D_PRODUCTION_PLAN_HRZN 
    BEFORE INSERT ON CC_D_PRODUCTION_PLAN_HORIZON 
    FOR EACH ROW 
    ENABLE 
BEGIN
