...
ALTER TABLE ETL_JOB_CONFIG ADD CONSTRAINT ETL_JOB_CONFIG_PK PRIMARY KEY (JOB_ID) USING INDEX TABLESPACE MAXDAT_TBS;
...
GRANT SELECT ON ETL_JOB_CONFIG TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_CONFIG TO MAXDAT_REPORTS;
...
ALTER TABLE ETL_JOB_CONFIG_AUDIT ADD CONSTRAINT ETL_JOB_CONFIG_AUDIT_PK PRIMARY KEY (JOB_ID, AUDIT_TYPE, AUDIT_UPD_DT) USING INDEX TABLESPACE MAXDAT_TBS;
ALTER TABLE ETL_JOB_CONFIG_AUDIT ADD CONSTRAINT ETL_JOB_CONFIG_AUDIT_TYPE_CHECK CHECK (AUDIT_TYPE IN ('DELETE','UPDATE'));

-- grant select on the table
GRANT SELECT ON ETL_JOB_CONFIG_AUDIT TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_CONFIG_AUDIT TO MAXDAT_REPORTS;
...
ALTER TABLE ETL_JOB_STATUS ADD CONSTRAINT ETL_JOB_STATUS_PK PRIMARY KEY (JOB_ID) USING INDEX TABLESPACE MAXDAT_TBS;
...
-- grant select on the table
GRANT SELECT ON ETL_JOB_STATUS TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_STATUS TO MAXDAT_REPORTS;
...
ALTER TABLE ETL_JOB_LIST ADD CONSTRAINT ETL_JOB_LIST_PK PRIMARY KEY (JOB_ID) USING INDEX TABLESPACE MAXDAT_TBS;

-- grant select on the table
GRANT SELECT ON ETL_JOB_LIST TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_LIST TO MAXDAT_REPORTS;
...
ALTER TABLE ETL_JOB_RUN ADD CONSTRAINT ETL_JOB_RUN_PK PRIMARY KEY (RUN_ID) USING INDEX TABLESPACE MAXDAT_TBS;
...
-- grant select on the table
GRANT SELECT ON ETL_JOB_RUN TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_RUN TO MAXDAT_REPORTS;
...
ALTER TABLE ETL_JOB_GLOBAL_CONFIG ADD CONSTRAINT ETL_JOB_GLOBAL_CONFIG_PK PRIMARY KEY (PROJECT_NAME, PARAM_KEY) USING INDEX TABLESPACE MAXDAT_TBS;
...
-- grant select on the table
GRANT SELECT ON ETL_JOB_GLOBAL_CONFIG TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_GLOBAL_CONFIG TO MAXDAT_REPORTS;
...
ALTER TABLE ETL_JOB_LOG ADD CONSTRAINT ETL_JOB_LOG_PK PRIMARY KEY (LOG_ID, LOG_DESC, LOG_UPD_DT) USING INDEX TABLESPACE MAXDAT_TBS;
...
-- grant select on the table
GRANT SELECT ON ETL_JOB_LOG TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_LOG TO MAXDAT_REPORTS;
...
-- add constraints to table ETL_JOB_CONFIG
ALTER TABLE ETL_JOB_HOLD_SKIP ADD CONSTRAINT ETL_JOB_HOLD_SKIP_PK PRIMARY KEY (SEQ_ID) USING INDEX TABLESPACE MAXDAT_TBS;
...
-- grant select on the table
GRANT SELECT ON ETL_JOB_HOLD_SKIP TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_HOLD_SKIP TO MAXDAT_REPORTS;
...
GRANT SELECT ON ETL_JOB_CONFIG_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_CONFIG_SV TO MAXDAT_REPORTS;
...
-- grant select on the view 
GRANT SELECT ON ETL_JOB_CONFIG_AUDIT_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_CONFIG_AUDIT_SV TO MAXDAT_REPORTS;
...
-- grant select on the view 
GRANT SELECT ON ETL_JOB_STATUS_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_STATUS_SV TO MAXDAT_REPORTS;
...
-- grant select on the view 
GRANT SELECT ON ETL_JOB_LIST_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_LIST_SV TO MAXDAT_REPORTS;
...
-- grant select on the view 
GRANT SELECT ON ETL_JOB_RUN_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_RUN_SV TO MAXDAT_REPORTS;
...
-- grant select on the view 
GRANT SELECT ON ETL_JOB_GLOBAL_CONFIG_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_GLOBAL_CONFIG_SV TO MAXDAT_REPORTS;
...
-- grant select on the view 
GRANT SELECT ON ETL_JOB_LOG_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_LOG_SV TO MAXDAT_REPORTS;
...
-- grant select on the view 
GRANT SELECT ON ETL_JOB_HOLD_SKIP_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON ETL_JOB_HOLD_SKIP_SV TO MAXDAT_REPORTS;
