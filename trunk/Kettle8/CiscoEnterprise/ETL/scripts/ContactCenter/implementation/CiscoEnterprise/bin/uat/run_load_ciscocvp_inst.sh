...
#   SVN_FILE_URL := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/Kettle8/CiscoEnterprise/ETL/scripts/ContactCenter/implementation/CiscoEnterprise/bin/uat/run_ciscocvp_stage.sh $'; 
...
#. /u01/maximus/maxdat-uat/CALL8/scripts/main/bin/.set_env
. $BASEDIR/.set_env

PROGNAME=$(basename $0)
echo "Start of program:  $(basename $0)"

JOBS_DIR=$MAXDAT_ETL_PATH//ContactCenter/implementation/CiscoEnterprise/jobs/IVR8
JOB=load_IVR_CISCOCVP_staging
