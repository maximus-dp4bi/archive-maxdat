use role MAXEB_DP4BI_PAIEB_UAT_ADMIN;
use warehouse MAXEB_DP4BI_PAIEB_UAT_LOAD_WH;
use database MAXEB_DP4BI_PAIEB_UAT;

## APP_STATUS_HISTORY ##

create table paieb_UAT.app_status_history ( APP_STATUS_HISTORY_ID number (18) not null, 
                                application_id number (18),
                                status_cd varchar(32),
                                 status_dt date );
                                 
ALTER TABLE "PAIEB_UAT"."APP_STATUS_HISTORY" ADD CONSTRAINT "XPKAPP_STATUS_HISTORY_ID" PRIMARY KEY ("APP_STATUS_HISTORY_ID");

ALTER TABLE "PAIEB_UAT"."APP_STATUS_HISTORY" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
                                 
## APP_MISSING_INFO ##

CREATE TABLE "PAIEB_UAT"."APP_HEADER"
...
ALTER TABLE "PAIEB_UAT"."APP_HEADER" ADD CONSTRAINT "XPKAPP_HEADER" PRIMARY KEY ("APPLICATION_ID");

ALTER TABLE "PAIEB_UAT"."APP_HEADER" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


## APP_HEADER ##

CREATE TABLE "PAIEB_UAT"."APP_MISSING_INFO"
...
ALTER TABLE "PAIEB_UAT"."APP_MISSING_INFO" ADD CONSTRAINT "XPKAPP_MISSING_INFO" PRIMARY KEY ("MISSING_INFO_ID");

ALTER TABLE "PAIEB_UAT"."APP_MISSING_INFO" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


## APP_CASE_LINK ##

CREATE TABLE "PAIEB_UAT"."APP_CASE_LINK"
...
ALTER TABLE "PAIEB_UAT"."APP_CASE_LINK" ADD CONSTRAINT "XPKAPP_CASE_LINK" PRIMARY KEY ("APP_CASE_LINK_ID");

ALTER TABLE "PAIEB_UAT"."APP_CASE_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


## ADDRESS ##


CREATE TABLE "PAIEB_UAT"."ADDRESS"
...
ALTER TABLE "PAIEB_UAT"."ADDRESS" ADD CONSTRAINT "PK_ADDRESS" PRIMARY KEY ("ADDR_ID") ;

ALTER TABLE "PAIEB_UAT"."ADDRESS" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


### CLIENT ###

CREATE TABLE "PAIEB_UAT"."CLIENT"
   (    "CLNT_CLIENT_ID" NUMBER(18,0),
...
ALTER TABLE "PAIEB_UAT"."CLIENT" ADD CONSTRAINT "PK_CLIENT" PRIMARY KEY ("CLNT_CLIENT_ID");

ALTER TABLE "PAIEB_UAT"."CLIENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  CREATE TABLE "PAIEB_UAT"."APP_DOC_DATA"
   (	
...
ALTER TABLE "PAIEB_UAT"."APP_DOC_DATA" ADD CONSTRAINT "XPKAPP_DOC_DATA" PRIMARY KEY ("APP_DOC_DATA_ID");  

ALTER TABLE "PAIEB_UAT"."APP_DOC_DATA" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."APP_ELIG_OUTCOME"
   (	
...
ALTER TABLE "PAIEB_UAT"."APP_ELIG_OUTCOME" ADD CONSTRAINT "XPKAPP_ELIG_OUTCOME" PRIMARY KEY ("APP_ELIG_OUTCOME_ID");  

ALTER TABLE "PAIEB_UAT"."APP_ELIG_OUTCOME" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."APP_HEADER_EXT"
   (	
...
ALTER TABLE "PAIEB_UAT"."APP_HEADER_EXT" ADD CONSTRAINT "XPKAPP_HEADER_EXT_ID" PRIMARY KEY ("APP_HEADER_EXT_ID");
ALTER TABLE "PAIEB_UAT"."APP_HEADER_EXT" ADD CONSTRAINT "UCAPP_EXT_APP_ID" UNIQUE ("APPLICATION_ID");  

ALTER TABLE "PAIEB_UAT"."APP_HEADER_EXT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."APP_INDIVIDUAL"
   (	
    "APP_INDIVIDUAL_ID" NUMBER(18,0),
...
ALTER TABLE "PAIEB_UAT"."APP_INDIVIDUAL" ADD CONSTRAINT "XPKAPP_INDIVIDUAL" PRIMARY KEY ("APP_INDIVIDUAL_ID"); 

ALTER TABLE "PAIEB_UAT"."APP_INDIVIDUAL" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;

 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."DOC_FLEX_FIELD"
   (	
    "DOCUMENT_SET_ID" NUMBER(18,0),
	"DOCUMENT_ID" NUMBER(18,0),
...
ALTER TABLE "PAIEB_UAT"."DOC_FLEX_FIELD" ADD CONSTRAINT "DOC_FLEX_FIELD_PK" PRIMARY KEY ("DOC_FLEX_FIELD_ID");

ALTER TABLE "PAIEB_UAT"."DOC_FLEX_FIELD" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."DOC_LINK"
   (	
...
ALTER TABLE "PAIEB_UAT"."DOC_LINK" ADD CONSTRAINT "DOC_LINK_PK" PRIMARY KEY ("DOC_LINK_ID");
ALTER TABLE "PAIEB_UAT"."DOC_LINK" ADD CONSTRAINT "DOC_LINK_UNIQUE_ID" UNIQUE ("DOCUMENT_ID", "LINK_TYPE_CD", "CASE_ID", "CLIENT_ID", "LINK_REF_ID");

ALTER TABLE "PAIEB_UAT"."DOC_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."DOCUMENT"
   (	
    "DOCUMENT_ID" NUMBER(18,0),
	"DCN" VARCHAR2(256),
...
ALTER TABLE "PAIEB_UAT"."DOCUMENT" ADD CONSTRAINT "DOCUMENT_PK" PRIMARY KEY ("DOCUMENT_ID");  

ALTER TABLE "PAIEB_UAT"."DOCUMENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."DOCUMENT_SET"
   (	
    "DOCUMENT_SET_ID" NUMBER(18,0),
	"ECN" VARCHAR2(256),
...
ALTER TABLE "PAIEB_UAT"."DOCUMENT_SET" ADD CONSTRAINT "DOCUMENT_SET_PK" PRIMARY KEY ("DOCUMENT_SET_ID");

ALTER TABLE "PAIEB_UAT"."DOCUMENT_SET" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."LETTER_REQUEST"
   (	
	...
	"LETTER_OUT_GENERATION_NUM" NUMBER(18,0)
   ) ;
   
ALTER TABLE "PAIEB_UAT"."LETTER_REQUEST" ADD CONSTRAINT "LETTER_REQUESTS_PK" PRIMARY KEY ("LMREQ_ID");

ALTER TABLE "PAIEB_UAT"."LETTER_REQUEST" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."LETTER_REQUEST_LINK"
   (	
...
ALTER TABLE "PAIEB_UAT"."LETTER_REQUEST_LINK" ADD CONSTRAINT "LETTER_REQUEST_LINK_PK" PRIMARY KEY ("LMLINK_ID");

ALTER TABLE "PAIEB_UAT"."LETTER_REQUEST_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_UAT"."NOTIFICATION_REQUEST"
   (	
...
ALTER TABLE "PAIEB_UAT"."NOTIFICATION_REQUEST" ADD CONSTRAINT "XPKNOTIFICATION_REQUEST" PRIMARY KEY ("NOTIFICATION_REQUEST_ID");

ALTER TABLE "PAIEB_UAT"."NOTIFICATION_REQUEST" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------


  CREATE TABLE "PAIEB_UAT"."STEP_INSTANCE"
   (	
...
ALTER TABLE "PAIEB_UAT"."STEP_INSTANCE" ADD CONSTRAINT "XPKSTEP_INSTANCE" PRIMARY KEY ("STEP_INSTANCE_ID");

ALTER TABLE "PAIEB_UAT"."STEP_INSTANCE" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_UAT"."APP_STATUS"
   (	
    
	"APP_STATUS_CODE" VARCHAR2(128),
	"APP_STATUS" VARCHAR2(128),
	"DISPLAY_ORDER" NUMBER(4),
	"INVENTORY_INDICATOR" NUMBER(3)
   );
   
   ALTER TABLE "PAIEB_UAT"."APP_STATUS" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


   ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   
   
    CREATE TABLE "PAIEB_UAT"."PHONE_NUMBER"
   (
   "PHON_ID"                 NUMBER(38)  NOT NULL ,    
   "PHON_BEGIN_DATE"                  TIMESTAMP_NTZ       ,    
   "PHON_TYPE_CD"                  VARCHAR2(32),   
   "PHON_END_DATE"                  TIMESTAMP_NTZ        ,   
   ...
   "PHON_BAD_DATE"                    TIMESTAMP_NTZ         ,  
   "PHON_BAD_DATE_SATISFIED"          TIMESTAMP_NTZ         ,  
"COMPARABLE_KEY"                   VARCHAR2(2000)
);

 ALTER TABLE "PAIEB_UAT"."PHONE_NUMBER" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_UAT"."ASSESSMENT"
   (
...
"UPDATE_TS"                            TIMESTAMP_NTZ,         
"STATUS_TS"                    TIMESTAMP_NTZ NOT NULL,         
...
ALTER TABLE "PAIEB_UAT"."ASSESSMENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_UAT"."CALENDAR_ITEM"
   (
   "CALENDAR_ITEM_ID"       NUMBER(18) NOT NULL ,   
   "TITLE"                          VARCHAR2(100),  
   ...
   "RECURRING_IND"                  NUMBER(1)      ,
   "RECURRENCE_ID"                  NUMBER(18)     ,
   "TRANSPARENCY_IND"               NUMBER(1)      ,
   "PUBLIC_IND"                     NUMBER(1)      ,
...
ALTER TABLE "PAIEB_UAT"."CALENDAR_ITEM" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_UAT"."APP_ADV_PLAN_SELECTION"
 (
 ...
 "SENT_DATE"                               TIMESTAMP_NTZ          , 
 "RESPONSE_RECEIVED_DATE"                  TIMESTAMP_NTZ          , 
 "CREATED_BY"                              VARCHAR2(80)  , 
 "CREATE_TS"                               TIMESTAMP_NTZ          , 
 "UPDATED_BY"                              VARCHAR2(80)  , 
 "UPDATE_TS"                               TIMESTAMP_NTZ          , 
...
ALTER TABLE "PAIEB_UAT"."APP_ADV_PLAN_SELECTION" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------


 CREATE TABLE "PAIEB_UAT"."SELECTION_TXN"
 (
...
FOLLOWUP_CALL_DATE                     TIMESTAMP_NTZ,  
FOLLOWUP_FORM_RCV_DATE                 TIMESTAMP_NTZ,  
...
PRIOR_SELECTION_START_DATE             TIMESTAMP_NTZ,  
PRIOR_SELECTION_END_DATE               TIMESTAMP_NTZ,  
...
ORIGINAL_START_DATE                    TIMESTAMP_NTZ,  
ORIGINAL_END_DATE                      TIMESTAMP_NTZ,  
SELECTION_GENERIC_FIELD1_DATE          TIMESTAMP_NTZ,  
SELECTION_GENERIC_FIELD2_DATE          TIMESTAMP_NTZ,  
...
COMMITTIMESTAMP TIMESTAMP_NTZ);

 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 
 CREATE TABLE "PAIEB_UAT"."SELECTION_SEGMENT"
 (
...
COMMITTIMESTAMP		TIMESTAMP_NTZ);
 ...
 CREATE TABLE "PAIEB_UAT"."ASSESSMENT_HIST"
 (
ASSESSMENT_HIST_ID          NUMBER(18) NOT NULL , 
ASSESSMENT_ID                        NUMBER(18)  , 
ASSESSMENT_TYPE_CD                   VARCHAR2(32), 
CALENDAR_ITEM_ID                     NUMBER(18)  , 
NURSE_ID                             NUMBER(18)  , 
CLIENT_ID                            NUMBER(18)  , 
STATUS_CD                            VARCHAR2(32), 
EFFECTIVE_DATE                       TIMESTAMP_NTZ,         
