...
create table paieb_PRD.app_status_history ( APP_STATUS_HISTORY_ID number (18) not null, 
                                application_id number (18),
                                status_cd varchar(32),
                                 status_dt date );
                                 
ALTER TABLE "PAIEB_PRD"."APP_STATUS_HISTORY" ADD CONSTRAINT "XPKAPP_STATUS_HISTORY_ID" PRIMARY KEY ("APP_STATUS_HISTORY_ID");

ALTER TABLE "PAIEB_PRD"."APP_STATUS_HISTORY" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
                                 
## APP_MISSING_INFO ##

CREATE TABLE "PAIEB_PRD"."APP_HEADER"
...
ALTER TABLE "PAIEB_PRD"."APP_HEADER" ADD CONSTRAINT "XPKAPP_HEADER" PRIMARY KEY ("APPLICATION_ID");

ALTER TABLE "PAIEB_PRD"."APP_HEADER" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


## APP_HEADER ##

CREATE TABLE "PAIEB_PRD"."APP_MISSING_INFO"
...
ALTER TABLE "PAIEB_PRD"."APP_MISSING_INFO" ADD CONSTRAINT "XPKAPP_MISSING_INFO" PRIMARY KEY ("MISSING_INFO_ID");

ALTER TABLE "PAIEB_PRD"."APP_MISSING_INFO" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


## APP_CASE_LINK ##

CREATE TABLE "PAIEB_PRD"."APP_CASE_LINK"
...
ALTER TABLE "PAIEB_PRD"."APP_CASE_LINK" ADD CONSTRAINT "XPKAPP_CASE_LINK" PRIMARY KEY ("APP_CASE_LINK_ID");

ALTER TABLE "PAIEB_PRD"."APP_CASE_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


## ADDRESS ##


CREATE TABLE "PAIEB_PRD"."ADDRESS"
...
ALTER TABLE "PAIEB_PRD"."ADDRESS" ADD CONSTRAINT "PK_ADDRESS" PRIMARY KEY ("ADDR_ID") ;

ALTER TABLE "PAIEB_PRD"."ADDRESS" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


### CLIENT ###

CREATE TABLE "PAIEB_PRD"."CLIENT"
   (    "CLNT_CLIENT_ID" NUMBER(18,0),
...
ALTER TABLE "PAIEB_PRD"."CLIENT" ADD CONSTRAINT "PK_CLIENT" PRIMARY KEY ("CLNT_CLIENT_ID");

ALTER TABLE "PAIEB_PRD"."CLIENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  CREATE TABLE "PAIEB_PRD"."APP_DOC_DATA"
   (	
...
ALTER TABLE "PAIEB_PRD"."APP_DOC_DATA" ADD CONSTRAINT "XPKAPP_DOC_DATA" PRIMARY KEY ("APP_DOC_DATA_ID");  

ALTER TABLE "PAIEB_PRD"."APP_DOC_DATA" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."APP_ELIG_OUTCOME"
   (	
...
ALTER TABLE "PAIEB_PRD"."APP_ELIG_OUTCOME" ADD CONSTRAINT "XPKAPP_ELIG_OUTCOME" PRIMARY KEY ("APP_ELIG_OUTCOME_ID");  

ALTER TABLE "PAIEB_PRD"."APP_ELIG_OUTCOME" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."APP_HEADER_EXT"
   (	
...
ALTER TABLE "PAIEB_PRD"."APP_HEADER_EXT" ADD CONSTRAINT "XPKAPP_HEADER_EXT_ID" PRIMARY KEY ("APP_HEADER_EXT_ID");
ALTER TABLE "PAIEB_PRD"."APP_HEADER_EXT" ADD CONSTRAINT "UCAPP_EXT_APP_ID" UNIQUE ("APPLICATION_ID");  

ALTER TABLE "PAIEB_PRD"."APP_HEADER_EXT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."APP_INDIVIDUAL"
   (	
    "APP_INDIVIDUAL_ID" NUMBER(18,0),
...
ALTER TABLE "PAIEB_PRD"."APP_INDIVIDUAL" ADD CONSTRAINT "XPKAPP_INDIVIDUAL" PRIMARY KEY ("APP_INDIVIDUAL_ID"); 

ALTER TABLE "PAIEB_PRD"."APP_INDIVIDUAL" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;

 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."DOC_FLEX_FIELD"
   (	
    "DOCUMENT_SET_ID" NUMBER(18,0),
	"DOCUMENT_ID" NUMBER(18,0),
...
ALTER TABLE "PAIEB_PRD"."DOC_FLEX_FIELD" ADD CONSTRAINT "DOC_FLEX_FIELD_PK" PRIMARY KEY ("DOC_FLEX_FIELD_ID");

ALTER TABLE "PAIEB_PRD"."DOC_FLEX_FIELD" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."DOC_LINK"
   (	
...
ALTER TABLE "PAIEB_PRD"."DOC_LINK" ADD CONSTRAINT "DOC_LINK_PK" PRIMARY KEY ("DOC_LINK_ID");
ALTER TABLE "PAIEB_PRD"."DOC_LINK" ADD CONSTRAINT "DOC_LINK_UNIQUE_ID" UNIQUE ("DOCUMENT_ID", "LINK_TYPE_CD", "CASE_ID", "CLIENT_ID", "LINK_REF_ID");

ALTER TABLE "PAIEB_PRD"."DOC_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."DOCUMENT"
   (	
    "DOCUMENT_ID" NUMBER(18,0),
	"DCN" VARCHAR2(256),
...
ALTER TABLE "PAIEB_PRD"."DOCUMENT" ADD CONSTRAINT "DOCUMENT_PK" PRIMARY KEY ("DOCUMENT_ID");  

ALTER TABLE "PAIEB_PRD"."DOCUMENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."DOCUMENT_SET"
   (	
    "DOCUMENT_SET_ID" NUMBER(18,0),
	"ECN" VARCHAR2(256),
...
ALTER TABLE "PAIEB_PRD"."DOCUMENT_SET" ADD CONSTRAINT "DOCUMENT_SET_PK" PRIMARY KEY ("DOCUMENT_SET_ID");

ALTER TABLE "PAIEB_PRD"."DOCUMENT_SET" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."LETTER_REQUEST"
   (	
...
ALTER TABLE "PAIEB_PRD"."LETTER_REQUEST" ADD CONSTRAINT "LETTER_REQUESTS_PK" PRIMARY KEY ("LMREQ_ID");

ALTER TABLE "PAIEB_PRD"."LETTER_REQUEST" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."LETTER_REQUEST_LINK"
   (	
...
ALTER TABLE "PAIEB_PRD"."LETTER_REQUEST_LINK" ADD CONSTRAINT "LETTER_REQUEST_LINK_PK" PRIMARY KEY ("LMLINK_ID");

ALTER TABLE "PAIEB_PRD"."LETTER_REQUEST_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

  CREATE TABLE "PAIEB_PRD"."NOTIFICATION_REQUEST"
   (	
...
ALTER TABLE "PAIEB_PRD"."NOTIFICATION_REQUEST" ADD CONSTRAINT "XPKNOTIFICATION_REQUEST" PRIMARY KEY ("NOTIFICATION_REQUEST_ID");

ALTER TABLE "PAIEB_PRD"."NOTIFICATION_REQUEST" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------


  CREATE TABLE "PAIEB_PRD"."STEP_INSTANCE"
   (	
...
ALTER TABLE "PAIEB_PRD"."STEP_INSTANCE" ADD CONSTRAINT "XPKSTEP_INSTANCE" PRIMARY KEY ("STEP_INSTANCE_ID");

ALTER TABLE "PAIEB_PRD"."STEP_INSTANCE" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_PRD"."APP_STATUS"
   (	
   ...
   ALTER TABLE "PAIEB_PRD"."APP_STATUS" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


   ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   
   
    CREATE TABLE "PAIEB_PRD"."PHONE_NUMBER"
   (
...
"COMPARABLE_KEY"                   VARCHAR2(2000)
 ...
 ALTER TABLE "PAIEB_PRD"."PHONE_NUMBER" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_PRD"."ASSESSMENT"
   (
...
ALTER TABLE "PAIEB_PRD"."ASSESSMENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_PRD"."CALENDAR_ITEM"
   (
   "CALENDAR_ITEM_ID"       NUMBER(18) NOT NULL ,   
   "TITLE"                          VARCHAR2(100),  
...
ALTER TABLE "PAIEB_PRD"."CALENDAR_ITEM" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_PRD"."APP_ADV_PLAN_SELECTION"
 (
...
ALTER TABLE "PAIEB_PRD"."APP_ADV_PLAN_SELECTION" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------


 CREATE TABLE "PAIEB_PRD"."SELECTION_TXN"
 (
...
COMMITTIMESTAMP TIMESTAMP_NTZ);
 ...
 CREATE TABLE "PAIEB_PRD"."SELECTION_SEGMENT"
 (
...
COMMITTIMESTAMP		TIMESTAMP_NTZ);
 ...
 CREATE TABLE "PAIEB_PRD"."ASSESSMENT_HIST"
 (
