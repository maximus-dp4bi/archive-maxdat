...
ALTER TABLE "PAIEB_DEV"."APP_STATUS_HISTORY" ADD CONSTRAINT "XPKAPP_STATUS_HISTORY_ID" PRIMARY KEY ("APP_STATUS_HISTORY_ID");

ALTER TABLE "PAIEB_DEV"."APP_STATUS_HISTORY" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
...
ALTER TABLE "PAIEB_DEV"."APP_HEADER" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
...
ALTER TABLE "PAIEB_DEV"."APP_MISSING_INFO" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
...
ALTER TABLE "PAIEB_DEV"."APP_CASE_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
...
ALTER TABLE "PAIEB_DEV"."ADDRESS" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
...
ALTER TABLE "PAIEB_DEV"."CLIENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
...
ALTER TABLE "PAIEB_DEV"."APP_DOC_DATA" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."APP_ELIG_OUTCOME" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."APP_HEADER_EXT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."APP_INDIVIDUAL" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
...
ALTER TABLE "PAIEB_DEV"."DOC_FLEX_FIELD" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."DOC_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."DOCUMENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."DOCUMENT_SET" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."LETTER_REQUEST" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."LETTER_REQUEST_LINK" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."NOTIFICATION_REQUEST" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ALTER TABLE "PAIEB_DEV"."STEP_INSTANCE" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_DEV"."APP_STATUS"
   (	
   ...
   ALTER TABLE "PAIEB_DEV"."APP_STATUS" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;


   ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   
   
    CREATE TABLE "PAIEB_DEV"."PHONE_NUMBER"
   (
...
"COMPARABLE_KEY"                   VARCHAR2(2000)
 ...
 ALTER TABLE "PAIEB_DEV"."PHONE_NUMBER" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_DEV"."ASSESSMENT"
   (
...
ALTER TABLE "PAIEB_DEV"."ASSESSMENT" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_DEV"."CALENDAR_ITEM"
   (
   "CALENDAR_ITEM_ID"       NUMBER(18) NOT NULL ,   
   "TITLE"                          VARCHAR2(100),  
...
ALTER TABLE "PAIEB_DEV"."CALENDAR_ITEM" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

 CREATE TABLE "PAIEB_DEV"."APP_ADV_PLAN_SELECTION"
 (
...
ALTER TABLE "PAIEB_DEV"."APP_ADV_PLAN_SELECTION" ADD COLUMN COMMITTIMESTAMP TIMESTAMP_NTZ;
 ...
 CREATE TABLE "PAIEB_DEV"."SELECTION_TXN"
 (
...
COMMITTIMESTAMP TIMESTAMP_NTZ);
 ...
 CREATE TABLE "PAIEB_DEV"."SELECTION_SEGMENT"
 (
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 CREATE TABLE "PAIEB_DEV"."ASSESSMENT_HIST"
 (
