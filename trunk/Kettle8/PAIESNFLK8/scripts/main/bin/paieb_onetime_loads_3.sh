...
# ================================================================================
$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/jobs/PAIEB_OneTime_Loads_3.kjb" -level="$KJB_LOG_LEVEL"  > $MAXDAT_ETL_LOGS/PAIEB_OneTime_Loads_3_$(date +%Y%m%d_%H%M%S).log
