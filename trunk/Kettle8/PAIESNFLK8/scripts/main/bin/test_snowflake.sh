...
# ================================================================================
$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/TechRefresh/PAIEB_OneTime_Loads.kjb" -level="$KJB_LOG_LEVEL"  > $MAXDAT_ETL_LOGS/${STCODE}_PAIEB_OneTime_Loads_$(date +%Y%m%d_%H%M%S).log
