...
$MAXDAT_ETL_PATH/Run_TN_CoverKids_Weekly.sh > $MAXDAT_ETL_LOGS/Run_TN_CoverKids_Weekly_$(date +%Y%m%d_%H%M%S).log

$MAXDAT_ETL_PATH/Run_TN_CoverKids_Cumulative.sh > $MAXDAT_ETL_LOGS/Run_TN_CoverKids_Cumulative_$(date +%Y%m%d_%H%M%S).log