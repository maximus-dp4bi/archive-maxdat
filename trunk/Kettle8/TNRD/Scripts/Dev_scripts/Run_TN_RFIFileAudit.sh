...
#---------------------------------
# SVN_FILE_URL        = $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/TNRD/scripts/Run_TN_RFIFileAudit.sh $ 
...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/TN_RFIFile_Audit_Report_Job.kjb" -log="$LOG_FILE" -level="$LOG_LEVEL"