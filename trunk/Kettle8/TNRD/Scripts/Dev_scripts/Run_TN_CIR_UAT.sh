...
#---------------------------------
# SVN_FILE_URL        = $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/TNRD/scripts/Run_TN_CIR_UAT.sh $ 
# SVN_REVISION        = $Revision: 16314 $ 
# SVN_REVISION_DATE   = $Date: 2016-01-11 14:52:56 -0800 (Mon, 11 Jan 2016) $
...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/TN_ComprehensiveInventory_Report_Job.kjb" -log="$LOG_FILE" -level="$LOG_LEVEL"