...
#---------------------------------
# SVN_FILE_URL        = $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/TNRD/scripts/Run_TN_CoverKids.sh $ 
# SVN_REVISION        = $Revision: 16067 $ 
# SVN_REVISION_DATE   = $Date: 2015-12-17 10:42:34 -0800 (Thu, 17 Dec 2015) $
...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/TN_CoverKids_Report_Job.kjb" -log="$LOG_FILE" -level="$LOG_LEVEL"