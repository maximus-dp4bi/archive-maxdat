...
#init check
ksh $MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/emrs_Init_check.kjb" -level="$DETAIL_LOG_LEVEL"  >> $MAXDAT_ETL_LOGS/$MODULE_INIT/il_erms_init_check_$(date +%Y%m%d_%H%M%S).log
