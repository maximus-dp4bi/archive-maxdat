...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ProcessIncidents/Process_Incidents_Subprogram_type_upd_one_time.kjb" -log="$LOG_DIR/Process_Incidents_Subprogram_type_upd_one_time.LOG" -level="$DETAIL_LOG_LEVEL"
