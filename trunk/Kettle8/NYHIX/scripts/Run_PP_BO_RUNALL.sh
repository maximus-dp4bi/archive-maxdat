...
# $URL: svn://rcmxapp1d.maximus.com/maxdat/trunk/NYHIX/ETL/scripts/Run_PP_BO_RUNALL.sh $
# $Revision: 15319 $
# $Date: 2015-09-18 14:22:52 -0700 (Fri, 18 Sep 2015) $
# $Author: pa28085 $
# =================================================================================
...
$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/${MODULE_PP}/PP_Back_Office_RUNALL.kjb" -log="$MAXDAT_ETL_LOGS/${MODULE_PP}/PP_Back_Office_RUNALL_$(date +%Y%m%d_%H%M%S).LOG" -level="$DETAIL_LOG_LEVEL"
