...
KJB_LOG_ROWLEVEL="Rowlevel"
     ...
     $MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/${MODULE_INIT_MFD}/DLY_Run_Initialization_MFD.kjb" -level="$KJB_LOG_LEVEL"  >> $MAXDAT_ETL_LOGS/${MODULE_INIT_MFD}/DLY_Run_Init_MFD_$(date +%Y%m%d_%H%M%S).log
