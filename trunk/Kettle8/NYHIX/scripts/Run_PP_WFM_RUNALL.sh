...
$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/${MODULE_ATL}/PP_WFM_RUNALL.kjb" -log="$MAXDAT_ETL_LOGS/${MODULE_ATL}/PP_WFM_RUNALL_$(date +%Y%m%d_%H%M%S).LOG" -level="$DETAIL_LOG_LEVEL"
