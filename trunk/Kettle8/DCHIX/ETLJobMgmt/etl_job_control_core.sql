...
--ALTER TABLE ETL_JOB_CONFIG ADD CONSTRAINT ETL_JOB_CONFIG_PROJECT_NAME_FK FOREIGN KEY (PROJECT_NAME) REFERENCES CC_A_SOURCE_LKUP (PROJECT_NAME); 
...
--ALTER TABLE ETL_JOB_GLOBAL_CONFIG ADD CONSTRAINT ETL_JOB_GLOBAL_CONFIG_PROJECT_NAME_FK FOREIGN KEY (PROJECT_NAME) REFERENCES CC_A_SOURCE_LKUP (PROJECT_NAME); 
