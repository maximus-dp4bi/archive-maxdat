#!/bin/bash
#. ~/.bash_profile
. /u01/maximus/maxdat-prd/DCHIX8/scripts/ContactCenter/implementation/DCHIX8/bin/.set_env
...
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/ContactCenter/trunk/kettle/MAXDAT/implementation/PA/bin/purge_cc_logs.sh $
# $Revision: 23101 $
# $Date: 2018-04-20 14:04:05 -0400 (Fri, 20 Apr 2018) $
# $Author: TM151500 $
# ====================================================================================================================================================================
