...
CREATE TABLE ETL_JOB_CONFIG(
    ...
    JOB_SCHEDULE        VARCHAR2(30)    NULL,
    JOB_ENABLED         VARCHAR2(1)     NOT NULL,
    JOB_SCRIPT_NAME     VARCHAR2(50)    NOT NULL,
...
ALTER TABLE ETL_JOB_CONFIG ADD CONSTRAINT ETL_JOB_CONFIG_PROJECT_NAME_FK FOREIGN KEY (PROJECT_NAME) REFERENCES MAXDAT_PA.CC_A_SOURCE_LKUP (PROJECT_NAME); 
...
ALTER TABLE ETL_JOB_GLOBAL_CONFIG ADD CONSTRAINT ETL_JOB_GLOBAL_CONFIG_PROJECT_NAME_FK FOREIGN KEY (PROJECT_NAME) REFERENCES MAXDAT_PA.CC_A_SOURCE_LKUP (PROJECT_NAME); 
