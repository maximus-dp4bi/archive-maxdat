...
$CUSTOM_DIR/run_kjb_20190626.sh $CUSTOM_DIR/ProcessDocuments_V2/ProcessDocuments_V2_RUNALL.kjb >> $LOG_DIR/ProcessDocuments_V2_RUNALL_$(date +%Y%m%d_%H%M%S).log &
