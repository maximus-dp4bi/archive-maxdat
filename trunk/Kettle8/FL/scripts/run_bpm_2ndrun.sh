...
LOG_DIR="/opt/maxbi/ETL/scripts"
LOG_LEVEL="Detailed"

CHILD_FAIL="/tmp/daily_child_task_fail_2ndrun.txt"

#mail related variables
EMAIL="MAXDatSystem@maximus.com"
EMAIL_MESSAGE="/tmp/run_bpm-ERROR-LOG2nd.txt"
EMAIL_SUBJECT="Errors with Florida run_bpm.sh 2ndrun daily"
