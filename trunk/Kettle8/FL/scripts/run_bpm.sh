...
#PATH=$KETTLE_FL_HOME/.kettle/kettle.properties:.:/opt/maxdat/pentaho_8.3/data-integration/:$PATH
#export PATH
...
export CHILD_FAIL="/tmp/child_task_fail.txt"
#mail related variables
export EMAIL="MAXDatSystem@maximus.com"
export EMAIL_MESSAGE="/tmp/run_bpm-ERROR-LOG.txt"
export EMAIL_SUBJECT="Errors with Florida run_bpm.sh"
...
# 1 	Errors occurred during process
