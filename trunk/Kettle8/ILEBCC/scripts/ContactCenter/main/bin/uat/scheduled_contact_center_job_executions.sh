...
#   SVN_FILE_URL := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/Kettle8/ILEBCC/scripts/ContactCenter/main/bin/dev/scheduled_contact_center_job_executions.sh $'; 
...
#. $MAXDAT_ETL_PATH/ILEBCC8/scripts/ContactCenter/implementation/ILEBCC/bin/set_env_vars.sh
