...
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/Kettle8/PAIEB/ETL/scripts/uat_set_env8.sh $
# $Revision: 30776 $
# $Date: 2020-09-10 10:11:34 -0500 (Thu, 10 Sep 2020) $
# $Author: ss153729 $
# =======================================================================
#
...
export ETL_JOBCONTROL_LOG_PATH="/u01/maximus/maxdat-$ENV_CODE/$STCODE/logs"
export ETL_JOBCONTROL_DATA_PATH="/u01/maximus/maxdat-$ENV_CODE/$STCODE/data"
export ETL_JOBCONTROL_SQL_PATH="/u01/maximus/maxdat-$ENV_CODE/$STCODE/sql"
