...
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/Kettle8/PAIEB/ETL/scripts/purge_logs.sh $
# $Revision: 27494 $
# $Date: 2019-06-25 19:40:17 -0500 (Tue, 25 Jun 2019) $
# $Author: TM151500 $
# ====================================================================================================================================================================
# Script Name:  purge_logs.sh
...
# TAM		06/17/2019	Added the function get_script_dir and modified for usage with PAIEB.
# ====================================================================================================================================================================
#
...
SCRIPT_LOG_FILE_NAME=purge_logs_$SCRIPT_LOG_TIMESTAMP.log
