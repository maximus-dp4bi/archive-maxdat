...
CREATE OR REPLACE TABLE raw.pi_files_to_ingest_1501 AS SELECT * FROM raw.pi_files_to_ingest;

TRUNCATE TABLE raw.pi_files_to_ingest_2222;
TRUNCATE TABLE raw.pi_files_to_ingest_740;
TRUNCATE TABLE raw.pi_files_to_ingest_1501;
...
GRANT SELECT, REFERENCES ON TABLE WRAPUP_MAPPING TO ROLE KYVOS_DP4BI_PROD_READ;
GRANT SELECT, REFERENCES ON TABLE WRAPUP_MAPPING TO ROLE MAX_QA;
GRANT UPDATE, TRUNCATE, SELECT, REFERENCES, REBUILD, INSERT, DELETE ON WRAPUP_MAPPING TO ROLE PUREINSIGHTS_PROD_POC;
GRANT SELECT, REFERENCES ON TABLE WRAPUP_MAPPING TO ROLE PUREINSIGHTS_PROD_READ;
...
INSERT INTO WRAPUP_MAPPING SELECT * FROM PUREINSIGHTS_UAT.RAW.WRAPUP_MAPPING;
