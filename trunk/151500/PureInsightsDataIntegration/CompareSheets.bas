Attribute VB_Name = "CompareSheets"
Sub CompareSheets(sheetOneName As String, sheetTwoName As String, NumRows As Long, NumCols As Long)
    ...
    For thisRow = 1 To NumRows
        ...
        For thisCol = 1 To NumCols
            ...
            If UCase(Trim(sheetOne.Cells(thisRow, thisCol).Value)) = "NULL" Or UCase(Trim(sheetOne.Cells(thisRow, thisCol).Value)) = "[NULL]" Then
                sheetOne.Cells(thisRow, thisCol).Value = ""
            End If
        
            If UCase(Trim(sheetTwo.Cells(thisRow, thisCol).Value)) = "NULL" Or UCase(Trim(sheetTwo.Cells(thisRow, thisCol).Value)) = "NULL" Then
...
Sub Compare_Sheets()
    ...
    Call CompareSheets("TableSourceData", "TableTargetData", 1, 20)
