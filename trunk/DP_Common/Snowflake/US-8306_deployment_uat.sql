...
CREATE OR REPLACE VIEW D_PROJECT_HOLIDAYS_SV AS
SELECT * FROM DECISIONPOINT_UAT.PUBLIC.D_PROJECT_HOLIDAYS_SV;

GRANT SELECT ON D_PROJECT_HOLIDAYS_SV TO PUREINSIGHTS_GEN_DP4BI_UAT;
GRANT SELECT ON D_PROJECT_HOLIDAYS_SV TO PUREINSIGHTS_UAT_READ;
...
GRANT SELECT ON D_PROJECT_HOLIDAYS_SV TO MARS_DP4BI_UAT_READ;
