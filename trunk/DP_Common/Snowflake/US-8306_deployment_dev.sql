...
CREATE OR REPLACE VIEW D_PROJECT_HOLIDAYS_SV AS
SELECT * FROM DECISIONPOINT_DEV.PUBLIC.D_PROJECT_HOLIDAYS_SV;

GRANT SELECT ON D_PROJECT_HOLIDAYS_SV TO PUREINSIGHTS_GEN_DP4BI_DEV;
GRANT SELECT ON D_PROJECT_HOLIDAYS_SV TO PUREINSIGHTS_DEV_READ;
...
GRANT SELECT ON D_PROJECT_HOLIDAYS_SV TO MARS_DP4BI_DEV_READ;
GRANT SELECT ON D_PROJECT_HOLIDAYS_SV TO MARS_DP4BI_DEV;
