...
select 
	...
	MONTHLONG
from
    PUREINSIGHTS_UAT.PUBLIC.D_DATES;
...
SELECT * FROM DECISIONPOINT_UAT.PUBLIC.D_DATES_SV;

GRANT SELECT ON D_DATES_COMMON_SV TO MARS_DP4BI_UAT_READ;
GRANT SELECT ON D_DATES_COMMON_SV TO MARS_DP4BI_UAT_ADMIN;
...
GRANT SELECT ON D_DATES_COMMON_SV TO PUREINSIGHTS_GEN_DP4BI_UAT;
GRANT SELECT ON D_DATES_COMMON_SV TO PUREINSIGHTS_UAT_READ;
