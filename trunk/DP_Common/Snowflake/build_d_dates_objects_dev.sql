...
use database DECISIONPOINT_DEV;
use schema PUBLIC;
...
select 
	...
	MONTHLONG
from
    PUREINSIGHTS_DEV.PUBLIC.D_DATES;
...
SELECT * FROM DECISIONPOINT_DEV.PUBLIC.D_DATES_SV;

GRANT SELECT ON D_DATES_COMMON_SV TO MARS_DP4BI_DEV_READ;
GRANT SELECT ON D_DATES_COMMON_SV TO MARS_DP4BI_DEV;
...
GRANT SELECT ON D_DATES_COMMON_SV TO PUREINSIGHTS_GEN_DP4BI_DEV;
GRANT SELECT ON D_DATES_COMMON_SV TO PUREINSIGHTS_DEV_READ;
