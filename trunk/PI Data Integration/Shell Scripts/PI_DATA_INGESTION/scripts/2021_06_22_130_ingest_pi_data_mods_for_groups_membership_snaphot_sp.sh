...
/snowsql/snowsql -c ${INGEST_C} -o exit_on_error=true -o friendly=false -o header=false -o timing=false -o output_format=plain -q " call ${DB}.stage.update_groups_membership_daily_snapshot(${REINGEST_FLAG});"
