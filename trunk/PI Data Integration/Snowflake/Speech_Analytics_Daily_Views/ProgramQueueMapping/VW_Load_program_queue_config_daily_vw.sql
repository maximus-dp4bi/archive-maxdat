create or replace view LOAD_PI_TRANSCRIPTION_PROGRAM_QUEUE_MAPPING_HISTORY_VW as         
SELECT 
PROJECTID
, PROJECTNAME
, PROGRAMID
...
RAW:queueId::varchar AS QUEUEId,
...
FROM PUREINSIGHTS_DEV.RAW.TRANSCRIPTION_PROGRAM_QUEUE_MAPPING;