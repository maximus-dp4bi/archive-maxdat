...
Create table FLHK_ETL_MONITOR_DISPUTES_OLTP
(
...
CREATE UNIQUE INDEX "DISPUTE_ID_PK1" ON "FLHK_ETL_MONITOR_DISPUTES_OLTP" ("DISPUTE_ID");
...
ALTER TABLE "FLHK_ETL_MONITOR_DISPUTES_OLTP" ADD CONSTRAINT "DISPUTE_ID_PK1" PRIMARY KEY ("DISPUTE_ID") ENABLE;
