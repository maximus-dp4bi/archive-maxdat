...
--------------------------------------------------------
DROP TABLE "FLHK_INITIATE_RENEWALS_WIP_BPM";
--------------------------------------------------------
...
';
   ...
   COMMENT ON COLUMN "FLHK_INITIATE_RENEWALS_WIP_BPM"."WAITING_FOR_DISENROLLMENT" IS 'Count of members waiting for disenrollment for the account.';
   COMMENT ON COLUMN "FLHK_INITIATE_RENEWALS_WIP_BPM"."ACCOUNT_NUMBER" IS 'Account number from the account table.';
/
--------------------------------------------------------
