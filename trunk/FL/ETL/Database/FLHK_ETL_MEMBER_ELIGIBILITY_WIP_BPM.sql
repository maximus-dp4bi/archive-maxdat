--------------------------------------------------------
--  File created - Wednesday-November-27-2013   
--------------------------------------------------------
--------------------------------------------------------
...
';
   ...
   COMMENT ON COLUMN "FLHK_ETL_ELIGIBILITY_WIP_BPM"."INSTANCE_STATUS" IS 'ETL status of COV_RQST_ID';
   COMMENT ON COLUMN "FLHK_ETL_ELIGIBILITY_WIP_BPM"."CANCEL_DATE" IS 'Cancel date for the coverage request row.';
   COMMENT ON COLUMN "FLHK_ETL_ELIGIBILITY_WIP_BPM"."IVIC_WRK_REQ_DATE" IS 'Date the IVIC work request row was created. ';
   COMMENT ON COLUMN "FLHK_ETL_ELIGIBILITY_WIP_BPM"."IVIC_COMPLETE_DATE" IS 'Date the IVIC work requested was moved to resolved status.';
   COMMENT ON COLUMN "FLHK_ETL_ELIGIBILITY_WIP_BPM"."ACCOUNT_NUMBER" IS 'Vida account number column.';
   COMMENT ON COLUMN "FLHK_ETL_ELIGIBILITY_WIP_BPM"."PERSON_NUMBER" IS 'Person number from Vida Person table.';
   COMMENT ON COLUMN "FLHK_ETL_ELIGIBILITY_WIP_BPM"."COVERAGE_REQUEST_STATUS" IS 'Coverage request status from source system.';
/
--------------------------------------------------------
--  DDL for Index FLHK_MEMBER_ELIGIBILITY_NDX
--------------------------------------------------------

  CREATE UNIQUE INDEX "FLHK_MEMBER_ELIGIBILITY_NDX" ON "FLHK_ETL_ELIGIBILITY_WIP_BPM" ("ME_ID") ;
/
--------------------------------------------------------
--  DDL for Index FLHK_MEMBER_ELIGIBILITY_NDX2
--------------------------------------------------------

  CREATE UNIQUE INDEX "FLHK_MEMBER_ELIGIBILITY_NDX2" ON "FLHK_ETL_ELIGIBILITY_WIP_BPM" ("COV_RQST_ID") ;
/
--------------------------------------------------------
