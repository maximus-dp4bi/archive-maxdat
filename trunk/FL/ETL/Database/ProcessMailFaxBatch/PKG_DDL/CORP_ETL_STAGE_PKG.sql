CREATE OR REPLACE PACKAGE "CORP_ETL_STAGE_PKG" is
  ...
  -- Do not edit these four SVN_* variable values.  They are populated when you commit code to SVN and used later to identify deployed code.
 	SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/Core/createdb/CORP_ETL_STAGE_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 9579 $'; 
 	SVN_REVISION_DATE varchar2(60) := '$Date: 2014-04-17 16:46:57 -0600 (Thu, 17 Apr 2014) $'; 
