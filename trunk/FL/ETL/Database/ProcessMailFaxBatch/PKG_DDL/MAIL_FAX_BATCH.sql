CREATE OR REPLACE PACKAGE "MAIL_FAX_BATCH" as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/Corp/MailFaxBatch/createdb/MAIL_FAX_BATCH_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 9772 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2014-04-28 12:50:34 -0600 (Mon, 28 Apr 2014) $'; 
  SVN_REVISION_AUTHOR varchar2(20) := '$Author: jh44463 $';
