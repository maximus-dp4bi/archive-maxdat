CREATE OR REPLACE PACKAGE "ETL_COMMON" as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/Core/createdb/ETL_COMMON_pkg.sql $';
  SVN_REVISION varchar2(20) := '$Revision: 7788 $';
  SVN_REVISION_DATE varchar2(60) := '$Date: 2014-01-17 16:14:01 -0700 (Fri, 17 Jan 2014) $';
