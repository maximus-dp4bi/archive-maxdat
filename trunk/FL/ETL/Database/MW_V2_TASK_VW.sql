...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for View MW_V2_TASK_VW
--------------------------------------------------------

 CREATE OR REPLACE FORCE VIEW "MW_V2_TASK_VW" ("TASK_ID", "SOURCE_PROCESS_ID", "PARENT_TASK_ID", "TASK_TYPE", "TASK_TYPE_ID", "TASK_STATUS", "STATUS_DATE", "CREATE_DATE", "COMPLETE_DATE", "INSTANCE_START_DATE", "STG_LAST_UPDATE_DATE", "STAGE_DONE_DATE", "STG_EXTRACT_DATE", "CREATED_BY_STAFF_ID", "PRIORITY", "ESCALATED_FLAG", "FORWARDED_FLAG", "CANCEL_WORK_FLAG", "OWNER_STAFF_ID", "SOURCE_REFERENCE_TYPE", "SOURCE_REFERENCE_ID", "CLIENT_ID", "APPLICATION_ID", "CANCEL_WORK_DATE", "INSTANCE_END_DATE", "INSTANCE_STATUS", "LAST_UPDATE_DATE", "LAST_UPDATE_BY_STAFF_ID", "ESCALATED_TO_STAFF_ID", "FORWARDED_BY_STAFF_ID", "CASE_ID", "COMPLETE_FLAG", "SOURCE_PROCESS_INSTANCE_ID", "TEAM_ID", "BUSINESS_UNIT_ID", "I_CHANGE_FLAG", "ERROR_DATE", "ERR_LEVEL", "PROCESS_NAME", "DRIVER_TABLE_NAME", "TRANSFORMATION_NAME", "RULE_EXECUTED") 
  AS 
 SELECT  TASK_ID,
