...
drop table FLHK_ETL_PROCESS_APP_OLTP;
--------------------------------------------------------
--  DDL for Table FLHK_ETL_PROCESS_APP_OLTP
--------------------------------------------------------

  CREATE TABLE "FLHK_ETL_PROCESS_APP_OLTP" 
 ("PA_ID" NUMBER,
 "APP_ID" NUMBER,
 ...
 "SOURCE" VARCHAR2(255));
--------------------------------------------------------
--  DDL for Index IDX_ACCOUNT_ID_APP_OLTP
--------------------------------------------------------

  CREATE INDEX "IDX_ACCOUNT_ID_APP_OLTP" ON "FLHK_ETL_PROCESS_APP_OLTP" ("ACCOUNT_ID");
--------------------------------------------------------
--  DDL for Index PK_APPLICATION_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_APPLICATION_ID" ON "FLHK_ETL_PROCESS_APP_OLTP" ("APP_ID");
