...
--------------------------------------------------------
DROP TABLE "FLHK_ETL_PROCESS_APP";
--------------------------------------------------------
--  DDL for Table FLHK_ETL_PROCESS_APP
--------------------------------------------------------

  CREATE TABLE "FLHK_ETL_PROCESS_APP" 
 ("PA_ID" NUMBER,
 "APP_ID" NUMBER,
...
/
--------------------------------------------------------
--  DDL for Index IDX_ACCOUNT_ID_APP
--------------------------------------------------------

  CREATE INDEX "IDX_ACCOUNT_ID_APP" ON "FLHK_ETL_PROCESS_APP" ("ACCOUNT_ID")
/
--------------------------------------------------------
--  DDL for Index APP_ID_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "APP_ID_PK" ON "FLHK_ETL_PROCESS_APP" ("APP_ID")
/
--------------------------------------------------------
--  Constraints for Table FLHK_ETL_PROCESS_APP
--------------------------------------------------------

  ALTER TABLE "FLHK_ETL_PROCESS_APP" ADD CONSTRAINT "APP_ID_PK" PRIMARY KEY ("APP_ID") ENABLE
/
--------------------------------------------------------
--  DDL for Trigger FLHK_ETL_PROCESS_APP_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "FLHK_ETL_PROCESS_APP_TRG" 
   before insert on "FLHK_ETL_PROCESS_APP" 
   for each row 
begin  
   if inserting then 
      if :NEW."PA_ID" is null then 
         select FLHK_ETL_PROCESS_APP_SEQ.nextval into :NEW."PA_ID" from dual; 
      end if; 
   end if; 
end;
/
ALTER TRIGGER "FLHK_ETL_PROCESS_APP_TRG" ENABLE
/
