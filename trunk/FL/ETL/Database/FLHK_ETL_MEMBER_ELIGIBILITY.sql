--------------------------------------------------------
--  File created - Friday-March-21-2014   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ("ME_ID" NUMBER(10,0), 
   ...
   "COVERAGE_REQUEST_STATUS" VARCHAR2(32),
   "COVERAGE_REQUEST_STATUS_DATE" DATE,
   "AGE_IN_BUSINESS_DAYS" NUMBER(10,0) DEFAULT 0,
   "AGE_IN_CALENDAR_DAYS" NUMBER(10,0) DEFAULT 0, 
   "STATUS_AGE_IN_BUS_DAYS" NUMBER(10,0) DEFAULT 0, 
   "STATUS_AGE_IN_CAL_DAYS" NUMBER(10,0) DEFAULT 0, 
   "PENDING_ELIG_NTFY_RQST_DATE" DATE, 
   "GWF_ELIG_PEND_NOTIFY" VARCHAR2(1),
...
';
   ...
   COMMENT ON COLUMN "FLHK_ETL_MEMBER_ELIGIBILITY"."ACCOUNT_NUMBER" IS 'Vida account number column.';
   COMMENT ON COLUMN "FLHK_ETL_MEMBER_ELIGIBILITY"."PERSON_NUMBER" IS 'Person number from Vida Person table.';
   COMMENT ON COLUMN "FLHK_ETL_MEMBER_ELIGIBILITY"."COVERAGE_REQUEST_STATUS" IS 'Coverage request status from source system.';
/
--------------------------------------------------------
--  DDL for Index FLHK_MEMBER_ELIGIBILITY_NDX
--------------------------------------------------------

  CREATE UNIQUE INDEX "FLHK_MEMBER_ELIGIBILITY_NDX" ON "FLHK_ETL_MEMBER_ELIGIBILITY" ("ME_ID") ;
/
--------------------------------------------------------
--  DDL for Index FLHK_MEMBER_ELIGIBILITY_NDX2
--------------------------------------------------------

  CREATE UNIQUE INDEX "FLHK_MEMBER_ELIGIBILITY_NDX2" ON "FLHK_ETL_MEMBER_ELIGIBILITY" ("COV_RQST_ID") ;
/
--------------------------------------------------------
--  DDL for Index CREATE_DATE_NDX
--------------------------------------------------------

  CREATE INDEX "CREATE_DATE_NDX" ON "FLHK_ETL_MEMBER_ELIGIBILITY" ("CREATE_DATE") ;
/
--------------------------------------------------------
--  DDL for Index ELIG_STATUS_DATE_NDX
--------------------------------------------------------

  CREATE INDEX "ELIG_STATUS_DATE_NDX" ON "FLHK_ETL_MEMBER_ELIGIBILITY" ("ELIG_STATUS_DATE") ;
/
--------------------------------------------------------
