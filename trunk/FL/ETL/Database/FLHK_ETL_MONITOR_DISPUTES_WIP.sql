Create table FLHK_ETL_MONITOR_DISPUTES_WIP
(
...
CREATE UNIQUE INDEX "DISPUTE_ID_PK2" ON "FLHK_ETL_MONITOR_DISPUTES_WIP" ("DISPUTE_ID");
...
ALTER TABLE "FLHK_ETL_MONITOR_DISPUTES_WIP" ADD CONSTRAINT "DISPUTE_ID_PK2" PRIMARY KEY ("DISPUTE_ID") ENABLE;
