...
public class MarsContactRecordEvents {
    ...
    private LocalDateTime contactRecordStartTime;
    private LocalDateTime contactRecordEndTime;
    private String consumerPhone;
    private String consumerFirstName;
    private String consumerLastName;
    private String consumerEmail;
    private String contactRecordStatusType;
    private String consumerAuthenticatedInd;
    ...
    private LocalDateTime genericField1Date;
    private LocalDateTime genericField2Date;
    private LocalDateTime genericField3Date;
    private LocalDateTime genericField4Date;
    private Double linkRefId;
    private String linkRefType;
    private String correlationId;
    private String uiid;
    private LocalDateTime wrapUpTime;
    ...
    public LocalDateTime getContactRecordStartTime() {
        return contactRecordStartTime;
    }

    public void setContactRecordStartTime(LocalDateTime contactRecordStartTime) {
        this.contactRecordStartTime = contactRecordStartTime;
    }

    public LocalDateTime getContactRecordEndTime() {
        return contactRecordEndTime;
    }

    public void setContactRecordEndTime(LocalDateTime contactRecordEndTime) {
    ...
    public String getConsumerAuthenticatedInd() {
        return consumerAuthenticatedInd;
    }

    public void setConsumerAuthenticatedInd(String consumerAuthenticatedInd) {
    ...
    public LocalDateTime getGenericField1Date() {
        return genericField1Date;
    }

    public void setGenericField1Date(LocalDateTime genericField1Date) {
        this.genericField1Date = genericField1Date;
    }

    public LocalDateTime getGenericField2Date() {
        return genericField2Date;
    }

    public void setGenericField2Date(LocalDateTime genericField2Date) {
        this.genericField2Date = genericField2Date;
    }

    public LocalDateTime getGenericField3Date() {
        return genericField3Date;
    }

    public void setGenericField3Date(LocalDateTime genericField3Date) {
        this.genericField3Date = genericField3Date;
    }

    public LocalDateTime getGenericField4Date() {
        return genericField4Date;
    }

    public void setGenericField4Date(LocalDateTime genericField4Date) {
    ...
    public LocalDateTime getWrapUpTime() {
        return wrapUpTime;
    }

    public void setWrapUpTime(LocalDateTime wrapUpTime) {
