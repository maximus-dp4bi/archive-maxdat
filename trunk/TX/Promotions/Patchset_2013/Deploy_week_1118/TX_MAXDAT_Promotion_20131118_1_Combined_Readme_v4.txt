...
2013/11/18 Clay Contact Center – v0.1.4 
...
execute PROCESS_BPM_QUEUE_JOB_CONTROL.SHUTDOWN_JOBS;	
	...
	----------------------------
        -- All files can be found in DB_CommunityOutreach_20131115_MAYURESH_4_CORP.zip
       Run order 
...
PROD SUUP       nohup /ttxe4t/ETL_Scripts/scripts/Run_onetime_CLIENT_INQUIRY_20131118.sh &
...
PROD SUPP       nohup /ttxe4t/ETL_Scripts/scripts/ContactCenter/main/bin/manage_adhoc_load_contact_center.sh &
