...
---------- ------------------- ------------- ------------------------------------------------------
2013/12/27 Mayuresh Bhalekar   201-328-5695   Modified Not nullable column, Load 400k records
...
execute PROCESS_BPM_QUEUE_JOB_CONTROL.SHUTDOWN_JOBS;	
	...
	** Unzip DB_ClientOutreach_20131230_Mayuresh_3_CORP.zip
 	...
 	1.truncate_data_model_Client_Outreach.sql
 	2.20131224_1029_Alter_ETL_ClientOutreach_tables.sql
	3.20131224_1044_insert_CORP_ETL_CLNT_SURVEY_LKUP.sql
	4.create_ETL_ClientOutreach_triggers.sql
	5.populate_BPM_ATTRIBUTE_LKUP.sql
	6.20131224_1039_alter_bpm_attr.sql
	7.20131224_1033_Alter_Semantic.sql
...
----------------------------
DOwnload AS_ClientOutreach_20131230_Mayuresh_SHELL.zip
