...
2.Copy the below kettle script (*.kjb, *.ktr) from 
  ...
  OR 
  svn://rcmxapp1d.maximus.com/maxdat/trunk/TX/Promotions/Patchset_2013/AS_MEA_KETTLE_CORP_20131003_RAJ_3.zip
  to:/u25/ETL_Scripts/UAT/scripts/ManageEnrollmentActivity

2.1 ManageEnroll_Update_Enrollment_Status.ktr


3. Turn on tx_run_bpm.sh cron job
