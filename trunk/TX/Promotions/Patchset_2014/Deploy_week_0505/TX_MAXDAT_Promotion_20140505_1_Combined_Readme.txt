...
-----------------------
     ...
     ****Download AS_ContactCenter_20140505_Sara_1.zip
...
00 22 * * * /ttxe4t/3rdparty/cron_files/cron_tx_run_timeout_calls.sh > /dtxe4t/ETL_Logs/logs/ContactCenter/run_timeout_calls_`date +\%Y\%m\%d`.log 2>&1

PRD #CONTACTCENTERTIMEOUTCALLS
00 22 * * * /ptxe4t/3rdparty/cron_files/cron_tx_run_timeout_calls.sh > /dtxe4t/ETL_Logs/logs/ContactCenter/run_timeout_calls_`date +\%Y\%m\%d`.log 2>&1
