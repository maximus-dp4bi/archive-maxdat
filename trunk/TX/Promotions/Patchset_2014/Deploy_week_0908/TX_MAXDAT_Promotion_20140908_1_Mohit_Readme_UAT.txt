...
---------- ------------------- ------------- ---------  ---------------------------------------------
2014/09/03 Mohit Agarwal       248-918-7479 TXEB-2934    Agent dimension records did not have their Site updated
...
** Run these SQL scripts below as the the Oracle user MAXDAT
       ...
       *******************************************************************************************	
       ...
       -------------------------------------------------------------------------------------------
       	** Unzip DB_UAT_ContactCenter_20140908_Mohit_1.zip
