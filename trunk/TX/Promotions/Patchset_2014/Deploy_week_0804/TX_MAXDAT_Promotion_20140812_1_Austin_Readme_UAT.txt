...
---------- ------------------- ------------  -----------    ---------------------------------------------
2014/08/12 Austin Baker        843-259-1955  TXEB - 3096    MAXDAT - validating increase in size of 'Message' field in CC_L_ERROR table
...
** Run these SQL scripts below as the the Oracle user MAXDAT
       ...
       *******************************************************************************************	
       ...
       -------------------------------------------------------------------------------------------
       	** Unzip DB_ContactCenter_20140812_Austin_4.zip
