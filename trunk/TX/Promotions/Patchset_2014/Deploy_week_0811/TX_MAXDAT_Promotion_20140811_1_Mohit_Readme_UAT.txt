...
---------- ------------------- ------------- ---------  ---------------------------------------------
2014/07/12 Mohit Agarwal       248-918-7479 TXEB-2933    Duplicate Agent Dimension & Fact Records
...
** Run these SQL scripts below as the the Oracle user MAXDAT
       ...
       *******************************************************************************************	
       ...
       -------------------------------------------------------------------------------------------
       	** Unzip DB_UAT_ContactCenter_20140811_Mohit_1.zip
        ** Run in the order specified below.
       
 		 100_TXEB_DuplicateAgent_Cleanup_1.sql
                 101_TXEB_DuplicateAgent_Cleanup_2.sql
                 102_TXEB_DuplicateAgent_Cleanup_3.sql
