...
Instructions to install TXEB  Promotions week of 07/21/2014
----------------
Date       Developer           PHONE         Jira       Reason/Description
---------- ------------------- ------------- --------- ---------------------------------------------
2014/07/21 M Bhalekar         201.328.5695  TXEB-2551  MAXDAT - removed debugging step and set translation req step.
...
-----------------------
	...
	*******************************************************************************************	
        Mayuresh B (SCI)
	--------------------------------------------------------------------
	Download AS_SCI_20140721_Mayuresh_2.zip
