...
Instructions to install TXEB  Promotions week of 2014/03/24
----------------
Date       Developer           PHONE         Reason/Description
---------- ------------------- ------------- ------------------------------------------------------
2014/03/24  M.Bhalekar        201.328.5695    update ops group according to #TXEB-2380
                                              
2014/03/24  Raj A.            361-228-5588    Deploy ktrs that call the plsql ETL code. Added Start_time and End_time to call the ETL during a specific time.
...
execute MAXDAT_ADMIN.SHUTDOWN_JOBS;	
       ...
       *******************************************************************************************	
         M.Bhalekar(update ops group)
        ------------------------------------------------------------------------------------
	** Unzip DB_OPSGROUP_20140324_MAYURESH_1.zip
        ** Run in the order specified below.

        populate_BPM_D_OPS_GROUP_TASK_update.sql
