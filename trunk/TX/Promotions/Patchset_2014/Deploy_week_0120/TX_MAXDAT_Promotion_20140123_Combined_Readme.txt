...
1. Deploy performance improved ktrs and some bug fixes.
   Hard-coded Client_IDs for UAT deployment to check for NO errors. Production code will not have any hard-coding.
...
----------------------------------
server: rmohstxeb01.oracleoutsourcing.com
Database SID: DTXE4T
...
execute MAXDAT_ADMIN.CONFIG_QUEUE_JOB(14,2,'ENABLED','N');
        ...
        ------------------------------------------------------------------------------------
	** Unzip DB_MEA_20140121_RAJ_5.zip
        ** Run in the order specified below.

        1.20140117_1725_DML_Global_Controls.sql
        ------------------------------------------------------------------------------------
...
---------------------
4. SCHEDULE CRON Job (MEA only) 
---------------------
Server: MAXDAT UAT App Server, i.e., 148.87.247.142

Check with the Developer before scheduling this cron job.
