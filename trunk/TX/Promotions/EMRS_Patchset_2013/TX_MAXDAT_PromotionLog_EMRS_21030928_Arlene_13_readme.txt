...
-----------------------
	...
	-- or DB_EMRS_20130928_ARLENE_10.zip

	20130927_1014_EMRS_missing_indexes.sql

-----------------------
2. KETTLE FILES SECTION
-----------------------

Download AS_EMRS_20130928_ARLENE_19.zip
...
ETL_Enrollment_ADHOC_DAILY.kjb

-----------------------
3. UNIX SCRIPT SECTION
-----------------------

DOwnload AS_EMRS_20130928_ARLENE_19.zip and
to <MAXDAT_ETL_PATH> directory

svn://rcmxapp1d.maximus.com/maxdat/trunk/TX/ETL/scripts/

tx_emrs_init_load12_daily.sh


Run dos2unix for the following List 
	tx_emrs_init_load12_daily.sh

chmod 755 tx_emrs_init_load12_daily.sh