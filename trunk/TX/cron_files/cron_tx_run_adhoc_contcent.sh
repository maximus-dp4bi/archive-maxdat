...
$MAXDAT_ETL_PATH/ContactCenter/implementation/TXEB/bin/manage_adhoc_contact_center_jobs.sh  >> $MAXDAT_ETL_LOGS/tx_manage_adhoc_contact_center_jobs.cron.log &
