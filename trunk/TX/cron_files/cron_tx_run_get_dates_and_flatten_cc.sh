...
$MAXDAT_ETL_PATH/ContactCenter/implementation/TXEB/bin/run_tx_get_dates_and_flatten_contact_center.sh  >> $MAXDAT_ETL_LOGS/tx_run_get_dates_flatten_concent.cron.log &
