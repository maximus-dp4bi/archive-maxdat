...
# $URL: svn://rcmxapp1d.maximus.com/maxdat/trunk/MDHIX/ETL/scripts/Run_Onetime_load_task.sh $
# $Revision: 10689 $
...
JOBS_DIR=$MAXDAT_ETL_PATH/AgentTimeline/onetime
JOB=Onetime_Load_task
