...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/SupportClientInquiry/ClientInquiry_Event_Inserts_Dec_One_Time.kjb" -log="$LOG_DIR/ClientInquiry_Event_Inserts_Dec_One_Time.LOG" -level="$DETAIL_LOG_LEVEL"
