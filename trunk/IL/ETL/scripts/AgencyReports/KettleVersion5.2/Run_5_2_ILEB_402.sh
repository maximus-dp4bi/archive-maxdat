...
#---------------------------------
# SVN_FILE_URL        = $URL: svn://rcmxapp1d.maximus.com/maxdat/trunk/IL/ETL/scripts/AgencyReports/KettleVersion5.2/Run_onetime_5_2_ILEB_402.sh $
# SVN_REVISION        = $Revision: 13749 $
# SVN_REVISION_DATE   = $Date: 2015-02-26 14:40:08 -0800 (Thu, 26 Feb 2015) $
...
CUSTOM_DIR=$MAXDAT_ETL_PATH/scripts/AgencyReports/kettle_5.2/insert_402_tables
...
CUSTOM_DIR=$MAXDAT_ETL_PATH/scripts/AgencyReports/kettle_5.2/create_402_report
export MAXDAT_ETL_DIR=$CUSTOM_DIR

$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ILEB_402_Write_Output_Only.kjb" -log="$LOG_FILE" -level="$LOG_LEVEL"

CUSTOM_DIR=$MAXDAT_ETL_PATH/scripts/AgencyReports

$CUSTOM_DIR/Email_402_report.sh
