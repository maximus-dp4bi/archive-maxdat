...
CUSTOM_DIR=$MAXDAT_ETL_PATH/scripts/AgencyReports/kettle_5.2/create_402M_report
...
#LOG_NAME=${PROGNAME}_$(date +%Y%m%d_%H%M%S)
LOG_FILE="${LOG_DIR}/${LOG_NAME}.log"

LOG_LEVEL="Rowlevel" # can be any of the following: Basic Detailed Debugging Rowlevel

export MAXDAT_KETTLE_DIR=/u01/app/appadmin/product/pentaho_5.2/data-integration
export MAXDAT_ETL_DIR=$CUSTOM_DIR

$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ILEB_402M_Prod_Report_Job.kjb" -log="$LOG_FILE" -level="$LOG_LEVEL"
