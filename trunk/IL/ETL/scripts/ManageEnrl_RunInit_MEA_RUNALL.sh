...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ManageEnrl_Run_Initialization.kjb" -log="$LOG_DIR/ManageEnrl_Run_Initialization.log" -level="$DETAIL_LOG_LEVEL"
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ManageEnrollmentActivity/ProcessManageEnroll_RUNALL.kjb" -log="$LOG_DIR/ManageEnrollmentActivity/ProcessManageEnroll_RUNALL.kjb" -level="$DETAIL_LOG_LEVEL"
