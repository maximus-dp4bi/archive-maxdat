...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ManageEnrollmentActivity/ManageEnroll_Selection_fix.kjb" -log="$LOG_DIR/ManageEnrollmentActivity/ManageEnroll_Selection_fix.log" -level="$DETAIL_LOG_LEVEL"