...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ProcessIncidents/Update_plan_code_provider_id.kjb" -log="$LOG_DIR/Update_plan_code_provider_id.LOG" -level="$DETAIL_LOG_LEVEL"
