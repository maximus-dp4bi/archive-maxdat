...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/SupportClientInquiry/ClientInquiry_Details_Inserts_One_Time.kjb" -log="$LOG_DIR/ClientInquiry_Details_Inserts_One_Time.LOG" -level="$DETAIL_LOG_LEVEL"
