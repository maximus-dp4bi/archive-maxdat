...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ManageEnrollmentActivity/ProcessManageEnroll_RUNALL_INTIAL_RUN_Partial.kjb" -log="$LOG_DIR/ManageEnrollmentActivity/ProcessManageEnroll_RUNALL_INTIAL_RUN_Partial.log" -level="$DETAIL_LOG_LEVEL"