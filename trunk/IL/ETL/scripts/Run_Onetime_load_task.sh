...
$MAXDAT_KETTLE_DIR/kitchen.sh -file="$MAXDAT_ETL_PATH/IL/ETL/scripts/AgentTimeline/onetime/Onetime_Load_task.kjb" -log="$MAXDAT_ETL_LOGS/Onetime_Load_task$(date +%Y%m%d_%H%M%S).LOG" -level="$DETAIL_LOG_LEVEL"
