 ...
 NOCOMPRESS LOGGING
  ...
  CREATE OR REPLACE TRIGGER "TRG_R_corp_etl_PROC_LTR_WIP" BEFORE
  INSERT OR
  UPDATE ON CORP_ETL_PROC_LETTERS_WIP_BPM FOR EACH ROW
BEGIN
  IF Inserting THEN
...
END;
/
ALTER TRIGGER "TRG_R_corp_etl_PROC_LTR_WIP" ENABLE;
