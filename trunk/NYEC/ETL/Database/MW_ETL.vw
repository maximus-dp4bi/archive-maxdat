-- C:\Documents and Settings\user\Desktop\MW_ETL.vw
--
...
Select Staff_id, First_Name, Last_Name, Middle_Name
       ,TRIM(LAST_NAME) || DECODE(LAST_NAME, NULL, NULL, ',') || TRIM(FIRST_NAME) || RTRIM(LPAD(SUBSTR(MIDDLE_NAME, 1, 1), ' ')) AS Display_Name
From
        (
...
/
PROMPT Creating View 'MW_STEP_INSTANCE_VW'
CREATE OR REPLACE VIEW MAXDAT.MW_STEP_INSTANCE_VW AS
