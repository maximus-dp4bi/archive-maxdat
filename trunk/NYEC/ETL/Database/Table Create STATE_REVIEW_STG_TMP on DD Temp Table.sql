CREATE TABLE NYEC_ETL_STATE_REVIEW_STG_TMP (
...
CREATE SEQUENCE seq_nesr_stg_tmp START WITH 1 CACHE 1000;

CREATE OR REPLACE TRIGGER MAXDAT."TRG_NYEC_ETL_STATE_REVIEW_tmp" BEFORE
       INSERT OR
       UPDATE ON NYEC_ETL_STATE_REVIEW_STG_TMP FOR EACH ROW
BEGIN
  IF Inserting THEN
...
insert into NYEC_ETL_STATE_REVIEW_STG_TMP
values (2,
        'I',
