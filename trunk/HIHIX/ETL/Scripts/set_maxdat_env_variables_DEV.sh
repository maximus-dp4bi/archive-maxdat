...
KETTLE_HCCHIX_HOME="/u01/maximus/maxdat-dev/HCCHIX/config"
...
export MAXDAT_ETL_LOGS="/u01/maximus/maxdat-dev/HCCHIX/ETL/logs"
#
export MAXDAT_ETL_DIR="/u01/maximus/maxdat-dev/HCCHIX/ETL/scripts"
export MAXDAT_LOG_DIR="/u01/maximus/maxdat-dev/HCCHIX/ETL/logs"
