...
//task for above procedure
create task paieb_uat.sp_current_s3_contents 
warehouse = 'MAXEB_DP4BI_PAIEB_PRD_LOAD_WH'
schedule = 'USING CRON 0 * * * * America/Los_Angeles'
ALLOW_OVERLAPPING_EXECUTION = FALSE
as call control.sp_current_s3_files('MAXEB_DP4BI_PAIEB_UAT_S3','/');
alter task paieb_uat.sp_current_s3_contents resume;
