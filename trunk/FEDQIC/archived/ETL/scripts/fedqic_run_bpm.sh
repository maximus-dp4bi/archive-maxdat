#!/bin/bash
source /u01/maximus/maxdat-dev/FEDQIC/scripts/.set_env
#corp_run_bpm.sh
# ================================================================================
# Do not edit these four SVN_* variable values.  They are populated when you
#     commit code to SVN and used later to identify deployed code.
# $URL: svn://svn-staging.maximus.com/dev1d/maxdat/trunk/FEDQIC/ETL/scripts/fedqic_run_bpm.sh $
# $Revision: 21547 $
# $Date: 2017-10-20 16:14:33 -0400 (Fri, 20 Oct 2017) $
# $Author: ch136904 $
# =================================================================================
