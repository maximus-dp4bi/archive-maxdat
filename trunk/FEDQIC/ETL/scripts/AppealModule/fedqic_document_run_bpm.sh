...
if [[ $rc != 0 ]] ; then
   ...
   $MAXDAT_ETL_PATH/run_kjb.sh $MAXDAT_ETL_PATH/AppealModule/Initialize_Documents.kjb $KJB_LOG_LEVEL > $MAXDAT_ETL_LOGS/${STCODE}_Initialize_Documents_$(date +%Y%m%d_%H%M%S).log
