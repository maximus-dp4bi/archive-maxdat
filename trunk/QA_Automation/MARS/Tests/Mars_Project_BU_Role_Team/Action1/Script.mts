...
cDataFileURL = "C:\UFT\MARS\Project\Data\Mars_Project_BU_Role_Team.xls"
...
strCP_ProjectName = strCP_BaseProject & strUniqueNumber_Create
strRole_Name = strRole_Name & strUniqueNumberRole_Create
strRole_NameUpdated = strRole_Name & strUniqueNumberRole_Update
strRole_Description = strRole_Description & strUniqueNumberRole_Update
Call Mars_Role_Update(strRole_Name, strRole_NameUpdated, strRole_StartDate, strRole_EndDate, strRole_Description)

' Read DB and create JSON file
Call Wait_SQLToStart()
SQLquery="select DATA::VARCHAR from MARS_DP4BI_DEV.SOLACE.EVENT_FULL_JSON_DATA where DATA:recordType = 'Project Role'and DATA:action = 'Update' and DATA:projectName = " & "'" & strCP_ProjectName & "'" & " and DATA:dataObject:roleName = " & "'" & strRole_NameUpdated & "'" & ";"
Call Snowflake_ReadDB(strCP_ProjectName, strCP_TenantManager_ProjectFile_JSON, strDB_SF_User, strDB_SF_Pass, SQLquery) 
...
' Role name
XMLTag = "roleName"
strExpectedValue = strRole_NameUpdated
Call XML_GetValue_byTag(XMLFileName, XMLTag, strExpectedValue, strEvent)
...
strCP_ProjectName = strCP_BaseProject & strUniqueNumber_Create
strBU_BusinessUnitName = strBU_BusinessUnitName & strUniqueNumberBU_Create
strTeam_Name = strTeam_Name & strUniqueNumberTeam_Update
strTeam_Desc = strTeam_Desc & strUniqueNumberTeam_Update
Call Mars_Team_Update(strTeam_Name, strBU_BusinessUnitName, strTeam_StartDate, strTeam_EndDate, strTeam_Desc)
