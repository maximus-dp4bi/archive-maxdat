...
strSummaryReportPath = ReadIni( strFilePathINI, "FinalReportPath", "value")

'MsgBox "Wait to broadcast email"

' Email subject
'strSubject = ReadExcelFile_CalculatePassedFailedRecords(strCurrentReportPath, "Run Status")
strEmail_Subject = "Please find final PureInsight/Snowflake Metadata-data verification Report results attached.  " 
' Attachment
