...
'cDataFileURL = "C:\Automation_Root\States\NC\Genesys\NCUI\Project\Data\DataDriver_FlowOutcomePerformanceSummary_GenNCUIFlowOutcomeSummarydataset.xls"
...
' Verify reports are not empty. If both of the reports are empty, mark status as PASSED
iRows_Genesys = ReadExcelFile_GetNumberOfRowsInExcel (strReportPath_Genesys, strWorkbookName) ' get original number of rows
iRows_Export = ReadExcelFile_GetNumberOfRowsInExcel (strExportReport_FullPath, strWorkbookName) ' get original number of rows

If iRows_Genesys = 1 and  iRows_Export = 1 Then
strPassed_Failed = "WARNING"	
Else
' ====================== Compare ==========================
' Compare genesys total number of rows with Grid total value for specified date
strResult = ReadExcelFile_CrossRef_FlowOutcomePerformanceSummary_GenNCUIFlowOutcomeSummarydataset(strReportPath_Genesys, strExportReport_FullPath, strR1_Col1_Filter, strR1_Col1_Filter_Value, strR1_Col2_Filter, strR1_Col2_Filter_Value, strR1_ColumnsToSum_1, strR1_ColumnsToSum_2, strR1_ColumnsToSum_3, strR2_Col1_Filter, strR2_Col1_Filter_Value, strR2_Col2_Filter, strR2_Col2_Filter_Value, strR2_ColumnsToSum_1, strR2_ColumnsToSum_2, strR2_ColumnsToSum_3)
...
' Update status of specific run
Call UpdateINI_BasedOnIterationNumber (strFilePathINI, iIndex, strPassed_Failed)
...
iIndex_Temp = 2
strColName = "Basic Location"
strBasicLocation = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(strTempFileURL, strColName, iIndex_Temp)
strFilePathINI = strBasicLocation & "\" & "Global_INI.ini"
strSummaryReportPath = ReadIni( strFilePathINI, "SummaryReportPath", "value" )

' Get data from data driver
strScriptName = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(strTempFileURL, "Test Name", iIndex_Temp)
strReport_1 = strGenesysReportName
strReport_2 = strExportReport
strRunStartTime = now()
'strRunStatus = strPassed_Failed
strNotes = "Please contact: " & strEmail_To & " for details"

'=========================== Do not continue running if both of the reports are empty. Update Summary report and leave ==========================================
If strPassed_Failed = "WARNING" Then
strRunStatus = strPassed_Failed
Call ReadExcelFile_SummaryReport_AppendRow (strSummaryReportPath, strScriptName, strReport_1, strReport_2, strRunStartTime, strRunStatus, strNotes)
Exit for
End If
...
' Exclude intermittent Report Summary entry
' Get individual statuses
strStatusL4 = ReadIni( strFilePathINI, "FlowOutcome_StatusL4", "value" )
strStatusL5 = ReadIni( strFilePathINI, "FlowOutcome_StatusL5", "value" )
If iIndex = 5 Then
If strStatusL4 =  "PASSED" and strStatusL5 =  "PASSED" Then
strRunStatus = "PASSED"
Else
strRunStatus = "FAILED"
End If
...
' ========================== Send email =================================================
strEmail_Subject = strEmail_Subject & " " & strGenesysReportName & " and " & strGenesysReportName & " comparison is: " & strPassed_Failed
strAttach_1 = strReportPath_Genesys
strAttach_2 = strExportReport_FullPath
'strAttach_1 = ""
'strAttach_2 = ""
strAttach_3 = ""
