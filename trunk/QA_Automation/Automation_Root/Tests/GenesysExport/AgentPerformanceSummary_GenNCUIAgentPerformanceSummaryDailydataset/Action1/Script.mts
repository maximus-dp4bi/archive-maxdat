...
'cDataFileURL = "C:\Automation_Root\States\NC\Genesys\NCUI\Project\Data\DataDriver_AgentPerformanceSummary_GenNCUIAgentPerformanceSummaryDailydataset.xls"
...
strAgentName = ReadExcelFile_GetFirstNoneBlankValue(strReportPath_Genesys, strR1_Col2_Filter, strR1_ColumnsToSum_1)

' Update Data Draver with agent name (genesys section)
strColumnIndex_Gen = ReadExcelFile_GetColumnIndexByColumnName(cDataFileURL, cR1_Col2_Filter_Value, 1)
...
strColumnIndex_Gen = ReadExcelFile_GetColumnIndexByColumnName(cDataFileURL, cR2_Col2_Filter_Value, 1)
Call ReadExcelFile_UpdateCellValue(cDataFileURL, iIndex, strColumnIndex_Gen, strAgentName)


' ====================== Compare ==========================
' Compare genesys total number of rows with Grid total value for specified date
strResult = ReadExcelFile_CrossRef_AgentPerformanceSummary_GenNCUIAgentPerformanceSummaryDailydataset(strReportPath_Genesys, strExportReport_FullPath, strR1_Col1_Filter, strR1_Col1_Filter_Value, strR1_Col2_Filter, strR1_Col2_Filter_Value, strR1_ColumnsToSum_1, strR1_ColumnsToSum_2, strR1_ColumnsToSum_3, strR2_Col1_Filter, strR2_Col1_Filter_Value, strR2_Col2_Filter, strR2_Col2_Filter_Value, strR2_ColumnsToSum_1, strR2_ColumnsToSum_2, strR2_ColumnsToSum_3)
...
' Submit email to automarion developer
' ========================== Send email =================================================
strEmail_Subject = strEmail_Subject & " " & strGenesysReportName & " and " & strExportReport & " comparison: " & strPassed_Failed
