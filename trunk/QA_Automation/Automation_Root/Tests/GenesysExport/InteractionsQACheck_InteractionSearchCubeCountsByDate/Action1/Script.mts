...
' =========================================== Manual run. Uncoment if you want to ran individual script in debug mode ================strColName = "Data Driver"

'strSQLLocation = "C:\Automation_Root\States\NC\Genesys\NCUI\SQL"
'cDataFileURL = "C:\Automation_Root\States\NC\Genesys\NCUI\Project\Data\DataDriver_InteractionsQACheck_InteractionSearchCubeCountsByDate.xls"
...
' Calculate yeasterday's date
strDate = ReadExcelFile_SubstractFromTodayDate(1)
' Update Data driver column with date value
strColumnIndex = ReadExcelFile_GetColumnIndexByColumnName(cDataFileURL, cR2_Col1_Filter_Value, 1)
Call ReadExcelFile_UpdateCellValue(cDataFileURL, iIndex, strColumnIndex, strDate)
...
strResult = ReadExcelFile_CrossRefererenceReports_Genesys_InteractionsQACheck(strExportReport_FullPath, strR2_Col1_Filter, strR2_Col1_Filter_Value, strR2_Col2_Filter, strR2_Col2_Filter_Value, strR2_TargetColumn, strNumberOfRows_Genesys)
...
' ===============================Send email ===================================================
strEmail_Subject = strEmail_Subject & " " & strGenesysReportName & " and " & strGridReport & " comparison is: " & strPassed_Failed
