...
cPath = "C:\Maximus\Reports\CP_Test"
strINIPath = "C:\Automation_Root\States\CA\Mars_ConnectionPoint\DataDriver_INI_CP.ini"
Call ReadExcelFile_RenameXMLFilesInLoop_WithEventsName(cPath, strINIPath)
...
'Call ReadExcelFile_DeleteAllFilesUnderFolder_SpecificExtention(cPath, "json")
'' Rename XMLs files with event's name
'Call ReadExcelFile_RenameXMLFilesInLoop_WithEventsName(cPath)
...
Call Snowflake_ReadDB_CP_2(cPath, strFileBaseName, strDB_SF_User, strDB_SF_Pass, SQLquery)
Wait(1)

' Convert JSONs to XMLs
strJsonFolderName = "Desktop;This PC;OSDisk (C:);Maximus;Reports;CP_Test"
Call Convert_JSON_to_XML_All(strJsonFolderName)
