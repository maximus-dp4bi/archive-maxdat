...
iRows_Grid = ReadExcelFile_GetNumberOfRowsInExcel (strGridReport_FullPath, strWorkbookName) ' get original number of rows

If iRows_Genesys = 1 and  iRows_Grid = 1 Then
strPassed_Failed = "WARNING"	
Else
' ====================== Compare ==========================
' Compare genesys total number of rows with Grid total value for specified date
strResult = ReadExcelFile_CrossRef_FlowOutcomePerformanceSummary_GenNCUIFlowOutcomeSummarydataset(strReportPath_Genesys, strGridReport_FullPath, strR1_Col1_Filter, strR1_Col1_Filter_Value, strR1_Col2_Filter, strR1_Col2_Filter_Value, strR1_ColumnsToSum_1, strR1_ColumnsToSum_2, strR1_ColumnsToSum_3, strR2_Col1_Filter, strR2_Col1_Filter_Value, strR2_Col2_Filter, strR2_Col2_Filter_Value, strR2_ColumnsToSum_1, strR2_ColumnsToSum_2, strR2_ColumnsToSum_3)
