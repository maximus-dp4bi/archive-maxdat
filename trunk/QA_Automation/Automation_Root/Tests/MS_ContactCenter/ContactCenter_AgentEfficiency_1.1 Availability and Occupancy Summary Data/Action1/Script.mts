...
cDataFileURL = "C:\Automation_Root\States\MI\MS_ContactCenter\MIEBS\Project\Data\DataDriver_ContactCenter_AgentEfficiency_1.1 Availability and Occupancy Summary Data.xls"
cReports = "C:\Maximus\Reports" & "\" & "MIEBS_PROD_09.23.2020_ContactCenter_AgentEfficiency_1.1 Availability and Occupancy Summary Data"
Call CreateFolderSingleIfNotExists(cReports) 
...
Call Wait_UntillDownloadLoaderDisappeared_Grid()
strTitle = "Agent Group"
Call ReadGrid_SelectDropdownList(strGrid_WebList_6, strTitle, 5)
Call Wait_UntillDownloadLoaderDisappeared_Grid()

' Grid calculations
Call Wait_UntillDownloadLoaderDisappeared()
Call ReadExcelFile_ReadGrid_Horizontal_sum_TIME_M_S_rows_ValidateTotal(strGrid_Time_RowsExcludedFromRun)
...
' Convert grid to vertical view
Call GUIReport_SwapRowsColumns()
Call Wait_UntillDownloadLoaderDisappeared_Grid()
