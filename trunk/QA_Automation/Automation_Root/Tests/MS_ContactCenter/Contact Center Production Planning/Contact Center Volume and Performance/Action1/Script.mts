...
cDataFileURL = "C:\UFT\Project\Contact Center\Data\DataDriver_ContactCenter_ Volume and Performance.xls"
...
'Call ReadExcelFile_CalculateTotalByColumn_AppendResult(cReportFileURL_SQL, strR2_ColumnsToTotalNumbers, strWorkbookName, ",", iRows)
...
Call ReadExcelFile_CalculateFilteredAverageNumbersByColumn_AppendResult(cReportFileURL_Grid, strR1_ColumnsToAverageNumber, strFilterByColumn, strFilterByValue, strWorkbookName, ",", iRows)
