...
cDataFileURL = "C:\Automation_Root\States\MI\MS_ContactCenter\MIEBS\Project\Data\CC_DataDriver_Ad Hoc - Volume and Performance (1.2 Contact Center Ad-Hoc Template – Hourly VS 1.1 Monthly Contact Center Volumes and Performance).xls"
cReports = "C:\Maximus\Reports" & "\" & "MIEBS_PROD_09.23.2020_Ad Hoc - Volume and Performance (1.2 Contact Center Ad-Hoc Template – Hourly VS 1.1 Monthly Contact Center Volumes and Performance)"
Call CreateFolderSingleIfNotExists(cReports) 
...
Case "1.2 Contact Center Ad-Hoc Template – Hourly"
...
Case "1.1 Monthly Contact Center Volumes and Performance"
...
Call ReadExcelFile_CalculateTotalByColumn_AppendResult(strFilePath, strR1_ColumnsToTotalNumbers, strWorkbookName, ",", iRows)
