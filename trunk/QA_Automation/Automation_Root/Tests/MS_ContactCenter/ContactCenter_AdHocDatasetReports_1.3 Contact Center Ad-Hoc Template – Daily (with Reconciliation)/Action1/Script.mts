...
cDataFileURL = "C:\Automation_Root\States\MI\MS_ContactCenter\MIEBS\Project\Data\DataDriver_ContactCenter_AdHocDatasetReports_1.3 Contact Center Ad-Hoc Template – Daily (with Reconciliation).xls"
cReports = "C:\Maximus\Reports" & "\" & "MIEBS_PROD_09.23.2020_AdHocDatasetReports_1.3 Contact Center Ad-Hoc Template – Daily (with Reconciliation)"
Call CreateFolderSingleIfNotExists(cReports) 
...
Else
strReportType_Temp = strReportLink
