...
'cDataFileURL = "C:\Automation_Root\States\CA\MS_ContactCenter\CALL\Project\Data\DataDriver_ContactCenter_SOASharedServices_SOA Agent Activity and Performance Summary with Billable Minutes.xls"
'cReports = "C:\Maximus\Reports" & "\" & "ContactCenter_SOASharedServices_SOA Agent Activity and Performance Summary with Billable Minutes"
'Call CreateFolderSingleIfNotExists(cReports) 
'
...
strGrid_ColumnsList_SumTime_H_M_S = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(cDataFileURL, cGrid_ColumnsList_SumTime_H_M_S, iIndex)
...
Case "RunReport_Grid"
Call MicroStarategy_DirectAccess_SelectReportLink_2 (strReportLink, strReportName, strContainerType)
Case Else
End Select
...
' Summarize data for each column and compare with column's total
GUIReport_ReadGrid_CalculateColumnsTotals(strGrid_ColumnsList_SumNumbers)
' Average percentage related columns
Call GUIReport_ReadGrid_CalculateColumns_PersentageAverage(strGrid_ColumnsList_AveragePercents)
' Percentage average related columns
Call GUIReport_ReadGrid_CalculateColumns_Time_H_M_C_Average(strGrid_ColumnsList_SumTime_H_M_S)
