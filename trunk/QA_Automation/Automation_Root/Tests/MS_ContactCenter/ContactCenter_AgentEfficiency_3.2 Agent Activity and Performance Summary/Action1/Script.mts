...
'cDataFileURL = strDataDriver_Location & "\" & strDataDriver_FileName & ".xls"
'
strSQLLocation = "C:\Automation_Root\States\MI\MS_ContactCenter\MIEBS\SQL"
cDataFileURL = "C:\Automation_Root\States\MI\MS_ContactCenter\MIEBS\Project\Data\DataDriver_ContactCenter_AgentEfficiency_3.2 Agent Activity and Performance Summary.xls"
cReports = "C:\Maximus\Reports" & "\" & "MIEBS_PROD_09.23.2020_ContactCenter_AgentEfficiency_3.2 Agent Activity and Performance Summary"
Call CreateFolderSingleIfNotExists(cReports) 
...
strGrid_ColumnsList_AverageTime_H_M_S = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(cDataFileURL, cGrid_ColumnsList_AverageTime_H_M_S, iIndex)
strGrid_ColumnsList_AveragePercents = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(cDataFileURL, cGrid_ColumnsList_AveragePercents, iIndex)
strGrid_ColumnsList_SumNumbers = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(cDataFileURL, cGrid_ColumnsList_SumNumbers, iIndex)
strGrid_ColumnsList_AverageNumbers = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(cDataFileURL, cGrid_ColumnsList_AverageNumbers, iIndex)
...
' Get SELECT statement from corresponded text file
...
' Calculate average values for percent related columns and compare with last row (Totals)
Call GUIReport_ReadGrid_CalculateColumns_PersentageAverage_METRICS_3_2_AgentActivityAndPerformanceSummary(strGrid_ColumnsList_AveragePercents)
' Calculate totals for number related columns
Call GUIReport_ReadGrid_CalculateColumns_TotalNumbers_METRICS_3_2_AgentActivityAndPerformanceSummary(strGrid_ColumnsList_SumNumbers)
' Calculate Average number related columns
Call GUIReport_ReadGrid_CalculateColumns_AverageNumbers_METRICS_3_2_AgentActivityAndPerformanceSummary(strGrid_ColumnsList_AverageNumbers)
' Calculate HH:MM:SS average
Call GUIReport_ReadGrid_CalculateColumns_HH_MM_SS_Average_METRICS_3_2_AgentActivityAndPerformanceSummary(strGrid_ColumnsList_AverageTime_H_M_S)
