strFilePath = "C:\Automation_Root\States\Stateless\PureInsights_Snowflake_DPWarehouse_Integration\PureInsite_Sandbox_9999\GlobalDataSheet_PI_vs_SF_DPWarehouse_Metadata_Data_Verification.xlsx"
...
strBasicLocation = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(strFilePath, "Basic Location", iIndex)
...
strSQLData = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(strFilePath, "SQL Data Location", iIndex)
strEmailTo = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(strFilePath, "Email To", iIndex)
strEmailCC = ReadExcelFile_GetCellValueByColumnNameAndRowIndex(strFilePath, "Email CC", iIndex)
...
sheet.Cells(1, 3).Value = "Basic Location"
sheet.Cells(1, 4).Value = "Data Driver Location"
sheet.Cells(1, 5).Value = "Data Driver"
sheet.Cells(1, 6).Value = "SQL Location"
sheet.Cells(1, 7).Value = "SQL Data Location"
sheet.Cells(1, 8).Value = "Email To"
sheet.Cells(1, 9).Value = "Email CC"
sheet.Cells(2, 1).Value = strScriptLocation
sheet.Cells(2, 2).Value = strTestName
sheet.Cells(2, 3).Value = strBasicLocation
sheet.Cells(2, 4).Value = strDataDriverLocation
sheet.Cells(2, 5).Value = strDataDriver
sheet.Cells(2, 6).Value = strSQL
sheet.Cells(2, 7).Value = strSQLData
sheet.Cells(2, 8).Value = strEmailTo
sheet.Cells(2, 9).Value = strEmailCC
