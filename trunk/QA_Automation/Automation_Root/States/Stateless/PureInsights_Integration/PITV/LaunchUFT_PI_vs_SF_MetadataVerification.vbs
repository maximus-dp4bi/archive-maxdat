strFilePath = "C:\Automation_Root\States\Stateless\PureInsights_Integration\PITV\GlobalDataSheet_PI_vs_SF_MetadataVerification.xlsx"
...
sheet.Cells(1, 7).Value = "Email To"
sheet.Cells(1, 8).Value = "Email CC"
...
sheet.Cells(2, 7).Value = strEmailTo
sheet.Cells(2, 8).Value = strEmailCC
