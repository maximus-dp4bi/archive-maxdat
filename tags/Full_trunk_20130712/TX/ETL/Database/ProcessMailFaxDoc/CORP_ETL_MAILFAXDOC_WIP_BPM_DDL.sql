...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table CORP_ETL_MAILFAXDOC_WIP_BPM
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger TRG_R_corp_etl_mail_wip_bpm
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "TRG_R_corp_etl_mail_wip_bpm" BEFORE
  INSERT OR
...
END;
/
ALTER TRIGGER "TRG_R_corp_etl_mail_wip_bpm" ENABLE;
