...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table FLHK_ETL_MONITOR_DISPUTES
--------------------------------------------------------

  CREATE TABLE "FLCST0_MAXDAT"."FLHK_ETL_MONITOR_DISPUTES" 
   (	"MD_ID" NUMBER, 
	"DISPUTE_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "FLCST0_MAXDAT"."FLHK_ETL_MONITOR_DISPUTES_TRG" 
   before insert on "FLCST0_MAXDAT"."FLHK_ETL_MONITOR_DISPUTES" 
   for each row 
begin  
   if inserting then 
...
/
ALTER TRIGGER "FLCST0_MAXDAT"."FLHK_ETL_MONITOR_DISPUTES_TRG" ENABLE;
