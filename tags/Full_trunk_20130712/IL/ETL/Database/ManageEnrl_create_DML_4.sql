...
v_rec.sla_days_type := 'C'; v_rec.sla_days := 14;  v_rec.sla_type := 'FIRST_FOLLOWUP'; v_rec.newborn_flag := 'Y'; ins_rec;
v_rec.sla_days_type := 'C'; v_rec.sla_days := 30;  v_rec.sla_type := 'SECOND_FOLLOWUP'; v_rec.newborn_flag := 'Y'; ins_rec;
v_rec.sla_days_type := 'C'; v_rec.sla_days := 40;  v_rec.sla_type := 'THIRD_FOLLOWUP'; v_rec.newborn_flag := 'Y'; ins_rec;
v_rec.sla_days_type := 'C'; v_rec.sla_days := 50;  v_rec.sla_type := 'FOURTH_FOLLOWUP'; v_rec.newborn_flag := 'Y'; ins_rec;
...
v_rec.sla_days_type := 'C'; v_rec.sla_days := 14;  v_rec.sla_type := 'FIRST_FOLLOWUP';  v_rec.newborn_flag := 'N'; ins_rec;
v_rec.sla_days_type := 'C'; v_rec.sla_days := 30;  v_rec.sla_type := 'SECOND_FOLLOWUP'; v_rec.newborn_flag := 'N'; ins_rec;
v_rec.sla_days_type := 'C'; v_rec.sla_days := 40;  v_rec.sla_type := 'THIRD_FOLLOWUP';  v_rec.newborn_flag := 'N'; ins_rec;
v_rec.sla_days_type := 'C'; v_rec.sla_days := 50;  v_rec.sla_type := 'FOURTH_FOLLOWUP'; v_rec.newborn_flag := 'N'; ins_rec;
