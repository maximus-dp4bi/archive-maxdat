...
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.cemw_id
  is 'sequence';
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.asf_cancel_work
  is 'Indicates if the Cancel Work step in the business process has been completed';
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.asf_complete_work
  is 'Indicates if the Complete Work step in the business process has been completed.';
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.age_in_business_days
...
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.source_reference_id
...
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.source_reference_type
  is 'Indicates the type of Source Reference ID that is being provided.';
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.status_age_in_bus_days
...
comment on column MAXDAT.CORP_ETL_MANAGE_WORK.status_age_in_cal_days
...
alter table MAXDAT.CORP_ETL_MANAGE_WORK
...
grant select on MAXDAT.CORP_ETL_MANAGE_WORK to MAXDAT_READ_ONLY;
