...
(SYSTEM_NAME,CLEANUP_NAME ,	RUN,START_DATE,START_TIME , END_DATE, END_TIME ,STATEMENT
  ) Values ('PROCESS_MAILFAXDOC','CLEANUP1','Y',SYSDATE,'00:01:00',to_date('07/07/7777','MM/DD/YYYY'),'05:59:00',
...
INSERT INTO CORP_INSTANCE_CLEANUP_TABLE 
(SYSTEM_NAME,CLEANUP_NAME ,RUN,START_DATE ,START_TIME ,END_DATE,END_TIME ,STATEMENT)
Values ('PROCESS_MAILFAXDOC','CLEANUP2','Y',SYSDATE,'00:01:00',to_date('07/07/7777','MM/DD/YYYY'),'05:59:00',
 'UPDATE corp_etl_mailfaxdoc 
  set CANCEL_DT = SYSDATE,
  INSTANCE_COMPLETE_DT = SYSDATE,
  STAGE_DONE_DT = SYSDATE,
...
AND  link_method = ''Manual'''
 ...
 INSERT INTO CORP_INSTANCE_CLEANUP_TABLE 
(SYSTEM_NAME,CLEANUP_NAME ,RUN,START_DATE , START_TIME , END_DATE,END_TIME ,STATEMENT)
Values ('PROCESS_MAILFAXDOC','CLEANUP3','Y',SYSDATE,'00:01:00',to_date('07/07/7777','MM/DD/YYYY'),'05:59:00',
 'UPDATE corp_etl_mailfaxdoc 
  set CANCEL_DT = SYSDATE,
  INSTANCE_COMPLETE_DT = SYSDATE,
  STAGE_DONE_DT = SYSDATE,
