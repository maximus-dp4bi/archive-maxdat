...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ManageEnrollmentActivity/ProcessManageEnroll_SPECIAL_RUN.kjb" -log="$LOG_DIR/ManageEnrollmentActivity/ProcessMngEnrl_SPECIAL_RUN.log" -level="$DETAIL_LOG_LEVEL"
