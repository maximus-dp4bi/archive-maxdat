...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ManageEnrollmentActivity/ProcessManageEnroll_RUNALL.kjb" -log="$LOG_DIR/ManageEnrollmentActivity/ProcessManageEnroll_RUNALL.log" -level="$DETAIL_LOG_LEVEL"
