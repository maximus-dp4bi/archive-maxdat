...
#CUSTOM_DIR=$MAXDAT_ETL_DIR change this to /u01/maximus/maxdat-dev
#LOG_DIR=$MAXDAT_LOG_DIR
CUSTOM_DIR=/u01/maximus/maxdat-dev/IL/ETL/scripts
LOG_DIR=/u01/maximus/maxdat-dev/IL/ETL/logs
LOG_LEVEL="Detailed"
