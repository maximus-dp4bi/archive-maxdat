...
(
  ...
  HEART_APPLICATION_STATUS  VARCHAR2(50),
  MAXE_APP_STATUS_GROUP     VARCHAR2(30),
...
(
  ...
  ALL_MI_SATISFIED          VARCHAR2(1) not null,
  AUTO_CLOSE_FLAG           VARCHAR2(1) not null,
  CALL_CAMPAIGN_ID          NUMBER,
  CALL_CAMPAIGN_FLAG        VARCHAR2(1) not null,
  CANCEL_DT                 DATE,
  CURRENT_TASK_ID           NUMBER,
  LETTER_REQ_ID             NUMBER,
  LETTER_STATUS             VARCHAR2(20),
  NEW_MI_FLAG               VARCHAR2(1),
  NEW_STATE_REVIEW_TASK_ID  NUMBER,
  RFE_STATUS_FLAG           VARCHAR2(1) not null,
  STATE_ACCEPT_IND          VARCHAR2(1) not null,
  STATE_REVIEW_OUTCOME      VARCHAR2(20),
