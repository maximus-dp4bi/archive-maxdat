...
begin
  ...
  --PRC_BPM_ETL_BIA_UPD_NUM ('INSERT',v_source_id,v_bi_id,  2,:old.AGE_IN_CALENDAR_DAYS,:new.AGE_IN_CALENDAR_DAYS,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_DATE('INSERT',v_source_id,v_bi_id,  3,:old.CANCEL_WORK_DATE,:new.CANCEL_WORK_DATE,v_bue_id);
  --PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id,  4,:old.CANCEL_WORK_FLAG,:new.CANCEL_WORK_FLAG,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_DATE('INSERT',v_source_id,v_bi_id,  5,:old.COMPLETE_DATE,:new.COMPLETE_DATE,v_bue_id);
  --PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id,  6,:old.COMPLETE_FLAG,:new.COMPLETE_FLAG,v_bue_id);
  ...
  --PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id, 16,:old.JEOPARDY_FLAG,:new.JEOPARDY_FLAG,v_bue_id);
  ...
  --PRC_BPM_ETL_BIA_UPD_NUM ('INSERT',v_source_id,v_bi_id, 27,:old.STATUS_AGE_IN_CAL_DAYS,:new.STATUS_AGE_IN_CAL_DAYS,v_bue_id);
  ...
  --PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id, 35,:old.TIMELINESS_STATUS,:new.TIMELINESS_STATUS,v_bue_id);
...
exception
  ...
  when others then
    ...
    values 
      (v_be_id,sysdate,$$PLSQL_UNIT,v_source_id,v_bi_id,v_bia_id,
