...
select 
  ...
  trunc(nvl(vdcod."Complete Date",sysdate) - vdcrd."Create Date") "Age in Calendar Days"
from
...
select
  ...
  trunc(nvl(vdcd."Complete Date",sysdate) - vdsd."Status Date") "Status Age in Calendar Days"
from
