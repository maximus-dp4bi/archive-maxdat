...
create or replace package body BPM_EVENT_PROJECT as
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      NYEC_PROCESS_APP.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
    elsif p_bueq_row.BSL_ID = 4 then
      NYEC_PROCESS_APP_MI.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
    elsif p_bueq_row.BSL_ID = 5 then
      NYEC_PROCESS_MI.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
    elsif p_bueq_row.BSL_ID = 7 then
      NYEC_PROCESS_STATE_REVIEW.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
    else
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      NYEC_PROCESS_APP.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);
    elsif p_bueq_row.BSL_ID = 4 then
      NYEC_PROCESS_APP_MI.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);
    elsif p_bueq_row.BSL_ID = 5 then
      NYEC_PROCESS_MI.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);
    elsif p_bueq_row.BSL_ID = 7 then
      NYEC_PROCESS_STATE_REVIEW.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);
    else
