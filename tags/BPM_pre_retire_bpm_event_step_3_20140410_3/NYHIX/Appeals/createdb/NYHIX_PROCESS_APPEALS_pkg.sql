...
/*
select '     '|| 'NEPA_ID varchar2(100),' attr_element from dual  
  union 
...
-- Get record for Process Incidents insert XML.
  ...
  begin  
/*
select '      extractValue(p_data_xml,''/ROWSET/ROW/NEPA_ID'') "' || 'NEPA_ID'|| '",' attr_element from dual
    union 
...
*/ 
  ...
  -- Insert fact for BPM Semantic model - Process Appeals.
    ...
    begin
      ...
      then
        ...
        BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,null,v_procedure_name,v_bsl_id,v_bil_id,p_identifier,p_apl_bi_id,null,v_log_message,v_sql_code);
  ...
  begin
    ...
    values
      (v_bi_id,v_bem_id,v_identifier,v_bil_id,v_bsl_id,
       v_start_date,v_end_date,to_char(v_new_data.NEPA_ID),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT));
 ...
 /*   select 'BPM_EVENT.INSERT_BIA(v_bi_id, '||b.ba_id || ','||bl.bdl_id || ',v_new_data.'|| stg.staging_table_column || ',v_start_date,v_bue_id);'
    ...
    BPM_EVENT.INSERT_BIA(v_bi_id, 2484,3,v_new_data.INSTANCE_COMPLETE_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2485,2,v_new_data.INSTANCE_STATUS,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2486,1,v_new_data.INCIDENT_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2487,3,v_new_data.CANCEL_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2488,2,v_new_data.CHANNEL,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2489,3,v_new_data.RECEIPT_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2490,2,v_new_data.ASPB_GATHER_MISS_INFO,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2491,3,v_new_data.ASED_GATHER_MISS_INFO,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2492,3,v_new_data.ASSD_GATHER_MISS_INFO,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2493,2,v_new_data.PRIORITY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2494,1,v_new_data.LINKED_CLIENT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2495,3,v_new_data.COMPLETE_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2496,3,v_new_data.CREATE_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2497,2,v_new_data.CREATED_BY_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2498,2,v_new_data.LAST_UPDATE_BY_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2499,3,v_new_data.LAST_UPDATE_BY_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2500,1,v_new_data.CASE_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2501,2,v_new_data.CANCEL_METHOD,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2502,2,v_new_data.CANCEL_REASON,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2503,2,v_new_data.CANCEL_BY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2504,2,v_new_data.INCIDENT_DESCRIPTION,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2505,2,v_new_data.OTHER_PARTY_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2506,2,v_new_data.REPORTER_RELATIONSHIP,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2507,2,v_new_data.REPORTED_BY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2508,2,v_new_data.ABOUT_PLAN_CODE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2509,1,v_new_data.ABOUT_PROVIDER_ID,v_start_date,v_bue_id);
    --BPM_EVENT.INSERT_BIA(v_bi_id, 2510,2,v_new_data.INCIDENT_REASON,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2511,2,v_new_data.INCIDENT_ABOUT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2512,2,v_new_data.INCIDENT_TYPE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2513,2,v_new_data.RESOLUTION_DESCRIPTION,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2514,2,v_new_data.RESOLUTION_TYPE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2515,2,v_new_data.ACTION_COMMENTS,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2516,2,v_new_data.ACTION_TYPE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2517,3,v_new_data.INCIDENT_STATUS_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2518,2,v_new_data.INCIDENT_STATUS,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2519,2,v_new_data.CREATED_BY_GROUP,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2520,2,v_new_data.TRACKING_NUMBER,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2521,3,v_new_data.STG_EXTRACT_DATE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2522,3,v_new_data.STG_LAST_UPDATE_DATE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2523,3,v_new_data.STAGE_DONE_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2524,1,v_new_data.CURRENT_TASK_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2525,2,v_new_data.ASF_ADVISE_WITHDRAW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2526,3,v_new_data.ASED_ADVISE_WITHDRAW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2527,2,v_new_data.ASPB_ADVISE_WITHDRAW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2528,3,v_new_data.ASSD_ADVISE_WITHDRAW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2529,3,v_new_data.APPEAL_HEARING_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2530,2,v_new_data.GWF_APPEAL_INVALID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2531,2,v_new_data.GWF_RESOLVED,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2533,2,v_new_data.GWF_VALID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2534,2,v_new_data.ASF_CANCEL_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2535,3,v_new_data.ASED_CANCEL_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2536,3,v_new_data.ASSD_CANCEL_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2537,2,v_new_data.ASPB_CANCEL_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2538,2,v_new_data.GWF_CHANGE_ELIGIBILITY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2539,2,v_new_data.GWF_CHANNEL,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2540,2,v_new_data.ASF_CON_HEARING_PROC,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2541,3,v_new_data.ASED_CON_HEARING_PROC,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2542,3,v_new_data.ASSD_CON_HEARING_PROC,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2543,2,v_new_data.ASPB_CON_HEARING_PROC,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2544,2,v_new_data.ASF_CONDUCT_ST_REV,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2545,3,v_new_data.ASED_CONDUCT_ST_REV,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2546,3,v_new_data.ASSD_CONDUCT_ST_REV,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2547,2,v_new_data.ASPB_CONDUCT_ST_REV,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2548,2,v_new_data.ASF_DETERMINE_VALID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2549,3,v_new_data.ASED_DETERMINE_VALID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2550,3,v_new_data.ASSD_DETERMINE_VALID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2551,2,v_new_data.ASPB_DETERMINE_VALID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2552,2,v_new_data.ASF_GATHER_MISS_INFO,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2553,2,v_new_data.ASF_PROC_VALID_AMEND,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2554,3,v_new_data.ASED_PROC_VALID_AMEND,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2555,3,v_new_data.ASSD_PROC_VALID_AMEND,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2556,2,v_new_data.ASPB_PROC_VALID_AMEND,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2557,2,v_new_data.ASF_REVIEW_APPEAL,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2558,3,v_new_data.ASED_REVIEW_APPEAL,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2559,3,v_new_data.ASSD_REVIEW_APPEAL,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2560,2,v_new_data.ASPB_REVIEW_APPEAL,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2561,2,v_new_data.ASF_SHOP_REVIEW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2562,2,v_new_data.ASF_SCHEDULE_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2563,3,v_new_data.ASED_SCHEDULE_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2564,3,v_new_data.ASSD_SCHEDULE_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2565,2,v_new_data.ASPB_SCHEDULE_HEARING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2566,2,v_new_data.GWF_SHOP_REVIEW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2567,3,v_new_data.ASED_SHOP_REVIEW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2568,3,v_new_data.ASSD_SHOP_REVIEW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2569,2,v_new_data.ASPB_SHOP_REVIEW,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2570,2,v_new_data.GWF_WITHDRAWN_IN_WRITING,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2571,2,v_new_data.ABOUT_PLAN_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2572,2,v_new_data.ABOUT_PROVIDER_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2574,1,v_new_data.EXPECTED_REQUEST,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2575,2,v_new_data.AID_TO_CONTINUE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2576,2,v_new_data.APPEAL_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2577,2,v_new_data.APPEAL_HEARING_LOCATION,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2578,2,v_new_data.APPEAL_HEARING_TIME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2579,2,v_new_data.APPELLANT_TYPE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2580,2,v_new_data.APPELLANT_TYPE_DESC,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2581,2,v_new_data.REQUESTED_DAY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2582,2,v_new_data.REQUESTED_TIME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2590,2,v_new_data.CURRENT_STEP,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2591,3,v_new_data.RECEIVED_DT,v_start_date,v_bue_id);
    commit;
    p_bue_id := v_bue_id;
  exception
    when OTHERS then
...
--    p_timeliness_status                 in  varchar2,    
 ...
 -- Update BPM Event model data.
  ...
  begin
    ...
    if p_data_version > 1 then
      v_log_message := 'Unsupported BPM_UPDATE_EVENT_QUEUE.DATA_VERSION value "' || p_data_version || '" with NYHIX Process Appeals in procedure ' || v_procedure_name || '.';
      RAISE_APPLICATION_ERROR(-20011,v_log_message);
    end if;
    ...
    and bsl_id = 23
    order by b.ba_id*/
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2484,3,'N',v_old_data.INSTANCE_COMPLETE_DT,v_new_data.INSTANCE_COMPLETE_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2485,2,'Y',v_old_data.INSTANCE_STATUS,v_new_data.INSTANCE_STATUS,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2487,3,'N',v_old_data.CANCEL_DT,v_new_data.CANCEL_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2490,2,'N',v_old_data.ASPB_GATHER_MISS_INFO,v_new_data.ASPB_GATHER_MISS_INFO,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2491,3,'N',v_old_data.ASED_GATHER_MISS_INFO,v_new_data.ASED_GATHER_MISS_INFO,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2492,3,'N',v_old_data.ASSD_GATHER_MISS_INFO,v_new_data.ASSD_GATHER_MISS_INFO,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2493,2,'N',v_old_data.PRIORITY,v_new_data.PRIORITY,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2495,3,'Y',v_old_data.COMPLETE_DT,v_new_data.COMPLETE_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2498,2,'N',v_old_data.LAST_UPDATE_BY_NAME,v_new_data.LAST_UPDATE_BY_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2499,3,'N',v_old_data.LAST_UPDATE_BY_DT,v_new_data.LAST_UPDATE_BY_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2500,1,'N',v_old_data.CASE_ID,v_new_data.CASE_ID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2501,2,'N',v_old_data.CANCEL_METHOD,v_new_data.CANCEL_METHOD,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2502,2,'N',v_old_data.CANCEL_REASON,v_new_data.CANCEL_REASON,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2503,2,'N',v_old_data.CANCEL_BY,v_new_data.CANCEL_BY,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2504,2,'Y',v_old_data.INCIDENT_DESCRIPTION,v_new_data.INCIDENT_DESCRIPTION,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2505,2,'N',v_old_data.OTHER_PARTY_NAME,v_new_data.OTHER_PARTY_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2506,2,'N',v_old_data.REPORTER_RELATIONSHIP,v_new_data.REPORTER_RELATIONSHIP,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2507,2,'N',v_old_data.REPORTED_BY,v_new_data.REPORTED_BY,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2508,2,'N',v_old_data.ABOUT_PLAN_CODE,v_new_data.ABOUT_PLAN_CODE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2509,1,'N',v_old_data.ABOUT_PROVIDER_ID,v_new_data.ABOUT_PROVIDER_ID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2513,2,'N',v_old_data.RESOLUTION_DESCRIPTION,v_new_data.RESOLUTION_DESCRIPTION,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2514,2,'N',v_old_data.RESOLUTION_TYPE,v_new_data.RESOLUTION_TYPE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2515,2,'Y',v_old_data.ACTION_COMMENTS,v_new_data.ACTION_COMMENTS,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2516,2,'N',v_old_data.ACTION_TYPE,v_new_data.ACTION_TYPE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2518,2,'Y',v_old_data.INCIDENT_STATUS,v_new_data.INCIDENT_STATUS,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2521,3,'N',v_old_data.STG_EXTRACT_DATE,v_new_data.STG_EXTRACT_DATE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2522,3,'N',v_old_data.STG_LAST_UPDATE_DATE,v_new_data.STG_LAST_UPDATE_DATE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2523,3,'N',v_old_data.STAGE_DONE_DT,v_new_data.STAGE_DONE_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2524,1,'Y',v_old_data.CURRENT_TASK_ID,v_new_data.CURRENT_TASK_ID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2525,2,'N',v_old_data.ASF_ADVISE_WITHDRAW,v_new_data.ASF_ADVISE_WITHDRAW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2526,3,'N',v_old_data.ASED_ADVISE_WITHDRAW,v_new_data.ASED_ADVISE_WITHDRAW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2527,2,'N',v_old_data.ASPB_ADVISE_WITHDRAW,v_new_data.ASPB_ADVISE_WITHDRAW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2528,3,'N',v_old_data.ASSD_ADVISE_WITHDRAW,v_new_data.ASSD_ADVISE_WITHDRAW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2529,3,'N',v_old_data.APPEAL_HEARING_DT,v_new_data.APPEAL_HEARING_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2530,2,'N',v_old_data.GWF_APPEAL_INVALID,v_new_data.GWF_APPEAL_INVALID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2531,2,'N',v_old_data.GWF_RESOLVED,v_new_data.GWF_RESOLVED,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2533,2,'N',v_old_data.GWF_VALID,v_new_data.GWF_VALID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2534,2,'N',v_old_data.ASF_CANCEL_HEARING,v_new_data.ASF_CANCEL_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2535,3,'N',v_old_data.ASED_CANCEL_HEARING,v_new_data.ASED_CANCEL_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2536,3,'N',v_old_data.ASSD_CANCEL_HEARING,v_new_data.ASSD_CANCEL_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2537,2,'N',v_old_data.ASPB_CANCEL_HEARING,v_new_data.ASPB_CANCEL_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2538,2,'N',v_old_data.GWF_CHANGE_ELIGIBILITY,v_new_data.GWF_CHANGE_ELIGIBILITY,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2539,2,'N',v_old_data.GWF_CHANNEL,v_new_data.GWF_CHANNEL,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2540,2,'N',v_old_data.ASF_CON_HEARING_PROC,v_new_data.ASF_CON_HEARING_PROC,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2541,3,'N',v_old_data.ASED_CON_HEARING_PROC,v_new_data.ASED_CON_HEARING_PROC,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2542,3,'N',v_old_data.ASSD_CON_HEARING_PROC,v_new_data.ASSD_CON_HEARING_PROC,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2543,2,'N',v_old_data.ASPB_CON_HEARING_PROC,v_new_data.ASPB_CON_HEARING_PROC,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2544,2,'N',v_old_data.ASF_CONDUCT_ST_REV,v_new_data.ASF_CONDUCT_ST_REV,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2545,3,'N',v_old_data.ASED_CONDUCT_ST_REV,v_new_data.ASED_CONDUCT_ST_REV,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2546,3,'N',v_old_data.ASSD_CONDUCT_ST_REV,v_new_data.ASSD_CONDUCT_ST_REV,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2547,2,'N',v_old_data.ASPB_CONDUCT_ST_REV,v_new_data.ASPB_CONDUCT_ST_REV,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2548,2,'N',v_old_data.ASF_DETERMINE_VALID,v_new_data.ASF_DETERMINE_VALID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2549,3,'Y',v_old_data.ASED_DETERMINE_VALID,v_new_data.ASED_DETERMINE_VALID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2550,3,'Y',v_old_data.ASSD_DETERMINE_VALID,v_new_data.ASSD_DETERMINE_VALID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2551,2,'Y',v_old_data.ASPB_DETERMINE_VALID,v_new_data.ASPB_DETERMINE_VALID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2552,2,'N',v_old_data.ASF_GATHER_MISS_INFO,v_new_data.ASF_GATHER_MISS_INFO,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2553,2,'N',v_old_data.ASF_PROC_VALID_AMEND,v_new_data.ASF_PROC_VALID_AMEND,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2554,3,'N',v_old_data.ASED_PROC_VALID_AMEND,v_new_data.ASED_PROC_VALID_AMEND,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2555,3,'N',v_old_data.ASSD_PROC_VALID_AMEND,v_new_data.ASSD_PROC_VALID_AMEND,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2556,2,'N',v_old_data.ASPB_PROC_VALID_AMEND,v_new_data.ASPB_PROC_VALID_AMEND,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2557,2,'N',v_old_data.ASF_REVIEW_APPEAL,v_new_data.ASF_REVIEW_APPEAL,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2558,3,'N',v_old_data.ASED_REVIEW_APPEAL,v_new_data.ASED_REVIEW_APPEAL,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2559,3,'N',v_old_data.ASSD_REVIEW_APPEAL,v_new_data.ASSD_REVIEW_APPEAL,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2560,2,'N',v_old_data.ASPB_REVIEW_APPEAL,v_new_data.ASPB_REVIEW_APPEAL,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2561,2,'N',v_old_data.ASF_SHOP_REVIEW,v_new_data.ASF_SHOP_REVIEW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2562,2,'N',v_old_data.ASF_SCHEDULE_HEARING,v_new_data.ASF_SCHEDULE_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2563,3,'N',v_old_data.ASED_SCHEDULE_HEARING,v_new_data.ASED_SCHEDULE_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2564,3,'N',v_old_data.ASSD_SCHEDULE_HEARING,v_new_data.ASSD_SCHEDULE_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2565,2,'N',v_old_data.ASPB_SCHEDULE_HEARING,v_new_data.ASPB_SCHEDULE_HEARING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2566,2,'N',v_old_data.GWF_SHOP_REVIEW,v_new_data.GWF_SHOP_REVIEW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2567,3,'N',v_old_data.ASED_SHOP_REVIEW,v_new_data.ASED_SHOP_REVIEW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2568,3,'N',v_old_data.ASSD_SHOP_REVIEW,v_new_data.ASSD_SHOP_REVIEW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2569,2,'N',v_old_data.ASPB_SHOP_REVIEW,v_new_data.ASPB_SHOP_REVIEW,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2570,2,'N',v_old_data.GWF_WITHDRAWN_IN_WRITING,v_new_data.GWF_WITHDRAWN_IN_WRITING,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2571,2,'N',v_old_data.ABOUT_PLAN_NAME,v_new_data.ABOUT_PLAN_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2572,2,'N',v_old_data.ABOUT_PROVIDER_NAME,v_new_data.ABOUT_PROVIDER_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2574,1,'N',v_old_data.EXPECTED_REQUEST,v_new_data.EXPECTED_REQUEST,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2575,2,'N',v_old_data.AID_TO_CONTINUE,v_new_data.AID_TO_CONTINUE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2577,2,'N',v_old_data.APPEAL_HEARING_LOCATION,v_new_data.APPEAL_HEARING_LOCATION,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2578,2,'N',v_old_data.APPEAL_HEARING_TIME,v_new_data.APPEAL_HEARING_TIME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2579,2,'N',v_old_data.APPELLANT_TYPE,v_new_data.APPELLANT_TYPE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2580,2,'N',v_old_data.APPELLANT_TYPE_DESC,v_new_data.APPELLANT_TYPE_DESC,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2581,2,'N',v_old_data.REQUESTED_DAY,v_new_data.REQUESTED_DAY,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2582,2,'N',v_old_data.REQUESTED_TIME,v_new_data.REQUESTED_TIME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2590,2,'N',v_old_data.CURRENT_STEP,v_new_data.CURRENT_STEP,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id, 2591,3,'N',v_old_data.RECEIVED_DT,v_new_data.RECEIVED_DT,v_bue_id,v_stg_last_update_date);
