...
/*
select '     '|| 'NEII_ID varchar2(100),' attr_element from dual
  union
...
-- Get record for IDR Incidents insert XML.
  ...
  begin
/*
select '      extractValue(p_data_xml,''/ROWSET/ROW/NEII_ID'') "' || 'NEII_ID'|| '",' attr_element from dual
    union
  ...
  insert into BPM_INSTANCE
    ...
    values
      (v_bi_id,v_bem_id,v_identifier,v_bil_id,v_bsl_id,
       v_start_date,v_end_date,to_char(v_new_data.neii_id),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT));
...
BPM_EVENT.INSERT_BIA(v_bi_id,2356,1,v_new_data.INCIDENT_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2357,2,v_new_data.CREATED_BY_GROUP,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2358,2,v_new_data.CREATED_BY_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2359,1,v_new_data.TRACKING_NUMBER,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2360,3,v_new_data.CREATE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2361,2,v_new_data.INCIDENT_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2362,1,v_new_data.CLIENT_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2363,3,v_new_data.ASSD_IDR_REVIEW_DOCS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2364,3,v_new_data.ASED_IDR_REVIEW_DOCS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2365,2,v_new_data.ASPB_IDR_REVIEW_DOCS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2366,3,v_new_data.ASSD_GATHER_MISS_INFO,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2367,3,v_new_data.ASED_GATHER_MISS_INFO,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2368,2,v_new_data.ASPB_GATHER_MISS_INFO,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2369,2,v_new_data.ABOUT_PLAN_CODE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2370,1,v_new_data.ABOUT_PROVIDER_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2371,2,v_new_data.ACTION_COMMENTS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2372,2,v_new_data.ACTION_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2373,2,v_new_data.CANCEL_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2374,3,v_new_data.CANCEL_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2375,2,v_new_data.CANCEL_METHOD,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2376,2,v_new_data.CANCEL_REASON,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2377,1,v_new_data.CURRENT_TASK_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2378,2,v_new_data.ENROLLMENT_STATUS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2379,2,v_new_data.INCIDENT_ABOUT,v_start_date,v_bue_id);
--BPM_EVENT.INSERT_BIA(v_bi_id,2380,2,v_new_data.INCIDENT_REASON,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2381,2,v_new_data.INCIDENT_STATUS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2382,3,v_new_data.INCIDENT_STATUS_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2383,3,v_new_data.INSTANCE_COMPLETE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2384,2,v_new_data.INSTANCE_STATUS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2385,2,v_new_data.LAST_UPDATE_BY_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2386,3,v_new_data.LAST_UPDATE_BY_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2387,2,v_new_data.UPDATED_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2388,2,v_new_data.OTHER_PARTY_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2389,2,v_new_data.PRIORITY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2390,2,v_new_data.REPORTED_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2391,2,v_new_data.REPORTER_RELATIONSHIP,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2392,2,v_new_data.RESOLUTION_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2393,1,v_new_data.CASE_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2394,2,v_new_data.FORWARDED,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2395,2,v_new_data.FORWARDED_TO,v_start_date,v_bue_id);

BPM_EVENT.INSERT_BIA(v_bi_id,2396,2,v_new_data.ASF_IDR_REVIEW_DOCS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2397,2,v_new_data.ASF_GATHER_MISS_INFO,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2398,2,v_new_data.GWF_CONTINUE_APPEAL,v_start_date,v_bue_id);

BPM_EVENT.INSERT_BIA(v_bi_id,2584,3,v_new_data.COMPLETE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2597,2,v_new_data.CURRENT_STEP,v_start_date,v_bue_id);

BPM_EVENT.INSERT_BIA(v_bi_id,2599,2,v_new_data.APPELLANT_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2600,2,v_new_data.APPELLANT_TYPE_DESC,v_start_date,v_bue_id);

BPM_EVENT.INSERT_BIA(v_bi_id,2605,2,v_new_data.REPORTER_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id,2606,2,v_new_data.REPORTER_PHONE,v_start_date,v_bue_id);
...
-- Update BPM Event model data.
 ...
 if p_data_version != 1 then
      v_log_message := 'Unsupported BPM_UPDATE_EVENT_QUEUE.DATA_VERSION value "' || p_data_version || '" with NYHIX IDR incidents in procedure ' || v_procedure_name || '.';
      RAISE_APPLICATION_ERROR(-20011,v_log_message);
    end if;
...
BPM_EVENT.UPDATE_BIA(v_bi_id,2356,1,'N',v_new_data.INCIDENT_ID,            v_new_data.INCIDENT_ID,          v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2357,2,'N',v_new_data.CREATED_BY_GROUP,       v_new_data.CREATED_BY_GROUP,     v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2358,2,'N',v_new_data.CREATED_BY_NAME,        v_new_data.CREATED_BY_NAME,      v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2359,1,'N',v_new_data.TRACKING_NUMBER,        v_new_data.TRACKING_NUMBER,      v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2360,3,'N',v_new_data.CREATE_DT,              v_new_data.CREATE_DT,            v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2361,2,'N',v_new_data.INCIDENT_TYPE,          v_new_data.INCIDENT_TYPE,        v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2362,1,'Y',v_new_data.CLIENT_ID,              v_new_data.CLIENT_ID,            v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2363,3,'N',v_new_data.ASSD_IDR_REVIEW_DOCS,   v_new_data.ASSD_IDR_REVIEW_DOCS, v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2364,3,'N',v_new_data.ASED_IDR_REVIEW_DOCS,   v_new_data.ASED_IDR_REVIEW_DOCS, v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2365,2,'Y',v_new_data.ASPB_IDR_REVIEW_DOCS,   v_new_data.ASPB_IDR_REVIEW_DOCS, v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2366,3,'Y',v_new_data.ASSD_GATHER_MISS_INFO,  v_new_data.ASSD_GATHER_MISS_INFO,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2367,3,'N',v_new_data.ASED_GATHER_MISS_INFO,  v_new_data.ASED_GATHER_MISS_INFO,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2368,2,'N',v_new_data.ASPB_GATHER_MISS_INFO,  v_new_data.ASPB_GATHER_MISS_INFO,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2369,2,'N',v_new_data.ABOUT_PLAN_CODE,        v_new_data.ABOUT_PLAN_CODE,      v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2370,1,'N',v_new_data.ABOUT_PROVIDER_ID,      v_new_data.ABOUT_PROVIDER_ID,    v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2371,2,'Y',v_new_data.ACTION_COMMENTS,        v_new_data.ACTION_COMMENTS,      v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2372,2,'N',v_new_data.ACTION_TYPE,            v_new_data.ACTION_TYPE,          v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2373,2,'N',v_new_data.CANCEL_BY,              v_new_data.CANCEL_BY,            v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2374,3,'N',v_new_data.CANCEL_DT,              v_new_data.CANCEL_DT,            v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2375,2,'N',v_new_data.CANCEL_METHOD,          v_new_data.CANCEL_METHOD,        v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2376,2,'N',v_new_data.CANCEL_REASON,         v_new_data.CANCEL_REASON,       v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2377,1,'Y',v_new_data.CURRENT_TASK_ID,        v_new_data.CURRENT_TASK_ID,      v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2378,2,'Y',v_new_data.ENROLLMENT_STATUS,      v_new_data.ENROLLMENT_STATUS,    v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2379,2,'Y',v_new_data.INCIDENT_ABOUT,         v_new_data.INCIDENT_ABOUT,       v_bue_id,v_stg_last_update_date);
--BPM_EVENT.UPDATE_BIA(v_bi_id,2380,2,'Y',v_new_data.INCIDENT_REASON,        v_new_data.INCIDENT_REASON,      v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2381,2,'Y',v_old_data.INCIDENT_STATUS,        v_new_data.INCIDENT_STATUS,          v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2382,3,'Y',v_old_data.INCIDENT_STATUS_DT,     v_new_data.INCIDENT_STATUS_DT,       v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2383,3,'N',v_old_data.INSTANCE_COMPLETE_DT,   v_new_data.INSTANCE_COMPLETE_DT,     v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2384,2,'Y',v_old_data.INSTANCE_STATUS,        v_new_data.INSTANCE_STATUS,          v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2385,2,'Y',v_old_data.LAST_UPDATE_BY_NAME,    v_new_data.LAST_UPDATE_BY_NAME,      v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2386,3,'Y',v_old_data.LAST_UPDATE_BY_DT,      v_new_data.LAST_UPDATE_BY_DT,        v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2387,2,'Y',v_old_data.UPDATED_BY,             v_new_data.UPDATED_BY,           v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2388,2,'N',v_old_data.OTHER_PARTY_NAME,       v_new_data.OTHER_PARTY_NAME,         v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2389,2,'N',v_old_data.PRIORITY,               v_new_data.PRIORITY,                 v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2390,2,'N',v_old_data.REPORTED_BY,            v_new_data.REPORTED_BY,              v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2391,2,'N',v_old_data.REPORTER_RELATIONSHIP,  v_new_data.REPORTER_RELATIONSHIP,    v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2392,2,'N',v_old_data.RESOLUTION_TYPE,        v_new_data.RESOLUTION_TYPE,       v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2393,1,'N',v_old_data.CASE_ID,                v_new_data.CASE_ID,               v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2394,2,'N',v_old_data.FORWARDED,              v_new_data.FORWARDED,             v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2395,2,'N',v_old_data.FORWARDED_TO,           v_new_data.FORWARDED_TO,          v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2396,2,'N',v_old_data.ASF_IDR_REVIEW_DOCS,    v_new_data.ASF_IDR_REVIEW_DOCS,   v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2397,2,'N',v_old_data.ASF_GATHER_MISS_INFO,   v_new_data.ASF_GATHER_MISS_INFO,  v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2398,2,'N',v_old_data.GWF_CONTINUE_APPEAL,    v_new_data.GWF_CONTINUE_APPEAL,   v_bue_id,v_stg_last_update_date);

BPM_EVENT.UPDATE_BIA(v_bi_id,2584,3,'Y',v_old_data.COMPLETE_DT,    v_new_data.COMPLETE_DT,   v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2597,2,'N',v_old_data.CURRENT_STEP,    v_new_data.CURRENT_STEP,   v_bue_id,v_stg_last_update_date);

BPM_EVENT.UPDATE_BIA(v_bi_id,2599,2,'N',v_old_data.APPELLANT_TYPE, v_new_data.APPELLANT_TYPE,   v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2600,2,'N',v_old_data.APPELLANT_TYPE_DESC, v_new_data.APPELLANT_TYPE_DESC,   v_bue_id,v_stg_last_update_date);

BPM_EVENT.UPDATE_BIA(v_bi_id,2605,2,'N',v_old_data.REPORTER_NAME, v_new_data.REPORTER_NAME,   v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2606,2,'N',v_old_data.REPORTER_PHONE, v_new_data.REPORTER_PHONE,   v_bue_id,v_stg_last_update_date);
commit;
