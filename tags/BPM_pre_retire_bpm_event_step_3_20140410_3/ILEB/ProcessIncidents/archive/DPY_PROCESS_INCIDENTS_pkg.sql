...
create or replace package DPY_PROCESS_INCIDENTS as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/ILEB/ProcessIncidents/createdb/DPY_PROCESS_INCIDENTS_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 3567 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2013-07-01 18:26:32 -0400 (Mon, 01 Jul 2013) $'; 
...
type T_INS_PI_XML is record 
    ...
    -- INCIDENT_DESCRIPTION varchar2(4000), /* Removed as per Pulin's suggestion 06/05/13 */
   ...
   --  RESOLUTION_DESCRIPTION varchar2(100),
...
function GET_JEOPARDY_STATUS_DATE
   ...
   as
   begin
   if (GET_JEOPARDY_STATUS(p_receipt_date,p_instance_status) is not null) then
...
update D_PI_CURRENT
    set
      ...
      "Cur Jeopardy Status"=GET_JEOPARDY_STATUS("Receipt Date","Cur Instance Status"),
      "Jeopardy Status Date"= to_date(GET_JEOPARDY_STATUS_DATE("Receipt Date","Cur Instance Status"),BPM_COMMON.DATE_FMT),
     "Timeliness Status" = GET_TIMELINESS_STATUS("Receipt Date","Cur Incident Status Date","Cur Instance Status","Cancel Date")
...
*/ 
 ...
 --  p_cur_incident_description	 in	varchar2, 
  ...
  r_dpicur."Cur Jeopardy Status"              :=  GET_JEOPARDY_STATUS(r_dpicur."Receipt Date",r_dpicur."Cur Instance Status");
  r_dpicur."Jeopardy Status Date" 	      :=  to_date(GET_JEOPARDY_STATUS_DATE(r_dpicur."Receipt Date",r_dpicur."Cur Instance Status"),BPM_COMMON.DATE_FMT);
  r_dpicur."Timeliness Status" 		      :=  GET_TIMELINESS_STATUS(r_dpicur."Receipt Date",r_dpicur."Cur Incident Status Date",r_dpicur."Cur Instance Status",r_dpicur."Cancel Date");
...
--  r_dpicur."Reporter Name" 		      :=  p_reporter_name;			 
 ...
 -- Insert current dimension and fact as a single transaction.
   ...
   SET_DPICUR
	 ...
	 v_new_data.GENERIC_FIELD5,/*v_new_data.ENROLLEE_RIN,v_new_data.REPORTER_NAME,*/v_new_data.ASF_IDENTIFY_RSRCH_INCIDENT
	); 
