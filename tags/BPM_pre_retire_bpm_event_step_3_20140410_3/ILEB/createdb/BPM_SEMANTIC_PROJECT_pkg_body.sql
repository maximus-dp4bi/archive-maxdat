...
create or replace package body BPM_SEMANTIC_PROJECT as
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then 
      ...
      PROCESS_ONLINE_INFO.INSERT_BPM_SEMANTIC(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA); 
      
    elsif p_bueq_row.BSL_ID = 20 then 
      OUTBOUND_CALLS.INSERT_BPM_SEMANTIC(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA);
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then 
      ...
      PROCESS_ONLINE_INFO.UPDATE_BPM_SEMANTIC(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA); 
      
    elsif p_bueq_row.BSL_ID = 20 then 
      OUTBOUND_CALLS.UPDATE_BPM_SEMANTIC(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA);
