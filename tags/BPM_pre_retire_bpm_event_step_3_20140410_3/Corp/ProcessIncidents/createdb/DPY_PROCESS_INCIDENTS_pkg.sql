 ...
 -- Insert BPM Event model data.
  ...
  begin  
    ...
    values
     ...
     BPM_EVENT.INSERT_BIA(v_bi_id,2592,2,v_new_data.REPORTER_NAME,v_start_date,v_bue_id);
     BPM_EVENT.INSERT_BIA(v_bi_id,618,2,v_new_data.ENROLLEE_RIN,v_start_date,v_bue_id);
     BPM_EVENT.INSERT_BIA(v_bi_id,2594,2,v_new_data.COUNTY_CODE,v_start_date,v_bue_id);
     BPM_EVENT.INSERT_BIA(v_bi_id,2595,2,v_new_data.COUNTY_NAME,v_start_date,v_bue_id);
     BPM_EVENT.INSERT_BIA(v_bi_id,573,2,v_new_data.ACTION_COMMENTS,v_start_date,v_bue_id);  
     BPM_EVENT.INSERT_BIA(v_bi_id,575,2,v_new_data.RESOLUTION_DESCRIPTION,v_start_date,v_bue_id);
...
-- Update BPM Event model data.
  ...
  begin
    ...
    if p_data_version != 1 then
      v_log_message := 'Unsupported BPM_UPDATE_EVENT_QUEUE.DATA_VERSION value "' || p_data_version || '" with Process Incidents in procedure ' || v_procedure_name || '.';
      RAISE_APPLICATION_ERROR(-20011,v_log_message);        
    end if; 
  ...
  insert into BPM_UPDATE_EVENT(BUE_ID,BI_ID,BUTL_ID,EVENT_DATE,BPMS_PROCESSED)
    ...
    BPM_EVENT.UPDATE_BIA(v_bi_id,2592,2,'N',v_old_data.REPORTER_NAME,v_new_data.REPORTER_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,618,2,'N',v_old_data.ENROLLEE_RIN,v_new_data.ENROLLEE_RIN,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,2594,2,'N',v_old_data.COUNTY_CODE,v_new_data.COUNTY_CODE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,2595,2,'N',v_old_data.COUNTY_NAME,v_new_data.COUNTY_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,573,2,'Y',v_old_data.ACTION_COMMENTS,v_new_data.ACTION_COMMENTS,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,575,2,'Y',v_old_data.RESOLUTION_DESCRIPTION,v_new_data.RESOLUTION_DESCRIPTION,v_bue_id,v_stg_last_update_date);
