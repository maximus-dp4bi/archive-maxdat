...
begin
  ...
  if :new.STAGE_DONE_DATE is not null then
    update BPM_INSTANCE
    set 
      END_DATE = :new.STAGE_DONE_DATE,
  ...
  -- PRC_BPM_ETL_BIA_UPD_CHAR('UPDATE',v_source_id,v_bi_id,238,:old.REFER_TO_DISTRICT_IND,:new.REFER_TO_DISTRICT_IND,v_bue_id);
  -- PRC_BPM_ETL_BIA_UPD_DATE('UPDATE',v_source_id,v_bi_id,239,:old.REFER_TO_DISTRICT_IND_DT,:new.REFER_TO_DISTRICT_IND_DT,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('UPDATE',v_source_id,v_bi_id,240,:old.UNDELIVERABLE_IND,:new.UNDELIVERABLE_IND,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_DATE('UPDATE',v_source_id,v_bi_id,241,:old.UNDELIVERABLE_IND_DT,:new.UNDELIVERABLE_IND_DT,v_bue_id);
