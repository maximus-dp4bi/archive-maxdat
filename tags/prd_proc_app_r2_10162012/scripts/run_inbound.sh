...
CUSTOM_DIR=$MAXDAT_ETL_DIR/ManageInboundInfo 
LOG_DIR=$MAXDAT_LOG_DIR
LOG_LEVEL="Basic"

                                                                                                   
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ManageInbound_Job_Start.kjb" -log="$LOG_DIR/ManageInbound_Job_Start.log" -level="$LOG_LEVEL" 
