...
create or replace package body PROCESS_COMPLAINTS_INCIDENTS as
 ...
 /*   select 'BPM_EVENT.INSERT_BIA(v_bi_id, '||b.ba_id || ','||bl.bdl_id || ',v_new_data.'|| stg.staging_table_column || ',v_start_date,v_bue_id);'
    ...
    BPM_EVENT.INSERT_BIA(v_bi_id, 2587,2,v_new_data.CURRENT_STEP,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2435,1,v_new_data.DE_TASK_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2573,2,v_new_data.FOLLOWUP_FLAG,v_start_date,v_bue_id);
    ...
    BPM_EVENT.INSERT_BIA(v_bi_id, 2585,3,v_new_data.COMPLETE_DT,v_start_date,v_bue_id);
    ...
    BPM_EVENT.INSERT_BIA(v_bi_id, 2586,3,v_new_data.FORWARD_DT,v_start_date,v_bue_id);
    ...
    BPM_EVENT.INSERT_BIA(v_bi_id, 2588,3,v_new_data.RECEIVED_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2596,2,v_new_data.PLAN_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2601,2,v_new_data.REPORTER_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2602,2,v_new_data.REPORTER_PHONE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 2603,2,v_new_data.SLA_SATISFIED,v_start_date,v_bue_id);
    commit;
    p_bue_id := v_bue_id;
  exception
    when OTHERS then
...
BPM_EVENT.UPDATE_BIA(v_bi_id, 2417,3,'N',v_old_data.ASSD_RESOLVE_INCIDENT_EES_CSS,v_new_data.ASSD_RESOLVE_INCIDENT_EES_CSS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2418,3,'N',v_old_data.ASED_RESOLVE_INCIDENT_SUP,v_new_data.ASED_RESOLVE_INCIDENT_SUP,v_bue_id,v_stg_last_update_date);
...
BPM_EVENT.UPDATE_BIA(v_bi_id, 2428,2,'N',v_old_data.ACTION_COMMENTS,v_new_data.ACTION_COMMENTS,v_bue_id,v_stg_last_update_date);
...
BPM_EVENT.UPDATE_BIA(v_bi_id, 2434,1,'N',v_old_data.CURRENT_TASK_ID,v_new_data.CURRENT_TASK_ID,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2587,2,'N',v_old_data.CURRENT_STEP,v_new_data.CURRENT_STEP,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2435,1,'N',v_old_data.DE_TASK_ID,v_new_data.DE_TASK_ID,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2573,2,'N',v_old_data.FOLLOWUP_FLAG,v_new_data.FOLLOWUP_FLAG,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2437,2,'N',v_old_data.INCIDENT_ABOUT,v_new_data.INCIDENT_ABOUT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2438,2,'N',v_old_data.INCIDENT_DESCRIPTION,v_new_data.INCIDENT_DESCRIPTION,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2439,2,'N',v_old_data.INCIDENT_REASON,v_new_data.INCIDENT_REASON,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2440,2,'N',v_old_data.INCIDENT_STATUS,v_new_data.INCIDENT_STATUS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2441,3,'N',v_old_data.INCIDENT_STATUS_DT,v_new_data.INCIDENT_STATUS_DT,v_bue_id,v_stg_last_update_date);
...
BPM_EVENT.UPDATE_BIA(v_bi_id, 2443,2,'N',v_old_data.INSTANCE_STATUS,v_new_data.INSTANCE_STATUS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2444,2,'N',v_old_data.LAST_UPDATE_BY_NAME,v_new_data.LAST_UPDATE_BY_NAME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2445,3,'N',v_old_data.LAST_UPDATE_BY_DT,v_new_data.LAST_UPDATE_BY_DT,v_bue_id,v_stg_last_update_date);
...
BPM_EVENT.UPDATE_BIA(v_bi_id, 2585,3,'Y',v_old_data.COMPLETE_DT,v_new_data.COMPLETE_DT,v_bue_id,v_stg_last_update_date);
...
BPM_EVENT.UPDATE_BIA(v_bi_id, 2586,3,'Y',v_old_data.FORWARD_DT,v_new_data.FORWARD_DT,v_bue_id,v_stg_last_update_date);
...
BPM_EVENT.UPDATE_BIA(v_bi_id, 2588,3,'N',v_old_data.RECEIVED_DT,v_new_data.RECEIVED_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2596,2,'N',v_old_data.PLAN_NAME,v_new_data.PLAN_NAME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2601,2,'N',v_old_data.REPORTER_NAME,v_new_data.REPORTER_NAME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2602,2,'N',v_old_data.REPORTER_PHONE,v_new_data.REPORTER_PHONE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id, 2603,2,'Y',v_old_data.SLA_SATISFIED,v_new_data.SLA_SATISFIED,v_bue_id,v_stg_last_update_date);
