...
create or replace package ETL_PROCESS_LETTERS_PKG as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/Corp/ClientOutreach/createdb/ETL_CLIENT_OUTREACH_PKG.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 8675 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2014-03-05 17:51:01 -0800 (Wed, 05 Mar 2014) $'; 
