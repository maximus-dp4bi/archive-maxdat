...
update F_PL_BY_DATE
set BUCKET_END_DATE = to_date('2013-12-19 00:00:00','YYYY-MM-DD')
where 
  PL_BI_ID = 18442651
...
set
  ...
  BUCKET_END_DATE = to_date('2013-12-20 00:00:00','YYYY-MM-DD')
where 
  PL_BI_ID = 18442651
...
set
  ...
  BUCKET_START_DATE = to_date('2013-12-20 00:00:00','YYYY-MM-DD')
where 
  PL_BI_ID = 18442651
...
where 
  PL_BI_ID = 18458637
  and FPLBD_ID = 2565858;

-- Temp setting.
update F_PL_BY_DATE
set
  D_DATE = to_date('2013-12-31 08:57:09','YYYY-MM-DD HH24:MI:SS'),
  BUCKET_START_DATE = to_date('2013-12-31','YYYY-MM-DD'),
  BUCKET_END_DATE = to_date('2013-12-20','YYYY-MM-DD')
where 
  PL_BI_ID = 18458637
  and FPLBD_ID = 2859166;
  
update F_PL_BY_DATE
set
  D_DATE = to_date('2013-12-20 19:57:20','YYYY-MM-DD HH24:MI:SS'),
  BUCKET_START_DATE = to_date('2013-12-20','YYYY-MM-DD')
where 
  PL_BI_ID = 18458637
  and FPLBD_ID = 3001577;
  
update F_PL_BY_DATE
set
  D_DATE = to_date('2013-12-19 08:57:09','YYYY-MM-DD HH24:MI:SS'),
  BUCKET_START_DATE = to_date('2013-12-19','YYYY-MM-DD')
where 
  PL_BI_ID = 18458637
  and FPLBD_ID = 2859166;
