...
BEGIN
  ...
  THEN v_dsc := 'Value and supplementary do not match: SUPP_CONTACT_TYPE_CD/CONTACT_TYPE' || CHR(10) || v_rec;
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,NULL ,$$PLSQL_UNIT, 13, NULL, :n.contact_record_id, null, null, v_dsc ,-20111);  
  END IF;
  ...
  THEN v_dsc := 'Value and supplementary do not match: SUPP_CONTACT_GROUP_CD/CONTACT_GROUP' || CHR(10) || v_rec;
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,NULL ,$$PLSQL_UNIT, 13, NULL, :n.contact_record_id, null, null, v_dsc ,-20112);  
  END IF;
  ...
  THEN v_dsc := 'Value and supplementary do not match: SUPP_LANGUAGE_CD/LANGUAGE' || CHR(10) || v_rec;
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,NULL ,$$PLSQL_UNIT, 13, NULL, :n.contact_record_id, null, null, v_dsc ,-20113);  
  END IF;
  ...
  THEN v_dsc := 'Value and supplementary do not match: SUPP_CREATED_BY/CREATED_BY' ||CHR(10) || v_rec;
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,NULL ,$$PLSQL_UNIT, 13, NULL, :n.contact_record_id, null, null, v_dsc ,-20114);  
  END IF;
  ...
  THEN v_dsc := 'Value and supplementary do not match: SUPP_UPDATE_BY/LAST_UPDATE_BY_NAME' ||CHR(10) || v_rec;
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,NULL ,$$PLSQL_UNIT, 13, NULL, :n.contact_record_id, null, null, v_dsc ,-20115);  
  END IF;
