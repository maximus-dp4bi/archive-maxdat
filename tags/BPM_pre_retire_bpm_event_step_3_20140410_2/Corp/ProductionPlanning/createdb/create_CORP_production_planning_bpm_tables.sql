...
ALTER TABLE PP_D_COUNTRY 
    ADD CONSTRAINT PP_D_COUNTRY_PK PRIMARY KEY ( COUNTRY_ID ) ;
ALTER TABLE PP_D_COUNTRY 
    ADD CONSTRAINT PP_D_COUNTRY_NAME_UN UNIQUE ( COUNTRY_NAME ) ;
...
ALTER TABLE PP_D_DATES 
    ADD CONSTRAINT PP_D_DATES_PK PRIMARY KEY ( D_DATE ) ;
...
ALTER TABLE PP_D_DISTRICT 
    ADD CONSTRAINT PP_D_DISTRICT_PK PRIMARY KEY ( DISTRICT_ID ) ;
ALTER TABLE PP_D_DISTRICT 
    ADD CONSTRAINT PP_D_DISTRICT_NAME_UN UNIQUE ( DISTRICT_NAME ) ;
...
ALTER TABLE PP_D_GEOGRAPHY_MASTER 
    ADD CONSTRAINT PP_D_GEOGRAPHY_MASTER_PK PRIMARY KEY ( GEOGRAPHY_MASTER_ID ) ;
ALTER TABLE PP_D_GEOGRAPHY_MASTER 
    ADD CONSTRAINT PP_D_GEOGRAPHY_LKUP_NAME_UN UNIQUE ( GEOGRAPHY_NAME ) ;
ALTER TABLE PP_D_GEOGRAPHY_MASTER 
    ADD CONSTRAINT PP_D_GEOGRAPHY_MASTER__UN UNIQUE ( COUNTRY_ID , STATE_ID , PROVINCE_ID , DISTRICT_ID , REGION_ID , SITE_ID ) ;
...
ALTER TABLE PP_D_HOURS 
    ADD CONSTRAINT D_HOURS_PK PRIMARY KEY ( D_HOUR ) ;
ALTER TABLE PP_D_HOURS 
    ADD CONSTRAINT PP_D_HOURS_UN UNIQUE ( HOUR12 , AM_PM ) ;
ALTER TABLE PP_D_HOURS 
    ADD CONSTRAINT PP_D_HOURS_UN1 UNIQUE ( TIME_OF_DAY12 ) ;
ALTER TABLE PP_D_HOURS 
    ADD CONSTRAINT PP_D_HOURS_UN2 UNIQUE ( TIME_OF_DAY24 ) ;
...
ALTER TABLE PP_D_PRODUCTION_PLAN 
    ADD CONSTRAINT D_PRODUCTION_PLAN_PK PRIMARY KEY ( PP_ID ) ;
ALTER TABLE PP_D_PRODUCTION_PLAN 
    ADD CONSTRAINT D_PRODUCTION_PLAN__UN UNIQUE ( PRODUCTION_PLAN_NAME , EFFECTIVE_DATE , PROJECT_ID , PROGRAM_ID , GEOGRAPHY_MASTER_ID ) ;
...
ALTER TABLE PP_D_PRODUCTION_PLAN_HORIZON 
    ADD CONSTRAINT D_PRODUCTION_PLAN_HRZN_PK PRIMARY KEY ( PPH_ID ) ;
ALTER TABLE PP_D_PRODUCTION_PLAN_HORIZON 
    ADD CONSTRAINT D_PRODUCTION_PLAN_HRZN_UN UNIQUE ( PP_ID , HORIZON_START_DATE , HORIZON_START_HOUR ) ;
ALTER TABLE PP_D_PRODUCTION_PLAN_HORIZON 
    ADD CONSTRAINT D_PRODUCTION_PLAN_HRZN_UN1 UNIQUE ( PP_ID , HORIZON_END_DATE , HORIZON_END_HOUR ) ;
...
ALTER TABLE PP_D_PROGRAM 
    ADD CONSTRAINT PP_D_PROGRAM_PK PRIMARY KEY ( PROGRAM_ID ) ;
ALTER TABLE PP_D_PROGRAM 
    ADD CONSTRAINT PP_D_PROGRAM_UNK UNIQUE ( PROGRAM_NAME ) ;
...
ALTER TABLE PP_D_PROVINCE 
    ADD CONSTRAINT PP_D_PROVINCE_PK PRIMARY KEY ( PROVINCE_ID ) ;
ALTER TABLE PP_D_PROVINCE 
    ADD CONSTRAINT PP_D_PROVINCE_NAME_UK UNIQUE ( PROVINCE_NAME ) ;
...
ALTER TABLE PP_D_REGION 
    ADD CONSTRAINT PP_D_REGION_PK PRIMARY KEY ( REGION_ID ) ;
ALTER TABLE PP_D_REGION 
    ADD CONSTRAINT PP_D_REGION_UNK UNIQUE ( REGION_NAME ) ;
...
ALTER TABLE PP_D_SEGMENT 
    ADD CONSTRAINT PK_D_SEGMENT_LKUP PRIMARY KEY ( SEGMENT_ID ) ;
ALTER TABLE PP_D_SEGMENT 
    ADD CONSTRAINT D_SEGMENT_UNK UNIQUE ( SEGMENT_NAME ) ;
...
ALTER TABLE PP_D_SITE 
    ADD CONSTRAINT PP_D_SITE_PK PRIMARY KEY ( SITE_ID ) ;
ALTER TABLE PP_D_SITE 
    ADD CONSTRAINT PP_D_SITE_SITE_NAME_UN UNIQUE ( SITE_NAME ) ;
...
ALTER TABLE PP_D_SOURCE 
    ADD CONSTRAINT PP_D_SOURCE_PK PRIMARY KEY ( SOURCE_ID ) ;
ALTER TABLE PP_D_SOURCE 
    ADD CONSTRAINT PP_D_SOURCE__UN UNIQUE ( SOURCE_NAME ) ;
...
ALTER TABLE PP_D_SOURCE_REF_TYPE 
    ADD CONSTRAINT PP_D_SOURCE_REF_TYPE_PK PRIMARY KEY ( SOURCE_REF_TYPE_ID ) ;
ALTER TABLE PP_D_SOURCE_REF_TYPE 
    ADD CONSTRAINT PP_D_SOURCE_REF_TYPE_UN UNIQUE ( SOURCE_REF_TYPE_NAME , SOURCE_ID ) ;
...
ALTER TABLE PP_D_STATE 
    ADD CONSTRAINT PP_D_STATE_PK PRIMARY KEY ( STATE_ID ) ;
ALTER TABLE PP_D_STATE 
    ADD CONSTRAINT PP_D_STATE__UN UNIQUE ( STATE_NAME ) ;
...
ALTER TABLE PP_D_UNIT_OF_WORK 
    ADD CONSTRAINT PP_D_UNIT_OF_WORK_PK PRIMARY KEY ( UOW_ID ) ;
ALTER TABLE PP_D_UNIT_OF_WORK 
    ADD CONSTRAINT PP_D_UNIT_OF_WORK_UK1 UNIQUE ( UNIT_OF_WORK_NAME ) ;
...
ALTER TABLE PP_D_UOW_SOURCE_REF 
    ADD CONSTRAINT PP_D_UOW_SOURCE_REF_PK PRIMARY KEY ( USR_ID ) ;
ALTER TABLE PP_D_UOW_SOURCE_REF 
    ADD CONSTRAINT PP_D_UOW_SOURCE_REF_UN UNIQUE ( UOW_ID , SOURCE_REF_TYPE_ID , SOURCE_REF_VALUE , EFFECTIVE_DATE ) ;
ALTER TABLE PP_D_UOW_SOURCE_REF 
    ADD CONSTRAINT PP_D_UOW_SOURCE_REF_UN1 UNIQUE ( UOW_ID , SOURCE_REF_TYPE_ID , SOURCE_REF_VALUE , END_DATE ) ;
...
ALTER TABLE PP_FORECAST_NOTES 
    ADD CONSTRAINT PP_FORECAST_NOTES_PK PRIMARY KEY ( PPN_ID ) ;
...
ALTER TABLE PP_F_ACTUALS 
    ADD CONSTRAINT PP_F_ACTUALS_PK PRIMARY KEY ( ACTUALS_ID ) ;
ALTER TABLE PP_F_ACTUALS 
    ADD CONSTRAINT PP_F_ACTUALS_UN UNIQUE ( D_DATE , D_HOUR , UOW_ID ) ;
...
ALTER TABLE PP_F_FORECAST 
    ADD CONSTRAINT FPP_PK PRIMARY KEY ( FORECAST_ID ) ;
ALTER TABLE PP_F_FORECAST 
    ADD CONSTRAINT PP_F_FORECAST_UN UNIQUE ( D_DATE , D_HOUR , UOW_ID , FORECAST_VERSION , PPH_ID ) ;
...
ALTER TABLE PP_D_PROJECT 
    ADD CONSTRAINT PK_PP_D_PROJECT PRIMARY KEY ( PROJECT_ID ) ;
ALTER TABLE PP_D_PROJECT 
    ADD CONSTRAINT PP_D_PROJECT_UNK UNIQUE ( PROJECT_NAME ) ;
...
ALTER TABLE PP_CFG_FORECAST_FILE_CONTROL 
    ADD CONSTRAINT PP_CFG_FRCST_FILE_CONTROL_PK PRIMARY KEY ( CFG_FORECAST_FILE_CONTROL_ID ) ;
ALTER TABLE PP_CFG_FORECAST_FILE_CONTROL 
    ADD CONSTRAINT PP_CFG_FRCST_FILE_CONTROL_UN UNIQUE ( CFG_PRODUCTION_PLAN_ID ) ;
...
ALTER TABLE PP_CFG_GEOGRAPHY_CONFIG 
    ADD CONSTRAINT PP_CFG_PROJECT_CONFIG_PK PRIMARY KEY ( CFG_GEOGRAPHY_CONFIG_ID ) ;
...
ALTER TABLE PP_CFG_HORIZON 
    ADD CONSTRAINT PP_CFG_HORIZON_PK PRIMARY KEY ( CFG_HORIZON_ID ) ;
ALTER TABLE PP_CFG_HORIZON 
    ADD CONSTRAINT PP_CFG_HORIZON_UN UNIQUE ( CFG_PRODUCTION_PLAN_ID , HORIZON_START_DATE , HORIZON_START_HOUR ) ;
ALTER TABLE PP_CFG_HORIZON 
    ADD CONSTRAINT PP_CFG_HORIZON_UN1 UNIQUE ( CFG_PRODUCTION_PLAN_ID , HORIZON_END_DATE , HORIZON_END_HOUR ) ;
...
ALTER TABLE PP_CFG_PRODUCTION_PLAN 
    ADD CONSTRAINT PP_CFG_PROD_PLAN_PK PRIMARY KEY ( CFG_PRODUCTION_PLAN_ID ) ;
ALTER TABLE PP_CFG_PRODUCTION_PLAN 
    ADD CONSTRAINT PP_CFG_PROD_PLAN_UN UNIQUE ( PRODUCTION_PLAN_NAME , CFG_GEOGRAPHY_CONFIG_ID , EFFECTIVE_DATE ) ;
ALTER TABLE PP_CFG_PRODUCTION_PLAN 
    ADD CONSTRAINT PP_CFG_PROD_PLAN_UN1 UNIQUE ( CFG_GEOGRAPHY_CONFIG_ID , PRODUCTION_PLAN_NAME , END_DATE ) ;
...
ALTER TABLE PP_CFG_PROJECT_CONFIG 
    ADD CONSTRAINT PP_CFG_PROJECT_PK PRIMARY KEY ( CFG_PROJECT_CONFIG_ID ) ;
ALTER TABLE PP_CFG_PROJECT_CONFIG 
    ADD CONSTRAINT PP_CFG_PROJECT_UN UNIQUE ( SEGMENT_NAME , PROJECT_NAME , PROGRAM_NAME ) ;
...
ALTER TABLE PP_CFG_PROGRAM_CONFIG 
    ADD CONSTRAINT PP_CFG_PROGRAM_CONFIG_PK PRIMARY KEY ( CFG_PROGRAM_CONFIG_ID ) ;
ALTER TABLE PP_CFG_PROGRAM_CONFIG 
    ADD CONSTRAINT PP_CFG_PROGRAM_CONFIG_UNK UNIQUE ( PROGRAM_NAME ) ;    
...
ALTER TABLE PP_CFG_SOURCE_CONFIG 
    ADD CONSTRAINT PP_CFG_SOURCE_CONFIG_PK PRIMARY KEY ( CFG_SOURCE_CONFIG_ID ) ;
ALTER TABLE PP_CFG_SOURCE_CONFIG 
    ADD CONSTRAINT PP_CFG_SOURCE_CONFIG_UNK UNIQUE ( SOURCE_NAME ) ;    
...
ALTER TABLE PP_CFG_UNIT_OF_WORK 
    ADD CONSTRAINT PP_CFG_UNIT_OF_WORK_PK PRIMARY KEY ( CFG_UOW_ID ) ;
ALTER TABLE PP_CFG_UNIT_OF_WORK 
    ADD CONSTRAINT PP_CFG_UNIT_OF_WORK_UK1 UNIQUE ( UNIT_OF_WORK_NAME ) ;
...
ALTER TABLE PP_STG_FORECAST 
    ADD CONSTRAINT PP_STG_FORECAST_PK PRIMARY KEY ( SPPF_ID ) ;
ALTER TABLE PP_STG_FORECAST 
    ADD CONSTRAINT PP_STG_FORECAST_UN UNIQUE ( CFG_HORIZON_ID , CFG_UOW_ID , FORECAST_DATE , FORECAST_HOUR , FORECAST_VERSION ) ;
ALTER TABLE PP_STG_FORECAST 
    ADD CONSTRAINT PP_STG_FORECAST_UN1 UNIQUE ( CFG_HORIZON_ID , FORECAST_DATE , FORECAST_HOUR , CFG_UOW_ID , END_DATE ) ;
...
ALTER TABLE PP_STG_LOG 
    ADD CONSTRAINT PP_STG_LOG_PK PRIMARY KEY ( PP_STG_ID ) ;
