CREATE OR REPLACE FORCE VIEW "MW_STEP_INSTANCE_VW" ("STAGE_ROWID", "TASK_ID", "TASK_STATUS", "TASK_TYPE", "CREATE_DATE", "COMPLETE_DATE", "ESCALATED_FLAG", "STEP_DUE_TS", "FORWARDED_FLAG", "GROUP_NAME", "GROUP_PARENT_NAME", "GROUP_SUPERVISOR_NAME", "TEAM_NAME", "TEAM_PARENT_NAME", "TEAM_SUPERVISOR_NAME", "SOURCE_REFERENCE_ID", "SOURCE_REFERENCE_TYPE", "CREATED_BY_NAME", "ESCALATED_TO_NAME", "FORWARDED_BY_NAME", "OWNER_NAME", "SUSPENDED_TS", "AGE_IN_CALENDAR_DAYS", "AGE_IN_BUSINESS_DAYS", "STATUS_DATE", "STATUS_AGE_IN_BUS_DAYS", "STATUS_AGE_IN_CAL_DAYS", "LAST_UPDATE_DATE", "LAST_UPDATED_BY", "SLA_DAYS", "SLA_DAYS_TYPE", "SLA_TARGET_DAYS", "SLA_JEOPARDY_DAYS", "JEOPARDY_FLAG", "TIMELINESS_STATUS", "ASF_CANCEL_WORK", "ASF_COMPLETE_WORK", "CANCEL_WORK_DATE", "CANCEL_WORK_FLAG", "COMPLETE_FLAG", "LAST_UPDATE_BY_NAME", "STG_EXTRACT_DATE", "STAGE_DONE_DATE", "UNIT_OF_WORK", "STEP_INSTANCE_HISTORY_ID", "MW_PROCESSED", "CLIENT_ID", "CASE_ID", "STAGE_CREATE_TS", "PRIORITY", "STATUS_ORDER") AS 
...
,CASE WHEN S1s.LAST_NAME||', '||S1s.FIRST_NAME = ', ' THEN S1e.LAST_NAME||', '||S1e.FIRST_NAME
      WHEN S1e.LAST_NAME||', '||S1e.FIRST_NAME = ', ' THEN S1s.LAST_NAME||', '||S1s.FIRST_NAME
...
,CASE WHEN S2s.LAST_NAME||', '||S2s.FIRST_NAME = ', ' THEN S2e.LAST_NAME||', '||S2e.FIRST_NAME
      WHEN S2e.LAST_NAME||', '||S2e.FIRST_NAME = ', ' THEN S2s.LAST_NAME||', '||S2s.FIRST_NAME
...
,CASE WHEN S3s.LAST_NAME||', '||S3s.FIRST_NAME = ', ' THEN S3e.LAST_NAME||', '||S3e.FIRST_NAME
      WHEN S3e.LAST_NAME||', '||S3e.FIRST_NAME = ', ' THEN S3s.LAST_NAME||', '||S3s.FIRST_NAME
...
,CASE WHEN S4s.LAST_NAME||', '||S4s.FIRST_NAME = ', ' THEN S4e.LAST_NAME||', '||S4e.FIRST_NAME
      WHEN S4e.LAST_NAME||', '||S4e.FIRST_NAME = ', ' THEN S4s.LAST_NAME||', '||S4s.FIRST_NAME
...
,CASE WHEN S5s.LAST_NAME||', '||S5s.FIRST_NAME = ', ' THEN S5e.LAST_NAME||', '||S5e.FIRST_NAME
      WHEN S5e.LAST_NAME||', '||S5e.FIRST_NAME = ', ' THEN S5s.LAST_NAME||', '||S5s.FIRST_NAME
...
,CASE WHEN S6s.LAST_NAME||', '||S6s.FIRST_NAME = ', ' THEN S6e.LAST_NAME||', '||S6e.FIRST_NAME
      WHEN S6e.LAST_NAME||', '||S6e.FIRST_NAME = ', ' THEN S6s.LAST_NAME||', '||S6s.FIRST_NAME
...
,CASE WHEN S7s.LAST_NAME||', '||S7s.FIRST_NAME = ', ' THEN S7e.LAST_NAME||', '||S7e.FIRST_NAME
      WHEN S7e.LAST_NAME||', '||S7e.FIRST_NAME = ', ' THEN S7s.LAST_NAME||', '||S7s.FIRST_NAME
