...
-- Trigger previously named "TRG_BIU_CORP_ETL_PRCES_INCDNTS"

CREATE OR REPLACE TRIGGER TRG_BIU_CORP_ETL_PROC_INCDNTS 
BEFORE INSERT OR UPDATE ON corp_etl_process_incidents 
FOR EACH ROW 
BEGIN 
  if INSERTING then 
  ...
  v_xml_string_new := 
    ...
    <ROWSET>  
      <ROW>
        ...
        <COUNTY_NAME><![CDATA[' || :new.COUNTY_NAME || ']]></COUNTY_NAME>
        ...
        <ENROLLEE_RIN><![CDATA[' || :new.ENROLLEE_RIN || ']]></ENROLLEE_RIN>
  ...
  v_xml_string_old := 
    ...
    <ROWSET>  
      <ROW>
        ...
        <COUNTY_NAME><![CDATA[' || :old.COUNTY_NAME || ']]></COUNTY_NAME>
        ...
        <ENROLLEE_RIN><![CDATA[' || :old.ENROLLEE_RIN || ']]></ENROLLEE_RIN>
