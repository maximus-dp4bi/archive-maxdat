...
--    c.clnt_cin ENROLLEE_RIN ,
  ...
  LEFT JOIN ats.incident_three_way_call twc ON (i.incident_header_id = twc.incident_header_id)
  LEFT JOIN 
    (SELECT si.ref_id, MAX(step_instance_id) step_instance_id FROM ats.step_instance si
