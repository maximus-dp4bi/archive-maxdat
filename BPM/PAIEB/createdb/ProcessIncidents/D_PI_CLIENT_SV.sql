...
AS
  SELECT cl.dod_source_cd AS DATE_OF_DEATH_SOURCE ,
    ...
    TRIM(cl.clnt_fname)||
    CASE
      WHEN SUBSTR(TRIM(cl.clnt_mi),1,1) IS NULL
      THEN ' '
      ELSE ' '||SUBSTR(TRIM(cl.clnt_mi),1,1)||' '
    END ||TRIM(cl.clnt_lname) AS FULL_NAME ,
    ...
    CASE
      WHEN (SELECT COUNT(1)
        FROM ats.other_health_care ohc
  ...
  FROM ats.client cl
  UNION ALL
  SELECT NULL AS DATE_OF_DEATH_SOURCE ,
    0 AS SOURCE_RECORD_ID ,
    'Y' AS CURRENT_FLAG ,
    0 AS CURRENT_CLIENT_ID ,
    0 AS CLNT_CLNT_CLIENT_ID ,
    NULL AS CLNT_ETHNICITY ,
    '0' AS CLNT_TPL_PRESENT ,
    NULL AS CLNT_NATIONAL_ID ,
    '0' AS CLNT_FROM_PACMIS ,
    '0' AS CLNT_SHARE_PREMIUM ,
    NULL AS CLNT_NOT_BORN ,
    '0' AS CLNT_HIPAA_PRIVACY_IND ,
    NULL AS CLNT_FINET_VENDOR_NBR ,
    NULL AS CLNT_ENROLL_STATUS ,
    NULL AS CLNT_ENROLL_STATUS_DATE ,
    NULL AS SCHED_AUTO_ASSIGN_DATE ,
    NULL AS CLNT_CIN ,
    NULL AS CLNT_COMMENT ,
    NULL AS CLNT_PSEUDO_ID ,
    NULL AS SSNVL_ID ,
    NULL AS NOTE_REF_ID ,
    NULL AS CLNT_MARITAL_CD ,
    NULL AS CLNT_STATUS_CD ,
    NULL AS CLNT_EXPECTED_DOB ,
    NULL AS CLNT_PREG_TERM_DATE ,
    NULL AS CLNT_PREG_TERM_REAS_CD ,
    'G' AS CLIENT_TYPE_CD ,
    NULL AS SUPPLEMENTAL_NBR ,
    NULL AS STATE_LANGUAGE ,
    0 AS DO_NOT_CALL_IND ,
    NULL AS WRITTEN_LANGUAGE ,
    NULL AS SUFFIX ,
    NULL AS SALUTATION_CD ,
    0 AS DOMESTIC_VIOLENCE_IND ,
    NULL AS ENGLISH_FLUENCY_CD ,
    NULL AS ENGLISH_LITERACY_CD ,
    NULL AS TRIBE_CD ,
    NULL AS CLNT_GENERIC_FIELD1_DATE ,
    NULL AS CLNT_GENERIC_FIELD2_DATE ,
    NULL AS CLNT_GENERIC_FIELD3_NUM ,
    NULL AS CLNT_GENERIC_FIELD4_NUM ,
    NULL AS CLNT_GENERIC_FIELD5_TXT ,
    NULL AS CLNT_GENERIC_FIELD6_TXT ,
    NULL AS CLNT_GENERIC_FIELD7_TXT ,
    NULL AS CLNT_GENERIC_FIELD8_TXT ,
    NULL AS CLNT_GENERIC_FIELD9_TXT ,
    NULL AS CLNT_GENERIC_FIELD10_TXT ,
    NULL AS CLNT_GENERIC_REF11_ID ,
    NULL AS CLNT_GENERIC_REF12_ID ,
    NULL AS DO_NOT_TEXT_IND ,
    NULL AS DO_NOT_EMAIL_IND ,
    ...
    1 AS VERSION ,
    NULL AS DATE_OF_VALIDITY_START ,
    TO_DATE('12/31/2050','mm/dd/yyyy') AS DATE_OF_VALIDITY_END ,
    ...
    'N' AS NEWBORN ,
    'A' AS ADULT_OR_CHILD ,
    'N' AS THIRD_PARTY_RESOURCES_AVAIL ,
    NULL AS MIGRANT_WORKER_FLAG ,
    NULL AS MANAGED_VIA_GEN_REV_FLAG ,
    NULL AS MANAGED_VIA_STATE_FUND_FLAG ,
    NULL AS RECEIVING_TANF_FLAG ,
