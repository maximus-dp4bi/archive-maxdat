...
comment on column CORP_ETL_MANAGE_WORK.CLIENT_ID is 'Unique identifier associated to the client level task in MAXe';
comment on column CORP_ETL_MANAGE_WORK.CASE_ID is 'Unique identifier associated to the case level task in MAXe';
...
comment on column CORP_ETL_MANAGE_WORK_TMP.CLIENT_ID is 'Unique identifier associated to the client level task in MAXe';
comment on column CORP_ETL_MANAGE_WORK_TMP.CASE_ID is 'Unique identifier associated to the case level task in MAXe';
