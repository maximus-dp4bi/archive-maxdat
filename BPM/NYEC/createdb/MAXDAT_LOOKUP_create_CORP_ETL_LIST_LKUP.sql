CREATE SEQUENCE  MAXDAT_LOOKUP."SEQ_CELL_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
...
grant select,references on CORP_ETL_LIST_LKUP to ATS_MAXDAT_REPORTS;
