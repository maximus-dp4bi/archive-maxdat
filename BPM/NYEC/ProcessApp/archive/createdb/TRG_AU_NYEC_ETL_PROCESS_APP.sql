...
begin
  ...
  PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id,405,:old.CIN,:new.CIN,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_DATE('UPDATE',v_source_id,v_bi_id,406,:old.CIN_DT,:new.CIN_DT,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('UPDATE',v_source_id,v_bi_id,407,:old.PROVIDER_NAME,:new.PROVIDER_NAME,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id,409,:old.FPBP_TYPE,:new.FPBP_TYPE,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('UPDATE',v_source_id,v_bi_id,410,:old.REV_CLEAR_IND,:new.REV_CLEAR_IND,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_DATE('UPDATE',v_source_id,v_bi_id,411,:old.REV_CLEAR_IND_DT,:new.REV_CLEAR_IND_DT,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('UPDATE',v_source_id,v_bi_id,412,:old.REV_CLEAR_OUTCOME,:new.REV_CLEAR_OUTCOME,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('UPDATE',v_source_id,v_bi_id,413,:old.UPSTATE_INDICATOR,:new.UPSTATE_INDICATOR,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_DATE('INSERT',v_source_id,v_bi_id,414,:old.INVOICE_READY_DT,:new.INVOICE_READY_DT,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id,415,:old.HEART_INCMPLT_APP_IND,:new.HEART_INCMPLT_APP_IND,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_NUM ('UPDATE',v_source_id,v_bi_id,416,:old.DAYS_UNTIL_TIMEOUT,:new.DAYS_UNTIL_TIMEOUT,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id,417,:old.WMS_REASON,:new.WMS_REASON,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_CHAR('INSERT',v_source_id,v_bi_id,418,:old.HEART_REPROCESS_STATUS,:new.HEART_REPROCESS_STATUS,v_bue_id);
  PRC_BPM_ETL_BIA_UPD_DATE('INSERT',v_source_id,v_bi_id,419,:old.HEART_REPROCESS_STATUS_DT,:new.HEART_REPROCESS_STATUS_DT,v_bue_id);
