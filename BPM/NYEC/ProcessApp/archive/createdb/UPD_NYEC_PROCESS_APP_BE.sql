...
create or replace procedure UPD_NYEC_PROCESS_APP_BE
...
begin
  ...
  select
    ...
    xmlquery('$x/ROWSET/ROW/APP_COMPLETE_RESULT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_COMPLETE_RESULT",
    xmlquery('$x/ROWSET/ROW/APP_CYCLE_BUS_DAYS/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_CYCLE_BUS_DAYS",
    xmlquery('$x/ROWSET/ROW/APP_CYCLE_CAL_DAYS/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_CYCLE_CAL_DAYS",
    xmlquery('$x/ROWSET/ROW/APP_CYCLE_END_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_CYCLE_END_DT",
    xmlquery('$x/ROWSET/ROW/APP_CYCLE_START_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_CYCLE_START_DT",
    xmlquery('$x/ROWSET/ROW/APP_ID/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_ID",
    xmlquery('$x/ROWSET/ROW/APP_STATUS/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_STATUS",
    xmlquery('$x/ROWSET/ROW/APP_STATUS_GROUP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_STATUS_GROUP",
    xmlquery('$x/ROWSET/ROW/APP_TYPE/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "APP_TYPE",
    xmlquery('$x/ROWSET/ROW/ASF_CANCEL_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_CANCEL_APP",
    xmlquery('$x/ROWSET/ROW/ASF_CLOSE_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_CLOSE_APP",
    xmlquery('$x/ROWSET/ROW/ASF_COMPLETE_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_COMPLETE_APP",
    xmlquery('$x/ROWSET/ROW/ASF_NOTIFY_CLIENT_PENDED_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_NOTIFY_CLIENT_PENDED_APP",
    xmlquery('$x/ROWSET/ROW/ASF_PERFORM_QC/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_PERFORM_QC",
    xmlquery('$x/ROWSET/ROW/ASF_PERFORM_RESEARCH/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_PERFORM_RESEARCH",
    xmlquery('$x/ROWSET/ROW/ASF_PROCESS_APP_INFO/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_PROCESS_APP_INFO",
    xmlquery('$x/ROWSET/ROW/ASF_RECEIVE_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_RECEIVE_APP",
    xmlquery('$x/ROWSET/ROW/ASF_RECEIVE_PROCESS_MI/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_RECEIVE_PROCESS_MI",
    xmlquery('$x/ROWSET/ROW/ASF_REVIEW_ENTER_DATA/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_REVIEW_ENTER_DATA",
    xmlquery('$x/ROWSET/ROW/GWF_OUTCM_NOTIFY_RQRD/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "GWF_OUTCM_NOTIFY_RQRD",
    xmlquery('$x/ROWSET/ROW/ASF_WAIT_STATE_APPROVAL/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASF_WAIT_STATE_APPROVAL",
    xmlquery('$x/ROWSET/ROW/ASPB_CANCEL_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASPB_CANCEL_APP",
    xmlquery('$x/ROWSET/ROW/ASPB_CLOSE_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASPB_CLOSE_APP",
    xmlquery('$x/ROWSET/ROW/ASPB_COMPLETE_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASPB_COMPLETE_APP",
    xmlquery('$x/ROWSET/ROW/ASPB_NOTIFY_CLIENT_PENDED_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASPB_NOTIFY_CLIENT_PENDED_APP",
    ...
    xmlquery('$x/ROWSET/ROW/ASPB_PROCESS_APP_INFO/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASPB_PROCESS_APP_INFO",
    xmlquery('$x/ROWSET/ROW/ASPB_RVW_ENTER_DATA/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASPB_RVW_ENTER_DATA",
    xmlquery('$x/ROWSET/ROW/ASPB_WAIT_STATE_APPROVAL/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASPB_WAIT_STATE_APPROVAL",
    xmlquery('$x/ROWSET/ROW/ASSD_NOTIFY_CLIENT_PENDED_APP/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASSD_NOTIFY_CLIENT_PENDED_APP",
    ...
    xmlquery('$x/ROWSET/ROW/ASSD_PROCESS_APP_INFO/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASSD_PROCESS_APP_INFO",
    xmlquery('$x/ROWSET/ROW/ASSD_RVW_ENTER_DATA/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASSD_RVW_ENTER_DATA",
    xmlquery('$x/ROWSET/ROW/ASSD_WAIT_STATE_APPROVAL/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ASSD_WAIT_STATE_APPROVAL",
    xmlquery('$x/ROWSET/ROW/AUTO_REPROCESS_FLAG/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "AUTO_REPROCESS_FLAG",
    xmlquery('$x/ROWSET/ROW/CANCEL_DATE/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "CANCEL_DATE",
    xmlquery('$x/ROWSET/ROW/CHANNEL/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "CHANNEL",
    xmlquery('$x/ROWSET/ROW/CLOCKDOWN_INDICATOR/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "CLOCKDOWN_INDICATOR",
    xmlquery('$x/ROWSET/ROW/COMPLETE_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "COMPLETE_DT",
    xmlquery('$x/ROWSET/ROW/COUNTY/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "COUNTY",
    xmlquery('$x/ROWSET/ROW/CREATE_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "CREATE_DT",
    xmlquery('$x/ROWSET/ROW/CURRENT_TASK_ID/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "CURRENT_TASK_ID",
    xmlquery('$x/ROWSET/ROW/DE_TASK_ID/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "DE_TASK_ID",
    xmlquery('$x/ROWSET/ROW/ELIGIBILITY_ACTION/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "ELIGIBILITY_ACTION",
    xmlquery('$x/ROWSET/ROW/GWF_MISSING_INFO/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "GWF_MISSING_INFO",
    xmlquery('$x/ROWSET/ROW/GWF_NEW_MI/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "GWF_NEW_MI",
    xmlquery('$x/ROWSET/ROW/GWF_PEND_NOTIFY_RQRD/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "GWF_PEND_NOTIFY_RQRD",
    xmlquery('$x/ROWSET/ROW/GWF_QC_OUTCOME/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "GWF_QC_OUTCOME",
    xmlquery('$x/ROWSET/ROW/GWF_QC_RQRD/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "GWF_QC_RQRD",
    xmlquery('$x/ROWSET/ROW/GWF_RESEARCH/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "GWF_RESEARCH",
    xmlquery('$x/ROWSET/ROW/HEART_APP_STATUS/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "HEART_APP_STATUS",
    xmlquery('$x/ROWSET/ROW/HEART_SYNCH_FLAG/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "HEART_SYNCH_FLAG",
    xmlquery('$x/ROWSET/ROW/JEOPARDY_FLAG/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "JEOPARDY_FLAG",
    xmlquery('$x/ROWSET/ROW/LAST_MAIL_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "LAST_MAIL_DT",
    xmlquery('$x/ROWSET/ROW/MI_RECEIVED_TASK_COUNT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "MI_RECEIVED_TASK_COUNT",
    xmlquery('$x/ROWSET/ROW/NOTIFY_CLIENT_PENDED_APP_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "NOTIFY_CLIENT_PENDED_APP_DT",
    xmlquery('$x/ROWSET/ROW/PERFORM_QC_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "PERFORM_QC_DT",
    xmlquery('$x/ROWSET/ROW/PERFORM_RESEARCH_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "PERFORM_RESEARCH_DT",
    xmlquery('$x/ROWSET/ROW/PROCESS_APP_INFO_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "PROCESS_APP_INFO_DT",
    xmlquery('$x/ROWSET/ROW/QC_TASK_ID/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "QC_TASK_ID",
    xmlquery('$x/ROWSET/ROW/RECEIPT_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "RECEIPT_DT",
    xmlquery('$x/ROWSET/ROW/REFER_LDSS_FLAG/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "REFER_LDSS_FLAG",
    ...
    xmlquery('$x/ROWSET/ROW/RVW_ENTER_DATA_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "RVW_ENTER_DATA_DT",
    ...
    xmlquery('$x/ROWSET/ROW/STATE_REVIEW_TASK_COUNT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "STATE_REVIEW_TASK_COUNT",
    ...
    xmlquery('$x/ROWSET/ROW/WAIT_STATE_APPROVAL_DT/text()[1]' passing p_old_data_xml as "x" returning content).getStringVal() "WAIT_STATE_APPROVAL_DT" 
  into v_old_data
  from dual;
  ...
  BPM_EVENT.UPDATE_BIA(v_bi_id,37,2,'N',v_old_data.APP_COMPLETE_RESULT,v_new_data.APP_COMPLETE_RESULT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,38,2,'Y',v_old_data.APP_STATUS,v_new_data.APP_STATUS,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,39,2,'Y',v_old_data.APP_STATUS_GROUP,v_new_data.APP_STATUS_GROUP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,41,2,'N',v_old_data.APP_TYPE,v_new_data.APP_TYPE,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,42,2,'N',v_old_data.AUTO_REPROCESS_FLAG,v_new_data.AUTO_REPROCESS_FLAG,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,44,2,'N',v_old_data.ASF_CANCEL_APP,v_new_data.ASF_CANCEL_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,45,2,'N',v_old_data.ASPB_CANCEL_APP,v_new_data.ASPB_CANCEL_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,47,3,'N',v_old_data.CANCEL_DATE,v_new_data.CANCEL_DATE,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,49,2,'N',v_old_data.CHANNEL,v_new_data.CHANNEL,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,50,2,'Y',v_old_data.CLOCKDOWN_INDICATOR,v_new_data.CLOCKDOWN_INDICATOR,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,52,2,'N',v_old_data.ASF_CLOSE_APP,v_new_data.ASF_CLOSE_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,53,2,'N',v_old_data.ASPB_CLOSE_APP,v_new_data.ASPB_CLOSE_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,56,2,'N',v_old_data.ASF_COMPLETE_APP,v_new_data.ASF_COMPLETE_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,57,2,'N',v_old_data.ASPB_COMPLETE_APP,v_new_data.ASPB_COMPLETE_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,59,2,'Y',v_old_data.COUNTY,v_new_data.COUNTY,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,60,1,'N',v_old_data.CURRENT_TASK_ID,v_new_data.CURRENT_TASK_ID,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,61,1,'N',v_old_data.DE_TASK_ID,v_new_data.DE_TASK_ID,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,62,2,'N',v_old_data.ELIGIBILITY_ACTION,v_new_data.ELIGIBILITY_ACTION,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,63,2,'Y',v_old_data.HEART_APP_STATUS,v_new_data.HEART_APP_STATUS,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,64,2,'Y',v_old_data.HEART_SYNCH_FLAG,v_new_data.HEART_SYNCH_FLAG,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,67,1,'N',v_old_data.APP_CYCLE_BUS_DAYS,v_new_data.APP_CYCLE_BUS_DAYS,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,68,1,'N',v_old_data.APP_CYCLE_CAL_DAYS,v_new_data.APP_CYCLE_CAL_DAYS,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,69,3,'N',v_old_data.APP_CYCLE_END_DT,v_new_data.APP_CYCLE_END_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,70,3,'N',v_old_data.APP_CYCLE_START_DT,v_new_data.APP_CYCLE_START_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,71,3,'N',v_old_data.LAST_MAIL_DT,v_new_data.LAST_MAIL_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,72,1,'N',v_old_data.MI_RECEIVED_TASK_COUNT,v_new_data.MI_RECEIVED_TASK_COUNT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,73,2,'N',v_old_data.GWF_MISSING_INFO,v_new_data.GWF_MISSING_INFO,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,74,2,'N',v_old_data.GWF_NEW_MI,v_new_data.GWF_NEW_MI,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,75,3,'N',v_old_data.NOTIFY_CLIENT_PENDED_APP_DT,v_new_data.NOTIFY_CLIENT_PENDED_APP_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,77,2,'N',v_old_data.ASF_NOTIFY_CLIENT_PENDED_APP,v_new_data.ASF_NOTIFY_CLIENT_PENDED_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,78,2,'N',v_old_data.ASPB_NOTIFY_CLIENT_PENDED_APP,v_new_data.ASPB_NOTIFY_CLIENT_PENDED_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,79,3,'N',v_old_data.ASSD_NOTIFY_CLIENT_PENDED_APP,v_new_data.ASSD_NOTIFY_CLIENT_PENDED_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,80,2,'N',v_old_data.GWF_OUTCM_NOTIFY_RQRD,v_new_data.GWF_OUTCM_NOTIFY_RQRD,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,81,2,'N',v_old_data.GWF_PEND_NOTIFY_RQRD,v_new_data.GWF_PEND_NOTIFY_RQRD,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,82,3,'N',v_old_data.PERFORM_QC_DT,v_new_data.PERFORM_QC_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,84,2,'N',v_old_data.ASF_PERFORM_QC,v_new_data.ASF_PERFORM_QC,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,85,2,'N',v_old_data.ASPB_PERFORM_QC,v_new_data.ASPB_PERFORM_QC,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,86,3,'N',v_old_data.ASSD_PERFORM_QC,v_new_data.ASSD_PERFORM_QC,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,87,3,'N',v_old_data.PERFORM_RESEARCH_DT,v_new_data.PERFORM_RESEARCH_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,89,2,'N',v_old_data.ASF_PERFORM_RESEARCH,v_new_data.ASF_PERFORM_RESEARCH,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,90,2,'N',v_old_data.ASPB_PERFORM_RESEARCH,v_new_data.ASPB_PERFORM_RESEARCH,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,91,3,'N',v_old_data.ASSD_PERFORM_RESEARCH,v_new_data.ASSD_PERFORM_RESEARCH,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,92,3,'N',v_old_data.PROCESS_APP_INFO_DT,v_new_data.PROCESS_APP_INFO_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,94,2,'N',v_old_data.ASF_PROCESS_APP_INFO,v_new_data.ASF_PROCESS_APP_INFO,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,95,2,'N',v_old_data.ASPB_PROCESS_APP_INFO,v_new_data.ASPB_PROCESS_APP_INFO,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,96,3,'N',v_old_data.ASSD_PROCESS_APP_INFO,v_new_data.ASSD_PROCESS_APP_INFO,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,97,2,'N',v_old_data.GWF_QC_OUTCOME,v_new_data.GWF_QC_OUTCOME,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,98,2,'N',v_old_data.GWF_QC_RQRD,v_new_data.GWF_QC_RQRD,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,99,1,'N',v_old_data.QC_TASK_ID,v_new_data.QC_TASK_ID,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,100,3,'Y',v_old_data.RECEIPT_DT,v_new_data.RECEIPT_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,102,2,'N',v_old_data.ASF_RECEIVE_PROCESS_MI,v_new_data.ASF_RECEIVE_PROCESS_MI,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,106,2,'N',v_old_data.ASF_RECEIVE_APP,v_new_data.ASF_RECEIVE_APP,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,109,2,'Y',v_old_data.REFER_LDSS_FLAG,v_new_data.REFER_LDSS_FLAG,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,110,2,'N',v_old_data.GWF_RESEARCH,v_new_data.GWF_RESEARCH,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,111,2,'N',v_old_data.RESEARCH_REASON,v_new_data.RESEARCH_REASON,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,112,1,'N',v_old_data.RESEARCH_TASK_ID,v_new_data.RESEARCH_TASK_ID,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,113,3,'N',v_old_data.RVW_ENTER_DATA_DT,v_new_data.RVW_ENTER_DATA_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,115,2,'N',v_old_data.ASF_REVIEW_ENTER_DATA,v_new_data.ASF_REVIEW_ENTER_DATA,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,116,2,'N',v_old_data.ASPB_RVW_ENTER_DATA,v_new_data.ASPB_RVW_ENTER_DATA,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,117,3,'N',v_old_data.ASSD_RVW_ENTER_DATA,v_new_data.ASSD_RVW_ENTER_DATA,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,123,3,'N',v_old_data.SLA_JEOPARDY_DT,v_new_data.SLA_JEOPARDY_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,124,1,'N',v_old_data.STATE_REVIEW_TASK_COUNT,v_new_data.STATE_REVIEW_TASK_COUNT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,125,1,'N',v_old_data.STATE_REVIEW_TASK_ID,v_new_data.STATE_REVIEW_TASK_ID,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,126,3,'N',v_old_data.WAIT_STATE_APPROVAL_DT,v_new_data.WAIT_STATE_APPROVAL_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,128,2,'N',v_old_data.ASPB_WAIT_STATE_APPROVAL,v_new_data.ASPB_WAIT_STATE_APPROVAL,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,129,3,'N',v_old_data.ASSD_WAIT_STATE_APPROVAL,v_new_data.ASSD_WAIT_STATE_APPROVAL,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,130,2,'N',v_old_data.ASF_WAIT_STATE_APPROVAL,v_new_data.ASF_WAIT_STATE_APPROVAL,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,131,1,'N',v_old_data.AGE_IN_BUSINESS_DAYS,v_new_data.AGE_IN_BUSINESS_DAYS,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,133,3,'N',v_old_data.COMPLETE_DT,v_new_data.COMPLETE_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,134,3,'N',v_old_data.CREATE_DT,v_new_data.CREATE_DT,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,136,1,'N',v_old_data.SLA_DAYS,v_new_data.SLA_DAYS,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,137,2,'N',v_old_data.SLA_DAYS_TYPE,v_new_data.SLA_DAYS_TYPE,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,138,1,'N',v_old_data.SLA_JEOPARDY_DAYS,v_new_data.SLA_JEOPARDY_DAYS,v_bue_id);
  BPM_EVENT.UPDATE_BIA(v_bi_id,139,1,'N',v_old_data.SLA_TARGET_DAYS,v_new_data.SLA_TARGET_DAYS,v_bue_id);
