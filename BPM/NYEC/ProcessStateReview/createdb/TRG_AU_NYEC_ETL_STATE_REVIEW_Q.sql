...
begin
  ...
  /* 
  Include:
    NESR_ID - TODO - Determine if actually needed.
  ...
  */
  ...
  insert into BPM_UPDATE_EVENT_QUEUE
    ...
    values (SEQ_BUEQ_ID.nextval,v_bsl_id,v_bil_id,v_identifier,v_event_date,sysdate,v_data_version,sys.xmltype(v_xml_string_old),sys.xmltype(v_xml_string_new));
