create table BPM_D_DATES tablespace USERS as
select 
  D_DATE,
...
grant select on BPM_D_DATES to MAXDATSUPPORT_READ_ONLY;
...
grant select on D_DATES to MAXDATSUPPORT_READ_ONLY;
...
grant select on d_weeks to MAXDATSUPPORT_READ_ONLY;
...
grant select on d_months to MAXDATSUPPORT_READ_ONLY;
...
grant select on d_years to MAXDATSUPPORT_READ_ONLY;
