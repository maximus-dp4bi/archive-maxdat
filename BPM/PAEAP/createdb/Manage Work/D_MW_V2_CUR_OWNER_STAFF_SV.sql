CREATE OR REPLACE VIEW D_MW_V2_CUR_OWNER_STAFF_SV
AS
  SELECT UPDATE_TS ,
      CREATE_TS ,
      END_DATE ,
...
UNION  
  SELECT 
    to_date('01/01/1985', 'mm/dd/yyyy') AS UPDATE_TS ,
  ...
  GRANT SELECT ON MAXDAT_SUPPORT.D_MW_V2_CUR_OWNER_STAFF_SV TO EB_MAXDAT_REPORTS ;
