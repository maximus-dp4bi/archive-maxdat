CREATE OR REPLACE VIEW EMRS_D_CASE_CLIENT
AS
  SELECT cscl_id source_record_id,
  ...
  GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_CASE_CLIENT TO EB_MAXDAT_REPORTS;