...
AS
  ...
  NULL AS CLNT_CLNT_CLIENT_ID,
  NULL AS CLNT_ETHNICITY,
  NULL AS CLNT_TPL_PRESENT,
  NULL AS CLNT_NATIONAL_ID,
  NULL AS CLNT_FROM_PACMIS,
  NULL AS CLNT_SHARE_PREMIUM,
  ...
  NULL AS DO_NOT_CALL_IND,
  NULL AS WRITTEN_LANGUAGE,
  NULL AS SUFFIX,
  NULL AS SALUTATION_CD,
  NULL AS DOMESTIC_VIOLENCE_IND,
...
FROM DUAL ;
  ...
  GRANT SELECT ON MAXDAT_SUPPORT.D_PI_CLIENT_SV TO EB_MAXDAT_REPORTS;