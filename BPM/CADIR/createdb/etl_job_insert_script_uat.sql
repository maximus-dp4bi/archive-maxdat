...
VALUES ('California DIR IMR EBR', 'ETL_AUDIT_DATA_RETENTION_DAYS', 365);

INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('California DIR IMR EBR', 'ETL_RUN_DATA_RETENTION_DAYS', 365);
        
INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('California DIR IMR EBR', 'ETL_LOG_DATA_RETENTION_DAYS', 365);

INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('California DIR IMR EBR', 'MAX_PARALLEL_JOBS_ALLOWED', 7);

INSERT INTO ETL_JOB_GLOBAL_CONFIG (PROJECT_NAME, PARAM_KEY, PARAM_VALUE)
VALUES ('California DIR IMR EBR', 'JOB_TIMEOUT_SEC', 3000);
...
INSERT INTO ETL_JOB_CONFIG (
    ...
    LAST_UPD_USER)
VALUES (
	'California DIR IMR EBR',
	'CRON CADIR RUN BMP',
	'STANDALONE',
	'0 4-22 * * *',
	'Y',
	'cron_cadir_run_bpm.sh',
	'/u01/maximus/maxdat-uat/CADIR8/logs',
	SYSDATE,
	USER
);
