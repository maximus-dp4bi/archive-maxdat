...
||=================================================================================*/
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/Admin/createdb/MAXDAT_STATISTICS_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 9938 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2014-05-07 07:09:04 -0700 (Wed, 07 May 2014) $'; 
...
create or replace package body MAXDAT_STATISTICS as
  ...
  begin
    ...
    loop
      begin  --Anon blk 1
         DBMS_STATS.GATHER_TABLE_STATS(OWNNAME => 'MAXDAT_CADR', TABNAME => r_Tname.table_name, CASCADE => TRUE,
  ...
  begin  --Anon blk 1
    DBMS_STATS.GATHER_TABLE_STATS(OWNNAME => 'MAXDAT_CADR', TABNAME => p_Table, CASCADE => TRUE,
                                       DEGREE  =>  p_Degree, ESTIMATE_PERCENT => DBMS_STATS.AUTO_SAMPLE_SIZE,
                                       METHOD_OPT => 'FOR ALL COLUMNS SIZE AUTO');
  ...
  begin
     ...
     DBMS_STATS.GATHER_TABLE_STATS(OWNNAME => 'MAXDAT_CADR', TABNAME => p_Table, CASCADE => TRUE, DEGREE  => v_Degree,
