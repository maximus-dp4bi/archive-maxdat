...
BEGIN
   ...
   if in_start_date >= v_begin_mo_date then   ---update/insert only when start date is greater than or equal to the first day of the current month, otherwise do nothing
