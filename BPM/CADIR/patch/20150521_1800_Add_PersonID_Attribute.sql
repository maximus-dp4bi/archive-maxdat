alter table corp_etl_manage_work add Person_id number;
alter table corp_etl_manage_work_tmp add Person_id number;
alter table d_mw_current add Person_id number;
  ...
  v_xml_string_new :=
    ...
    <ROWSET>
      <ROW>
        ...
        <PERSON_ID><![CDATA[' || :new.PERSON_ID || ']]></PERSON_ID>        
      </ROW>
    </ROWSET>
    ';
  ...
  v_xml_string_old :=
    ...
    <ROWSET>
      <ROW>
        ...
        <PERSON_ID><![CDATA[' || :old.PERSON_ID || ']]></PERSON_ID> 
    </ROW>
    </ROWSET>
    ';
