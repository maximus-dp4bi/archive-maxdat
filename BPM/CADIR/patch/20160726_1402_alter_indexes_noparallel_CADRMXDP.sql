...
Description: MAXDAT-3691. Created for CADRMXDP.
...
alter index SYS_C004773 noparallel; 
alter index SYS_C004798 noparallel; 
alter index SYS_C004799 noparallel; 
alter index SYS_C004821 noparallel; 
alter index SYS_C004842 noparallel; 
alter index SYS_C004843 noparallel; 
alter index SYS_C004845 noparallel; 
alter index SYS_C004902 noparallel; 
alter index SYS_C004909 noparallel; 
alter index SYS_C004918 noparallel; 
alter index SYS_C004943 noparallel; 
alter index SYS_C004944 noparallel; 
alter index SYS_C004945 noparallel; 
alter index SYS_C004977 noparallel; 
alter index SYS_C004983 noparallel; 
alter index SYS_C004984 noparallel; 
alter index SYS_C005010 noparallel; 
