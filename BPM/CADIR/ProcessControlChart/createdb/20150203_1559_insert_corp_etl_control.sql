...
values ('MIN_NUM_OBSERVATIONS','N','3','Minimum number of observations for calculating MW control chart parameters',sysdate,sysdate);
...
insert into CORP_ETL_CONTROL(name,VALUE_TYPE,value,DESCRIPTION,CREATED_TS,UPDATED_TS) 
values ('MW_CURRENT_REPORTING_PERIOD','D','2015/01/19','Current reporting period for Manage Work metrics calculation',sysdate,sysdate);
