...
Insert into CORP_ETL_CONTROL (NAME,VALUE_TYPE,VALUE,DESCRIPTION,CREATED_TS,UPDATED_TS) values ('MW_MAX_PROCESSED_ID','N','1','This is a control to limit how many "2 rows" MW looks at to insert',to_date('01-JUN-12','DD-MON-RR'),to_date('01-JUN-12','DD-MON-RR'));
