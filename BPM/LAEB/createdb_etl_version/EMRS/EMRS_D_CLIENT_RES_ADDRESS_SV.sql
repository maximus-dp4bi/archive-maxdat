CREATE OR REPLACE VIEW EMRS_D_CLIENT_RES_ADDRESS_SV
AS
WITH tmp AS
  (SELECT /*+ parallel(10) */ a.ADDR_ID 
  , a.client_id
  ,ROW_NUMBER() OVER(PARTITION BY a.client_id ORDER BY CASE WHEN a.ADDR_TYPE_CD = 'MR' THEN 1 
...
GRANT SELECT ON EMRS_D_CLIENT_RES_ADDRESS_SV TO &role_name;
