DROP VIEW MAXDAT_SUPPORT.EMRS_D_CLIENT_RES_ADDRESS_SV;

CREATE OR REPLACE VIEW MAXDAT_SUPPORT.EMRS_D_CLIENT_RES_ADDRESS_SV
AS
WITH tmp AS
...
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_CLIENT_RES_ADDRESS_SV TO DP4BI_READ_ONLY;
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_CLIENT_RES_ADDRESS_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_CLIENT_RES_ADDRESS_SV TO MAXDAT_SUPPORT_READ_ONLY;
