...
CREATE OR REPLACE VIEW MAXDAT_SUPPORT.EMRS_D_CLIENT_PLAN_ELIG_SV
AS
SELECT
  ...
  FROM eb.client_elig_status;

GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_CLIENT_PLAN_ELIG_SV TO DP4BI_READ_ONLY;
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_CLIENT_PLAN_ELIG_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_CLIENT_PLAN_ELIG_SV TO MAXDAT_SUPPORT_READ_ONLY;
