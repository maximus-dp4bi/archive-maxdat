...
CREATE OR REPLACE VIEW MAXDAT_SUPPORT.EMRS_D_SELECTION_STATUS_SV
AS
SELECT 
...
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_SELECTION_STATUS_SV TO DP4BI_READ_ONLY;
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_SELECTION_STATUS_SV TO MAXDATSUPPORT_READ_ONLY;
GRANT SELECT ON MAXDAT_SUPPORT.EMRS_D_SELECTION_STATUS_SV TO MAXDAT_SUPPORT_READ_ONLY;
