...
("CEMW_ID" NUMBER NOT NULL ENABLE, 
	"ASF_CANCEL_WORK" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	"ASF_COMPLETE_WORK" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	...
	"CANCEL_WORK_FLAG" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	"COMPLETE_DATE" DATE, 
	"COMPLETE_FLAG" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	"CREATE_DATE" DATE NOT NULL ENABLE, 
	"CREATED_BY_NAME" VARCHAR2(100 BYTE), 
	"ESCALATED_FLAG" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	"ESCALATED_TO_NAME" VARCHAR2(100 BYTE), 
	"FORWARDED_BY_NAME" VARCHAR2(100 BYTE), 
	"FORWARDED_FLAG" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	"GROUP_NAME" VARCHAR2(100 BYTE), 
	"GROUP_PARENT_NAME" VARCHAR2(100 BYTE), 
	"GROUP_SUPERVISOR_NAME" VARCHAR2(100 BYTE), 
	"JEOPARDY_FLAG" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	...
	"SOURCE_REFERENCE_TYPE" VARCHAR2(30 BYTE), 
	...
	"TASK_STATUS" VARCHAR2(50 BYTE) NOT NULL ENABLE, 
	"TASK_TYPE" VARCHAR2(100 BYTE) NOT NULL ENABLE, 
	"TEAM_NAME" VARCHAR2(100 BYTE), 
	"TEAM_PARENT_NAME" VARCHAR2(100 BYTE), 
	"TEAM_SUPERVISOR_NAME" VARCHAR2(100 BYTE), 
	"TIMELINESS_STATUS" VARCHAR2(20 BYTE) DEFAULT 'Not Complete' NOT NULL ENABLE, 
	...
	"CLAIM_DATE" DATE, 
	"LAST_TASK" VARCHAR2(1 BYTE) DEFAULT 'N' NOT NULL ENABLE, 
	"PREV_TASK_NAME" VARCHAR2(100 BYTE), 
	"PREV_TASK_CREATE_DATE" DATE, 
	"PERSON_ID" NUMBER, 
	 PRIMARY KEY ("CEMW_ID")
  USING INDEX TABLESPACE "MAXDAT_INDX"  ENABLE, 
  ...
  CREATE INDEX "IDX_MANAGE_WORK_CASE_ID" ON "CORP_ETL_MANAGE_WORK" ("CASE_ID") 
  TABLESPACE "MAXDAT_INDX" ;

  CREATE INDEX "IDX_MANAGE_WORK_CLIENT_ID" ON "CORP_ETL_MANAGE_WORK" ("CLIENT_ID") 
  TABLESPACE "MAXDAT_INDX" ;

CREATE TABLE "CORP_ETL_MANAGE_WORK_TMP" 
("CEMW_ID" NUMBER, 
	"ASF_CANCEL_WORK" VARCHAR2(1 BYTE), 
	"ASF_COMPLETE_WORK" VARCHAR2(1 BYTE), 
	"AGE_IN_BUSINESS_DAYS" NUMBER, 
	"AGE_IN_CALENDAR_DAYS" NUMBER, 
	"CANCEL_WORK_DATE" DATE, 
	"CANCEL_WORK_FLAG" VARCHAR2(1 BYTE), 
	"COMPLETE_DATE" DATE, 
	"COMPLETE_FLAG" VARCHAR2(1 BYTE), 
	"CREATE_DATE" DATE, 
	"CREATED_BY_NAME" VARCHAR2(100 BYTE), 
	"ESCALATED_FLAG" VARCHAR2(1 BYTE), 
	"ESCALATED_TO_NAME" VARCHAR2(100 BYTE), 
	"FORWARDED_BY_NAME" VARCHAR2(100 BYTE), 
	"FORWARDED_FLAG" VARCHAR2(1 BYTE), 
	"GROUP_NAME" VARCHAR2(100 BYTE), 
	"GROUP_PARENT_NAME" VARCHAR2(100 BYTE), 
	"GROUP_SUPERVISOR_NAME" VARCHAR2(100 BYTE), 
	"JEOPARDY_FLAG" VARCHAR2(1 BYTE), 
	"LAST_UPDATE_BY_NAME" VARCHAR2(100 BYTE), 
