...
AS SELECT "APPEAL_ID","CREATE_DATE","COMPLETE_DATE","CANCELLED_DATE","ADJUDICATOR","DEADLINE_DATE","APPEAL_ISSUE","APPEAL_ITEM","APPEAL_NUMBER","APPEAL_PRIORITY","REQUEST_RECEIVED","APPEAL_STAGE","APPEAL_STATUS","APPEAL_TYPE","APPEAL_DISMISSAL","APPEAL_DISMISSAL_REASON","AUTO_FORWARD","CASE_FILE_REQUEST_DATE","ACKNOWLEDGEMENT_LETTER_DATE","DECISION_MAILED_DATE","DECISION_SENT_PLAN_DATE","MEDICAL_REVIEW_CHECK","APPEAL_PART","APPEAL_REASON","APPEAL_TOLLING_DATE","APPEAL_NOTICE_DATE","CASE_FILE_RECEIVED_DATE","PRECHECK_COMPLETED","ACKNOWLEDGEMENT_LETTER_AGE_IN_BUS_DAYS","ACKNOWLEDGEMENT_LETTER_AGE_IN_CAL_DAYS","ACKNOWLEDGEMENT_LETTER_DAYS_TYPE","ACKNOWLEDGEMENT_LETTER_TIMELINESS_STATUS","ACKNOWLEDGEMENT_LETTER_JEOPARDY_DAYS","ACKNOWLEDGEMENT_LETTER_JEOPARDY_FLAG","ACKNOWLEDGEMENT_LETTER_TIMELINESS","CASE_FILE_AGE_IN_BUS_DAYS","CASE_FILE_AGE_IN_CAL_DAYS","CASE_FILE_RECEIVED_AGE_IN_CAL_DAYS","CASE_FILE_DAYS_TYPE","CASE_FILE_TIMELINESS_STATUS","CASE_FILE_JEOPARDY_DAYS","CASE_FILE_JEOPARDY_FLAG","CASE_FILE_TIMELINESS_THRESHOLD","APPEAL_AGE_IN_BUS_DAYS","APPEAL_AGE_IN_CAL_DAYS","APPEAL_DAYS_TYPE","APPEAL_TIMELINESS_STATUS","APPEAL_JEOPARDY_DAYS","APPEAL_JEOPARDY_FLAG","APPEAL_TIMELINESS_THRESHOLD","CASE_FILE_ENTRY_AGE_IN_BUS_DAYS","CASE_FILE_ENTRY_AGE_IN_CAL_DAYS","CASE_FILE_ENTRY_DAYS_TYPE","CASE_FILE_ENTRY_TIMELINESS_STATUS","CASE_FILE_ENTRY_JEOPARDY_DAYS","CASE_FILE_ENTRY_JEOPARDY_FLAG","CASE_FILE_ENTRY_TIMELINESS_THRESHOLD","DECISION_LETTER_AGE_IN_BUS_DAYS","DECISION_LETTER_AGE_IN_CAL_DAYS","DECISION_LETTER_DAYS_TYPE","DECISION_LETTER_TIMELINESS_STATUS","DECISION_LETTER_JEOPARDY_DAYS","DECISION_LETTER_JEOPARDY_FLAG","DECISION_LETTER_TIMELINESS_THRESHOLD","REQUEST_HPMS_AGE_IN_BUS_DAYS","REQUEST_HPMS_AGE_IN_CAL_DAYS","REQUEST_HPMS_DAYS_TYPE","REQUEST_HPMS_TIMELINESS_STATUS","REQUEST_HPMS_JEOPARDY_DAYS","REQUEST_HPMS_JEOPARDY_FLAG","REQUEST_HPMS_TIMELINESS_THRESHOLD","ADJUDICATOR_PROCESS_AGE_IN_BUS_DAYS","ADJUDICATOR_PROCESS_AGE_IN_CAL_DAYS","ADJUDICATOR_PROCESS_DAYS_TYPE","ADJUDICATOR_PROCESS_TIMELINESS_STATUS","ADJUDICATOR_PROCESS_JEOPARDY_DAYS","ADJUDICATOR_PROCESS_JEOPARDY_FLAG","ADJUDICATOR_PROCESS_TIMELINESS_THRESHOLD","CASE_FILE_REQUEST_AGE_IN_BUS_DAYS","CASE_FILE_REQUEST_AGE_IN_CAL_DAYS","CASE_FILE_REQUEST_DAYS_TYPE","CASE_FILE_REQUEST_TIMELINESS_STATUS","CASE_FILE_REQUEST_JEOPARDY_DAYS","CASE_FILE_REQUEST_JEOPARDY_FLAG","CASE_FILE_REQUEST_TIMELINESS_THRESHOLD","CLAIMED_DATE","DECISION","DECISION_NOTIFICATION_METHOD","HPMS","HPMS_REQUESTED_DATE","IS_REQUEST_FOR_INFORMATION_P","MAC","MEDICARE_TYPE","MSP","NEW_DOCUMENTATION_REVIEWED","PHYSICIAN_SPECIALTY","REASON_FOR_APPEAL","WITHDRAWAL","WITHDRAWAL_REQUEST_SUBMITTED","NON_ENGLISH","NON_ENGLISH_OTHER","DISPOSITION","DISPOSITION_EXPLANATION","PROCEDURAL_DECISION_REASON","SUBSTANTIVE_REASON","FIRST_REVIEW_CASE_ATTESTATIO","FIRST_MEDICAL_REVIEW_DECISIO","FIRST_REVIEWER","THIRD_MEDICAL_REVIEW_DECISIO","THIRD_REVIEW_CASE_ATTESTATIO","THIRD_REVIEWER","EXPERT_REVIEW_CASE_ATTESTATI","EXPERT_REVIEW_CITATION","EXPERT_REVIEWER_MD_ID","STG_LAST_UPDATE_DATE","CLAIMED_TIME","UNCLAIMED_TIME","CLOSED_DATE","WITHDRAWN_DATE","INVENTORY_FLAG","SLA_INVENTORY_FLAG","DOCUMENT_COUNT","CLAIM_COUNT","DEMO_REOPENING_TYPE","OTHER_REOPENING_TYPE","CASE_CURRENTLY_WITH_ALJ","DATE_OF_REQUEST_TO_ALJ","DEMO_REOPENING_DUE_DATE","DEMO_REO_SENT_TO_OMHA_DATE","OMHA_RESPONSE_RECEIVED","RESPONSE_FROM_OMHA","ADDITIONAL_INFO_REQUESTED","REQUESTED_INFORMATION_DUE","DEMO_REOPEN_FOLLOW_UP","ADDITIONAL_INFO_RECEIVED","REOPENING_DECISION_RESULTS","NOT_REOPENED_REASON","OMHA_REMAND_REQUEST","REMAND_ELIGIBILITY_RESPONSE","REMAND_RECEIVED_DATE","OMHA_REMAND_REQUEST_RESPONSE","OMHA_WITHDRAW_FORM_SENT","OMHA_WITHDRAW_FORM_RETURNED","OMHA_NOTIFIED_OF_WITHDRAWL","ALJ_WITHDRAWAL","DEMO_REOPENING_APPEAL_NUMBER","REOPENING_ANALYSIS_COMPLETED","REOPENING_ANALYSIS_OUTCOME","NOT_PURSUED_BY_CONTR_REASON","ACK_LETTER_MAILED","REO_DECISION_LETTER_MAILED","REOPENING_OUTCOME","DECLINE_TO_REOPEN_DECISION","APPEAL_ATTESTATION_DATE","APPEAL_ATTESTATION","DEMO_SCHEDULED","DEMO_NOTIFICATION_LETTER_SENT","RESPONSE_DUE","RESPONSE_RECEIVED","DEMO_ACCEPTANCE_STATUS","TELE_DEMO_FOLLOW_UP","DEMO_NOTIFICATION_LTR_RESENT","RESCHEDULED_RESPONSE_DUE","RESCHEDULE_RESPONSE_RECEIVED","VERBAL_CONFIRMATION","RESCHEDULED_DEMO_STATUS","PROVIDER_OR_SUPPLIER_NAME","DEMO_CONFERENCE_STATUS","REVIEW_TYPE","EXPERT_REVIEW_DECISION","REVIEW_NUMBER","SECOND_REVIEW_CASE_ATTESTATION","DEMO_REOPENING_NEW_COUNT","SENT_TO_OMHA_COUNT","OMHA_RESPONSE_RECEIVED_NOT_REOPEN_COUNT","OMHA_RESPONSE_RECEIVED_REOPEN_COUNT","AWAITING_ADDITIONAL_INFO_COUNT","ADDITIONAL_INFO_OVERDUE_COUNT","ADDITIONAL_INFORMATION_RECEIVED_COUNT","AWAITING_REMAND_ELIGIBILITY_RESPONSE_FROM_OMHA_COUNT","AWAITING_REMAND_COUNT","REOPENING_ANALYSIS_COUNT","REOPENING_DECISION_LETTER_NEEDED_COUNT","REOPENING_COMPLETE_COUNT","AWAITING_OMHA_WITHDRAWL_FORM_FROM_SUPPLIER_COUNT","NOTIFY_OMHA_OF_SUPPLIER_WITHDRAWL_COUNT","PENDING_ALJ_WITHDRAWAL_COUNT","NEW_READY_FOR_DEMO_COUNT","AWAITING_RESPONSE_COUNT","RESPONSE_RECEIVED_ACCEPTED_PENDING_CONFERENCE_COUNT","RESPONSE_RECEIVED_DECLINED_COUNT","RESPONSE_OVERDUE_FOLLOW_UP_REQUIRED_COUNT","RESPONSE_OVERDUE_FOLLOW_UP_COMPLETE_COUNT","AWAITING_RESCHEDULE_RESPONSE_COUNT","RESCHEDULE_RESPONSE_RECEIVED_ACCEPTED_COUNT","RESCHEDULE_RESPONSE_RECEIVED_DECLINED_COUNT","RESCHEDULE_RESPONSE_OVERDUE_COUNT","DEMO_CONFERENCE_HELD_COUNT","DEMO_CONFERENCE_CANCELLED_NO_SHOW_COUNT","RNK"
from (select
  a.APPEAL_ID
, a.CREATE_DATE
, a.COMPLETE_DATE
