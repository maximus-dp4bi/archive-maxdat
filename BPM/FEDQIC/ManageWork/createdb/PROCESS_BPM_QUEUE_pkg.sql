...
create or replace package PROCESS_BPM_QUEUE as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/BPM/FEDQIC/createdb/PROCESS_BPM_QUEUE_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 15003 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2015-08-12 17:51:05 -0400 (Wed, 12 Aug 2015) $'; 
...
create or replace package body PROCESS_BPM_QUEUE as
  ...
  begin
    DBMS_OUTPUT.put_line('in PROCESS_RESERVED_ROWS ...');
    update PROCESS_BPM_QUEUE_JOB
    set 
    ...
    loop
      ...
      begin
DBMS_OUTPUT.put_line('in PROCESS_RESERVED_ROWS 2...');
        ...
        if v_prev_identifier is null 
          ...
          DBMS_OUTPUT.put_line('in PROCESS_RESERVED_ROWS 3...');
          update PROCESS_BPM_QUEUE_JOB_BATCH
          set
