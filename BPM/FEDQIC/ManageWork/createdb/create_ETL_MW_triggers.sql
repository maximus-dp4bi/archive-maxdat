  ...
  v_xml_string_new :=
    ...
    <ROWSET>
      <ROW>
        ...
        <CASE_ID><![CDATA[' || :new.CASE_ID || ']]></CASE_ID>
	...
	<ROLE><![CDATA[' || :new.ROLE || ']]></ROLE>
        <PART><![CDATA[' || :new.PART || ']]></PART>
        <RECEIVED_DATE>' || to_char(:new.RECEIVED_DATE,BPM_COMMON.GET_DATE_FMT) || '</RECEIVED_DATE>
 <APPEAL_STAGE><![CDATA[' || :new.APPEAL_STAGE || ']]></APPEAL_STAGE>
 <PREVIOUS_TASK_TYPE_ID><![CDATA[' || :new.PREVIOUS_TASK_TYPE_ID || ']]></PREVIOUS_TASK_TYPE_ID>
 <NON_STANDARD_WORK_FLAG><![CDATA[' || :new.NON_STANDARD_WORK_FLAG || ']]></NON_STANDARD_WORK_FLAG>
 <HANDLE_TIME><![CDATA[' || :new.HANDLE_TIME || ']]></HANDLE_TIME>
    </ROW>
    </ROWSET>
    ';
  ...
  v_xml_string_old :=
    ...
    <ROWSET>
      <ROW>
        ...
        <CASE_ID><![CDATA[' || :old.CASE_ID || ']]></CASE_ID>
	...
	<ROLE><![CDATA[' || :old.ROLE || ']]></ROLE>
        <PART><![CDATA[' || :old.PART || ']]></PART>
        <RECEIVED_DATE>' || to_char(:old.CLAIM_DATE,BPM_COMMON.GET_DATE_FMT) || '</RECEIVED_DATE>
	 <APPEAL_STAGE><![CDATA[' || :old.APPEAL_STAGE || ']]></APPEAL_STAGE>
 <PREVIOUS_TASK_TYPE_ID><![CDATA[' || :old.PREVIOUS_TASK_TYPE_ID || ']]></PREVIOUS_TASK_TYPE_ID>
 <NON_STANDARD_WORK_FLAG><![CDATA[' || :old.NON_STANDARD_WORK_FLAG || ']]></NON_STANDARD_WORK_FLAG>
 <HANDLE_TIME><![CDATA[' || :old.HANDLE_TIME || ']]></HANDLE_TIME>
