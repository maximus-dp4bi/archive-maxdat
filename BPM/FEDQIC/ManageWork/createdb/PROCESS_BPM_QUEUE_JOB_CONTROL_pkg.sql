...
create or replace package PROCESS_BPM_QUEUE_JOB_CONTROL as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/BPM/FEDQIC/createdb/PROCESS_BPM_QUEUE_JOB_CONTROL_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 15002 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2015-08-12 17:50:37 -0400 (Wed, 12 Aug 2015) $'; 
...
create or replace package body PROCESS_BPM_QUEUE_JOB_CONTROL as
  ...
  begin
   DBMS_OUTPUT.put_line('ADJUST_NUM_OF_JOBS');
  ...
  begin
  DBMS_OUTPUT.put_line('in ADJUST_ALL_JOBS ...');
    -- BPM Queue jobs.
    FIX_JOBS;
  ...
  as
  begin
DBMS_OUTPUT.put_line('in CREATE_ALL_JOBS ...');
    update PROCESS_BPM_QUEUE_JOB_CTRL_CFG
  ...
  begin
      DBMS_OUTPUT.put_line('in CONTROL_JOB ...');
    CREATE_ALL_JOBS;
  ...
  as
    ...
    v_sql_code number := null;
  begin
  DBMS_OUTPUT.put_line('in CREATE_CONTROL_JOB ...');
    dbms_scheduler.create_job (
  ...
  as
    ...
    v_sql_code number := null;
  begin
  DBMS_OUTPUT.put_line('in STARTUP_JOBS ...');
    CREATE_CONTROL_JOB;
