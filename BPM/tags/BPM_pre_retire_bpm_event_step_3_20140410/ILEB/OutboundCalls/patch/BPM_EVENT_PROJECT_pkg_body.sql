...
-- Project-specfic calls to process-specific BPM Event insert and update procedures.
create or replace package body BPM_EVENT_PROJECT as
  ...
  begin
    ...
    elsif p_bueq_row.BSL_ID = 19 then
      PROCESS_ONLINE_INFO.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id); 

    elsif p_bueq_row.BSL_ID = 20 then
      OUTBOUND_CALLS.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      PROCESS_ONLINE_INFO.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);

    elsif p_bueq_row.BSL_ID = 20 then
      OUTBOUND_CALLS.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);
