...
UPDATE emrs_d_client_plan_eligibility
SET current_eligibility_status_cd = null
WHERE current_eligibility_status_cd IS NOT NULL;

COMMIT;

UPDATE emrs_d_client_plan_enrl_status
SET current_enrollment_status_id = null
WHERE current_enrollment_status_id IS NOT NULL;
