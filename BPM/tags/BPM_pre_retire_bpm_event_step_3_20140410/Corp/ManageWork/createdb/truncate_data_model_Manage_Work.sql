/*
Created on 09-May-2013 by Saraswathi Konidena.
Description:
This script is created to clean the Semantic layer for a fresh reload of the Manage Work staging table.
...
-- Remove from queue.
delete from BPM_UPDATE_EVENT_QUEUE where BSL_ID = 1;
