...
FUNCTION GET_POI_JEOPARDY_TARGET_DAYS(
  ...
  /*
   select '     '|| 'CEPOI_ID varchar2(100),' attr_element from dual  
  union 
...
-- Get record for Process Online Info insert XML.
  ...
  begin  
/*
select '      extractValue(p_data_xml,''/ROWSET/ROW/CEPOI_ID'') "' || 'CEPOI_ID'|| '",' attr_element from dual
    union 
 ...
 -- Insert BPM Event model data.
  ...
  if p_data_version >1 then
    ...
    values
      (v_bi_id,v_bem_id,v_identifier,v_bil_id,v_bsl_id,
       v_start_date,v_end_date,to_char(v_new_data.CEPOI_ID),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT));
  ...
  /*
     select 'BPM_EVENT.INSERT_BIA(v_bi_id, '||b.ba_id || ','||bl.bdl_id || ',v_new_data.'|| stg.staging_table_column || ',v_start_date,v_bue_id);'
      ...
      order by b.ba_id;
  */    
BPM_EVENT.INSERT_BIA(v_bi_id, 2295,1,v_new_data.TRANSACTION_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2296,2,v_new_data.TRANSACTION_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2297,3,v_new_data.CREATE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2298,2,v_new_data.CREATE_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2299,1,v_new_data.CLIENT_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2300,1,v_new_data.CASE_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2301,2,v_new_data.WORK_REQUIRED_FLAG,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2302,2,v_new_data.INSTANCE_STATUS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2303,2,v_new_data.SOURCE_RECORD_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2304,1,v_new_data.SOURCE_RECORD_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2305,3,v_new_data.LAST_UPDATED_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2306,2,v_new_data.LAST_UPDATED_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2307,2,v_new_data.LANGUAGE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2308,3,v_new_data.ASSD_PROCESS_NEW_INFO,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2309,3,v_new_data.ASED_PROCESS_NEW_INFO,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2310,3,v_new_data.ASSD_CREATE_ROUTE_WORK,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2311,3,v_new_data.ASED_CREATE_ROUTE_WORK,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2312,2,v_new_data.CANCEL_REASON,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2313,2,v_new_data.CANCEL_METHOD,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2314,2,v_new_data.CANCEL_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2315,3,v_new_data.CANCEL_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2316,3,v_new_data.COMPLETE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2317,2,v_new_data.ASF_PROCESS_NEW_INFO,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2318,2,v_new_data.ASF_CREATE_ROUTE_WORK,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2319,2,v_new_data.GWF_WORK_IDENTIFIED,v_start_date,v_bue_id);
commit;
...
-- Update BPM Event model data.
  ...
  begin
    ...
    if p_data_version > 1 then
      v_log_message := 'Unsupported BPM_UPDATE_EVENT_QUEUE.DATA_VERSION value "' || p_data_version || '" with Process Online Info in procedure ' || v_procedure_name || '.';
      RAISE_APPLICATION_ERROR(-20011,v_log_message);        
    end if; 
...
select 'BPM_EVENT.UPDATE_BIA(v_bi_id,' ||b.ba_id || ','||bl.bdl_id || ','||''''||b.retain_history_flag||''''||',v_old_data.'|| stg.staging_table_column ||
    ...
    order by b.ba_id; 
 */   
BPM_EVENT.UPDATE_BIA(v_bi_id,2302,2,'Y',v_old_data.INSTANCE_STATUS,v_new_data.INSTANCE_STATUS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2304,1,'N',v_old_data.SOURCE_RECORD_ID,v_new_data.SOURCE_RECORD_ID,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2305,3,'N',v_old_data.LAST_UPDATED_DT,v_new_data.LAST_UPDATED_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2306,2,'N',v_old_data.LAST_UPDATED_BY,v_new_data.LAST_UPDATED_BY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2309,3,'N',v_old_data.ASED_PROCESS_NEW_INFO,v_new_data.ASED_PROCESS_NEW_INFO,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2310,3,'N',v_old_data.ASSD_CREATE_ROUTE_WORK,v_new_data.ASSD_CREATE_ROUTE_WORK,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2311,3,'N',v_old_data.ASED_CREATE_ROUTE_WORK,v_new_data.ASED_CREATE_ROUTE_WORK,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2312,2,'N',v_old_data.CANCEL_REASON,v_new_data.CANCEL_REASON,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2313,2,'N',v_old_data.CANCEL_METHOD,v_new_data.CANCEL_METHOD,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2314,2,'N',v_old_data.CANCEL_BY,v_new_data.CANCEL_BY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2315,3,'N',v_old_data.CANCEL_DT,v_new_data.CANCEL_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2316,3,'N',v_old_data.COMPLETE_DT,v_new_data.COMPLETE_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2317,2,'N',v_old_data.ASF_PROCESS_NEW_INFO,v_new_data.ASF_PROCESS_NEW_INFO,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2318,2,'N',v_old_data.ASF_CREATE_ROUTE_WORK,v_new_data.ASF_CREATE_ROUTE_WORK,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2319,2,'N',v_old_data.GWF_WORK_IDENTIFIED,v_new_data.GWF_WORK_IDENTIFIED,v_bue_id,v_stg_last_update_date);commit;
