...
-- Insert BPM Event model data.
 ...
 BPM_EVENT.INSERT_BIA(v_bi_id,2023,2,v_new_data.BATCH_GUID,v_start_date,v_bue_id);
...
BPM_EVENT.UPDATE_BIA(v_bi_id,2023,2,'N',v_old_data.BATCH_GUID,v_new_data.BATCH_GUID,v_bue_id,v_stg_last_update_date);   
