...
FUNCTION GET_RECORD_OUTCOME_TIME_STAT(
  ...
  /*
   select '     '|| 'CECOM_ID varchar2(100),' attr_element from dual  
  union 
...
-- Get record for Community Outreach insert XML.
  ...
  begin  
/*
select '      extractValue(p_data_xml,''/ROWSET/ROW/CECOM_ID'') "' || 'CECOM_ID'|| '",' attr_element from dual
    union 
 ...
 -- Insert BPM Event model data.
  ...
  insert into BPM_INSTANCE 
    ...
    values
      (v_bi_id,v_bem_id,v_identifier,v_bil_id,v_bsl_id,
       v_start_date,v_end_date,to_char(v_new_data.CECOM_ID),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT));
  ...
  /*
    select 'BPM_EVENT.INSERT_BIA(v_bi_id, '||b.ba_id || ','||bl.bdl_id || ',v_new_data.'|| stg.staging_table_column || ',v_start_date,v_bue_id);'
      ...
      order by b.ba_id;
  */    
BPM_EVENT.INSERT_BIA(v_bi_id, 2072,1,v_new_data.OUTREACH_SESSION_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2073,3,v_new_data.REQUEST_DATE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2074,2,v_new_data.REQUESTED_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2075,2,v_new_data.REQUEST_METHOD,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2076,2,v_new_data.SESSION_CREATED_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2077,3,v_new_data.SESSION_CREATE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2078,2,v_new_data.EVENT_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2079,2,v_new_data.SESSION_STATUS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2080,3,v_new_data.SESSION_STATUS_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2081,2,v_new_data.PUBLIC_ALLOWED_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2082,2,v_new_data.MULTILINGUAL_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2083,2,v_new_data.GROUP_INDIVIDUAL_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2084,2,v_new_data.ESTIMATED_ATTENDEES,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2085,3,v_new_data.EVENT_DATE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2086,3,v_new_data.ALTERNATE_1_DATE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2087,3,v_new_data.ALTERNATE_2_DATE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2088,3,v_new_data.ALTERNATE_3_DATE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2091,2,v_new_data.PREPARATION_TIME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2092,2,v_new_data.TRAVEL_TIME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2093,2,v_new_data.PRESENTER_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2094,2,v_new_data.SITE_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2095,2,v_new_data.SITE_TYPE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2096,2,v_new_data.SITE_LANGUAGE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2097,2,v_new_data.SITE_CITY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2098,2,v_new_data.SITE_ZIP_CD,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2099,2,v_new_data.SITE_COUNTY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2100,2,v_new_data.SITE_STATE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2101,2,v_new_data.SITE_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2102,1,v_new_data.SITE_CAPACITY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2103,2,v_new_data.SITE_SERVICE_AREA,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2104,2,v_new_data.SITE_STATUS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2105,2,v_new_data.CONTACT_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2106,2,v_new_data.SESSION_UPDATED_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2107,3,v_new_data.SESSION_UPDATED_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2108,1,v_new_data.NOTE_REF_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2109,2,v_new_data.RESCHEDULE_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2110,1,v_new_data.RECURRING_GROUP_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2111,2,v_new_data.RECURRING_FREQUENCY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2112,1,v_new_data.NUMBER_OF_OCCURENCES,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2113,2,v_new_data.CLIENT_REG_REQ_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2114,2,v_new_data.SESSION_START_TIME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2115,2,v_new_data.SESSION_END_TIME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2116,1,v_new_data.DETAILS_SURVEY_ID,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2117,2,v_new_data.SURVEY_NAME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2118,2,v_new_data.EVENT_TITLE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2119,2,v_new_data.LANGUAGES_SUPPORTED,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2120,2,v_new_data.EVENT_RECEIVED_FROM,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2121,2,v_new_data.EVENT_RECEIVED_VIA,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2122,2,v_new_data.GENERAL_PUBLIC_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2123,2,v_new_data.SENIORS_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2124,2,v_new_data.RESTRICTED_AGENCY_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2125,2,v_new_data.SCHOOL_AGED_FAMILIES_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2126,2,v_new_data.MIGRANTS_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2127,2,v_new_data.PREGNANT_WOMEN_TEENS_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2128,2,v_new_data.OTHER_GROUPS_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2129,2,v_new_data.PLANS_TO_ATTEND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2130,2,v_new_data.ALL_PLANS_INVITED,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2131,2,v_new_data.STAR_INVITED_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2132,2,v_new_data.STARPLUS_INVITED_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2133,2,v_new_data.DENTAL_INVITED_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2134,2,v_new_data.NORTHSTAR_INVITED_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2135,2,v_new_data.PLAN_SPONSORED_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2136,2,v_new_data.PLAN_EXCLUSIVE_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2137,2,v_new_data.PLAN_RSVP_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2138,2,v_new_data.RSVP_DEADLINE,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2139,2,v_new_data.STAR_EVENT_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2140,2,v_new_data.STARPLUS_EVENT_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2141,2,v_new_data.NORTHSTAR_EVENT_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2142,2,v_new_data.DENTAL_EVENT_IND,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2143,2,v_new_data.SURVEY_COMMENTS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2144,3,v_new_data.COMPLETE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2145,3,v_new_data.CANCEL_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2146,2,v_new_data.CANCEL_BY,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2147,2,v_new_data.CANCEL_REASON,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2148,2,v_new_data.CANCEL_METHOD,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2149,2,v_new_data.INSTANCE_STATUS,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2150,3,v_new_data.ASSD_REVIEW_EVENT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2151,3,v_new_data.ASED_REVIEW_EVENT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2152,2,v_new_data.ASPB_REVIEW_EVENT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2153,3,v_new_data.ASSD_WAIT_FOR_EVENT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2154,3,v_new_data.ASED_WAIT_FOR_EVENT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2155,3,v_new_data.ASSD_RECORD_OUTCOME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2156,3,v_new_data.ASED_RECORD_OUTCOME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2157,2,v_new_data.ASPB_RECORD_OUTCOME,v_start_date,v_bue_id);
--BPM_EVENT.INSERT_BIA(v_bi_id, 2158,1,v_new_data.COMMUNITY_ACTIVITY_ID,v_start_date,v_bue_id);
--BPM_EVENT.INSERT_BIA(v_bi_id, 2159,3,v_new_data.ACTIVITY_CREATE_DT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2160,2,v_new_data.GWF_OUTREACH_APPROVED,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2161,2,v_new_data.GWF_PUSH_TO_CALENDAR,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2162,2,v_new_data.GWF_ATTENDED,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2163,2,v_new_data.ASF_REVIEW_EVENT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2164,2,v_new_data.ASF_WAIT_FOR_EVENT,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2165,2,v_new_data.ASF_RECORD_OUTCOME,v_start_date,v_bue_id);
BPM_EVENT.INSERT_BIA(v_bi_id, 2355,2,v_new_data.DURATION,v_start_date,v_bue_id);
commit;
...
select 'BPM_EVENT.UPDATE_BIA(v_bi_id,' ||b.ba_id || ','||bl.bdl_id || ','||''''||b.retain_history_flag||''''||',v_old_data.'|| stg.staging_table_column ||
    ...
    order by b.ba_id; 
 */   
BPM_EVENT.UPDATE_BIA(v_bi_id,2075,2,'N',v_old_data.REQUEST_METHOD,v_new_data.REQUEST_METHOD,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2078,2,'N',v_old_data.EVENT_TYPE,v_new_data.EVENT_TYPE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2079,2,'N',v_old_data.SESSION_STATUS,v_new_data.SESSION_STATUS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2080,3,'Y',v_old_data.SESSION_STATUS_DT,v_new_data.SESSION_STATUS_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2081,2,'N',v_old_data.PUBLIC_ALLOWED_IND,v_new_data.PUBLIC_ALLOWED_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2082,2,'N',v_old_data.MULTILINGUAL_IND,v_new_data.MULTILINGUAL_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2083,2,'N',v_old_data.GROUP_INDIVIDUAL_IND,v_new_data.GROUP_INDIVIDUAL_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2084,2,'N',v_old_data.ESTIMATED_ATTENDEES,v_new_data.ESTIMATED_ATTENDEES,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2085,3,'N',v_old_data.EVENT_DATE,v_new_data.EVENT_DATE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2086,3,'N',v_old_data.ALTERNATE_1_DATE,v_new_data.ALTERNATE_1_DATE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2087,3,'N',v_old_data.ALTERNATE_2_DATE,v_new_data.ALTERNATE_2_DATE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2088,3,'N',v_old_data.ALTERNATE_3_DATE,v_new_data.ALTERNATE_3_DATE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2091,2,'N',v_old_data.PREPARATION_TIME,v_new_data.PREPARATION_TIME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2092,2,'N',v_old_data.TRAVEL_TIME,v_new_data.TRAVEL_TIME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2093,2,'N',v_old_data.PRESENTER_NAME,v_new_data.PRESENTER_NAME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2094,2,'N',v_old_data.SITE_ID,v_new_data.SITE_ID,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2095,2,'N',v_old_data.SITE_TYPE,v_new_data.SITE_TYPE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2096,2,'N',v_old_data.SITE_LANGUAGE,v_new_data.SITE_LANGUAGE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2097,2,'N',v_old_data.SITE_CITY,v_new_data.SITE_CITY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2098,2,'N',v_old_data.SITE_ZIP_CD,v_new_data.SITE_ZIP_CD,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2099,2,'N',v_old_data.SITE_COUNTY,v_new_data.SITE_COUNTY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2100,2,'N',v_old_data.SITE_STATE,v_new_data.SITE_STATE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2101,2,'N',v_old_data.SITE_NAME,v_new_data.SITE_NAME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2102,1,'N',v_old_data.SITE_CAPACITY,v_new_data.SITE_CAPACITY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2103,2,'N',v_old_data.SITE_SERVICE_AREA,v_new_data.SITE_SERVICE_AREA,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2104,2,'N',v_old_data.SITE_STATUS,v_new_data.SITE_STATUS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2105,2,'N',v_old_data.CONTACT_NAME,v_new_data.CONTACT_NAME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2106,2,'N',v_old_data.SESSION_UPDATED_BY,v_new_data.SESSION_UPDATED_BY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2107,3,'N',v_old_data.SESSION_UPDATED_DT,v_new_data.SESSION_UPDATED_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2108,1,'N',v_old_data.NOTE_REF_ID,v_new_data.NOTE_REF_ID,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2109,2,'N',v_old_data.RESCHEDULE_IND,v_new_data.RESCHEDULE_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2110,1,'N',v_old_data.RECURRING_GROUP_ID,v_new_data.RECURRING_GROUP_ID,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2111,2,'N',v_old_data.RECURRING_FREQUENCY,v_new_data.RECURRING_FREQUENCY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2112,1,'N',v_old_data.NUMBER_OF_OCCURENCES,v_new_data.NUMBER_OF_OCCURENCES,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2113,2,'N',v_old_data.CLIENT_REG_REQ_IND,v_new_data.CLIENT_REG_REQ_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2114,2,'N',v_old_data.SESSION_START_TIME,v_new_data.SESSION_START_TIME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2115,2,'N',v_old_data.SESSION_END_TIME,v_new_data.SESSION_END_TIME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2116,1,'N',v_old_data.DETAILS_SURVEY_ID,v_new_data.DETAILS_SURVEY_ID,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2117,2,'N',v_old_data.SURVEY_NAME,v_new_data.SURVEY_NAME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2118,2,'N',v_old_data.EVENT_TITLE,v_new_data.EVENT_TITLE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2119,2,'N',v_old_data.LANGUAGES_SUPPORTED,v_new_data.LANGUAGES_SUPPORTED,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2120,2,'N',v_old_data.EVENT_RECEIVED_FROM,v_new_data.EVENT_RECEIVED_FROM,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2121,2,'N',v_old_data.EVENT_RECEIVED_VIA,v_new_data.EVENT_RECEIVED_VIA,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2122,2,'N',v_old_data.GENERAL_PUBLIC_IND,v_new_data.GENERAL_PUBLIC_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2123,2,'N',v_old_data.SENIORS_IND,v_new_data.SENIORS_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2124,2,'N',v_old_data.RESTRICTED_AGENCY_IND,v_new_data.RESTRICTED_AGENCY_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2125,2,'N',v_old_data.SCHOOL_AGED_FAMILIES_IND,v_new_data.SCHOOL_AGED_FAMILIES_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2126,2,'N',v_old_data.MIGRANTS_IND,v_new_data.MIGRANTS_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2127,2,'N',v_old_data.PREGNANT_WOMEN_TEENS_IND,v_new_data.PREGNANT_WOMEN_TEENS_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2128,2,'N',v_old_data.OTHER_GROUPS_IND,v_new_data.OTHER_GROUPS_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2129,2,'N',v_old_data.PLANS_TO_ATTEND,v_new_data.PLANS_TO_ATTEND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2130,2,'N',v_old_data.ALL_PLANS_INVITED,v_new_data.ALL_PLANS_INVITED,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2131,2,'N',v_old_data.STAR_INVITED_IND,v_new_data.STAR_INVITED_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2132,2,'N',v_old_data.STARPLUS_INVITED_IND,v_new_data.STARPLUS_INVITED_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2133,2,'N',v_old_data.DENTAL_INVITED_IND,v_new_data.DENTAL_INVITED_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2134,2,'N',v_old_data.NORTHSTAR_INVITED_IND,v_new_data.NORTHSTAR_INVITED_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2135,2,'N',v_old_data.PLAN_SPONSORED_IND,v_new_data.PLAN_SPONSORED_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2136,2,'N',v_old_data.PLAN_EXCLUSIVE_IND,v_new_data.PLAN_EXCLUSIVE_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2137,2,'N',v_old_data.PLAN_RSVP_IND,v_new_data.PLAN_RSVP_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2138,2,'N',v_old_data.RSVP_DEADLINE,v_new_data.RSVP_DEADLINE,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2139,2,'N',v_old_data.STAR_EVENT_IND,v_new_data.STAR_EVENT_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2140,2,'N',v_old_data.STARPLUS_EVENT_IND,v_new_data.STARPLUS_EVENT_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2141,2,'N',v_old_data.NORTHSTAR_EVENT_IND,v_new_data.NORTHSTAR_EVENT_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2142,2,'N',v_old_data.DENTAL_EVENT_IND,v_new_data.DENTAL_EVENT_IND,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2143,2,'N',v_old_data.SURVEY_COMMENTS,v_new_data.SURVEY_COMMENTS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2144,3,'N',v_old_data.COMPLETE_DT,v_new_data.COMPLETE_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2145,3,'N',v_old_data.CANCEL_DT,v_new_data.CANCEL_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2146,2,'N',v_old_data.CANCEL_BY,v_new_data.CANCEL_BY,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2147,2,'N',v_old_data.CANCEL_REASON,v_new_data.CANCEL_REASON,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2148,2,'N',v_old_data.CANCEL_METHOD,v_new_data.CANCEL_METHOD,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2149,2,'N',v_old_data.INSTANCE_STATUS,v_new_data.INSTANCE_STATUS,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2151,3,'N',v_old_data.ASED_REVIEW_EVENT,v_new_data.ASED_REVIEW_EVENT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2152,2,'N',v_old_data.ASPB_REVIEW_EVENT,v_new_data.ASPB_REVIEW_EVENT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2153,3,'N',v_old_data.ASSD_WAIT_FOR_EVENT,v_new_data.ASSD_WAIT_FOR_EVENT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2154,3,'N',v_old_data.ASED_WAIT_FOR_EVENT,v_new_data.ASED_WAIT_FOR_EVENT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2155,3,'N',v_old_data.ASSD_RECORD_OUTCOME,v_new_data.ASSD_RECORD_OUTCOME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2156,3,'N',v_old_data.ASED_RECORD_OUTCOME,v_new_data.ASED_RECORD_OUTCOME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2157,2,'N',v_old_data.ASPB_RECORD_OUTCOME,v_new_data.ASPB_RECORD_OUTCOME,v_bue_id,v_stg_last_update_date);
--BPM_EVENT.UPDATE_BIA(v_bi_id,2158,1,'N',v_old_data.COMMUNITY_ACTIVITY_ID,v_new_data.COMMUNITY_ACTIVITY_ID,v_bue_id,v_stg_last_update_date);
--BPM_EVENT.UPDATE_BIA(v_bi_id,2159,3,'N',v_old_data.ACTIVITY_CREATE_DT,v_new_data.ACTIVITY_CREATE_DT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2160,2,'N',v_old_data.GWF_OUTREACH_APPROVED,v_new_data.GWF_OUTREACH_APPROVED,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2161,2,'N',v_old_data.GWF_PUSH_TO_CALENDAR,v_new_data.GWF_PUSH_TO_CALENDAR,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2162,2,'N',v_old_data.GWF_ATTENDED,v_new_data.GWF_ATTENDED,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2163,2,'N',v_old_data.ASF_REVIEW_EVENT,v_new_data.ASF_REVIEW_EVENT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2164,2,'N',v_old_data.ASF_WAIT_FOR_EVENT,v_new_data.ASF_WAIT_FOR_EVENT,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2165,2,'N',v_old_data.ASF_RECORD_OUTCOME,v_new_data.ASF_RECORD_OUTCOME,v_bue_id,v_stg_last_update_date);
BPM_EVENT.UPDATE_BIA(v_bi_id,2355,2,'N',v_old_data.DURATION,v_new_data.DURATION,v_bue_id,v_stg_last_update_date); 
commit;
