...
create or replace package body BPM_EVENT_PROJECT as
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      NYHIX_PROCESS_APPEALS.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      NYHIX_PROCESS_APPEALS.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);
