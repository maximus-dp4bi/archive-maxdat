...
alter table NYHX_ETL_IDR_INCIDENTS
  add constraint IDR_PK primary key (NEII_ID) ;

alter table NYHX_ETL_IDR_INCIDENTS
  add constraint IDR_UK unique (INCIDENT_ID) ;  
...
CREATE PUBLIC SYNONYM NYHX_ETL_IDR_INCIDENTS FOR NYHX_ETL_IDR_INCIDENTS;
...
--GRANTS & PUBLIC SYNONYMNS
CREATE PUBLIC SYNONYM NYHX_ETL_IDR_INCIDENTS_oltp FOR NYHX_ETL_IDR_INCIDENTS_oltp;
...
--GRANTS & PUBLIC SYNONYMNS
CREATE PUBLIC SYNONYM NYHX_ETL_IDR_INCIDENTS_wip FOR NYHX_ETL_IDR_INCIDENTS_wip;
...
--GRANTS & PUBLIC SYNONYMNS
CREATE PUBLIC SYNONYM IDR_forwarding_Hierarchy FOR IDR_forwarding_Hierarchy;
...
--GRANTS & PUBLIC SYNONYMNS
CREATE PUBLIC SYNONYM IDR_timeliness_jeopardy FOR IDR_timeliness_jeopardy;
