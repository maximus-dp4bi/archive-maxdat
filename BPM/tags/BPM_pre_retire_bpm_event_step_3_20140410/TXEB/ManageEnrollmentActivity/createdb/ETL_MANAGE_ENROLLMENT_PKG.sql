...
SELECT  CEME_ID,
      ...
      'Y' as in_yes
FROM CORP_ETL_MANAGE_ENROLL_OLTP
WHERE INSTANCE_STATUS = 'Active'
AND CANCEL_DT IS NULL
and gwf_enrl_pack_req = 'N'
;
...
and w.gwf_enrl_pack_req = 'Y'
and w.assd_send_enroll_packet is not null
and w.ased_send_enroll_packet is null
--
and w.enrl_pack_id is not null          
AND w.enrl_pack_request_dt is not null
;
...
and w.first_followup_id is not null
;
...
AND W.INSTANCE_STATUS = 'Active'
AND W.CANCEL_DT IS NULL
AND W.ASED_FOURTH_FOLLOWUP IS NOT NULL
...
SELECT  o.CEME_ID,
        ...
        'Complete'           AS in_Complete,
        SYSDATE              AS IN_SYSDATE, 
        o.enroll_fee_paid_dt AS o_enroll_fee_paid_dt
FROM CORP_ETL_MANAGE_ENROLL_OLTP   o
join corp_etl_manage_enroll_wip   w on o.ceme_id = w.ceme_id
WHERE 1=1 
AND W.INSTANCE_STATUS = 'Active'
