...
create or replace
trigger TRG_AI_CORP_ETL_MANAGE_ENRL_Q
...
create or replace
trigger TRG_AU_CORP_ETL_MANAGE_ENRL_Q
after update on CORP_ETL_MANAGE_ENROLL
for each row
...
begin
  ...
  */
  v_xml_string_old := 
    ...
    <ROWSET>  
      <ROW>
        <AA_DUE_DT>' || to_char(:old.AA_DUE_DT,BPM_COMMON.GET_DATE_FMT) || '</AA_DUE_DT>
        <ASED_AUTO_ASSIGN>' || to_char(:old.ASED_AUTO_ASSIGN,BPM_COMMON.GET_DATE_FMT) || '</ASED_AUTO_ASSIGN>
        <ASED_FIRST_FOLLOWUP>' || to_char(:old.ASED_FIRST_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASED_FIRST_FOLLOWUP>
        <ASED_FOURTH_FOLLOWUP>' || to_char(:old.ASED_FOURTH_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASED_FOURTH_FOLLOWUP>
        <ASED_SECOND_FOLLOWUP>' || to_char(:old.ASED_SECOND_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASED_SECOND_FOLLOWUP>
        <ASED_SELECTION_RECD>' || to_char(:old.ASED_SELECTION_RECD,BPM_COMMON.GET_DATE_FMT) || '</ASED_SELECTION_RECD>
        <ASED_SEND_ENROLL_PACKET>' || to_char(:old.ASED_SEND_ENROLL_PACKET,BPM_COMMON.GET_DATE_FMT) || '</ASED_SEND_ENROLL_PACKET>
        <ASED_THIRD_FOLLOWUP>' || to_char(:old.ASED_THIRD_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASED_THIRD_FOLLOWUP>
        <ASED_WAIT_FOR_FEE>' || to_char(:old.ASED_WAIT_FOR_FEE,BPM_COMMON.GET_DATE_FMT) || '</ASED_WAIT_FOR_FEE>
        <ASF_AUTO_ASSIGN><![CDATA[' || :old.ASF_AUTO_ASSIGN || ']]></ASF_AUTO_ASSIGN>
        <ASF_CANCEL_ENRL_ACTIVITY><![CDATA[' || :old.ASF_CANCEL_ENRL_ACTIVITY || ']]></ASF_CANCEL_ENRL_ACTIVITY>
        <ASF_FIRST_FOLLOWUP><![CDATA[' || :old.ASF_FIRST_FOLLOWUP || ']]></ASF_FIRST_FOLLOWUP>
        <ASF_FOURTH_FOLLOWUP><![CDATA[' || :old.ASF_FOURTH_FOLLOWUP || ']]></ASF_FOURTH_FOLLOWUP>
        <ASF_SECOND_FOLLOWUP><![CDATA[' || :old.ASF_SECOND_FOLLOWUP || ']]></ASF_SECOND_FOLLOWUP>
        <ASF_SELECTION_RECD><![CDATA[' || :old.ASF_SELECTION_RECD || ']]></ASF_SELECTION_RECD>
        <ASF_SEND_ENROLL_PACKET><![CDATA[' || :old.ASF_SEND_ENROLL_PACKET || ']]></ASF_SEND_ENROLL_PACKET>
        <ASF_THIRD_FOLLOWUP><![CDATA[' || :old.ASF_THIRD_FOLLOWUP || ']]></ASF_THIRD_FOLLOWUP>
        <ASF_WAIT_FOR_FEE><![CDATA[' || :old.ASF_WAIT_FOR_FEE || ']]></ASF_WAIT_FOR_FEE>
        <ASSD_AUTO_ASSIGN>' || to_char(:old.ASSD_AUTO_ASSIGN,BPM_COMMON.GET_DATE_FMT) || '</ASSD_AUTO_ASSIGN>
        <ASSD_FIRST_FOLLOWUP>' || to_char(:old.ASSD_FIRST_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASSD_FIRST_FOLLOWUP>
        <ASSD_FOURTH_FOLLOWUP>' || to_char(:old.ASSD_FOURTH_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASSD_FOURTH_FOLLOWUP>
        <ASSD_SECOND_FOLLOWUP>' || to_char(:old.ASSD_SECOND_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASSD_SECOND_FOLLOWUP>
        <ASSD_SELECTION_RECD>' || to_char(:old.ASSD_SELECTION_RECD,BPM_COMMON.GET_DATE_FMT) || '</ASSD_SELECTION_RECD>
        <ASSD_SEND_ENROLL_PACKET>' || to_char(:old.ASSD_SEND_ENROLL_PACKET,BPM_COMMON.GET_DATE_FMT) || '</ASSD_SEND_ENROLL_PACKET>
        <ASSD_THIRD_FOLLOWUP>' || to_char(:old.ASSD_THIRD_FOLLOWUP,BPM_COMMON.GET_DATE_FMT) || '</ASSD_THIRD_FOLLOWUP>
        <ASSD_WAIT_FOR_FEE>' || to_char(:old.ASSD_WAIT_FOR_FEE,BPM_COMMON.GET_DATE_FMT) || '</ASSD_WAIT_FOR_FEE>
        ...
        <CHIP_EMI_ID>' || :old.CHIP_EMI_ID || '</CHIP_EMI_ID>
        <CHIP_EMI_MAILED_DT>' || to_char(:old.CHIP_EMI_MAILED_DT,BPM_COMMON.GET_DATE_FMT) || '</CHIP_EMI_MAILED_DT>
        <CHIP_HPC_ID>' || :old.CHIP_HPC_ID || '</CHIP_HPC_ID>
        <CHIP_HPC_MAILED_DT>' || to_char(:old.CHIP_HPC_MAILED_DT,BPM_COMMON.GET_DATE_FMT) || '</CHIP_HPC_MAILED_DT>
        <CLIENT_CIN><![CDATA[' || :old.CLIENT_CIN || ']]></CLIENT_CIN>
        <CLIENT_ENROLL_STATUS_ID>' || :old.CLIENT_ENROLL_STATUS_ID || '</CLIENT_ENROLL_STATUS_ID>
        ...
        <ENRL_PACK_ID>' || :old.ENRL_PACK_ID || '</ENRL_PACK_ID>
        <ENRL_PACK_REQUEST_DT>' || to_char(:old.ENRL_PACK_REQUEST_DT,BPM_COMMON.GET_DATE_FMT) || '</ENRL_PACK_REQUEST_DT>
        <ENROLLMENT_STATUS_CODE><![CDATA[' || :old.ENROLLMENT_STATUS_CODE || ']]></ENROLLMENT_STATUS_CODE>
        <ENROLLMENT_STATUS_DT>' || to_char(:old.ENROLLMENT_STATUS_DT,BPM_COMMON.GET_DATE_FMT) || '</ENROLLMENT_STATUS_DT>
        <ENROLL_FEE_AMNT_DUE>' || :old.ENROLL_FEE_AMNT_DUE || '</ENROLL_FEE_AMNT_DUE>
        <ENROLL_FEE_AMNT_PAID>' || :old.ENROLL_FEE_AMNT_PAID || '</ENROLL_FEE_AMNT_PAID>
        <ENROLL_FEE_PAID_DT>' || to_char(:old.ENROLL_FEE_PAID_DT,BPM_COMMON.GET_DATE_FMT) || '</ENROLL_FEE_PAID_DT>
        <FEE_PAID_FLG><![CDATA[' || :old.FEE_PAID_FLG || ']]></FEE_PAID_FLG>
		<FIRST_FOLLOWUP_ID>' || :old.FIRST_FOLLOWUP_ID || '</FIRST_FOLLOWUP_ID>
        <FIRST_FOLLOWUP_TYPE_CODE><![CDATA[' || :old.FIRST_FOLLOWUP_TYPE_CODE || ']]></FIRST_FOLLOWUP_TYPE_CODE>
        <FOURTH_FOLLOWUP_ID><![CDATA[' || :old.FOURTH_FOLLOWUP_ID || ']]></FOURTH_FOLLOWUP_ID>
        <FOURTH_FOLLOWUP_TYPE_CODE><![CDATA[' || :old.FOURTH_FOLLOWUP_TYPE_CODE || ']]></FOURTH_FOLLOWUP_TYPE_CODE>
        <GENERIC_FIELD_1><![CDATA[' || :old.GENERIC_FIELD_1 || ']]></GENERIC_FIELD_1>
        <GENERIC_FIELD_2><![CDATA[' || :old.GENERIC_FIELD_2 || ']]></GENERIC_FIELD_2>
        <GENERIC_FIELD_3><![CDATA[' || :old.GENERIC_FIELD_3 || ']]></GENERIC_FIELD_3>
        <GENERIC_FIELD_4><![CDATA[' || :old.GENERIC_FIELD_4 || ']]></GENERIC_FIELD_4>
        <GENERIC_FIELD_5><![CDATA[' || :old.GENERIC_FIELD_5 || ']]></GENERIC_FIELD_5>
        <GWF_ENRL_PACK_REQ><![CDATA[' || :old.GWF_ENRL_PACK_REQ || ']]></GWF_ENRL_PACK_REQ>
        <GWF_FIRST_FOLLOWUP_REQ><![CDATA[' || :old.GWF_FIRST_FOLLOWUP_REQ || ']]></GWF_FIRST_FOLLOWUP_REQ>
        <GWF_FOURTH_FOLLOWUP_REQ><![CDATA[' || :old.GWF_FOURTH_FOLLOWUP_REQ || ']]></GWF_FOURTH_FOLLOWUP_REQ>
        <GWF_REQUIRED_FEE_PAID><![CDATA[' || :old.GWF_REQUIRED_FEE_PAID || ']]></GWF_REQUIRED_FEE_PAID>
        <GWF_SECOND_FOLLOWUP_REQ><![CDATA[' || :old.GWF_SECOND_FOLLOWUP_REQ || ']]></GWF_SECOND_FOLLOWUP_REQ>
        <GWF_THIRD_FOLLOWUP_REQ><![CDATA[' || :old.GWF_THIRD_FOLLOWUP_REQ || ']]></GWF_THIRD_FOLLOWUP_REQ>
        <INSTANCE_STATUS><![CDATA[' || :old.INSTANCE_STATUS || ']]></INSTANCE_STATUS>
        <NEWBORN_FLG><![CDATA[' || :old.NEWBORN_FLG || ']]></NEWBORN_FLG>
        <PLAN_TYPE><![CDATA[' || :old.PLAN_TYPE || ']]></PLAN_TYPE>
        <PROGRAM_TYPE><![CDATA[' || :old.PROGRAM_TYPE || ']]></PROGRAM_TYPE>
        <SECOND_FOLLOWUP_ID>' || :old.SECOND_FOLLOWUP_ID || '</SECOND_FOLLOWUP_ID>
        <SECOND_FOLLOWUP_TYPE_CODE><![CDATA[' || :old.SECOND_FOLLOWUP_TYPE_CODE || ']]></SECOND_FOLLOWUP_TYPE_CODE>
        <SERVICE_AREA><![CDATA[' || :old.SERVICE_AREA || ']]></SERVICE_AREA>
        <SLCT_AUTO_PROC><![CDATA[' || :old.SLCT_AUTO_PROC || ']]></SLCT_AUTO_PROC>
        <SLCT_CREATE_BY_NAME><![CDATA[' || :old.SLCT_CREATE_BY_NAME || ']]></SLCT_CREATE_BY_NAME>
        <SLCT_CREATE_DT>' || to_char(:old.SLCT_CREATE_DT,BPM_COMMON.GET_DATE_FMT) || '</SLCT_CREATE_DT>
        <SLCT_LAST_UPDATE_BY_NAME><![CDATA[' || :old.SLCT_LAST_UPDATE_BY_NAME || ']]></SLCT_LAST_UPDATE_BY_NAME>
        <SLCT_LAST_UPDATE_DT>' || to_char(:old.SLCT_LAST_UPDATE_DT,BPM_COMMON.GET_DATE_FMT) || '</SLCT_LAST_UPDATE_DT>
        <SLCT_METHOD><![CDATA[' || :old.SLCT_METHOD || ']]></SLCT_METHOD>
		...
		<THIRD_FOLLOWUP_ID><![CDATA[' || :old.THIRD_FOLLOWUP_ID || ']]></THIRD_FOLLOWUP_ID>
        <THIRD_FOLLOWUP_TYPE_CODE><![CDATA[' || :old.THIRD_FOLLOWUP_TYPE_CODE || ']]></THIRD_FOLLOWUP_TYPE_CODE>
        <ZIP_CODE><![CDATA[' || :old.ZIP_CODE || ']]></ZIP_CODE>
     </ROW>
    </ROWSET>
    ';
