...
create or replace 
trigger TRG_AU_CORP_ETL_PROC_LETTERS_Q
...
begin
  ...
  */
  ...
  values (SEQ_BUEQ_ID.nextval,v_bsl_id,v_bil_id,:new.LETTER_REQUEST_ID,:new.STG_LAST_UPDATE_DATE,sysdate,v_data_version,xmltype(v_xml_string_old),xmltype(v_xml_string_new));
