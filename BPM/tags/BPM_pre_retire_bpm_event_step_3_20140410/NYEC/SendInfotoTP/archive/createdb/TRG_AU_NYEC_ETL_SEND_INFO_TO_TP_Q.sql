...
create or replace
trigger TRG_AU_NYEC_SEND_INFO_TO_TP_Q
  ...
  v_xml_string_old := 
    ...
    <ROWSET>  
      <ROW>
        ...
        <ASED_CREATE_NEW_CALL_REQ>' || to_char(:old.ASED_CREATE_NEW_CALL_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASED_CREATE_NEW_CALL_REQ>
        <ASED_CREATE_NEW_LETTER_REQ>' || to_char(:old.ASED_CREATE_NEW_LETTER_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASED_CREATE_NEW_LETTER_REQ>
        <ASED_CREATE_REFERRAL>' || to_char(:old.ASED_CREATE_REFERRAL,BPM_COMMON.GET_DATE_FMT) || '</ASED_CREATE_REFERRAL>
        <ASED_MAIL_LETTER_REQ>' || to_char(:old.ASED_MAIL_LETTER_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASED_MAIL_LETTER_REQ>
        <ASED_PERFORM_OUTBOUND_CALL>' || to_char(:old.ASED_PERFORM_OUTBOUND_CALL,BPM_COMMON.GET_DATE_FMT) || '</ASED_PERFORM_OUTBOUND_CALL>
        <ASED_PROCESS_IMAGE>' || to_char(:old.ASED_PROCESS_IMAGE,BPM_COMMON.GET_DATE_FMT) || '</ASED_PROCESS_IMAGE>
        <ASED_RECEIVE_INFO_REQ>' || to_char(:old.ASED_RECEIVE_INFO_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASED_RECEIVE_INFO_REQ>
        <ASF_CREATE_NEW_CALL_REQ><![CDATA[' || :old.ASF_CREATE_NEW_CALL_REQ || ']]></ASF_CREATE_NEW_CALL_REQ>
        <ASF_CREATE_NEW_LETTER_REQ><![CDATA[' || :old.ASF_CREATE_NEW_LETTER_REQ || ']]></ASF_CREATE_NEW_LETTER_REQ>
        <ASF_MAIL_LETTER_REQ><![CDATA[' || :old.ASF_MAIL_LETTER_REQ || ']]></ASF_MAIL_LETTER_REQ>
        <ASF_PERFORM_OUTBOUND_CALL><![CDATA[' || :old.ASF_PERFORM_OUTBOUND_CALL || ']]></ASF_PERFORM_OUTBOUND_CALL>
        <ASF_PROCESS_IMAGE><![CDATA[' || :old.ASF_PROCESS_IMAGE || ']]></ASF_PROCESS_IMAGE>
        <ASF_RECEIVE_INFO_REQ><![CDATA[' || :old.ASF_RECEIVE_INFO_REQ || ']]></ASF_RECEIVE_INFO_REQ>
        <ASPB_CREATE_NEW_CALL_REQ><![CDATA[' || :old.ASPB_CREATE_NEW_CALL_REQ || ']]></ASPB_CREATE_NEW_CALL_REQ>
        <ASPB_CREATE_REFERRAL><![CDATA[' || :old.ASPB_CREATE_REFERRAL || ']]></ASPB_CREATE_REFERRAL>
        <ASPB_MAIL_LETTER_REQUEST><![CDATA[' || :old.ASPB_MAIL_LETTER_REQUEST || ']]></ASPB_MAIL_LETTER_REQUEST>
        <ASPB_NEW_LETTER_REQ><![CDATA[' || :old.ASPB_NEW_LETTER_REQ || ']]></ASPB_NEW_LETTER_REQ>
        <ASPB_PERFORM_OUTBOUND_CALL><![CDATA[' || :old.ASPB_PERFORM_OUTBOUND_CALL || ']]></ASPB_PERFORM_OUTBOUND_CALL>
        <ASPB_PROCESS_IMAGE><![CDATA[' || :old.ASPB_PROCESS_IMAGE || ']]></ASPB_PROCESS_IMAGE>
        <ASPB_RECEIVE_INFO_REQUEST><![CDATA[' || :old.ASPB_RECEIVE_INFO_REQUEST || ']]></ASPB_RECEIVE_INFO_REQUEST>
        <ASSD_CREATE_NEW_CALL_REQ>' || to_char(:old.ASSD_CREATE_NEW_CALL_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASSD_CREATE_NEW_CALL_REQ>
        <ASSD_CREATE_NEW_LETTER_REQ>' || to_char(:old.ASSD_CREATE_NEW_LETTER_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASSD_CREATE_NEW_LETTER_REQ>
        <ASSD_CREATE_REFERRAL>' || to_char(:old.ASSD_CREATE_REFERRAL,BPM_COMMON.GET_DATE_FMT) || '</ASSD_CREATE_REFERRAL>
        <ASSD_MAIL_LETTER_REQ>' || to_char(:old.ASSD_MAIL_LETTER_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASSD_MAIL_LETTER_REQ>
        <ASSD_PERFORM_OUTBOUND_CALL>' || to_char(:old.ASSD_PERFORM_OUTBOUND_CALL,BPM_COMMON.GET_DATE_FMT) || '</ASSD_PERFORM_OUTBOUND_CALL>
        <ASSD_PROCESS_IMAGE>' || to_char(:old.ASSD_PROCESS_IMAGE,BPM_COMMON.GET_DATE_FMT) || '</ASSD_PROCESS_IMAGE>
        <ASSD_RECEIVE_INFO_REQ>' || to_char(:old.ASSD_RECEIVE_INFO_REQ,BPM_COMMON.GET_DATE_FMT) || '</ASSD_RECEIVE_INFO_REQ>
        <CALL_FLAG><![CDATA[' || :old.CALL_FLAG || ']]></CALL_FLAG>
        <CALL_RESULT><![CDATA[' || :old.CALL_RESULT || ']]></CALL_RESULT>
        <CALL_STATUS_DT>' || to_char(:old.CALL_STATUS_DT,BPM_COMMON.GET_DATE_FMT) || '</CALL_STATUS_DT>
        <CANCEL_DATE>' || to_char(:old.CANCEL_DATE,BPM_COMMON.GET_DATE_FMT) || '</CANCEL_DATE>
        <DISTRICT><![CDATA[' || :old.DISTRICT || ']]></DISTRICT>
        <GWF_LTR_MAILED><![CDATA[' || :old.GWF_LTR_MAILED || ']]></GWF_LTR_MAILED>
        <GWF_REQUEST_TYPE><![CDATA[' || :old.GWF_REQUEST_TYPE || ']]></GWF_REQUEST_TYPE>
        <GWF_RETRY_CALL><![CDATA[' || :old.GWF_RETRY_CALL || ']]></GWF_RETRY_CALL>
        <IEDR_ERROR_FLAG><![CDATA[' || :old.IEDR_ERROR_FLAG || ']]></IEDR_ERROR_FLAG>
        <INFO_REQ_CREATE_DT>' || to_char(:old.INFO_REQ_CREATE_DT,BPM_COMMON.GET_DATE_FMT) || '</INFO_REQ_CREATE_DT>
        <INFO_REQ_CYCLE_BUS_DAYS>' || :old.INFO_REQ_CYCLE_BUS_DAYS || '</INFO_REQ_CYCLE_BUS_DAYS>
        <INFO_REQ_CYCLE_END_DT>' || to_char(:old.INFO_REQ_CYCLE_END_DT,BPM_COMMON.GET_DATE_FMT) || '</INFO_REQ_CYCLE_END_DT>
        <INFO_REQ_CYCLE_START_DT>' || to_char(:old.INFO_REQ_CYCLE_START_DT,BPM_COMMON.GET_DATE_FMT) || '</INFO_REQ_CYCLE_START_DT>
        <INFO_REQ_GROUP><![CDATA[' || :old.INFO_REQ_GROUP || ']]></INFO_REQ_GROUP>
        <INFO_REQ_ID>' || :old.INFO_REQ_ID || '</INFO_REQ_ID>
        <INFO_REQ_SENT_DT>' || to_char(:old.INFO_REQ_SENT_DT,BPM_COMMON.GET_DATE_FMT) || '</INFO_REQ_SENT_DT>
        <INFO_REQ_SOURCE><![CDATA[' || :old.INFO_REQ_SOURCE || ']]></INFO_REQ_SOURCE>
        <INFO_REQ_STATUS><![CDATA[' || :old.INFO_REQ_STATUS || ']]></INFO_REQ_STATUS>
        <INFO_REQ_TYPE><![CDATA[' || :old.INFO_REQ_TYPE || ']]></INFO_REQ_TYPE>
        ...
        <LETTER_IMAGE_LINK_DT>' || to_char(:old.LETTER_IMAGE_LINK_DT,BPM_COMMON.GET_DATE_FMT) || '</LETTER_IMAGE_LINK_DT>
        <LETTER_REQ_DT>' || to_char(:old.LETTER_REQ_DT,BPM_COMMON.GET_DATE_FMT) || '</LETTER_REQ_DT>
        <LETTER_STATUS_DT>' || to_char(:old.LETTER_STATUS_DT,BPM_COMMON.GET_DATE_FMT) || '</LETTER_STATUS_DT>
        <MAN_LETTER_FLAG><![CDATA[' || :old.MAN_LETTER_FLAG || ']]></MAN_LETTER_FLAG>
        <NEW_CALL_REQ_ID>' || :old.NEW_CALL_REQ_ID || '</NEW_CALL_REQ_ID>
        <NEW_LTR_REQ_ID>' || :old.NEW_LTR_REQ_ID || '</NEW_LTR_REQ_ID>
        <SEND_IEDR_DT>' || to_char(:old.SEND_IEDR_DT,BPM_COMMON.GET_DATE_FMT) || '</SEND_IEDR_DT>
