...
CREATE OR REPLACE
PROCEDURE UPD_NYEC_PROCESS_APP_Q(
    p_bi_id      IN NUMBER,
...
ORDER BY bue_id ASC
  ...
  LOOP
    BEGIN
      ...
      v_string7:='<STG_LAST_UPDATE_DATE>'|| TO_CHAR(v_event_date,'YYYY-MM-DD HH24:MI:SS')||'</STG_LAST_UPDATE_DATE>'||chr(13);
      v_xml_string2 :=v_xml_string||v_string5||v_string6||v_string7||'    </ROW>'||chr(13)||'    </ROWSET>';
      INSERT
