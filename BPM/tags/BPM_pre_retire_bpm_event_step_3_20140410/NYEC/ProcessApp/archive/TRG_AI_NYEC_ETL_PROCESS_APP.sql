...
begin
  ...
  values
    ...
    :new.CREATE_DT,v_end_date,to_char(:new.CEPA_ID),v_current_date,v_current_date);
  ...
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,405,null,null,:new.CIN,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,406,null,:new.CIN_DT,null,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,407,null,null,:new.PROVIDER_NAME,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,409,null,null,:new.FPBP_TYPE,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,410,null,null,:new.REV_CLEAR_IND,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,411,null,:new.REV_CLEAR_IND_DT,null,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,412,null,null,:new.REV_CLEAR_OUTCOME,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,413,null,null,:new.UPSTATE_INDICATOR,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,414,null,:new.INVOICE_READY_DT,null,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,415,null,null,:new.HEART_INCMPLT_APP_IND,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,416,:new.DAYS_UNTIL_TIMEOUT,null,null,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,417,null,null,:new.WMS_REASON,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,418,null,null,:new.HEART_REPROCESS_STATUS,:new.CREATE_DT,v_max_date,v_bue_id);
  PRC_BPM_ETL_BIA_INS(SEQ_BIA_ID.nextval,v_bi_id,419,null,:new.HEART_REPROCESS_STATUS_DT,null,:new.CREATE_DT,v_max_date,v_bue_id);
