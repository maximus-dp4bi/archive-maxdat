...
$SCRIPTS_DIR/kitchen.sh -file="$CUSTOM_DIR/ProcessApplication/BPM_EVENT_TO_QUEUE_CONV_PROCESSAPP_30.kjb" -log="$LOG_DIR/BpmUpdateEventConv.log" -level="$LOG_LEVEL" 
