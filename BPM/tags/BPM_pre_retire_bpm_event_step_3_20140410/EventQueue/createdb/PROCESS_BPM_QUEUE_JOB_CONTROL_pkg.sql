...
create or replace package body PROCESS_BPM_QUEUE_JOB_CONTROL as
  ...
  begin
    ...
    BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_INFO,null,v_procedure_name,null,null,null,null,null,v_log_message,null);
  ...
  exception
    ...
    when OTHERS then
      ...
      BPM_COMMON.LOGGER
        (BPM_COMMON.LOG_LEVEL_SEVERE,null,v_procedure_name,null,null,null,null,null,v_log_message,v_sql_code);
      raise;
  ...
  begin
    if p_bdm_id = 1 then
      ...
      BPM_COMMON.LOGGER
       (BPM_COMMON.LOG_LEVEL_SEVERE,null,v_procedure_name,p_bsl_id,null,null,null,null,v_log_message,v_error_number);
  ...
  exception
    ...
    when OTHERS then
      ...
      v_log_message := SQLERRM;
      BPM_COMMON.LOGGER
        (BPM_COMMON.LOG_LEVEL_SEVERE,v_job_id,v_procedure_name,p_bsl_id,null,null,null,null,v_log_message,v_sql_code);
      raise;
  ...
  begin
    ...
    if v_num_jobs = 0 then 
      ...
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_WARNING,null,v_procedure_name,null,null,null,null,null,v_log_message,null);  
    else
      ...
      begin
        ...
        exception
          ...
          when NO_DATA_FOUND then
            ...
            BPM_COMMON.LOGGER
              (BPM_COMMON.LOG_LEVEL_WARNING,p_job_id,v_procedure_name,null,null,null,null,null,v_log_message,null);
            return;
  ...
  begin
    ...
    if v_job_id is null then 
      ...
      BPM_COMMON.LOGGER
        (BPM_COMMON.LOG_LEVEL_WARNING,v_job_id,v_procedure_name,null,null,null,null,null,v_log_message,null);
      return;
    end if;
  ...
  begin
    ...
    if (v_min_num_jobs is null or v_init_num_jobs is null or v_max_num_jobs is null or v_batch_size is null) then
      ...
      exception
        ...
        when OTHERS then
          v_sql_code := SQLCODE;
          v_log_message := SQLERRM;
          BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_WARNING,null,v_procedure_name,p_bsl_id,null,null,null,null,v_log_message,v_sql_code);
          raise;
    ...
    if v_min_num_jobs is null then
      ...
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_WARNING,null,v_procedure_name,p_bsl_id,null,null,null,null,v_log_message,null); 
      return;
    end if;
    ...
    if v_init_num_jobs is null then
      ...
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,null,v_procedure_name,p_bsl_id,null,null,null,null,v_log_message,null);    
      return;
    end if;
