...
alter index PBQJ_PK rebuild tablespace MAXDAT_INDX parallel;

create index PBQJ_IX1 on PROCESS_BPM_QUEUE_JOB (BSL_ID) tablespace MAXDAT_INDX parallel;
create index PBQJ_IX2 on PROCESS_BPM_QUEUE_JOB (STATUS) tablespace MAXDAT_INDX parallel;
create index PBQJ_UX1 on PROCESS_BPM_QUEUE_JOB (JOB_NAME) tablespace MAXDAT_INDX parallel;
