...
create or replace package MAIL_FAX_BATCH as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/BPM/Corp/MailFaxBatch/createdb/MAIL_FAX_BATCH_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 13699 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2015-02-18 13:41:28 -0800 (Wed, 18 Feb 2015) $'; 
