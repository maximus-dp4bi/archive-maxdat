...
alter table D_PI_INCIDENT_ABOUT add constraint DPIIA_PK primary key (DPIIA_ID) using index tablespace MAXDAT_INDX;
...
alter table D_PI_INCIDENT_REASON add constraint DPIIR_PK primary key (DPIIR_ID) using index tablespace MAXDAT_INDX;
...
alter table D_PI_INCIDENT_STATUS add constraint DPIISS_PK primary key (DPIISS_ID) using index tablespace MAXDAT_INDX;
...
alter table D_PI_LAST_UPDATE_BY add constraint DPILUB_PK primary key (DPIUB_ID) using index tablespace MAXDAT_INDX;
