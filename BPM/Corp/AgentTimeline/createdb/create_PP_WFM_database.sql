...
ALTER TABLE PP_WFM_TASK ADD CONSTRAINT TSK_STAFF_ID_FK FOREIGN KEY ( STAFF_ID ) REFERENCES PP_WFM_STAFF ( STAFF_ID ) NOT DEFERRABLE ;
ALTER TABLE PP_WFM_TASK ADD CONSTRAINT TSK_TASK_CATEGORY_ID_FK FOREIGN KEY ( TASK_CATEGORY_ID ) REFERENCES PP_WFM_TASK_CATEGORY ( TASK_CATEGORY_ID ) NOT DEFERRABLE ;
ALTER TABLE PP_WFM_SUPERVISOR ADD CONSTRAINT SUPERVISR_STAFF_ID_FK FOREIGN KEY ( STAFF_ID ) REFERENCES PP_WFM_STAFF ( STAFF_ID ) NOT DEFERRABLE ;
ALTER TABLE PP_WFM_SCHEDULE_MONITOR ADD CONSTRAINT SCHED_MON_STAFF_ID_FK FOREIGN KEY ( STAFF_ID ) REFERENCES PP_WFM_STAFF ( STAFF_ID ) NOT DEFERRABLE ;
