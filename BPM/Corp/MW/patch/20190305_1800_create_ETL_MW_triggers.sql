CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_AI_CORP_ETL_MW_Q" 
  ...
  v_xml_string_new :=
    ...
    <ROWSET>
      <ROW>
        ...
        <DOCUMENT_RECEIVED_DATE><![CDATA[' || to_char(:new.DOCUMENT_RECEIVED_DATE, BPM_COMMON.GET_DATE_FMT) || ']]></DOCUMENT_RECEIVED_DATE>        
      </ROW>
    </ROWSET>
    ';
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_AU_CORP_ETL_MW_Q" 
  ...
  v_xml_string_old :=
    ...
    <ROWSET>
      <ROW>
        ...
        <DOCUMENT_RECEIVED_DATE><![CDATA[' || to_char(:old.DOCUMENT_RECEIVED_DATE, BPM_COMMON.GET_DATE_FMT) || ']]></DOCUMENT_RECEIVED_DATE>                
    </ROW>
    </ROWSET>
    ';
