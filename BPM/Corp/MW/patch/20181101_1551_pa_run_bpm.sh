...
# Echo Environment Variables
echo "------------------------------------------------------------------------------"
echo "$STCODE_run_bpm run date/time: $(date +%Y%m%d_%H%M%S)"
echo "STCODE=$STCODE"
echo "MAXDAT_ETL_PATH=$MAXDAT_ETL_PATH"
echo "MAXDAT_ETL_LOGS=$MAXDAT_ETL_LOGS"
echo "ENV_CODE=$ENV_CODE"
echo "PENTAHO_JAVA_HOME=$PENTAHO_JAVA_HOME"
echo "MAXDAT_KETTLE_DIR=$MAXDAT_KETTLE_DIR"
echo "KETTLE_HOME=$KETTLE_HOME"
echo "KTR_LOG_LEVEL=$KTR_LOG_LEVEL"
echo "KJB_LOG_LEVEL=$KJB_LOG_LEVEL"
echo "INIT_OK=$INIT_OK"
echo "CHILD_FAIL=$CHILD_FAIL"
echo "PATH=$PATH"
#
#mail related variables
EMAIL="toddamccracken@maximus.com;RandallBKolb@maximus.com;SitaSathiraju@maximus.com;GuyDThibodeau@maximus.com;"
