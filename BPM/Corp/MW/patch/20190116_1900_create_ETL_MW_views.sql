...
with read only;
GRANT SELECT ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "MAXDAT_READ_ONLY";
GRANT SELECT ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_READ_ONLY";
GRANT DELETE ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_OLTP_SIUD";
GRANT INSERT ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_OLTP_SIUD";
GRANT SELECT ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_OLTP_SIUD";
GRANT UPDATE ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_OLTP_SIUD";
GRANT INSERT ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_OLTP_SIU";
GRANT SELECT ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_OLTP_SIU";
GRANT UPDATE ON "PA_IEB"."D_MW_TASK_INSTANCE_SV" TO "PA_IEB_OLTP_SIU";
