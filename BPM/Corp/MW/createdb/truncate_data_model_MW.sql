/*
Description:
This script is created to clean the semantic layer for a fresh reload of the MW (Manage Work v3) staging table.
...
-- Remove from queue.
delete from BPM_UPDATE_EVENT_QUEUE where BSL_ID = 2002;
...
truncate table D_MW_TASK_INSTANCE;
alter table F_MW_BY_DATE add constraint FMWBD_DMWCUR_FK foreign key (MW_BI_ID) references D_MW_TASK_INSTANCE (MW_BI_ID);
