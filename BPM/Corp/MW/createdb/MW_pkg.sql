create or replace package MW as
  ...
  */
  ...
  DCN                        varchar2(20),
  DOCUMENT_RECEIVED_DATE     varchar2(19)
    );
...
create or replace package body MW as
  ...
  begin
   ...
   select
        ...
        extractValue(p_data_xml,'/ROWSET/ROW/DOCUMENT_RECEIVED_DATE') "DOCUMENT_RECEIVED_DATE"        
    into p_data_record
    from dual;
  ...
  procedure SET_DMWCUR
      (p_set_type in varchar2,
       ...
       p_dcn in varchar2,
       p_document_received_date in varchar2
       )
  as
  ...
  r_dmwcur.DCN                           :=  p_DCN;
  r_dmwcur.DOCUMENT_RECEIVED_DATE        := to_date(p_DOCUMENT_RECEIVED_DATE, BPM_COMMON.DATE_FMT);
    ...
    begin
      ...
      SET_DMWCUR
        ('INSERT',
         ...
         v_new_data.DCN,
         v_new_data.DOCUMENT_RECEIVED_DATE
         );
