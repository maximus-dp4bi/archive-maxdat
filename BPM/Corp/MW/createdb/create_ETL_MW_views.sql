...
CREATE OR REPLACE FORCE VIEW D_BPM_PROCESS_INSTANCE_SV ("PROCESS_INSTANCE_ID", "PROCESS_ID", "PROCESS_NAME", "PROCESS_DESCRIPTION", "PARENT_PROCESS_ID", "PROCESS_START_DATE", "PROCESS_COMPLETE_DATE", "TIMELINESS_STATUS") AS 
  SELECT
    PROCESS_INSTANCE_ID
    , PROCESS_ID
    , PROCESS_NAME
    ...
    , TIMELINESS_STATUS
FROM D_BPM_PROCESS_INSTANCE
WITH read only;

GRANT SELECT ON D_BPM_PROCESS_INSTANCE_SV TO MAXDAT_READ_ONLY;
