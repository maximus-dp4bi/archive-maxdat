...
--dbms_output.put_line ('IN - UPD1_60 - task_histID :'||new_cur.step_instance_history_id||' NEW Owner: '||new_cur.owner_name||' Old : '||v_stage_upd_rec.owner_name) ;
  ...
  EXCEPTION
      WHEN OTHERS THEN
        ...
        VALUES 
         (sysdate, 'ABORT', 'MW_V2', 'CORP_ETL_MW_V2_PKG',err_code, err_msg, 
         err_code, err_msg, 'corp_etl_mw_v2_wip', v_stage_upd_rec.cemw_id, sysdate, sysdate);
        COMMIT;
      END;
