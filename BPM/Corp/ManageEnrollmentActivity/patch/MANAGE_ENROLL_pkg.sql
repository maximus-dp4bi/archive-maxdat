...
create or replace package maxdat.MANAGE_ENROLL as
 ...
 -- Do not edit these four SVN_* variable values.  They are populated when you commit code to SVN and used later to identify deployed code.
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/Corp/ManageEnrollmentActivity/createdb/MANAGE_ENROLL_pkg.sql $';
  SVN_REVISION varchar2(20) := '$Revision: 4395 $';
  SVN_REVISION_DATE varchar2(60) := '$Date: 2013-08-06 13:01:04 -0500 (Tue, 06 Aug 2013) $';
...
/*
procedure Calc_Semantic_Attr
\*
This procedure calculates the semantic layer attributes.
*\
    (
    p_new_data_xml               in xmltype,
p_AA_Timely_Stat         out D_ME_CURRENT.AUTO_ASSIGN_TIMELY_STATUS%type,
--p_AA_SLA_Days            out D_ME_CURRENT.AUTO_ASSIGN_SLA_DAYS%type,
--p_AA_SLA_Days_Type       out D_ME_CURRENT.AUTO_ASSIGN_SLA_DAYS_TYPE%type,
P_Enrl_Pkt_Timely_Stat   out D_ME_CURRENT.ENROLL_PACKET_TIMELY_STATUS%type,
--p_Enrl_Pkt_SLA_Days      out D_ME_CURRENT.ENROLL_PACKET_SLA_DAYS%type,
--p_Enrl_Pkt_SLA_Days_Type out D_ME_CURRENT.ENROLL_PACKET_SLA_DAYS_TYPE%type,
p_F_FU_Timely_Stat       out D_ME_CURRENT.FIRST_FOLLOWUP_TIMELY_STATUS%type,
--p_F_FU_SLA_Days          out D_ME_CURRENT.FIRST_FOLLOWUP_SLA_DAYS%type,
--p_F_FU_SLA_Days_Type     out D_ME_CURRENT.FIRST_FOLLOWUP_SLA_DAYS_TYPE%type,
p_S_FU_Timely_Stat       out D_ME_CURRENT.SECOND_FOLLOWUP_TIMELY_STATUS%type,
--p_S_FU_SLA_Days          out D_ME_CURRENT.SECOND_FOLLOWUP_SLA_DAYS%type,
--p_S_FU_SLA_Days_Type     out D_ME_CURRENT.SECOND_FOLLOWUP_SLA_DAYS_TYPE%type,
p_T_FU_Timely_Stat       out D_ME_CURRENT.THIRD_FOLLOWUP_TIMELY_STATUS%type,
--p_T_FU_SLA_Days          out D_ME_CURRENT.THIRD_FOLLOWUP_SLA_DAYS%type,
--p_T_FU_SLA_Days_Type     out D_ME_CURRENT.THIRD_FOLLOWUP_SLA_DAYS_TYPE%type,
p_FR_FU_Timely_Stat      out D_ME_CURRENT.FOURTH_FOLLOWUP_TIMELY_STATUS%type,
--p_FR_FU_SLA_Days         out D_ME_CURRENT.FOURTH_FOLLOWUP_SLA_DAYS%type,
--p_FR_FU_SLA_Days_Type    out D_ME_CURRENT.FOURTH_FOLLOWUP_SLA_DAYS_TYPE%type,
p_F_FU_Type              out D_ME_CURRENT.FIRST_FOLLOW_UP_TYPE%type,
p_S_FU_Type              out D_ME_CURRENT.SECOND_FOLLOW_UP_TYPE%type,
p_T_FU_Type              out D_ME_CURRENT.THIRD_FOLLOW_UP_TYPE%type,
p_FR_FU_Type             out D_ME_CURRENT.FOURTH_FOLLOW_UP_TYPE%type,
--p_Enrl_Fee_Rqrd          out D_ME_CURRENT.ENROLLMENT_FEE_REQUIRED%type,
p_Enrl_Activity_Outc     out D_ME_CURRENT.ENROLLMENT_ACTIVITY_OUTCOME%type
--p_Days_to_AA             out D_ME_CURRENT.DAYS_TO_AUTO_ASSIGNMENT%type
)
  as
    v_procedure_name varchar2(61) := $$PLSQL_UNIT || '.' || 'CALC_SEMANTIC_ATTR';
    v_sql_code number := null;
    v_log_message clob := null;
    v_new_data T_INS_ME_XML := null;

v_AA_Timely_Stat         D_ME_CURRENT.AUTO_ASSIGN_TIMELY_STATUS%type := null;
--v_AA_SLA_Days            D_ME_CURRENT.AUTO_ASSIGN_SLA_DAYS%type := null;
--v_AA_SLA_Days_Type       D_ME_CURRENT.AUTO_ASSIGN_SLA_DAYS_TYPE%type := null;
v_Enrl_Pkt_Timely_Stat   D_ME_CURRENT.ENROLL_PACKET_TIMELY_STATUS%type := null;
--v_Enrl_Pkt_SLA_Days      D_ME_CURRENT.ENROLL_PACKET_SLA_DAYS%type := null;
--v_Enrl_Pkt_SLA_Days_Type D_ME_CURRENT.ENROLL_PACKET_SLA_DAYS_TYPE%type := null;
v_F_FU_Timely_Stat       D_ME_CURRENT.FIRST_FOLLOWUP_TIMELY_STATUS%type := null;
--v_F_FU_SLA_Days          D_ME_CURRENT.FIRST_FOLLOWUP_SLA_DAYS%type := null;
--v_F_FU_SLA_Days_Type     D_ME_CURRENT.FIRST_FOLLOWUP_SLA_DAYS_TYPE%type := null;
v_S_FU_Timely_Stat       D_ME_CURRENT.SECOND_FOLLOWUP_TIMELY_STATUS%type := null;
--v_S_FU_SLA_Days          D_ME_CURRENT.SECOND_FOLLOWUP_SLA_DAYS%type := null;
--v_S_FU_SLA_Days_Type     D_ME_CURRENT.SECOND_FOLLOWUP_SLA_DAYS_TYPE%type := null;
v_T_FU_Timely_Stat       D_ME_CURRENT.THIRD_FOLLOWUP_TIMELY_STATUS%type := null;
--v_T_FU_SLA_Days          D_ME_CURRENT.THIRD_FOLLOWUP_SLA_DAYS%type := null;
--v_T_FU_SLA_Days_Type     D_ME_CURRENT.THIRD_FOLLOWUP_SLA_DAYS_TYPE%type := null;
v_FR_FU_Timely_Stat      D_ME_CURRENT.FOURTH_FOLLOWUP_TIMELY_STATUS%type := null;
--v_FR_FU_SLA_Days         D_ME_CURRENT.FOURTH_FOLLOWUP_SLA_DAYS%type := null;
--v_FR_FU_SLA_Days_Type    D_ME_CURRENT.FOURTH_FOLLOWUP_SLA_DAYS_TYPE%type := null;
v_F_FU_Type              D_ME_CURRENT.FIRST_FOLLOW_UP_TYPE%type := null;
v_S_FU_Type              D_ME_CURRENT.SECOND_FOLLOW_UP_TYPE%type := null;
v_T_FU_Type              D_ME_CURRENT.THIRD_FOLLOW_UP_TYPE%type := null;
v_FR_FU_Type             D_ME_CURRENT.FOURTH_FOLLOW_UP_TYPE%type := null;
--v_Enrl_Fee_Rqrd          D_ME_CURRENT.ENROLLMENT_FEE_REQUIRED%type := null;
v_Enrl_Activity_Outc     D_ME_CURRENT.ENROLLMENT_ACTIVITY_OUTCOME%type := null;
--v_Days_to_AA             D_ME_CURRENT.DAYS_TO_AUTO_ASSIGNMENT%type := null;

begin

    GET_INS_ME_XML(p_new_data_xml,v_new_data);

    --Auto Assign Timely Status
    select case when v_new_data.ASED_AUTO_ASSIGN is null then 'NA'
                when v_new_data.ASED_AUTO_ASSIGN is not null and v_new_data.AGE_IN_CALENDAR_DAYS <= v_new_data.ASED_AUTO_ASSIGN-v_new_data.CREATE_DT then 'Timely'
                when v_new_data.ASED_AUTO_ASSIGN is not null and v_new_data.AGE_IN_CALENDAR_DAYS > v_new_data.ASED_AUTO_ASSIGN-v_new_data.CREATE_DT then 'Untimely'
           end
      into v_AA_Timely_Stat
     from dual;
    p_AA_Timely_Stat := v_AA_Timely_Stat;

    --Enroll Packet Timely Status
    select case when v_new_data.ASED_SEND_ENROLL_PACKET is null then 'NA'
                when v_new_data.ASED_SEND_ENROLL_PACKET is not null and v_new_data.AGE_IN_CALENDAR_DAYS <= to_date(v_new_data.ASED_SEND_ENROLL_PACKET,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Timely'
                when v_new_data.ASED_SEND_ENROLL_PACKET is not null and v_new_data.AGE_IN_CALENDAR_DAYS > to_date(v_new_data.ASED_SEND_ENROLL_PACKET,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Untimely'
           end
      into v_Enrl_Pkt_Timely_Stat
     from dual;
    P_Enrl_Pkt_Timely_Stat := v_Enrl_Pkt_Timely_Stat;

    --First Follow-up Timely Status
    select case when v_new_data.ASED_FIRST_FOLLOWUP is null then 'NA'
                when v_new_data.ASED_FIRST_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS <= to_date(v_new_data.ASED_FIRST_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Timely'
                when v_new_data.ASED_FIRST_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS > to_date(v_new_data.ASED_FIRST_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Untimely'
           end
      into v_F_FU_Timely_Stat
     from dual;
     p_F_FU_Timely_Stat := v_F_FU_Timely_Stat;

     --Second Follow-up Timely Status
    select case when v_new_data.ASED_SECOND_FOLLOWUP is null then 'NA'
                when v_new_data.ASED_SECOND_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS <= to_date(v_new_data.ASED_SECOND_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Timely'
                when v_new_data.ASED_SECOND_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS > to_date(v_new_data.ASED_SECOND_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Untimely'
           end
      into v_S_FU_Timely_Stat
     from dual;
     p_S_FU_Timely_Stat := v_S_FU_Timely_Stat;

    --Third Follow-up Timely Status
    select case when v_new_data.ASED_THIRD_FOLLOWUP is null then 'NA'
                when v_new_data.ASED_THIRD_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS <= to_date(v_new_data.ASED_THIRD_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Timely'
                when v_new_data.ASED_THIRD_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS > to_date(v_new_data.ASED_THIRD_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Untimely'
           end
      into v_T_FU_Timely_Stat
     from dual;
    p_T_FU_Timely_Stat := v_T_FU_Timely_Stat;

    --Fourth Follow-up Timely Status
    select case when v_new_data.ASED_FOURTH_FOLLOWUP is null then 'NA'
                when v_new_data.ASED_FOURTH_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS <= to_date(v_new_data.ASED_FOURTH_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Timely'
                when v_new_data.ASED_FOURTH_FOLLOWUP is not null and v_new_data.AGE_IN_CALENDAR_DAYS > to_date(v_new_data.ASED_FOURTH_FOLLOWUP,BPM_COMMON.DATE_FMT) - to_date(v_new_data.CREATE_DT,BPM_COMMON.DATE_FMT) then 'Untimely'
           end
      into v_FR_FU_Timely_Stat
     from dual;
     p_FR_FU_Timely_Stat := v_FR_FU_Timely_Stat;

    --First Follow-up Type
    select case when v_new_data.FIRST_FOLLOWUP_TYPE_CODE is not null
                 then (select FU.FOLLOWUP_TYPE
                         from Rule_Lkup_Mng_Enrl_Followup FU
                         where FU.FOLLOWUP_TYPE_CODE = v_new_data.FIRST_FOLLOWUP_TYPE_CODE
                         )
                    else null end
      into v_F_FU_Type
      from dual;
    p_F_FU_Type := v_F_FU_Type;

    --Second Follow-up Type
    select case when v_new_data.SECOND_FOLLOWUP_TYPE_CODE is not null
                 then (select FU.FOLLOWUP_TYPE
                         from Rule_Lkup_Mng_Enrl_Followup FU
                         where FU.FOLLOWUP_TYPE_CODE = v_new_data.SECOND_FOLLOWUP_TYPE_CODE
                         )
                    else null end
      into v_S_FU_Type
      from dual;
    p_S_FU_Type := v_S_FU_Type;

    --Third Follow-up Type
    select case when v_new_data.THIRD_FOLLOWUP_TYPE_CODE is not null
                 then (select FU.FOLLOWUP_TYPE
                         from Rule_Lkup_Mng_Enrl_Followup FU
                         where FU.FOLLOWUP_TYPE_CODE = v_new_data.THIRD_FOLLOWUP_TYPE_CODE
                         )
                    else null end
      into v_T_FU_Type
      from dual;
    p_T_FU_Type := v_T_FU_Type;

    --Fourth Follow-up Type
    select case when v_new_data.FOURTH_FOLLOWUP_TYPE_CODE is not null
                 then (select FU.FOLLOWUP_TYPE
                         from Rule_Lkup_Mng_Enrl_Followup FU
                         where FU.FOLLOWUP_TYPE_CODE = v_new_data.FOURTH_FOLLOWUP_TYPE_CODE
                         )
                    else null end
      into v_FR_FU_Type
      from dual;
    p_FR_FU_Type := v_FR_FU_Type;

exception
when OTHERS then
          v_sql_code := SQLCODE;
          v_log_message := SQLERRM;
          BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE, null, v_procedure_name, v_bsl_id, v_bil_id, V_NEW_DATA.CLIENT_ENROLL_STATUS_ID, null, null, v_log_message, v_sql_code);
          raise;

end Calc_Semantic_Attr;
...
---
p_ASF_CANCEL_ENRL_ACTIVITY in	 corp_etl_manage_enroll.ASF_CANCEL_ENRL_ACTIVITY%type,
p_ASF_SEND_ENROLL_PACKET   in	 corp_etl_manage_enroll.ASF_SEND_ENROLL_PACKET%type,
p_ASF_SELECTION_RECD       in	 corp_etl_manage_enroll.ASF_SELECTION_RECD%type,
p_ASF_FIRST_FOLLOWUP       in	 corp_etl_manage_enroll.ASF_FIRST_FOLLOWUP%type,
p_ASF_SECOND_FOLLOWUP      in	 corp_etl_manage_enroll.ASF_SECOND_FOLLOWUP%type,
p_ASF_THIRD_FOLLOWUP       in	 corp_etl_manage_enroll.ASF_THIRD_FOLLOWUP%type,
p_ASF_FOURTH_FOLLOWUP      in	 corp_etl_manage_enroll.ASF_FOURTH_FOLLOWUP%type,
p_ASF_AUTO_ASSIGN          in	 corp_etl_manage_enroll.ASF_AUTO_ASSIGN%type,
p_ASF_WAIT_FOR_FEE         in	 corp_etl_manage_enroll.ASF_WAIT_FOR_FEE%type,

p_GWF_ENRL_PACK_REQ       in	 corp_etl_manage_enroll.GWF_ENRL_PACK_REQ%type,
p_GWF_FIRST_FOLLOWUP_REQ  in	 corp_etl_manage_enroll.GWF_FIRST_FOLLOWUP_REQ%type,
p_GWF_SECOND_FOLLOWUP_REQ in	 corp_etl_manage_enroll.GWF_SECOND_FOLLOWUP_REQ%type,
p_GWF_THIRD_FOLLOWUP_REQ  in	 corp_etl_manage_enroll.GWF_THIRD_FOLLOWUP_REQ%type,
p_GWF_FOURTH_FOLLOWUP_REQ in	 corp_etl_manage_enroll.GWF_FOURTH_FOLLOWUP_REQ%type,
p_GWF_REQUIRED_FEE_PAID   in	 corp_etl_manage_enroll.GWF_REQUIRED_FEE_PAID%type,
---
p_GENERIC_FIELD_1   in		 corp_etl_manage_enroll.GENERIC_FIELD_1%type,
p_GENERIC_FIELD_2   in		 corp_etl_manage_enroll.GENERIC_FIELD_2%type,
p_GENERIC_FIELD_3   in		 corp_etl_manage_enroll.GENERIC_FIELD_3%type,
p_GENERIC_FIELD_4   in		 corp_etl_manage_enroll.GENERIC_FIELD_4%type,
p_GENERIC_FIELD_5   in		 corp_etl_manage_enroll.GENERIC_FIELD_5%type,
---
...
r_dmecur.THIRD_FOLLOWUP_SLA_DAYS            :=  GET_SLA_DAYS('THIRD_FOLLOWUP', p_NEWBORN_FLG);
r_dmecur.THIRD_FOLLOWUP_SLA_DAYS_TYPE       :=  GET_SLA_DAYS_TYPE('THIRD_FOLLOWUP', p_NEWBORN_FLG);
r_dmecur.FOURTH_FOLLOWUP_SLA_DAYS           :=  GET_SLA_DAYS('FOURTH_FOLLOWUP', p_NEWBORN_FLG);
r_dmecur.FOURTH_FOLLOWUP_SLA_DAYS_TYPE      :=  GET_SLA_DAYS_TYPE('FOURTH_FOLLOWUP', p_NEWBORN_FLG);
...
r_dmecur.AUTO_ASSIGN_TIMELY_STATUS          :=  GET_TIMELY_STATUS(to_date(p_ASED_AUTO_ASSIGN,BPM_COMMON.DATE_FMT), to_date(p_CREATE_DT,BPM_COMMON.DATE_FMT),'AUTO_ASSIGNMENT', p_NEWBORN_FLG);
...
r_dmecur.THIRD_FOLLOWUP_TIMELY_STATUS       :=  GET_TIMELY_STATUS(to_date(p_ASED_THIRD_FOLLOWUP,BPM_COMMON.DATE_FMT),  to_date(p_CREATE_DT,BPM_COMMON.DATE_FMT),'THIRD_FOLLOWUP', p_NEWBORN_FLG);
r_dmecur.FOURTH_FOLLOWUP_TIMELY_STATUS      :=  GET_TIMELY_STATUS(to_date(p_ASED_FOURTH_FOLLOWUP,BPM_COMMON.DATE_FMT),  to_date(p_CREATE_DT,BPM_COMMON.DATE_FMT),'FOURTH_FOLLOWUP', p_NEWBORN_FLG);
...
r_dmecur.THIRD_FOLLOW_UP_TYPE               :=  GET_FOLLOWUP_TYPE(p_THIRD_FOLLOWUP_TYPE_CODE);
r_dmecur.FOURTH_FOLLOW_UP_TYPE              :=  GET_FOLLOWUP_TYPE(p_FOURTH_FOLLOWUP_TYPE_CODE);
...
v_new_data.ENROLL_FEE_AMNT_DUE,v_new_data.ENROLL_FEE_AMNT_PAID,v_new_data.ENROLL_FEE_PAID_DT,v_new_data.CHIP_HPC_ID,
