...
create  index DCMPLISD_IX1 on  D_COMPLAINT_CURRENT (INSTANCE_COMPLETE_DATE) online tablespace MAXDAT_INDX parallel compute statistics; 
...
create  index DCMPLIIA_IX1 on  D_COMPLAINT_CURRENT (CUR_INCIDENT_ABOUT) online tablespace MAXDAT_INDX parallel compute statistics; 
create  index DCMPLIR_IX1 on D_COMPLAINT_CURRENT (CUR_INCIDENT_REASON) online tablespace MAXDAT_INDX parallel compute statistics; 

create or replace public synonym D_COMPLAINT_CURRENT for D_COMPLAINT_CURRENT;
grant select on D_COMPLAINT_CURRENT to MAXDAT_READ_ONLY;

CREATE OR REPLACE FORCE VIEW "MAXDAT"."D_COMPLAINT_CURRENT_SV" ("CMPL_BI_ID", "CHANNEL", "CREATED_BY_GROUP", "CREATED_BY_NAME", "INCIDENT_ID", "INCIDENT_TRACKING_NUMBER", "CREATE_DATE", "ATMPT_TO_RES_INCIDENT_END", "ATMPT_TO_RES_INCIDENT_START", "ATMPT_TO_RES_INCIDENT_SUPV_END", "ATMPT_TO_RES_INCIDENT_SUPV_ST", "RESOLVE_INCIDENT_END", "RESOLVE_INCIDENT_START", "WITHDRAW_INCIDENT_END", "WITHDRAW_INCIDENT_START", "PERFORM_FOLLOWUP_ACTIONS_END", "PERFORM_FOLLOWUP_ACTIONS_START", "ABOUT_PLAN_CODE", "ABOUT_PROVIDER_ID", "CUR_ACTION_COMMENTS", "ACTION_TYPE", "CANCEL_BY", "CANCEL_DATE", "CANCEL_METHOD", "CANCEL_REASON", "CUR_CURRENT_TASK_ID", "DATA_ENTRY_TASK_ID", "FOLLOWUP_FLAG", "CUR_INCIDENT_ABOUT", "CUR_INCIDENT_DESCRIPTION", "CUR_INCIDENT_REASON", "CUR_INCIDENT_STATUS", "CUR_INCIDENT_STATUS_DATE", "INSTANCE_COMPLETE_DATE", "CUR_INSTANCE_STATUS", "CUR_LAST_UPDATE_BY_NAME", "CUR_LAST_UPDATE_DATE", "LAST_UPDATED_BY", "CLIENT_ID", "OTHER_PARTY_NAME", "PRIORITY", "REPORTED_BY", "REPORTER_RELATIONSHIP", "CUR_RESOLUTION_DESCRIPTION", "RESOLUTION_TYPE", "CASE_ID", "FORWARDED_FLAG", "INCIDENT_TYPE", "FORWARDED_TO", "SLA_DAYS_TYPE", "SLA_JEOPARDY_DATE", "SLA_JEOPARDY_DAYS", "SLA_TARGET_DAYS", "AGE_IN_BUSINESS_DAYS", "AGE_IN_CALENDAR_DAYS", "JEOPARDY_DAYS_TYPE", "JEOPARDY_FLAG", "TIMELINESS_STATUS", "INCIDENT_FWD_TIMELINESS_STATUS", "INCIDENT_FORWARDING_TARGET", "COMPLETE_DT", "FORWARD_DT", "CURRENT_STEP", "RECEIVED_DT", "PLAN_NAME", "REPORTER_NAME", "REPORTER_PHONE", "SLA_SATISFIED", "CREATED_BY_SUP", "CREATED_BY_EID", "CREATED_BY_SUP_NAME", "PROJECT_NAME") AS 
  SELECT "CMPL_BI_ID"
    , "CHANNEL"
    , "CREATED_BY_GROUP"
    , "CREATED_BY_NAME"
...
create or replace public synonym D_COMPLAINT_ACTION_COMMENTS for D_COMPLAINT_ACTION_COMMENTS;
...
create or replace public synonym D_COMPLAINT_ACTION_COMMENTS_SV for D_COMPLAINT_ACTION_COMMENTS_SV;
...
create or replace public synonym D_COMPLAINT_INCIDENT_ABOUT for D_COMPLAINT_INCIDENT_ABOUT;
...
create or replace public synonym D_COMPLAINT_INCIDENT_ABOUT_SV for D_COMPLAINT_INCIDENT_ABOUT_SV  ;
...
create or replace public synonym D_COMPLAINT_INCIDENT_DESC for D_COMPLAINT_INCIDENT_DESC;
...
create or replace public synonym D_COMPLAINT_INCIDENT_DESC_SV for D_COMPLAINT_INCIDENT_DESC_SV;
...
create or replace public synonym D_COMPLAINT_INCIDENT_REASON for D_COMPLAINT_INCIDENT_REASON;
...
create or replace public synonym D_COMPLAINT_INCIDENT_REASON_SV for D_COMPLAINT_INCIDENT_REASON_SV;
...
create or replace public synonym D_COMPLAINT_INCIDENT_STATUS for D_COMPLAINT_INCIDENT_STATUS;
...
create or replace public synonym D_COMPLAINT_INSTANCE_STATUS for D_COMPLAINT_INSTANCE_STATUS;
...
create or replace public synonym D_COMPLAINT_INSTANCE_STATUS_SV for D_COMPLAINT_INSTANCE_STATUS_SV;
...
create or replace public synonym D_COMPLAINT_RESOLUTION_DESC for D_COMPLAINT_RESOLUTION_DESC;
...
create or replace public synonym D_COMPLAINT_RESOLUTION_DESC_SV for D_COMPLAINT_RESOLUTION_DESC_SV;
...
create or replace public synonym F_COMPLAINT_BY_DATE for F_COMPLAINT_BY_DATE;
