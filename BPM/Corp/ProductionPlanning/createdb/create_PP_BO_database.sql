...
ALTER TABLE PP_BO_ACTUALS ADD CONSTRAINT EVENT_ID_FK FOREIGN KEY ( EVENT_ID ) REFERENCES PP_D_UOW_SOURCE_REF ( SOURCE_REF_ID ) NOT DEFERRABLE ;
...
ALTER TABLE PP_BO_TASK ADD CONSTRAINT TSK_EVENT_ID_FK FOREIGN KEY ( EVENT_ID ) REFERENCES PP_D_UOW_SOURCE_REF ( SOURCE_REF_ID ) NOT DEFERRABLE ;
...
ALTER TABLE PP_BO_SCHEDULE_MONITOR ADD CONSTRAINT SCHED_MON_EVENT_ID_FK FOREIGN KEY ( EVENT_ID ) REFERENCES PP_D_UOW_SOURCE_REF ( SOURCE_REF_ID ) NOT DEFERRABLE ;
