...
CREATE OR REPLACE VIEW F_TRANSMITTAL_DETAILS_ADHOC_SV AS 
...
grant select on F_TRANSMITTAL_DETAILS_ADHOC_SV to MAXDAT_MITRAN_OLTP_SIU;
grant select on F_TRANSMITTAL_DETAILS_ADHOC_SV to MAXDAT_MITRAN_OLTP_SIUD;
grant select on F_TRANSMITTAL_DETAILS_ADHOC_SV to MAXDAT_MITRAN_READ_ONLY;
