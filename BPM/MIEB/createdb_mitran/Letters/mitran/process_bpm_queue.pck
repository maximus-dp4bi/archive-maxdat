create or replace package PROCESS_BPM_QUEUE as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/BPM/EventQueue/createdb/PROCESS_BPM_QUEUE_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 15003 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2015-08-12 14:51:05 -0700 (Wed, 12 Aug 2015) $'; 
...
/
grant execute on PROCESS_BPM_QUEUE to MAXDAT_MIEB_PFP_E;
