CREATE OR REPLACE FORCE VIEW D_LETTER_TYPE_SV AS
...
grant select on D_LETTER_TYPE_SV to MAXDAT_MITRAN_OLTP_SIU;
grant select on D_LETTER_TYPE_SV to MAXDAT_MITRAN_OLTP_SIUD;
grant select on D_LETTER_TYPE_SV to MAXDAT_MITRAN_READ_ONLY;
