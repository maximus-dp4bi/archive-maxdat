create or replace package MAXDAT_ADMIN as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/BPM/Admin/createdb/MAXDAT_ADMIN_pkg.sql $';
  SVN_REVISION varchar2(20) := '$Revision: 14422 $';
  SVN_REVISION_DATE varchar2(60) := '$Date: 2015-06-02 15:15:32 -0700 (Tue, 02 Jun 2015) $';
...
/
grant execute on MAXDAT_ADMIN to MAXDAT_MIEB_PFP_E;
