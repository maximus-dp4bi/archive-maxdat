create or replace package SVN_REVISION_KEYWORD as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/BPM/Admin/createdb/SVN_REVISION_KEYWORD_pkg.sql $';
...
/
grant execute on SVN_REVISION_KEYWORD to MAXDAT_MIEB_PFP_E;
