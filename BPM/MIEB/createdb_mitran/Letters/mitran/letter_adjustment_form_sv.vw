CREATE OR REPLACE FORCE VIEW LETTER_ADJUSTMENT_FORM_SV AS
SELECT 
...
grant select on LETTER_ADJUSTMENT_FORM_SV to MAXDAT_MITRAN_OLTP_SIU;
grant select on LETTER_ADJUSTMENT_FORM_SV to MAXDAT_MITRAN_OLTP_SIUD;
grant select on LETTER_ADJUSTMENT_FORM_SV to MAXDAT_MITRAN_READ_ONLY;
