CREATE OR REPLACE FORCE VIEW D_PL_LETTER_DEFN_SV
AS
select f.*,
...
from (
SELECT NAME Letter_name, description, driver_type, effective_from_date, effective_thru_date
  ...
  GRANT SELECT ON MAXDAT_SUPPORT.D_PL_LETTER_DEFN_SV TO MAXDAT_REPORTS ;
