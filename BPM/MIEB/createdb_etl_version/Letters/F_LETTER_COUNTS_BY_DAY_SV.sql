/*create or replace view F_LETTER_COUNTS_BY_DAY_SV
 as
 select 1000000 LETTER_COUNT_BY_DAY_ID
, to_date('10/10/2020','mm/dd/yyyy') REPORT_DATE
,100177 LETTER_DEFINITION_ID
, null PROGRAM_CON_XWALK_CODE
,100 EB_MAILED_COUNT
,101 CON_CONFIRMED_COUNT
,-1 FORM_ADJUSTMENT_COUNT
,1 NOF_FORM_ADJUSTMENTS
,100 LETTER_COUNT_BY_TOTAL
from dual;

grant select on F_LETTER_COUNTS_BY_DAY_SV to MAXDAT_MIEB_READ_ONLY;
*/
