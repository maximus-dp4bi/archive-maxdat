...
grant select on CORP_ETL_CLEAN_TABLE to &role_name;
...
grant select on CORP_ETL_CLEAN_TABLE_HS to &role_name;
...
grant select on CORP_ETL_CONTROL to &role_name;
...
grant select on CORP_ETL_ERROR_LOG to &role_name;
...
grant select on CORP_ETL_JOB_STATISTICS to &role_name;
...
grant select on CORP_ETL_LIST_LKUP to &role_name; 
...
grant select on CORP_ETL_LIST_LKUP_HIST to &role_name;
...
grant select on CORP_INSTANCE_CLEANUP_TABLE to &role_name;
...
grant select on HOLIDAYS to &role_name; 