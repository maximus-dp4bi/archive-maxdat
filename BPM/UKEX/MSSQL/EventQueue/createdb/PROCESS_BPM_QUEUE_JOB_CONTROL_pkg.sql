...
create or replace package PROCESS_BPM_QUEUE_JOB_CONTROL as
  ...
  CONTROL_JOB_NAME varchar(30) = 'PROCESS_BPM_QUEUE_CONTROL';
  ...
  procedure CREATE_JOB
    (p_process_action in varchar,
     p_process_param in varchar);
     
  procedure CREATE_JOB
    (p_process_action in varchar,
     p_process_param in varchar,
     p_start_reason_id in varchar);
...
create or replace package body PROCESS_BPM_QUEUE_JOB_CONTROL as
  ...
  procedure CREATE_CALC_JOB
    (p_package_name in varchar,
     p_procedure_name in varchar)
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'CREATE_CALC_JOB';
    @v_log_message clob = null;
    @v_sql_code number = null;
    @v_job_action varchar(200) = null;
    @v_job_name varchar(30) = null;
  begin
  ...
  procedure CREATE_JOB
    (p_process_action in varchar,
     ...
     p_start_reason_id in varchar)
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'CREATE_JOB';
    @v_log_message clob = null;
    @v_sql_code number = null;
    @v_start_delay_seconds number = null;
    @v_job_id number = null;
    @v_job_name varchar(40) = null;
    @v_job_action varchar(200) = null;
  begin
  ...
  procedure CREATE_PROCESS_ALL_ROWS_BY_BSL
    (p_bsl_id in number,
     ...
     p_start_reason_id in number)
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'CREATE_PROCESS_ALL_ROWS_BY_BSL';
    @v_log_message clob = null;
    @v_error_number number = null;
    @v_sql_code number = null;
    @v_process_param varchar(200) = null;
    @v_data_model_name varchar(12) = null;
    @v_start_delay_seconds number = null;
    @v_job_id number = null;
    @v_job_name varchar(40) = null;
    @v_job_action varchar(200) = null;
  begin
    if p_bdm_id = 2 then
      ...
      RAISE_APPLICATION_ERROR(50023,v_log_message);
    end if;
  ...
  procedure STOP_JOB
    (p_job_name in varchar)
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'STOP_JOB';
    @v_log_message clob = null;
    @v_sql_code number = null;
  ...
  procedure STOP_JOB_BY_ID
    (p_job_id in number,
     p_stop_reason_id number)
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'STOP_JOB_BY_ID';
    @v_log_message clob = null;
    @v_stop_delay_seconds number = null;
    @v_job_name varchar(30) = null;
    @v_job_status varchar(10) = null;
    @v_num_jobs number = null;
  begin
  ...
  procedure STOP_JOB_BY_NAME
    (p_job_name in varchar,
     p_stop_reason_id number)
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'STOP_JOB_BY_NAME';
    @v_log_message clob = null;
    @v_stop_delay_seconds number = null;
    @v_job_id number;
  begin
  ...
  procedure ADJUST_NUM_OF_JOBS
    (p_bsl_id in number,
     p_bdm_id in number)
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'ADJUST_NUM_JOBS';
    @v_sql_code number = null;
    @v_log_message clob = null;
    ...
    @v_processing_enabled varchar(1) = null;
    ...
    @v_config_enabled varchar(1) = null;
  ...
  procedure CREATE_CONTROL_JOB
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'CREATE_CONTROL_JOB';
    @v_log_message clob = null;
    @v_sql_code number = null;
  begin
  ...
  procedure STARTUP_JOBS
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'START_JOBS';
    @v_log_message clob = null;
    @v_sql_code number = null;
  begin
    CREATE_CONTROL_JOB;
  ...
  procedure STOP_CONTROL_JOB
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'STOP_CONTROL_JOB';
    @v_log_message clob = null;
    @v_sql_code number = null;
  begin  
  ...
  procedure SHUTDOWN_JOBS
  as
    @v_procedure_name varchar(61) = OBJECT_NAME(@@PROCID) + '.' + 'SHUTDOWN_JOBS';
    @v_log_message clob = null;
    @v_sql_code number = null;
  begin
    STOP_CONTROL_JOB;
