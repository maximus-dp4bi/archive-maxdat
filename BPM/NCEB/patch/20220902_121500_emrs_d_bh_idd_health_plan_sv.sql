...
and ((st.selection_generic_field5_txt in ('MCS004','MCS005','MCS006','MCS007','MCS012','MCS027','MCS028','MCS031','MCS035','MCS036','MCS039','MCS045','MCS046','MCS049','MCS050')
        and st.status_date < TO_DATE('8/15/2022','MM/DD/YYYY'))
  or (ct.plan_service_type_cd != 'TLRPLN' and cs.subprogram_type like 'TP%' and st.status_date >= TO_DATE('8/15/2022','MM/DD/YYYY')) )
