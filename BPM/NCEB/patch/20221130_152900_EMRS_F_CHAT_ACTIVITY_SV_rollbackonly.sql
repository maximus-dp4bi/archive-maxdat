...
SELECT
    ...
    and cr.call_event_order = 1
    and cr.worker_username IS NOT NULL
-- UNION ALL
-- SELECT
...
-- WHERE D.D_DATE >= GREATEST(TO_DATE('3/01/2021','MM/DD/YYYY'), ADD_MONTHS(TRUNC(SYSDATE), -13))
