...
alter table MAXDAT_SUPPORT.CORP_ETL_LIST_LKUP
...
grant select,references on maxdat_support.CORP_ETL_LIST_LKUP to MAXDAT_REPORTS;
GRANT SELECT ON maxdat_support.CORP_ETL_LIST_LKUP TO MAXDATSUPPORT_READ_ONLY;
