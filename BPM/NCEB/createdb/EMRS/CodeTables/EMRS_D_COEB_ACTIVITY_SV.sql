create or replace view EMRS_D_COEB_ACTIVITY_SV as 
select activity_id
, substr(activity_type, 1, instr(activity_type,',')-1) activity_type
, substr(activity_type, instr(activity_type,',')+1) activity_label
from (
...
GRANT SELECT ON maxdat_support.EMRS_D_COEB_ACTIVITY_SV TO MAXDAT_REPORTS;
