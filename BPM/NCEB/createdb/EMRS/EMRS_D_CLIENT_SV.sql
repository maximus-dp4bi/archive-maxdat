...
AS
  ...
  FROM &schema_name..client cl  
  LEFT JOIN &schema_name..client cl2 ON (cl2.clnt_clnt_client_id = cl.clnt_client_id)
  LEFT JOIN &schema_name..other_health_care ohc ON (ohc.ohc_client_id = cl.clnt_client_id AND (ohc.ohc_end_date > SYSDATE OR ohc.ohc_end_date IS NULL));
