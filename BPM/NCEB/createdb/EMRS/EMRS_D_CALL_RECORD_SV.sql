...
LEFT JOIN EB.ENUM_MEDCHAT_TOPIC CHRSN ON UPPER(CHRSN.VALUE)=UPPER(TRIM(substr(CR.MEDCHAT_TOPIC,1,32)))
...
WHERE CA.ROWN = 1
AND CA.CALL_DATE >= GREATEST(TO_DATE('3/1/2021','MM/DD/YYYY'), ADD_MONTHS(TRUNC(SYSDATE,'MM'), COALESCE(-(ca.out_var),-13)));
