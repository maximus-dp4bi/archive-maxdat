...
AS
  ...
  FROM &schema_name..selection_txn st
  JOIN &schema_name..selection_missing_info smi              ON st.missing_info_id = smi.missing_info_id
  LEFT JOIN &schema_name..selection_missing_info_details smd ON smi.missing_info_id = smd.missing_info_id AND st.client_id = smd.client_id;
