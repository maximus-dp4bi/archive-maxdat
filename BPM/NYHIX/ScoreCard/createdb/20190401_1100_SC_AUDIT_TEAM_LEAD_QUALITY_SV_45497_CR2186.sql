...
( SELECT 
   ...
   nvl(QPP_QUALITY_SCORE_1_RATING,null) as QPP_QUALITY_SCORE_1_RATING, 
   nvl(QPP_QUALITY_SCORE_1_POINTS,0) as QPP_QUALITY_SCORE_1_POINTS, 
   nvl(QPP_QUALITY_SCORE_2_RATING,null) as QPP_QUALITY_SCORE_2_RATING, 
   nvl(QPP_QUALITY_SCORE_2_POINTS,0) as QPP_QUALITY_SCORE_2_POINTS,
   ---
   REVIEW_SESSIONS_COMPLTD_POINTS 
   +nvl(LIVE_OBSRV_COMPLTD_POINTS,0)
   +nvl(QPP_CHECKLIST_COMPLTD_POINTS,0) 
   +nvl(QPP_QUALITY_SCORE_1_POINTS,0) 
   +nvl(QPP_QUALITY_SCORE_2_POINTS,0) AS TOTAL_POINTS
   ---
...
ON  nvl(STAFF_REC.TOTAL_POINTS,0) 
