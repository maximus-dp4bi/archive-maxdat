...
create table dp_scorecard.sc_summary_cc_prod_wrk
as select * from dp_scorecard.sc_summary_cc_wrk
where 1=2;

grant select on dp_scorecard.sc_summary_cc_prod_wrk to maxdat;
grant select on dp_scorecard.sc_summary_cc_prod_wrk to maxdat_reports;
grant select on dp_scorecard.sc_summary_cc_prod_wrk to maxdat_read_only;
grant select on dp_scorecard.sc_summary_cc_prod_wrk to dp_scorecard_read_only;

create table dp_scorecard.sc_summary_cc_prod
as select * from dp_scorecard.sc_summary_cc
where 1=2;

grant select on dp_scorecard.sc_summary_cc_prod to maxdat;
grant select on dp_scorecard.sc_summary_cc_prod to maxdat_reports;
grant select on dp_scorecard.sc_summary_cc_prod to maxdat_read_only;
grant select on dp_scorecard.sc_summary_cc_prod to dp_scorecard_read_only;



create or replace procedure              LOAD_SC_SUMMARY_CC_prod
...
BEGIN
	...
	DELETE FROM DP_SCORECARD.SC_SUMMARY_CC_prod_WRK
	WHERE DATES_MONTH_NUM = LV_DATES_MONTH_NUM;

    COMMIT;

   INSERT INTO SC_SUMMARY_CC_prod_WRK (STAFF_STAFF_ID, STAFF_NATID,
	STAFF_STAFF_NAME,
	DATES_MONTH,
	DATES_MONTH_NUM,
	DATES_YEAR,
...
DELETE FROM DP_SCORECARD.SC_SUMMARY_CC_prod
WHERE DATES_MONTH_NUM = LV_DATES_MONTH_NUM;

COMMIT;

INSERT INTO DP_SCORECARD.SC_SUMMARY_CC_prod
(
    STAFF_STAFF_ID,
    STAFF_NATID,
	STAFF_STAFF_NAME,
...
FROM SC_SUMMARY_CC_prod_WRK SC_SUMMARY_CC_WRK
...
SELECT
	...
	0
FROM DP_SCORECARD.SC_SUMMARY_CC_prod_WRK  WRK
...
COMMIT;
	...
	UPDATE DP_SCORECARD.SC_SUMMARY_CC_prod
	SET CC_QIP_FLAG = 1
...
END LOAD_SC_SUMMARY_CC_prod;
/

show errors

grant execute on dp_scorecard.LOAD_SC_SUMMARY_CC_prod to maxdat;
grant execute on dp_scorecard.LOAD_SC_SUMMARY_CC_prod to maxdat_reports;
grant execute on dp_scorecard.LOAD_SC_SUMMARY_CC_prod to maxdat_read_only;
grant execute on dp_scorecard.LOAD_SC_SUMMARY_CC_prod to dp_scorecard_read_only;

exec LOAD_SC_SUMMARY_CC_prod();