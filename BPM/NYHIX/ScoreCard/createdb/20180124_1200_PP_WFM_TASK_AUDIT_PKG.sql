CREATE OR REPLACE PACKAGE DP_SCORECARD.PP_WFM_TASK_AUDIT_PKG AS
 ...
 PROCEDURE PP_WFM_TASK_BO_WRK_TRUNCATE(P_START_YYYYMM VARCHAR default NULL, P_END_YYYYMM VARCHAR default NULL);
 PROCEDURE PP_WFM_TASK_BO_WRK_MERGE(P_START_YYYYMM VARCHAR default NULL, P_END_YYYYMM VARCHAR default NULL);
