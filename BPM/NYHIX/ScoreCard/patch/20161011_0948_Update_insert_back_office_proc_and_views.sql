...
Grant execute on SCORECARD_PROD_BO_MTHLY_SV to MAXDAT_READ_ONLY;
Grant execute on SCORECARD_PROD_BO_MTHLY_SV to MAXDAT;
...
Grant select on SCORECARD_PROD_BO_SV to MAXDAT;
...
Grant select on SCORECARD_PROD_BO_MTHLY_SV to MAXDAT;
