...
select staff_id, end_date, case when scorecard_group = 'All Other Tasks' then 2 else 1 end, scorecard_group, 1, 'Total Logged', TOTAL_LOGGED
From
(
select  
  a11.STAFF_ID,
...
select staff_id, dates_month_num, dates_year, case when scorecard_group = 'All Other Tasks' then 2 else 1 end, scorecard_group, 1, 'Total Logged', TOTAL_LOGGED
From
(
select  
  a11.STAFF_ID,
