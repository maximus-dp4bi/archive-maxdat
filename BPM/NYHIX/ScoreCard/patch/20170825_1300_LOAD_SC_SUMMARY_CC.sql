...
--                  max(case when discussion_topic = 'Live Phone Observation' then 1 else 0 end ) as Live_Phone_Observation_flag dropped per CR 1653
...
--                    'Live Phone Observation'  -- dropped per CR 1653
