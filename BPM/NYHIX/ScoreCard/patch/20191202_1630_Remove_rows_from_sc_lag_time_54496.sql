...
BEGIN
  ...
  WHERE (AGENT_ID IN ('255763') AND TRUNC(LAG_DATE) in ('11-NOV-19')) OR(AGENT_ID IN ('148062') AND TRUNC(LAG_DATE) in ('21-NOV-19'));
  ...
  THEN
    ...
    DELETE FROM DP_SCORECARD.Sc_Lag_Time WHERE (AGENT_ID IN ('255763') AND TRUNC(LAG_DATE) in ('11-NOV-19')) OR(AGENT_ID IN ('148062') AND TRUNC(LAG_DATE) in ('21-NOV-19'));
  ...
  INTO   v_after_count FROM DP_SCORECARD.Sc_Lag_Time WHERE (AGENT_ID IN ('255763') AND TRUNC(LAG_DATE) in ('11-NOV-19')) OR(AGENT_ID IN ('148062') AND TRUNC(LAG_DATE) in ('21-NOV-19'));
