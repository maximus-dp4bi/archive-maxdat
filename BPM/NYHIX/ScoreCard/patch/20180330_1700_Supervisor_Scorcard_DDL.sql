...
GRANT SELECT ON DP_SCORECARD.SC_AUDIT_PAYROLL TO MAXDAT;

GRANT SELECT ON DP_SCORECARD.SC_AUDIT_PAYROLL TO MAXDAT_REPORTS;
...
GRANT SELECT ON DP_SCORECARD.SC_AUDIT_SCORECARD TO MAXDAT;

GRANT SELECT ON DP_SCORECARD.SC_AUDIT_SCORECARD TO MAXDAT_REPORTS;
...
CREATE OR REPLACE FORCE VIEW DP_SCORECARD.SC_AUDIT_HIERARCHY_JOB_LVLS_SV
(JOB_LVL, JOB_CODE, JOB_TITLE)
AS 
...
GRANT SELECT ON DP_SCORECARD.SC_AUDIT_HIERARCHY_JOB_LVLS_SV TO MAXDAT_RPORTS;
...
GRANT SELECT ON DP_SCORECARD.SC_AUDIT_SCORECARD_SV TO MAXDAT_RPORTS;
...
GRANT SELECT ON DP_SCORECARD.SC_AUDIT_SYSTEM_LKUP_SV TO MAXDAT_RPORTS;
...
(SEARCH_STAFF_ID, MANAGER_STAFF_ID, MANAGER_NAME, MANAGER_NATID, SUPERVISOR_STAFF_ID, 
 SUPERVISOR_NAME, STAFF_STAFF_ID, STAFF_STAFF_NAME, STAFF_NATID, GOAL_ID, 
 STAFF_ID, GOAL_ENTRY_DATE, GTL_ID, GOAL_DESCRIPTION, GOAL_DATE, 
 PROGRESS_NOTE, CREATE_BY, CREATE_DATETIME, LAST_UPDATED_BY, LAST_UPDATED_DATETIME)
AS 
select
...
(SEARCH_STAFF_ID, MANAGER_STAFF_ID, MANAGER_NAME, MANAGER_NATID, SUPERVISOR_STAFF_ID, 
 SUPERVISOR_NAME, STAFF_STAFF_ID, STAFF_STAFF_NAME, STAFF_NATID, PT_ID, 
 PT_ENTRY_DATE, DL_ID, DISCUSSION_TOPIC, COMMENTS, CREATE_BY, 
...
(SEARCH_STAFF_ID, MANAGER_STAFF_ID, MANAGER_NAME, MANAGER_NATID, SUPERVISOR_STAFF_ID, 
 SUPERVISOR_NAME, STAFF_STAFF_ID, STAFF_STAFF_NAME, STAFF_NATID, DATES, 
 CREATE_DATETIME, SC_ATTENDANCE_ID, INCENTIVE_FLAG, ABSENCE_TYPE)
AS 
