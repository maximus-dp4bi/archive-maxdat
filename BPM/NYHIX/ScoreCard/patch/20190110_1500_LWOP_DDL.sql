...
GRANT DELETE, INSERT, SELECT, UPDATE ON DP_SCORECARD.SC_AUDIT_LWOP_AUD TO MAXDAT;

GRANT SELECT ON DP_SCORECARD.SC_AUDIT_LWOP_AUD TO MAXDAT_READ_ONLY;

GRANT DELETE, INSERT, SELECT, UPDATE ON DP_SCORECARD.SC_AUDIT_LWOP_AUD TO MAXDAT_REPORTS;

GRANT SELECT ON DP_SCORECARD.SC_AUDIT_LWOP_AUD TO dp_scorecard_read_only;
...
CREATE INDEX DP_SCORECARD.LWOP_IDX ON DP_SCORECARD.SC_AUDIT_LWOP
