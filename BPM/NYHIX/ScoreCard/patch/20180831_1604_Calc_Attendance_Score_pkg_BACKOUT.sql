...
-- Do not edit these four SVN_* variable values.  They are populated when you commit code to SVN and used later to identify deployed code.
 	SVN_FILE_URL varchar2(200) := '$URL: svn://svn-staging.maximus.com/dev1d/maxdat/BPM/NYHIX/ScoreCard/patch/20180517_1500_Calc_Attendance_Score_PKG.SQL $';
  	SVN_REVISION varchar2(20) := '$Revision: 23544 $';
 	SVN_REVISION_DATE varchar2(60) := '$Date: 2018-05-30 17:20:54 -0400 (Wed, 30 May 2018) $';
