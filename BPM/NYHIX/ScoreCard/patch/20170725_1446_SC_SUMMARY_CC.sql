...
GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON DP_SCORECARD.SC_SUMMARY_CC TO MAXDAT;

GRANT SELECT ON DP_SCORECARD.SC_SUMMARY_CC TO MAXDAT_READ_ONLY;

GRANT REFERENCES, SELECT ON DP_SCORECARD.SC_SUMMARY_CC TO MAXDAT_REPORTS;
