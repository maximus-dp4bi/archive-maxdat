...
AS SELECT
               ...
               -- Modified for NYHIX-47593 QC count mismatch between Summary and QC tab
               S.staff_staff_id,
               S.staff_staff_name,
               S.staff_natid,
...
AND (TRUNC(CALL_DATE) >= TRUNC(ADD_MONTHS(SYSDATE, -12), 'MM') )         ;
  ...
  GRANT select on DP_SCORECARD.SCORECARD_QUALITY_SV to DP_SCORECARD; 
