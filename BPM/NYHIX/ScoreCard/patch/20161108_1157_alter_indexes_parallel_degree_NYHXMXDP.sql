...
*/
alter index BO_TASK_EVENT_ID_IDX parallel 4;
alter index BO_TASK_STAFF_ID_IDX parallel 4;
alter index BO_TASK_TASK_CATEGORY_ID_IDX parallel 4;
alter index BO_TASK_TASK_ID_IDX parallel 4;
alter index PP_WFM_TASK_BO_PK parallel 4;