...
-- Do not edit these four SVN_* variable values.  They are populated when you commit code to SVN and used later to identify deployed code.
	...
	PROCEDURE STEP4_LOAD_SC_PRDUCTION_BO_P41;
	PROCEDURE STEP4_LOAD_SC_PRDUCTION_BO_P42;
...
PROCEDURE LOAD_SC_PROD_AND_SMRY IS
	...
	BEGIN
		...
		STEP4_LOAD_SC_PRDUCTION_BO_P41;
		STEP4_LOAD_SC_PRDUCTION_BO_P42;
...
PROCEDURE STEP4_lOAD_SC_PRDUCTION_BO_P41 IS
...
PROCEDURE STEP4_LOAD_SC_PRDUCTION_BO_P42 IS
...
BEGIN
    ...
    FROM DP_SCORECARD.SC_PRODUCTION_BO
    WHERE DATES >= TO_DATE('20180401','YYYYMMDD')
    AND EVENT_NAME = 'Daily Adherence Detail'
    AND EVENT_SUBNAME =  'Adherence';
