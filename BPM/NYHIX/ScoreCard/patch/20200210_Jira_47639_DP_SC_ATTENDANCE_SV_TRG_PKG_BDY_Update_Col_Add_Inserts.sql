--------------------------------------------------------
--  DDL for Table SC_ATTENDANCE, DML for Table SCORECARD_DROP_DOWN_LKUP
--------------------------------------------------------
ALTER TABLE DP_SCORECARD.SC_ATTENDANCE
ADD WAIVE_POINT_CMNTS VARCHAR2(100) default NULL;
...
Insert into DP_SCORECARD.SCORECARD_DROP_DOWN_LKUP (TARGET_TABLE,TARGET_COLUMN,DROP_DOWN_ORDER,DROP_DOWN_VALUE,EFFECTIVE_DATE,END_DATE,DROP_DOWN_METRIC,DROP_DOWN_RANGE_LOW,DROP_DOWN_RANGE_HIGH) 
values ('SC_ATTENDANCE','WAIVE_POINT_CMNTS',1,'Severe Weather',to_date('01-JAN-17','DD-MON-RR'),null,null,null,null);
Insert into DP_SCORECARD.SCORECARD_DROP_DOWN_LKUP (TARGET_TABLE,TARGET_COLUMN,DROP_DOWN_ORDER,DROP_DOWN_VALUE,EFFECTIVE_DATE,END_DATE,DROP_DOWN_METRIC,DROP_DOWN_RANGE_LOW,DROP_DOWN_RANGE_HIGH) 
values ('SC_ATTENDANCE','WAIVE_POINT_CMNTS',2,'Traffic Incident',to_date('01-JAN-17','DD-MON-RR'),null,null,null,null);
Insert into DP_SCORECARD.SCORECARD_DROP_DOWN_LKUP (TARGET_TABLE,TARGET_COLUMN,DROP_DOWN_ORDER,DROP_DOWN_VALUE,EFFECTIVE_DATE,END_DATE,DROP_DOWN_METRIC,DROP_DOWN_RANGE_LOW,DROP_DOWN_RANGE_HIGH) 
values ('SC_ATTENDANCE','WAIVE_POINT_CMNTS',3,'Other',to_date('01-JAN-17','DD-MON-RR'),null,null,null,null);
Insert into DP_SCORECARD.SCORECARD_DROP_DOWN_LKUP (TARGET_TABLE,TARGET_COLUMN,DROP_DOWN_ORDER,DROP_DOWN_VALUE,EFFECTIVE_DATE,END_DATE,DROP_DOWN_METRIC,DROP_DOWN_RANGE_LOW,DROP_DOWN_RANGE_HIGH) 
values ('SC_ATTENDANCE','WAIVE_POINT_CMNTS',4,NULL,to_date('01-JAN-17','DD-MON-RR'),null,null,null,null);
...
--------------------------------------------------------
  ...
  "BALANCE", "INCENTIVE_BALANCE", "TOTAL_BALANCE", "INCENTIVE_FLAG", "SC_ATTENDANCE_ID", "CREATE_DATETIME", "CREATE_BY", "LAST_UPDATED_BY", "LAST_UPDATED_DATETIME", "WAIVE_POINT_CMNTS") AS 
  WITH STAFF AS
(
SELECT
       MANAGER_STAFF_ID,
...
SELECT
    ...
    CREATE_DATETIME, CREATE_BY, LAST_UPDATED_BY, LAST_UPDATED_DATETIME, WAIVE_POINT_CMNTS
FROM COMBINED   
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "DP_SCORECARD"."SCORECARD_SUPERVISOR_ATTND_SV" ("SEARCH_STAFF_ID", "MANAGER_STAFF_ID", "MANAGER_NAME", "MANAGER_NATID", "SUPERVISOR_STAFF_ID", "SUPERVISOR_NAME", "STAFF_STAFF_ID", "STAFF_STAFF_NAME", "STAFF_NATID", "DATES", "CREATE_DATETIME", "SC_ATTENDANCE_ID", "INCENTIVE_FLAG", "ABSENCE_TYPE", "WAIVE_POINT_CMNTS") AS 
...
IF UPDATING THEN
  ...
  IF    :old.SC_ATTENDANCE_ID      <> :new.SC_ATTENDANCE_ID
    ...
    or :old.WAIVE_POINT_CMNTS <> :new.WAIVE_POINT_CMNTS
  THEN
...
--	GV_HOLD_EOM_FLAG              	VARCHAR2(1 BYTE) := NULL;
	...
	SC_ATTEND_ENTRIES AS
		...
		SELECT
            ...
            SCA.WAIVE_POINT_CMNTS 					AS WAIVE_POINT_CMNTS
...
IS
    ...
    IF STAFF_REC.WAIVE_POINT_CMNTS IS NULL
    THEN
