...
grant debug on LOAD_SCORECARD_HIERARCHY to MAXDAT;

grant debug on LOAD_SCORECARD_HIERARCHY to MAXDAT_read_only;

grant debug on LOAD_SCORECARD_HIERARCHY to MAXDAT_reports;

grant execute on LOAD_SCORECARD_HIERARCHY to dp_scorecard_read_only;

grant debug on LOAD_SCORECARD_HIERARCHY to dp_scorecard_read_only;
