...
grant DEBUG on dp_scorecard.LOAD_SC_HIERARCHY_PKG TO MAXDAT_REPORTS;

grant DEBUG on dp_scorecard.LOAD_SC_HIERARCHY_PKG TO MAXDAT_READ_ONLY;

grant DEBUG on dp_scorecard.LOAD_SC_HIERARCHY_PKG TO DP_SCORECARD_READ_ONLY;
