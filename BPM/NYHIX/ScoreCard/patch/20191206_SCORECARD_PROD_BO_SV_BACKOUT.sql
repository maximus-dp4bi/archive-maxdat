-- PRODUCTION BACKOUT
  CREATE OR REPLACE FORCE EDITIONABLE VIEW DP_SCORECARD.SCORECARD_PROD_BO_SV 
  (STAFF_ID, STAFF_NATID, DATES, 
  EVENT_SORT_ID, EVENT_NAME, 
  TOTAL_LOGGED, ACTIVITY_TIME, ACTIVITY_TIME_IN_HHMMSS, TARGET, OPS_GROUP) AS 
  WITH
ADHERENCE AS
(
