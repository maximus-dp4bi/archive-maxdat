...
grant execute on Calc_Attendance_Score_PKG to MAXDAT;

grant execute on Calc_Attendance_Score_PKG to MAXDAT_READ_ONLY;

grant debug on Calc_Attendance_Score_PKG to DP_SCORECARD_PFP_READ_ONLY;

grant execute on Calc_Attendance_Score_PKG to DP_SCORECARD_READ_ONLY;