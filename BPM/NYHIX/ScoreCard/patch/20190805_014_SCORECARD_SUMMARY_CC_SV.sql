...
CREATE OR REPLACE FORCE EDITIONABLE VIEW DP_SCORECARD.SCORECARD_SUMMARY_CC_SV (STAFF_STAFF_ID, STAFF_STAFF_NAME, STAFF_NATID,
  DATES_MONTH, DATES_MONTH_NUM, DATES_YEAR, DATES_QTR_YEAR, EXCLUSION_FLAG, TOT_CALLS_ANSWERED, TOT_SHORT_CALLS_ANSWERED,
  ...
  TOT_TALK_TIME, TOT_WRAP_UP_TIME, TOT_LOGGED_IN_TIME, TOT_NOT_READY_TIME, TOT_BREAK_TIME, TOT_LUNCH_TIME, QCS_PERFORMED,
  AVG_QC_SCORE, TOT_INCIDENTS_COMPLETED, DAYS_INCIDENTS_COMPLETED, TOT_DEFECTS_COMPLETED, DAYS_DEFECTS_COMPLETED, TOT_CALL_RECORDS,
  TOT_CUSTOMER_COUNT, TOT_CALL_WRAP_UP_COUNT, TOT_WRAP_UP_ERROR, DAYS_SHORT_CALLS_GT_10, DAYS_CALLS_ANSWERED, BALANCE, TOTAL_BALANCE,
  ADHERENCE, CORRECTIVE_ACTION_FLAG, ONE_ON_ONE_FLAG, OBSERVATION_FLAG, RECORDED_CALL_REVIEW_FLAG, LIVE_PHONE_OBSERVATION_FLAG, 
  ADHERENCE_TOT_LOGGED_IN_TIME, ADHERENCE_TOT_NOT_READY_TIME, LAG_TIME_TOT_SCHED_PROD_TIME, DAYS_DEF_INC_COMPLETED, SUM_QC_SCORE,
  CALLS_OFFERED, WEBCHAT_ASSIGNED, WEBCHAT_TRANSFERRED, WEBCHAT_CONFERENCED, WEBCHAT_TOTAL_NUMBER, SHORT_CALLS_DISCONNECTED_BY_AGENT, 
  SHORT_CALLS_DISCONNECTED_BY_CONSUMER, CURRENT_MONTH_EVENTS_SCHEDULED, CURRENT_MONTH_EVENTS_MET, FIRST_PRIOR_MONTH_EVENTS_SCHEDULED, 
  FIRST_PRIOR_MONTH_EVENTS_MET, SECOND_PRIOR_MONTH_EVENTS_SCHEDULED, SECOND_PRIOR_MONTH_EVENTS_MET, 
  ...
  THREE_MONTH_CONFORMANCE_MISSED_COUNT, THREE_MONTH_AVG_ADHERENCE, THREE_MONTH_ADHERENCE_FLAG, 
  MONTHLY_CONFORMANCE_FLAG, CC_QIP_FLAG) AS 
  WITH
        ATTEND_Metrics
        AS
