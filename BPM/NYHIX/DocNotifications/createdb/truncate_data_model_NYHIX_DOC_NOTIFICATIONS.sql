...
truncate table D_NYHIX_MFDN_HISTORY;
alter table D_NYHIX_MFDN_HISTORY drop constraint DMFDNBD_NYHIX_MFDN_BI_ID_FK;

truncate table D_NYHIX_MFDN_CURRENT;
alter table D_NYHIX_MFDN_HISTORY add constraint DMFDNBD_NYHIX_MFDN_BI_ID_FK foreign key (NYHIX_MFDN_BI_ID) references D_NYHIX_MFDN_CURRENT (NYHIX_MFDN_BI_ID);
