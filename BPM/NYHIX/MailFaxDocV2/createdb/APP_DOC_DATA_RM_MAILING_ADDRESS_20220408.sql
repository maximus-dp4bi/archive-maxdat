...
CREATE TABLE MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS
(
  RM_MAILING_ADDRESS_ID  NUMBER,
  APP_DOC_TRACKER_ID     NUMBER,
  LMREQ_ID               NUMBER,
  ECN                    VARCHAR2(256 BYTE),
  FIRST_NAME             VARCHAR2(100 BYTE),
  LAST_NAME              VARCHAR2(100 BYTE),
  STREET_1               VARCHAR2(70 BYTE),
  STREET_2               VARCHAR2(55 BYTE),
  ...
  MAILING_REQ_IND        NUMBER,
  ERROR_MSG              VARCHAR2(2000 BYTE)
);

CREATE UNIQUE INDEX MAXDAT.PK_APP_DOC_DATA_RM_MAILING_ADDRESS_ID ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS
(RM_MAILING_ADDRESS_ID);

CREATE TABLE MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS_STG
(
  RM_MAILING_ADDRESS_ID  NUMBER,
  APP_DOC_TRACKER_ID     NUMBER,
  LMREQ_ID               NUMBER,
...
GRANT INSERT, SELECT, UPDATE ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS TO MAXDAT_OLTP_SIU;

GRANT INSERT, SELECT, UPDATE ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS_STG TO MAXDAT_OLTP_SIU;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS TO MAXDAT_OLTP_SIUD;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS_STG TO MAXDAT_OLTP_SIUD;

GRANT EXECUTE ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS_PKG TO MAXDAT_PFP_E;

GRANT DEBUG ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS_PKG TO MAXDAT_PFP_READ_ONLY;

GRANT SELECT ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS TO MAXDAT_READ_ONLY;

GRANT SELECT ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS_STG TO MAXDAT_READ_ONLY;

GRANT SELECT ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS TO MAXDAT_REPORTS;

GRANT SELECT ON MAXDAT.APP_DOC_DATA_RM_MAILING_ADDRESS_STG TO MAXDAT_REPORTS;
