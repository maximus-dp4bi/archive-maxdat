...
insert into PROCESS_BPM_CALC_JOB_CONFIG (PBCJC_ID,PACKAGE_NAME,PROCEDURE_NAME,PROCESS_ENABLED) values (SEQ_PBCJC_ID.nextval,'NYHIX_MAIL_FAX_DOC_V2','CALC_D_NYHIX_MF_CUR_V2','Y');
