...
begin
  ...
  <BATCH_ID><![CDATA[' ||:new.BATCH_ID|| ']]></BATCH_ID>		 
    ...
    <DOC_REPROCESSED_FLAG><![CDATA[' ||:new.DOC_REPROCESSED_FLAG|| ']]></DOC_REPROCESSED_FLAG>
    ...
    <ENV_REPROCESSED_FLAG><![CDATA[' ||:new.ENV_REPROCESSED_FLAG|| ']]></ENV_REPROCESSED_FLAG>
...
begin
  ...
  <BATCH_ID><![CDATA[' ||:old.BATCH_ID|| ']]></BATCH_ID>		 	
    ...
    <DOC_REPROCESSED_FLAG><![CDATA[' ||:old.DOC_REPROCESSED_FLAG|| ']]></DOC_REPROCESSED_FLAG>
    ...
    <ENV_REPROCESSED_FLAG><![CDATA[' ||:old.ENV_REPROCESSED_FLAG|| ']]></ENV_REPROCESSED_FLAG>
...
select
  ...
  extractValue(p_data_xml,'/ROWSET/ROW/DOC_REPROCESSED_FLAG')"DOC_REPROCESSED_FLAG",
  ...
  extractValue(p_data_xml,'/ROWSET/ROW/ENV_REPROCESSED_FLAG')"ENV_REPROCESSED_FLAG",
...
procedure SET_D_NYHIX_MF_CUR_V2
  (p_set_type in varchar2,
   ...
   p_dcn in varchar2,
   p_doc_reprocessed_flag in varchar2,
   ...
   p_env_reprocessed_flag in varchar2,
   p_env_status in varchar2,
 ...
 as
  ...
  begin
    ...
    r_d_nyhix_mdf_cur_v2.DOC_REPROCESSED_FLAG:= p_doc_reprocessed_flag;
    ...
    r_d_nyhix_mdf_cur_v2.ENV_REPROCESSED_FLAG:= p_env_reprocessed_flag;
...
begin
 ...
 SET_D_NYHIX_MF_CUR_V2
  ('INSERT',
   ...
   v_new_data.DCN,
   v_new_data.DOC_REPROCESSED_FLAG,
   ...
   v_new_data.ENV_REPROCESSED_FLAG,
