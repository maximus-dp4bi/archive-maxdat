...
AS
  SELECT
    ...
    TRASHED_DT,
    CASE
      WHEN LENGTH(S4.LAST_NAME || ', ' || S4.FIRST_NAME) > 2  THEN S4.LAST_NAME || ', '  || S4.FIRST_NAME
      WHEN LENGTH(E4.LAST_NAME || ', ' || E4.FIRST_NAME) > 2  THEN E4.LAST_NAME || ', '  || E4.FIRST_NAME
      ELSE C.ENV_UPDATED_BY
  ...
  LEFT JOIN STAFF_STG S4  ON    cast(S4.STAFF_ID as Char(8)) = cast(C.TRASHED_BY as Char(8))
  ...
  LEFT JOIN STAFF_STG E4  ON    E4.EXT_STAFF_NUMBER = C.TRASHED_BY;
