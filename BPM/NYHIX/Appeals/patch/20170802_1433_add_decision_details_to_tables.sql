ALTER TABLE NYHBE_ETL_PROCESS_APPEALS ADD (DECISION_DETAILS VARCHAR2(30) DEFAULT NULL);
ALTER TABLE NYHBE_PROCESS_APPEALS_WIP_BPM ADD (DECISION_DETAILS VARCHAR2(30) DEFAULT NULL);
ALTER TABLE NYHBE_PROCESS_APPEALS_OLTP ADD (DECISION_DETAILS VARCHAR2(30) DEFAULT NULL);
ALTER TABLE D_APPEALS_CURRENT ADD (DECISION_DETAILS VARCHAR2(30) DEFAULT NULL);
...
grant select on D_APPEALS_CURRENT_SV to DP_SCORECARD;
