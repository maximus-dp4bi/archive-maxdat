...
where batch_name = 'NYSOH_FAX-NavCAC2019-10-16-22-00-03-765';
...
WHERE  dcn IN ('18598171','18598172');

update NYHIX_ETL_MAIL_FAX_DOC_V2 
set CANCEL_DT  = to_date('10/29/2019', 'mm/dd/yyyy') ,
CANCEL_BY = 'NYHIX-53645' ,
ASF_CANCEL_DOC = 'Y' ,
