...
where batch_name = 'NYSOH_FAX-9/15/2019-3:30:45 AM';
...
WHERE  dcn IN ('18510827','18510826');

update NYHIX_ETL_MAIL_FAX_DOC_V2 
set CANCEL_DT  = to_date('09/25/2019', 'mm/dd/yyyy') ,
CANCEL_BY = 'NYHIX-52858' ,
ASF_CANCEL_DOC = 'Y' ,
CANCEL_REASON = 'Inactivated' ,
CANCEL_METHOD = 'Exception' ,
INSTANCE_STATUS = 'Complete' ,
INSTANCE_END_DATE = to_date('09/25/2019', 'mm/dd/yyyy'), 
STG_DONE_DATE = to_date('09/25/2019', 'mm/dd/yyyy')
where dcn IN ('18510827','18510826');
