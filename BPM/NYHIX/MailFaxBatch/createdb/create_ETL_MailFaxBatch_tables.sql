...
create table CORP_ETL_MFB_BATCH_OLTP(
  ...
  ASPB_VALIDATE_DATA_USER_ID varchar2(32) NULL,  
  VALIDATION_DT DATE NULL,
...
comment on column CORP_ETL_MFB_BATCH_OLTP.ASPB_VALIDATE_DATA_USER_ID is 'National ID of the staff member who completed the Verify Results activity step.';
...
comment on column CORP_ETL_MFB_BATCH_STG.ASPB_VALIDATE_DATA_USER_ID is 'National ID of the staff member who completed the Verify Results activity step.';
...
comment on column CORP_ETL_MFB_BATCH_WIP.ASPB_VALIDATE_DATA_USER_ID is 'National ID of the staff member who completed the Verify Results activity step.';
...
comment on column CORP_ETL_MFB_BATCH.ASPB_VALIDATE_DATA_USER_ID is 'National ID of the staff member who completed the Verify Results activity step.';
