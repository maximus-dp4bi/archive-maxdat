...
procedure SET_D_NYHIX_MF_CUR
  ...
  r_d_nyhix_mdf_cur.INSTANCE_START_DATE := to_date(p_instance_start_date,BPM_COMMON.DATE_FMT);
  r_d_nyhix_mdf_cur.INSTANCE_END_DATE := to_date(p_instance_end_date,BPM_COMMON.DATE_FMT);
