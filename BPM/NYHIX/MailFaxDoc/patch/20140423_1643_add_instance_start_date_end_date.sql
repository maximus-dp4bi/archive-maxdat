alter table nyhix_etl_mail_fax_doc add (INSTANCE_START_DATE date, INSTANCE_END_DATE date);
alter table nyhix_etl_mail_fax_doc_oltp add (INSTANCE_START_DATE date, INSTANCE_END_DATE date);
alter table nyhix_etl_mail_fax_doc_wip_bpm add (INSTANCE_START_DATE date, INSTANCE_END_DATE date);

alter table d_nyhix_mfd_current add (INSTANCE_START_DATE date, INSTANCE_END_DATE date);
