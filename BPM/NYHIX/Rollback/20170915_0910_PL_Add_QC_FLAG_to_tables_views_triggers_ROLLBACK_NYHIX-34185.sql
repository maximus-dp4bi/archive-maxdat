--Rollback script for NYHIX-34185
Alter table corp_etl_proc_letters drop column (QC_FLAG);
Alter table corp_etl_proc_letters_oltp drop column (QC_FLAG);
Alter table corp_etl_proc_letters_wip_bpm drop column (QC_FLAG);
Alter table d_pl_current drop column (QC_FLAG);
