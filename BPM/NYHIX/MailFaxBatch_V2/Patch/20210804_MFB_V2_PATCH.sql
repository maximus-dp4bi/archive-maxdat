ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_LAUNCH_OLTP MODIFY END_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_LAUNCH_OLTP MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_LAUNCH_OLTP MODIFY START_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_LAUNCH_OLTP_ERR MODIFY END_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_LAUNCH_OLTP_ERR MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_LAUNCH_OLTP_ERR MODIFY START_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_OLTP MODIFY END_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_OLTP MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_OLTP MODIFY START_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_OLTP_ERR MODIFY END_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_OLTP_ERR MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_MODULE_OLTP_ERR MODIFY START_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_OLTP MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_OLTP MODIFY SBM_START_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_OLTP_ERR MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_BATCH_OLTP_ERR MODIFY SBM_START_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_FORM_TYPE_OLTP MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
ALTER TABLE MAXDAT.NYHIX_MFB_V2_STATS_FORM_TYPE_OLTP_ERR MODIFY OLTP_LOAD_DATE_TIME VARCHAR2(40);
...
Insert into MAXDAT.CORP_ETL_CONTROL (NAME,VALUE_TYPE,VALUE,DESCRIPTION,CREATED_TS,UPDATED_TS) values ('MFB_V2_CENTRAL_LAST_UPDATE_DATE','D','01-JAN-21','This is the date of the last ProcessMailFaxBatch Central database run.',to_date('01-JUN-21','DD-MON-RR'),to_date('14-JUL-21','DD-MON-RR'));
Insert into MAXDAT.CORP_ETL_CONTROL (NAME,VALUE_TYPE,VALUE,DESCRIPTION,CREATED_TS,UPDATED_TS) values ('MFB_V2_REMOTE_LAST_UPDATE_DATE','D','01-JAN-21','This is the date of the last ProcessMailFaxBatch Remote database run.',to_date('01-JUN-21','DD-MON-RR'),to_date('14-JUL-21','DD-MON-RR'));
