...
ALTER TABLE MAXDAT.NYHIX_MFB_V2_GUID_RUN_LIST
 ADD (BATCH_SUMMARY_JOB_ID  NUMBER);
...
-----------------------------------------------------------------------------
GV_SRC_REC_SUMMARY.BATCH_DELETED 	:= NULL;
GV_SRC_REC_SUMMARY.INSTANCE_STATUS	:= 'Active';

-- These event records are at the end of ever EVENT
-- to signify that the batch is no longer in KOFAX.
-- The record mus be to be skipped to avoid 
