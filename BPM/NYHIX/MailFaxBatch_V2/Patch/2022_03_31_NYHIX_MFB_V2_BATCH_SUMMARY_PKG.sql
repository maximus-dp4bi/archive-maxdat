...
Procedure Extract_Batch_Event(P_SOURCE_SERVER VARCHAR DEFAULT 'CENTRAL', P_BATCH_GUID varchar default null) IS
	...
	BEGIN
		...
		LOOP  -- FOR EACH EVENT for each Source_Server and Batch_Guid
		...
		FETCH BATCH_EVENT_CSR
			...
			-- Apparently a batch can be "Exported' in error.  So this test is 
			-- No good
			...
			-- and incorrect setting of the Instance_status
...
--				GV_SRC_REC_EVENT.MODULENAME = 'Batch Manager'
			...
			-- AND  GV_SRC_REC_SUMMARY.INSTANCE_STATUS = 'Active'
			THEN
			...
			-----------------------------------------------------------------------------
            -- If there is an EVENT record AFTER any of the above
            -- RESET the DATES and the STATUS 
