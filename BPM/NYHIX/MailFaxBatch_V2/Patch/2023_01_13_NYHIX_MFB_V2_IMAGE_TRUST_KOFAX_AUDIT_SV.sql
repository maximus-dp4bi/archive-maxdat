...
/* Formatted on 12/30/2022 11:52:15 AM (QP5 v5.374) */
...
--                    ITSB.BATCH_DESCRIPTION
 --                       AS IMAGE_TRUST_BATCH_DESCRIPTION,
 --                   ITSB.USER_NAME
 --                       AS IMAGE_TRUST_USER_NAME
               ...
               CASE                                            -- FIX JAN 2023
                   WHEN     IT_LAST_MODULE.queue = 'Export'    -- FIX JAN 2023
                        AND IT_LAST_MODULE.REASON              -- FIX JAN 2023
                                                  IN
                                ('EXPORT', 'BATCH_CLEANUP?')   -- FIX JAN 2023
                        AND IT_LAST_MODULE.QUEUE_MODE = 'READY' -- FIX JAN 2023
                   THEN
                       IT_LAST_MODULE.END_DATE                 -- FIX JAN 2023
                   ELSE
                       SYSDATE
               END                                             -- FIX JAN 2023
