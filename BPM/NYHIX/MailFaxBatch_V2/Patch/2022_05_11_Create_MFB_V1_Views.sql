...
CREATE OR REPLACE FORCE VIEW MAXDAT.D_MFB_V1_BATCH_EVENTS_CURMOD_SV
(
...
/* Formatted on 5/9/2022 12:20:58 PM (QP5 v5.374) */
CREATE OR REPLACE FORCE VIEW MAXDAT.D_MFB_V1_BATCH_EVENTS_CURRENT_SV
(
    BATCH_MODULE_ID,
    BATCH_GUID,
    MODULE_LAUNCH_ID,
...
/* Formatted on 5/9/2022 12:20:58 PM (QP5 v5.374) */
CREATE OR REPLACE FORCE VIEW MAXDAT.D_MFB_V1_CURRENT_MFD_DCN_SV
(
    NYHIX_MFD_BI_ID,
    MFB_BI_ID
)
...
/* Formatted on 5/9/2022 12:20:58 PM (QP5 v5.374) */
CREATE OR REPLACE FORCE VIEW MAXDAT.D_MFB_V1_CURRENT_SV
(
    MFB_BI_ID,
    BATCH_GUID,
    BATCH_ID,
...
/* Formatted on 5/9/2022 12:20:58 PM (QP5 v5.374) */
CREATE OR REPLACE FORCE VIEW MAXDAT.D_MFB_V1_DOC_CURRENT_SV
(
    ECN,
    BATCH_GUID,
    DOCUMENT_ID,
...
/* Formatted on 5/9/2022 12:20:58 PM (QP5 v5.374) */
CREATE OR REPLACE FORCE VIEW MAXDAT.F_MFB_V1_BY_BATCH_GROUP_BY_DAY_SV
(
    D_DATE,
    WEEKEND_FLAG,
    BATCH_GROUP,
...
/* Formatted on 5/9/2022 12:20:58 PM (QP5 v5.374) */
CREATE OR REPLACE FORCE VIEW MAXDAT.F_MFB_V1_BY_HOUR_SV
(
    FMFBBH_ID,
    D_DATE_HOUR,
    MFB_BI_ID,
...
GRANT INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_BATCH_EVENTS_CURMOD_SV TO MAXDAT_OLTP_SIU;

GRANT INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_BATCH_EVENTS_CURRENT_SV TO MAXDAT_OLTP_SIU;

GRANT INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_CURRENT_MFD_DCN_SV TO MAXDAT_OLTP_SIU;

GRANT INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_CURRENT_SV TO MAXDAT_OLTP_SIU;

GRANT INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_DOC_CURRENT_SV TO MAXDAT_OLTP_SIU;

GRANT INSERT, SELECT, UPDATE ON MAXDAT.F_MFB_V1_BY_HOUR_SV TO MAXDAT_OLTP_SIU;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_BATCH_EVENTS_CURMOD_SV TO MAXDAT_OLTP_SIUD;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_BATCH_EVENTS_CURRENT_SV TO MAXDAT_OLTP_SIUD;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_CURRENT_MFD_DCN_SV TO MAXDAT_OLTP_SIUD;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_CURRENT_SV TO MAXDAT_OLTP_SIUD;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.D_MFB_V1_DOC_CURRENT_SV TO MAXDAT_OLTP_SIUD;

GRANT DELETE, INSERT, SELECT, UPDATE ON MAXDAT.F_MFB_V1_BY_HOUR_SV TO MAXDAT_OLTP_SIUD;

GRANT SELECT ON MAXDAT.D_MFB_V1_BATCH_EVENTS_CURMOD_SV TO MAXDAT_READ_ONLY;

GRANT SELECT ON MAXDAT.D_MFB_V1_BATCH_EVENTS_CURRENT_SV TO MAXDAT_READ_ONLY;

GRANT SELECT ON MAXDAT.D_MFB_V1_CURRENT_MFD_DCN_SV TO MAXDAT_READ_ONLY;

GRANT SELECT ON MAXDAT.D_MFB_V1_CURRENT_SV TO MAXDAT_READ_ONLY;

GRANT SELECT ON MAXDAT.D_MFB_V1_DOC_CURRENT_SV TO MAXDAT_READ_ONLY;

GRANT SELECT ON MAXDAT.F_MFB_V1_BY_HOUR_SV TO MAXDAT_READ_ONLY;
