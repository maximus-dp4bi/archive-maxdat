...
values (103336,'Call Center Supervisor Team','Created for MAXDat NYHIX-19948. Manually adding and delete after queue procesing.');
commit;
...
--Wait for rows to process through queue and be loaded into the D_MW_V2_HISTORY Table
--*********
