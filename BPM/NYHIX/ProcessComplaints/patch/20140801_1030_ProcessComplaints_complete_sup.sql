--This will populate ased date for sup for the process path where sup completes,183 rows
...
and not exists (select incident_header_id from incident_header_stat_hist_stg where incident_header_id = stg.incident_id and  status_cd like '%STATE%');
