...
alter table D_BATCHES parallel 2;
alter table D_COMPLAINT_ACTION_COMMENTS parallel 2;
alter table D_COMPLAINT_CURRENT parallel 2;
alter table D_DOCUMENTS noparallel;
alter table D_IDR_CURRENT noparallel;
alter table D_MFB_CURRENT parallel 4;
alter table D_MW_CURRENT parallel 4;
alter table D_MW_V2_CURRENT parallel 4;
alter table D_MW_V2_HISTORY parallel 4;
alter table D_NOTE parallel 2;
alter table D_NYHIX_DOC_NOTIF_CURRENT parallel 4;
alter table D_NYHIX_DOC_NOTIF_HISTORY parallel 4;
alter table D_NYHIX_MFD_CURRENT parallel 4;
alter table D_NYHIX_MFD_CURRENT_V2 parallel 4;
alter table D_NYHIX_MFD_HISTORY_V2 parallel 4;
alter table D_PL_CURRENT noparallel;
alter table D_PL_MEDIA_CD noparallel;
alter table F_APPEALS_BY_DATE noparallel;
alter table F_COMPLAINT_BY_DATE parallel 4;
alter table F_IDR_BY_DATE noparallel;
alter table F_MFB_BY_HOUR parallel 4;
alter table F_MW_BY_DATE parallel 4;
alter table F_NYHIX_MFD_BY_DATE parallel 4;
