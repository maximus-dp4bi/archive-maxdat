...
This script was created based on the dev patch script created by Randall.
svn://rcmxapp1d.maximus.com/maxdat/BPM/NYHIX/patch/20161031_1038_repartition_BUEQ_DEV.sql
*/
-- NYHIX-4283 - UAT
...
alter table BPM_UPDATE_EVENT_QUEUE rename to BPM_UPDATE_EVENT_BAK;
