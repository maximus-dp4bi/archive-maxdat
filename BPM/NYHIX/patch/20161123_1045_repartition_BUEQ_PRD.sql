/*
Created on 11/23/2016 by Raj A.
...
create index BUEQ_IX1 on BPM_UPDATE_EVENT_QUEUE (BSL_ID,EVENT_DATE) online tablespace MAXDAT_INDX parallel 4 compute statistics;
create index BUEQ_IX2 on BPM_UPDATE_EVENT_QUEUE (BSL_ID,PROCESS_BUEQ_ID) online tablespace MAXDAT_INDX parallel 4 compute statistics;
create index BUEQ_IX3 on BPM_UPDATE_EVENT_QUEUE (BSL_ID,IDENTIFIER) online tablespace MAXDAT_INDX parallel 4 compute statistics;
create index BUEQ_IX4 on BPM_UPDATE_EVENT_QUEUE (BSL_ID,WROTE_BPM_SEMANTIC_DATE) online tablespace MAXDAT_INDX parallel 4 compute statistics;
