/*
Created by B Arun 10/01/2018
Description:
NYHIX-42612 changes
*/
ALTER TABLE corp_etl_proc_letters          ADD FILE_NAME VARCHAR2(200);
ALTER TABLE corp_etl_proc_letters_oltp     ADD FILE_NAME VARCHAR2(200);
ALTER TABLE corp_etl_proc_letters_wip_bpm  ADD FILE_NAME VARCHAR2(200);
ALTER TABLE d_pl_current                   ADD FILE_NAME VARCHAR2(200);
/
