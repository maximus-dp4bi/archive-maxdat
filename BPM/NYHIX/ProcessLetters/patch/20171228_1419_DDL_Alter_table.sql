/*
Created by P Smith 12/28/2017
Description:
NYHIX-36797 changes
*/
ALTER TABLE corp_etl_proc_letters          ADD DELIVERY_METHOD VARCHAR2(64);
ALTER TABLE corp_etl_proc_letters_oltp     ADD DELIVERY_METHOD VARCHAR2(64);
ALTER TABLE corp_etl_proc_letters_wip_bpm  ADD DELIVERY_METHOD VARCHAR2(64);
ALTER TABLE d_pl_current                   ADD DELIVERY_METHOD VARCHAR2(64);
/
