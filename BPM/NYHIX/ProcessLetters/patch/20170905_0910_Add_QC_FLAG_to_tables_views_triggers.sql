Alter table corp_etl_proc_letters add (QC_FLAG varchar2(1) default 'N');
Alter table corp_etl_proc_letters_oltp add (QC_FLAG varchar2(1) default 'N');
Alter table corp_etl_proc_letters_wip_bpm add (QC_FLAG varchar2(1) default 'N');
Alter table d_pl_current add (QC_FLAG varchar2(1) default 'N');
...
GRANT SELECT ON MAXDAT.D_PL_CURRENT_SV TO MAXDAT_READ_ONLY;
GRANT SELECT ON MAXDAT.D_PL_CURRENT_SV TO DP_SCORECARD;
