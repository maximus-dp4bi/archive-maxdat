  ...
  v_xml_string_old :=
    ...
    <ROWSET>
      <ROW>
        ...
        <AIAN_MEMBER_COUNT>' || :old.AIAN_MEMBER_COUNT || '</AIAN_MEMBER_COUNT>
        <ALT_MEDIA_SENT_ON>' || to_char(:old.ALT_MEDIA_SENT_ON,BPM_COMMON.GET_DATE_FMT) || '</ALT_MEDIA_SENT_ON>
        ...
        <DELIVERY_METHOD><![CDATA[' || :old.DELIVERY_METHOD || ']]></DELIVERY_METHOD>
        <ERROR_REASON><![CDATA[' || :old.ERROR_REASON || ']]></ERROR_REASON>
        <FAMILY_MEMBER_COUNT>' || :old.FAMILY_MEMBER_COUNT || '</FAMILY_MEMBER_COUNT>
        ...
        <MANUAL_NOTICE_TYPE><![CDATA[' || :old.MANUAL_NOTICE_TYPE || ']]></MANUAL_NOTICE_TYPE>
        <MATERIAL_REQUEST_ID>' || :old.MATERIAL_REQUEST_ID || '</MATERIAL_REQUEST_ID>
        ...
        <QC_FLAG><![CDATA[' || :old.QC_FLAG || ']]></QC_FLAG>
        ...
        <FILE_NAME>' || :old.FILE_NAME || '</FILE_NAME>
       </ROW>
    </ROWSET>
    ';
  ...
  v_xml_string_new :=
    ...
    <ROWSET>
      <ROW>
	    ...
	    <AIAN_MEMBER_COUNT>' || :new.AIAN_MEMBER_COUNT || '</AIAN_MEMBER_COUNT>
        <ALT_MEDIA_SENT_ON>' || to_char(:new.ALT_MEDIA_SENT_ON,BPM_COMMON.GET_DATE_FMT) || '</ALT_MEDIA_SENT_ON>
        ...
        <DELIVERY_METHOD><![CDATA[' || :new.DELIVERY_METHOD || ']]></DELIVERY_METHOD>
        ...
        <MANUAL_NOTICE_TYPE><![CDATA[' || :new.MANUAL_NOTICE_TYPE || ']]></MANUAL_NOTICE_TYPE>
        <MATERIAL_REQUEST_ID>' || :new.MATERIAL_REQUEST_ID || '</MATERIAL_REQUEST_ID>
        ...
        <QC_FLAG><![CDATA[' || :new.QC_FLAG || ']]></QC_FLAG>
        ...
        <FILE_NAME>' || :new.FILE_NAME || '</FILE_NAME>
      </ROW>
    </ROWSET>
    ';
