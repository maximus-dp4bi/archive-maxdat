alter table NYHX_ETL_IDR_INCIDENTS add (ACCOUNT_ID varchar2(30));
alter table NYHX_ETL_IDR_INCIDENTS_OLTP add (ACCOUNT_ID varchar2(30));
alter table NYHX_ETL_IDR_INCIDENTS_WIP add (ACCOUNT_ID varchar2(30));
alter table D_IDR_CURRENT add (ACCOUNT_ID varchar2(30));

CREATE OR REPLACE VIEW MAXDAT.D_IDR_CURRENT_SV
AS
select IDR_BI_ID,
INCIDENT_ID,
CREATED_BY_GROUP,
...
GRANT SELECT ON MAXDAT.D_IDR_CURRENT_SV TO MAXDAT_READ_ONLY;
