...
create or replace package body BPM_EVENT_PROJECT as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/NYHIX/createdb/BPM_EVENT_PROJECT_pkg_body.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 6206 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2013-10-16 14:31:22 -0500 (Wed, 16 Oct 2013) $'; 
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      IDR_INCIDENTS.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);

    elsif p_bueq_row.BSL_ID = 22 then
      PROCESS_COMPLAINTS_INCIDENTS.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      IDR_INCIDENTS.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);  

    elsif p_bueq_row.BSL_ID = 22 then
      PROCESS_COMPLAINTS_INCIDENTS.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);   
