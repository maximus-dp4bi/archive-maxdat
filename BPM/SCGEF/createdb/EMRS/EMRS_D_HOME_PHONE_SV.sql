...
IF OBJECT_ID('MAXDAT_SUPPORT.EMRS_D_HOME_PHONE_SV', 'V') IS NOT NULL
DROP VIEW [maxdat_support].[EMRS_D_HOME_PHONE_SV]
GO
...
CREATE VIEW MAXDAT_SUPPORT.EMRS_D_HOME_PHONE_SV
AS
...
WHERE ct.contact_info_type_code = 'pn'
GO