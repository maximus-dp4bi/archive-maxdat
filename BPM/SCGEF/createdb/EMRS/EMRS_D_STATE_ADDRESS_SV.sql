IF OBJECT_ID('MAXDAT_SUPPORT.EMRS_D_STATE_ADDRESS_SV', 'V') IS NOT NULL
DROP VIEW [maxdat_support].[EMRS_D_STATE_ADDRESS_SV]
GO
...
CREATE VIEW MAXDAT_SUPPORT.EMRS_D_STATE_ADDRESS_SV
AS
