 CREATE OR REPLACE VIEW d_app_processing_timeliness_old_sv
 AS 
...
SELECT ah.application_id      
       ...
       ,renewal_due_date coverage_end_date       
        ...
        ,opntask.step_instance_id open_task_id
...
GRANT SELECT ON D_APP_PROCESSING_TIMELINESS_OLD_SV to MAXDAT_READ_ONLY;
