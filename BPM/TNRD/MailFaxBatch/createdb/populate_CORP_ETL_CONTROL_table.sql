...
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_ARS_FLAG', 'V', 'N', 'Flag to run MFB ARS ETL processing, Y run, N skip', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_REMOTE_FLAG', 'V', 'N', 'Flag to run MFB Remote ETL processing, Y run, N skip', sysdate, sysdate);
...
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST1', 'V', 'TNERPC - Fax', 'These are the TNRD Batch Classes', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST2', 'V', 'TNERPC - LTSS Form', 'These are the TNRD Batch Classes', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST3', 'V', 'TNERPC - Missing Information', 'These are the TNRD Batch Classes', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST4', 'V', 'TNERPC - Other', 'These are the TNRD Batch Classes', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST5', 'V', 'TNERPC - Redetermination Form', 'These are the TNRD Batch Classes', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST6', 'V', 'TNERPC - State Fax', 'These are the TNRD Batch Classes', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST7', 'V', 'TNERPC - Undeliverable Mail', 'These are the TNRD Batch Classes', sysdate, sysdate);
insert into corp_etl_control (NAME, VALUE_TYPE, VALUE, DESCRIPTION, CREATED_TS, UPDATED_TS) values ('MFB_BATCH_CLASS_LIST8', 'V', 'TNERPC HCFA Documents', 'These are the TNRD Batch Classes', sysdate, sysdate);
