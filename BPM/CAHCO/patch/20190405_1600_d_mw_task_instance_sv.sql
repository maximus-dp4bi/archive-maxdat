...
SELECT 
  ...
  CASE WHEN te.team_supervisor_staff_id is null or te.team_supervisor_staff_id = 0 then 'Y'
  ELSE 'N' END as IS_MAXIMUS_SUPERVISOR
...
LEFT OUTER JOIN d_teams te
ON a.curr_team_id = te.team_id
with read only;
/
