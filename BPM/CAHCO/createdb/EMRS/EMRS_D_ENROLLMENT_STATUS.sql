...
CREATE TABLE EMRS_D_ENROLLMENT_STATUS
 ...
 ALTER TABLE "EMRS_D_ENROLLMENT_STATUS" ADD CONSTRAINT "ENRLSTATUS_UK" UNIQUE ("ENROLLMENT_STATUS_CODE") USING INDEX TABLESPACE "MAXDAT_INDX"  ENABLE;
 ALTER TABLE "EMRS_D_ENROLLMENT_STATUS" ADD CONSTRAINT "ENRLSTATUSPK" PRIMARY KEY ("ENROLLMENT_STATUS_ID") USING INDEX TABLESPACE "MAXDAT_INDX"  ENABLE;
