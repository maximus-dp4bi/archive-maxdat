...
CREATE TABLE EMRS_D_CHANGE_REASON
   (CHANGE_REASON_ID NUMBER NOT NULL, 	
    ...
    CHANGE_REASON_TYPE VARCHAR2(10)
   ) TABLESPACE MAXDAT_DATA ;

 ALTER TABLE "EMRS_D_CHANGE_REASON" ADD CONSTRAINT "CHGREASON_PLAN_REASON_UK" UNIQUE ("CHANGE_REASON_CODE", "CHANGE_REASON_CODE_PLAN") USING INDEX TABLESPACE "MAXDAT_INDX"  ENABLE;
 ALTER TABLE "EMRS_D_CHANGE_REASON" ADD CONSTRAINT "CHGREASON_PK" PRIMARY KEY ("CHANGE_REASON_ID") USING INDEX TABLESPACE "MAXDAT_INDX"  ENABLE;
