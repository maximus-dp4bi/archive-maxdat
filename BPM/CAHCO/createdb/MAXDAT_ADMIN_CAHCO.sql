...
create or replace package maxdat.MAXDAT_ADMIN as
...
create or replace package body maxdat.MAXDAT_ADMIN as
...
procedure UPDATE_HCO_V2_CALL
  as
    ...
    v_log_message clob := null;
  begin
    v_log_message := 'Manually update CC_F_V2_CALL_SV';
    AUDIT_LOGGER(v_procedure_name,null,v_log_message);

    PKG_HCO_V2_CALL_UPDATE.PROC_REFRESH_MATERIALIZED_VIEW;
  end;
