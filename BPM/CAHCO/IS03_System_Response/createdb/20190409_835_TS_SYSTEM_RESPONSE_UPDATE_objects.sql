CREATE OR REPLACE Procedure TS_SYSTEM_RESPONSE_UPDATE
    ...
    IN_SYSTEM_RESPONSE_DELETE_FLAG IN NUMBER,
...
BEGIN
if IN_SYSTEM_RESPONSE_DELETE_FLAG = 1 then
     delete from TS_SYSTEM_RESPONSE where SYSTEM_RESPONSE_ID = IN_SYSTEM_RESPONSE_ID;
     commit;
elsif 
