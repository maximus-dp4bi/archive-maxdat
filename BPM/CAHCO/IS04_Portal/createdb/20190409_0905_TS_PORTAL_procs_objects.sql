CREATE OR REPLACE Procedure TS_PORTAL_AVAILABILTY_UPDATE
    ...
    IN_PORTAL_AVAILABILTY_DELETE_FLAG IN NUMBER,
...
BEGIN
if IN_PORTAL_AVAILABILTY_DELETE_FLAG = 1 then
     delete from TS_PORTAL_AVAILABILTY where PORTAL_AVAILABILTY_ID = IN_PORTAL_AVAILABILTY_ID;
     commit;
elsif 
...
CREATE OR REPLACE Procedure TS_PORTAL_USAGE_UPDATE
   ...
   IN_PORTAL_USAGE_PACKET_REQUEST   IN NUMBER,
   IN_PORTAL_USAGE_OTHER    IN NUMBER,
   IN_PORTAL_USAGE_DELETE_FLAG IN NUMBER,
    IN_STAFF_ID      IN VARCHAR2
   )
...
BEGIN
if IN_PORTAL_USAGE_DELETE_FLAG = 1 then
     delete from TS_PORTAL_USAGE where PORTAL_USAGE_ID = IN_PORTAL_USAGE_ID;
     commit;
elsif 
