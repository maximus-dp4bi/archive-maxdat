...
( select concat(cl.clnt_fname, ' ', cl.clnt_lname) AS client_name,
    ...
    ms.description AS maritial_status,
    ...
    dsb.rr_status_code,
	null AS Consumer_Reported_Data,
	null AS Verified_Source_Reported_Data,
	null AS Verified_Source_Name,
	dsb.file_run_date  AS Verified_Source_File_Date,
