...
order by 
  ...
  SYNONYM_NAME asc;
*/
drop public synonym "ADDCORP_ETL_MANAGE_WORK";
...
drop public synonym "BI_CC_D_GEOGRAPHY_MASTER";
...
drop public synonym "BI_CC_D_PRODUCTION_PLAN_HRZN";
drop public synonym "BI_CC_D_PROGRAM";
drop public synonym "BI_CC_D_PROJECT";
...
drop public synonym "CC_D_AGENT_BKP";
...
drop public synonym "CC_D_SITE_BKP";
...
drop public synonym "CC_S_AGENT_BKP";
...
drop public synonym "CEMWID_SEQ";
drop public synonym "CFG_ACTIVITY_TYPE";
drop public synonym "CFG_CONTACT_QUEUE";
drop public synonym "CFG_PROJECT_CONFIG";
drop public synonym "CFG_UNIT_OF_WORK";
...
drop public synonym "D_MW_CURRENT_TMP";
...
drop public synonym "F_MFB_BY_DATE";
drop public synonym "F_MFB_BY_DATE_SV";
...
drop public synonym "F_MW_BY_DATE_TMP";
drop public synonym "F_SCI_BY_DATE";
drop public synonym "F_SCI_BY_DATE_SV";
drop public synonym "GETCORP_ETL_MANAGE_WORK";
...
drop public synonym "HCCHIX_COMMON_PKG";
...
drop public synonym "MANAGEWORKTYPE";
...
drop public synonym "SELECT_JOB_HISTORY";
drop public synonym "SEQ_AP_D_ACTIVITY_TYPE";
drop public synonym "SEQ_AP_D_AGENT";
drop public synonym "SEQ_AP_D_DATE";
drop public synonym "SEQ_AP_D_GROUP";
drop public synonym "SEQ_AP_D_PROJECT_TARGETS";
drop public synonym "SEQ_AP_F_AGENT_ACTVTY_BY_DATE";
drop public synonym "SEQ_AP_F_AGENT_BY_DATE";
...
drop public synonym "SEQ_PP_D_CONTACT_QUEUE";
drop public synonym "SEQ_PP_D_GEOGRAPHY_MASTER";
drop public synonym "SEQ_PP_D_INTERVAL";
drop public synonym "SEQ_PP_D_IVR_SELF_SERVICE_PATH";
drop public synonym "SEQ_PP_D_PRODUCTION_PLAN";
drop public synonym "SEQ_PP_D_PROD_PLAN_HORIZON";
drop public synonym "SEQ_PP_D_PROGRAM";
drop public synonym "SEQ_PP_D_PROJECT";
drop public synonym "SEQ_PP_D_SITE";
drop public synonym "SEQ_PP_D_UNIT_OF_WORK";
drop public synonym "SEQ_PP_F_ACTUALS_IVR_INTERVAL";
drop public synonym "SEQ_PP_F_ACTUALS_Q_INTERVAL";
drop public synonym "SEQ_PP_F_FORECAST_INTERVAL";
drop public synonym "SEQ_PP_F_IVR_SELF_SVC_USAGE";
drop public synonym "SEQ_PROCESS_BUEQ_ID";
drop public synonym "SEQ_STG_AGENT";
drop public synonym "SEQ_STG_AGENT_ABSENCE";
drop public synonym "SEQ_STG_AGENT_ACTIVITY";
drop public synonym "SEQ_STG_AGENT_SUPERVISOR";
drop public synonym "SEQ_STG_AGENT_WORK_DAY";
drop public synonym "SEQ_STG_EXTERNAL_INTERNAL";
...
drop public synonym "STG_ACD_INTERVAL";
drop public synonym "STG_ACD_INTERVAL_PERIOD";
drop public synonym "STG_AGENT";
drop public synonym "STG_AGENT_ABSENCE";
drop public synonym "STG_AGENT_ACTIVITY";
drop public synonym "STG_AGENT_SUPERVISOR";
drop public synonym "STG_AGENT_WORK_DAY";
drop public synonym "STG_CALL_DETAIL";
drop public synonym "STG_CONTACT_QUEUE";
drop public synonym "STG_EXTERNAL_INTERNAL";
drop public synonym "STG_FCST_INTERVAL";
drop public synonym "STG_INTERVAL";
drop public synonym "STG_IVR_INTERVAL";
drop public synonym "STG_IVR_SELF_SERVICE_PATH";
drop public synonym "STG_IVR_SELF_SERVICE_USAGE";
drop public synonym "STG_WFM_INTERVAL";
drop public synonym "SVN_REVISION_DEPLOYED";
drop public synonym "SVN_REVISION_KEYWORD";
drop public synonym "TASKID_SEQ";
...
drop public synonym "UPDATECORP_ETL_MANAGE_WORK";