...
create or replace package CLIENT_INQUIRY as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/TXEB/SupportClientInquiry/createdb/CLIENT_INQUIRY_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 3653 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2013-07-08 08:52:38 -0500 (Mon, 08 Jul 2013) $'; 
  ...
  /*
  select '     '|| 'CECI_ID varchar2(100),' attr_element from dual  
  union 
  select '     '|| 'PARTICIPANT_STATUS varchar2(15),' attr_element from dual  
  union 
...
-- Get record for Manage Jobs insert XML.
  ...
  begin  
/*
    select '      extractValue(p_data_xml,''/ROWSET/ROW/CECI_ID'') "' || 'CECI_ID'|| '",' attr_element from dual
    union 
    select '      extractValue(p_data_xml,''/ROWSET/ROW/PARTICIPANT_STATUS'') "' || 'PARTICIPANT_STATUS'|| '",' attr_element from dual
    union 
...
--      extractValue(p_data_xml,'/ROWSET/ROW/CECI_ID') "CECI_ID",
  ...
  EXCEPTION
    when OTHERS then
      BPM_COMMON.LOGGER(BPM_COMMON.LOG_LEVEL_SEVERE,NULL
                       ...
                       ,v_bsl_id,v_bil_id,null,null,null,SQLERRM,SQLCODE);
      raise; 
  END get_handle_time;
 ...
 -- Insert BPM Event model data.
  ...
  insert into BPM_INSTANCE 
    ...
    values
      (v_bi_id,v_bem_id,v_identifier,v_bil_id,v_bsl_id,
       v_start_date,v_end_date,to_char(v_new_data.CECI_ID),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT),to_date(v_new_data.STG_LAST_UPDATE_DATE,BPM_COMMON.DATE_FMT));
  ...
  select 'BPM_EVENT.INSERT_BIA(v_bi_id, '||b.ba_id || ','||bl.bdl_id || ',v_new_data.'|| stg.staging_table_column || ',v_start_date,v_bue_id);'
      ...
      order by b.ba_id
  */    
    BPM_EVENT.INSERT_BIA(v_bi_id, 1630,1,v_new_data.CECI_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1631,1,v_new_data.CONTACT_RECORD_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1632,2,v_new_data.SUPP_CONTACT_TYPE_CD,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1633,2,v_new_data.CONTACT_TYPE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1634,1,v_new_data.PARENT_RECORD_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1635,2,v_new_data.TRACKING_NUMBER,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1636,1,v_new_data.SUPP_WORKER_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1637,2,v_new_data.SUPP_WORKER_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1638,2,v_new_data.SUPP_CREATED_BY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1639,2,v_new_data.CREATED_BY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1640,3,v_new_data.CREATE_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1641,3,v_new_data.COMPLETE_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1642,3,v_new_data.CONTACT_START_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1643,3,v_new_data.CONTACT_END_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1645,2,v_new_data.SUPP_CONTACT_GROUP_CD,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1646,2,v_new_data.CONTACT_GROUP,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1647,2,v_new_data.SUPP_LANGUAGE_CD,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1648,2,v_new_data.LANGUAGE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1649,2,v_new_data.TRANSLATION_REQ,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1650,2,v_new_data.EXT_TELEPHONY_REF,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1652,1,v_new_data.SUPP_LATEST_NOTE_ID,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1653,2,v_new_data.NOTE_CATEGORY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1654,2,v_new_data.NOTE_TYPE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1655,2,v_new_data.NOTE_SOURCE,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1656,2,v_new_data.NOTE_PRESENT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1657,2,v_new_data.CONTACT_RECORD_FIELD1,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1658,2,v_new_data.CONTACT_RECORD_FIELD2,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1659,2,v_new_data.CONTACT_RECORD_FIELD3,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1660,2,v_new_data.CONTACT_RECORD_FIELD4,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1661,2,v_new_data.CONTACT_RECORD_FIELD5,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1666,2,v_new_data.INSTANCE_STATUS,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1667,2,v_new_data.SUPP_UPDATE_BY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1668,2,v_new_data.LAST_UPDATE_BY_NAME,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1669,3,v_new_data.LAST_UPDATE_DT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1670,3,v_new_data.ASSD_HANDLE_CONTACT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1671,3,v_new_data.ASED_HANDLE_CONTACT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1672,2,v_new_data.ASPB_HANDLE_CONTACT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1673,3,v_new_data.ASSD_CREATE_ROUTE_WORK,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1674,3,v_new_data.ASED_CREATE_ROUTE_WORK,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1675,2,v_new_data.ASF_HANDLE_CONTACT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1676,2,v_new_data.ASF_CREATE_ROUTE_WORK,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1677,2,v_new_data.ASF_CANCEL_CONTACT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1678,2,v_new_data.GWF_WORK_IDENTIFIED,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1679,3,v_new_data.CANCEL_DT,v_start_date,v_bue_id);
--    BPM_EVENT.INSERT_BIA(v_bi_id, 1680,3,v_new_data.STG_LAST_UPDATE_DATE,v_start_date,v_bue_id);
	  BPM_EVENT.INSERT_BIA(v_bi_id, 1690,2,v_new_data.CANCEL_METHOD,v_start_date,v_bue_id);
	  BPM_EVENT.INSERT_BIA(v_bi_id, 1691,2,v_new_data.CANCEL_REASON,v_start_date,v_bue_id);
	  BPM_EVENT.INSERT_BIA(v_bi_id, 1692,2,v_new_data.CANCEL_BY,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1790,2,v_new_data.CREATED_BY_UNIT,v_start_date,v_bue_id);
    BPM_EVENT.INSERT_BIA(v_bi_id, 1792,2,v_new_data.CREATED_BY_ROLE,v_start_date,v_bue_id);
...
if v_end_date is not null then
 ...
 select 'BPM_EVENT.UPDATE_BIA(v_bi_id,' ||b.ba_id || ','||bl.bdl_id || ','||''''||b.retain_history_flag||''''||',v_old_data.'|| stg.staging_table_column ||
    ...
    order by b.ba_id;  
 */   
    BPM_EVENT.UPDATE_BIA(v_bi_id,1632,2,'N',v_old_data.SUPP_CONTACT_TYPE_CD,v_new_data.SUPP_CONTACT_TYPE_CD,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1633,2,'N',v_old_data.CONTACT_TYPE,v_new_data.CONTACT_TYPE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1634,1,'N',v_old_data.PARENT_RECORD_ID,v_new_data.PARENT_RECORD_ID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1635,2,'N',v_old_data.TRACKING_NUMBER,v_new_data.TRACKING_NUMBER,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1636,1,'N',v_old_data.SUPP_WORKER_ID,v_new_data.SUPP_WORKER_ID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1637,2,'N',v_old_data.SUPP_WORKER_NAME,v_new_data.SUPP_WORKER_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1641,3,'N',v_old_data.COMPLETE_DT,v_new_data.COMPLETE_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1642,3,'N',v_old_data.CONTACT_START_DT,v_new_data.CONTACT_START_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1643,3,'N',v_old_data.CONTACT_END_DT,v_new_data.CONTACT_END_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1645,2,'N',v_old_data.SUPP_CONTACT_GROUP_CD,v_new_data.SUPP_CONTACT_GROUP_CD,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1646,2,'N',v_old_data.CONTACT_GROUP,v_new_data.CONTACT_GROUP,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1647,2,'N',v_old_data.SUPP_LANGUAGE_CD,v_new_data.SUPP_LANGUAGE_CD,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1648,2,'N',v_old_data.LANGUAGE,v_new_data.LANGUAGE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1649,2,'N',v_old_data.TRANSLATION_REQ,v_new_data.TRANSLATION_REQ,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1650,2,'N',v_old_data.EXT_TELEPHONY_REF,v_new_data.EXT_TELEPHONY_REF,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1652,1,'N',v_old_data.SUPP_LATEST_NOTE_ID,v_new_data.SUPP_LATEST_NOTE_ID,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1653,2,'N',v_old_data.NOTE_CATEGORY,v_new_data.NOTE_CATEGORY,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1654,2,'N',v_old_data.NOTE_TYPE,v_new_data.NOTE_TYPE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1655,2,'N',v_old_data.NOTE_SOURCE,v_new_data.NOTE_SOURCE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1656,2,'N',v_old_data.NOTE_PRESENT,v_new_data.NOTE_PRESENT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1657,2,'N',v_old_data.CONTACT_RECORD_FIELD1,v_new_data.CONTACT_RECORD_FIELD1,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1658,2,'N',v_old_data.CONTACT_RECORD_FIELD2,v_new_data.CONTACT_RECORD_FIELD2,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1659,2,'N',v_old_data.CONTACT_RECORD_FIELD3,v_new_data.CONTACT_RECORD_FIELD3,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1660,2,'N',v_old_data.CONTACT_RECORD_FIELD4,v_new_data.CONTACT_RECORD_FIELD4,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1661,2,'N',v_old_data.CONTACT_RECORD_FIELD5,v_new_data.CONTACT_RECORD_FIELD5,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1666,2,'N',v_old_data.INSTANCE_STATUS,v_new_data.INSTANCE_STATUS,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1667,2,'N',v_old_data.SUPP_UPDATE_BY,v_new_data.SUPP_UPDATE_BY,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1668,2,'N',v_old_data.LAST_UPDATE_BY_NAME,v_new_data.LAST_UPDATE_BY_NAME,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1669,3,'N',v_old_data.LAST_UPDATE_DT,v_new_data.LAST_UPDATE_DT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1670,3,'N',v_old_data.ASSD_HANDLE_CONTACT,v_new_data.ASSD_HANDLE_CONTACT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1671,3,'N',v_old_data.ASED_HANDLE_CONTACT,v_new_data.ASED_HANDLE_CONTACT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1672,2,'N',v_old_data.ASPB_HANDLE_CONTACT,v_new_data.ASPB_HANDLE_CONTACT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1673,3,'N',v_old_data.ASSD_CREATE_ROUTE_WORK,v_new_data.ASSD_CREATE_ROUTE_WORK,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1674,3,'N',v_old_data.ASED_CREATE_ROUTE_WORK,v_new_data.ASED_CREATE_ROUTE_WORK,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1675,2,'N',v_old_data.ASF_HANDLE_CONTACT,v_new_data.ASF_HANDLE_CONTACT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1676,2,'N',v_old_data.ASF_CREATE_ROUTE_WORK,v_new_data.ASF_CREATE_ROUTE_WORK,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1677,2,'N',v_old_data.ASF_CANCEL_CONTACT,v_new_data.ASF_CANCEL_CONTACT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1678,2,'N',v_old_data.GWF_WORK_IDENTIFIED,v_new_data.GWF_WORK_IDENTIFIED,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1679,3,'N',v_old_data.CANCEL_DT,v_new_data.CANCEL_DT,v_bue_id,v_stg_last_update_date);
--    BPM_EVENT.UPDATE_BIA(v_bi_id,1680,3,'N',v_old_data.STG_LAST_UPDATE_DATE,v_new_data.STG_LAST_UPDATE_DATE,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1790,2,'N',v_old_data.CREATED_BY_UNIT,v_new_data.CREATED_BY_UNIT,v_bue_id,v_stg_last_update_date);
    BPM_EVENT.UPDATE_BIA(v_bi_id,1792,2,'N',v_old_data.CREATED_BY_ROLE,v_new_data.CREATED_BY_ROLE,v_bue_id,v_stg_last_update_date);
