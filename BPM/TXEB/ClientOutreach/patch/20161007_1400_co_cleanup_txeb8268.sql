DECLARE  
  CURSOR temp_cur IS
    ...
    and outreach_status in('Outreach Successful','Outreach Unsuccessful','Outreach No Longer Required','Outreach Invalid Request');
   ...
   LOOP
     ...
     BEGIN
       FORALL indx IN 1..temp_tab.COUNT         
        ...
        set ased_validate_outreach_req = null
          ,aspb_validate_outreach_req = null
          ,asf_validate_outreach_req = 'N'
          ,ased_outreach_step1 = null
