create or replace view qc_staff_answers_sv as
with y1 as (
...
, stf3.first_name||' '||stf3.last_name as reviewer_name, sr.template_question_id, sr.survey_template_answer_id, qt.question_text, aw.answer_text
...
--and y1.survey_id = 678665
--order by y1.survey_id
;

grant select on qc_staff_answers_sv to maxdat_reports;
grant select on qc_staff_answers_sv to maxdat_read_only;
