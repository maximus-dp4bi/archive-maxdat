CREATE OR REPLACE VIEW MAXDAT.QC_REVIEW_SCORE_HIST_SV
AS select /*+ parallel(10) */
...
GRANT SELECT ON MAXDAT.QC_REVIEW_SCORE_HIST_SV TO maxdat_read_only;
GRANT SELECT ON MAXDAT.QC_REVIEW_SCORE_HIST_SV TO maxdat_reports;
