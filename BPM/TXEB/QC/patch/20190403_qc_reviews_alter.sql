...
, LPAD(to_char(sr.agent_id),5,'0') agent_id
, LPAD(ag.ext_staff_number,5,'0') ext_staff_number
...
left join qc_staff ag on LPAD(ag.ext_staff_number,5,'0') = LPAD(to_char(sr.agent_id),5,'0')
