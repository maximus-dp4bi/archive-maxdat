...
package body BPM_EVENT_PROJECT as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/TXEB/ManageEnrollmentActivity/patch/BPM_EVENT_PROJECT_pkg_body.sql $';
  SVN_REVISION varchar2(20) := '$Revision: 5661 $';
  SVN_REVISION_DATE varchar2(60) := '$Date: 2013-09-26 11:37:12 -0700 (Thu, 26 Sep 2013) $';
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      COMMUNITY_OUTREACH.INSERT_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.NEW_DATA,p_bue_id);
  ...
  begin
    ...
    if p_bueq_row.BSL_ID = 1 then
      ...
      COMMUNITY_OUTREACH.UPDATE_BPM_EVENT(p_bueq_row.DATA_VERSION,p_bueq_row.OLD_DATA,p_bueq_row.NEW_DATA,p_bue_id);
