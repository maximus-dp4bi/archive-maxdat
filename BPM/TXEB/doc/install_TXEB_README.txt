...
----------------------------------------
	...
	3. createdb/MASH_views.sql
        4. populate_CORP_ETL_LIST_LKUP_RunInit_Daily
...
----------------------------------------
	...
	Run order:
	 ...
	 9. (TXEB) populate_BPM_EVENT_MASTER.sql
	10. (TXEB) create_ETL_Mailfaxdoc_triggers.sql
	...
	-- or DB_INITIAL_LOAD_PROCESSINCIDENTS_1.zip
        ...
        Run order:
         ...
         8. create_ETL_ProcessIncidents_triggers.sql
	...
	-- or DB_INITIAL_LOAD_MANAGEJOBS_1.zip
	 ...
	 8. (TXEB) INSERT_CORP_MJ_ETL_FILE_LKUP.sql
         9. (TXEB) INSERT_CORP_MJ_FILE_CAL_LKUP.sql
	10. create_ETL_ManageJobs_triggers.sql
	...
	-- or DB_INITIAL_LOAD_PROCESSLETTERS_1.zip
	 ...
	 1. create_ETL_ProcessLetters_tables.sql
         ...
         7. populate_CORP_ETL_CONTROL.sql
         8. populate_CORP_ETL_LIST_LKUP.sql
         9. create_ETL_ProcessLetters_triggers.sql
	...
	Run order:
	 ...
	 5. populate_lkup_tables.sql
  	...
  	10. populate_CORP_SCI_ETL_CTYPES_LKUP.sql
	11. create_ETL_SupportClientInquiry_triggers.sql
	...
	ClientOutreach
        ...
        -- or (TXEB) svn://rcmxapp1d.maximus.com/maxdat/BPM/(TXEB)/ClientOutreach/createdb
        -- or DB_INITIAL_LOAD_

        Run order 

        1.  create_ETL_ClientOutreach_tables.sql
        2.  create_ETL_ClientOutreach_sequences.sql  
        3.  create_ETL_ClientOutreach_triggers.sql
        4.  populate_CORP_ETL_CONTROL.sql
        5.  populate_CORP_ETL_LIST_LKUP.sql
        6.  (TXEB) populate_CORP_CLNT_OUTREACH_NOTIFY_LKUP.sql
        7.  (TXEB) populate_CORP_CLNT_OUTREACH_PROC_LKUP.sql
        8.  (TXEB) populate_CORP_ETL_CLNT_OR_ACTIVITY_LKUP.sql
        9.  (TXEB) populate_CORP_ETL_CLNT_SURVEY_LKUP.sql
       10.  populate_lkup_tables.sql
       11.  (TXEB) populate_BPM_EVENT_MASTER.sql
       12.  SemanticModel_Client_Outreach.sql
       13.  CLIENT_OUTREACH_pkg.sql
	...
	Community Outreach
        ...
        9.  SemanticModel_Client_Outreach.sql
       10.  CommunityOutreach_pkg.sql
