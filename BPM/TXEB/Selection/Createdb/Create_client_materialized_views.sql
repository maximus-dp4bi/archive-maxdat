...
Select /*+Parallel*/job_id, CLIENT_NBR, ENROLL_SEGMENT, COORD_PLAN, COORD_FROM, COORD_TO, COORD_STATUS_CODE
From
...
--, Prior_reporting as (
Select job_id, CLIENT_NBR, ENROLL_SEGMENT, COORD_PLAN, COORD_FROM, COORD_TO, COORD_STATUS_CODE
From COORD_UNPIVOTS
;
...
ON DEMAND
AS
Select /*+Index(e,TX_ETL_L_ELIGIBILITY_IDX4)*/ E.JOB_ID, e.CLIENT_NBR, ALIAS_FLAG, cand_program1, cand_program2, cand_candidate_flag1, cand_candidate_flag2
...
CREATE INDEX TX_ETL_ELIG_CAND_MV_IDX1 ON TX_ETL_ELIG_CAND_MV(JOB_ID, CLIENT_NBR);
CREATE INDEX TX_ETL_ELIG_CAND_MV_IDX2 ON TX_ETL_ELIG_CAND_MV(CLIENT_NBR);
