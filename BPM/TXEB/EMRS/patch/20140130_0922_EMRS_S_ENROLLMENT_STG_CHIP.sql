...
--------------------------------------------------------
  ...
  CREATE TABLE "EMRS_S_ENROLLMENT_STG_CHIP" 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE INDEX IDX1_ENROLLCHIP ON EMRS_S_ENROLLMENT_STG_CHIP(SOURCE_SELECTION_RECORD_ID) TABLESPACE MAXDAT_INDX;            
  CREATE INDEX IDX2_ENROLLCHIP ON EMRS_S_ENROLLMENT_STG_CHIP(RECORD_STATUS) TABLESPACE MAXDAT_INDX;            
  CREATE INDEX IDX3_ENROLLCHIP ON EMRS_S_ENROLLMENT_STG_CHIP(SOURCE_CASE_ID) TABLESPACE MAXDAT_INDX;    
  CREATE INDEX IDX4_ENROLLCHIP ON EMRS_S_ENROLLMENT_STG_CHIP(ENROLLMENT_ID) TABLESPACE MAXDAT_INDX;           
  
  CREATE OR REPLACE PUBLIC SYNONYM EMRS_S_ENROLLMENT_STG_CHIP FOR EMRS_S_ENROLLMENT_STG_CHIP; 