...
create or replace package MANAGE_MAIL_FAX_DOC as
  ...
  SVN_FILE_URL varchar2(200) := '$URL: svn://rcmxapp1d.maximus.com/maxdat/BPM/Corp/ManageMailFaxDoc/createdb/MANAGE_MAIL_FAX_DOC_pkg.sql $'; 
  SVN_REVISION varchar2(20) := '$Revision: 10029 $'; 
  SVN_REVISION_DATE varchar2(60) := '$Date: 2014-05-12 08:18:25 -0700 (Mon, 12 May 2014) $'; 
 ...
 if p_document_type is not null then
  ...
  begin
    ...
    select
      ...
      extractValue(p_data_xml,'/ROWSET/ROW/GWF_CHANNEL_ONLINE') "GWF_CHANNEL_ONLINE",
  ...
  procedure SET_DPDCUR
    (p_set_type in varchar2,
     ...
     p_channel_online_flag in varchar2,
  ...
  begin
   ...
   r_dpdcur."DCN" := p_DCN;
    ...
    r_dpdcur."Channel Online Flag" := p_channel_online_flag;
    r_dpdcur."Document ID" := p_document_id;
    ...
    begin
      ...
      SET_DPDCUR
        ('INSERT',v_identifier,v_bi_id
          ...
          ,v_new_data.cancel_method,v_new_data.cancel_reason,v_new_data.cancel_by,v_new_data.gwf_channel_online,v_new_data.document_id
        );
      INS_FPDBD
  ...
  begin
    ...
    where "Document ID" = v_identifier;
