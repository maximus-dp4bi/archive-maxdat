create table BPM_D_DATES tablespace EB_DATA as
select 
  D_DATE,
...
alter table BPM_D_DATES add constraint BPM_D_DATES_PK primary key (D_DATE) using index tablespace EB_DATA;

grant select,references on BPM_D_DATES to EB_MAXDAT_REPORTS;