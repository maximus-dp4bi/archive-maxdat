...
truncate table D_FLHK_DOCUMENTS_HISTORY;
alter table D_FLHK_DOCUMENTS_HISTORY drop constraint DFDH_FLHK_DOC_BI_ID_FK;

truncate table D_FLHK_DOCUMENTS_CURRENT;
alter table D_FLHK_DOCUMENTS_HISTORY add constraint DFDH_FLHK_DOC_BI_ID_FK foreign key (FLHK_DOC_BI_ID) references D_FLHK_DOCUMENTS_CURRENT (FLHK_DOC_BI_ID);
