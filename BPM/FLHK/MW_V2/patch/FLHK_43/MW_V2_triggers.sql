--------------------------------------------------------
--  DDL for Trigger TRG_AU_CORP_ETL_MW_V2_Q
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "TRG_AU_CORP_ETL_MW_V2_Q" 
  ...
  v_xml_string_old :=
    ...
    <ROWSET>
      <ROW>
        ...
        <RULE_EXECUTED><![CDATA[' || :old.RULE_EXECUTED || ']]></RULE_EXECUTED>
    </ROW>
    </ROWSET>
    ';
  ...
  v_xml_string_new :=
    ...
    <ROWSET>
      <ROW>
        ...
        <RULE_EXECUTED><![CDATA[' || :new.RULE_EXECUTED || ']]></RULE_EXECUTED>
     </ROW>
    </ROWSET>
    ';
...
ALTER TRIGGER "TRG_AU_CORP_ETL_MW_V2_Q" ENABLE

--------------------------------------------------------
--  DDL for Trigger TRG_AI_CORP_ETL_MW_V2_Q
--------------------------------------------------------
...
ALTER TRIGGER "TRG_AI_CORP_ETL_MW_V2_Q" ENABLE
