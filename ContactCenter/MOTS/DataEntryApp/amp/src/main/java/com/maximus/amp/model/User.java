...
public class User extends BaseObject implements Serializable, UserDetails {
    ...
    @Id
	@SequenceGenerator(name = "SEQ_AMP_USER", sequenceName="SEQ_AMP_USER", initialValue=1, allocationSize=20)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "SEQ_AMP_USER")
    @DocumentId
    public Long getId() {
        return id;
    }
	...
	public Set<Project> getProjects() {
    	...
    	for(ProjectUser pu : this.projectUserSet) {
    ...
    @Transient
	public Set<String> getFunctionalAreas(Project project) {
    	
    	Set<String> functionalAreas = new HashSet<String>();
    	
    	for(ProjectUser pu : this.projectUserSet) {
        	if(pu.getProject().equals(project)) { functionalAreas.add(pu.getFunctionalArea()); }
        }
