...
import com.maximus.amp.util.Props;
...
public class StartupListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        //TODO:  remove this
//        Props props = (Props) ctx.getBean("ldapProps");
//        
//        log.debug("ldap.manager.dn: " + props.getDn());
//        log.debug("ldap.server.url: " + props.getPwd());
    ...
    public static void setupContext(ServletContext context) {
        ...
        context.setAttribute(Constants.AVAILABLE_ROLES, mgr.getApplicationRoles());
        context.setAttribute(Constants.REPORTING_PERIOD_TYPE_MAP, mgr.getReportingPeriodTypeMap());
