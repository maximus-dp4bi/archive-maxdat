...
import com.maximus.amp.service.RoleManager;
import com.maximus.amp.service.UserExistsException;
import com.maximus.amp.service.UserManager;
import com.maximus.amp.webapp.util.RequestUtil;
...
public class UserFormController extends BaseFormController {
    ...
    public String onSubmit(@ModelAttribute("user") final User user, final BindingResult errors, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
...
//                    try {
//                        final String resetPasswordUrl = getUserManager().buildRecoveryPasswordUrl(user, UpdatePasswordController.RECOVERY_PASSWORD_TEMPLATE);
//                        sendUserMessage(user, getText("newuser.email.message", user.getFullName(), locale),RequestUtil.getAppURL(request) + resetPasswordUrl);
