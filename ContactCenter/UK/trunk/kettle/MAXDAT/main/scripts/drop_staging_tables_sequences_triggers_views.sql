use UK_HWS
go
DROP VIEW MAXDAT.CC_S_AGENT_SV
GO

DROP VIEW MAXDAT.CC_S_CALL_DETAIL_SV
GO
...
ALTER TABLE MAXDAT.CC_A_SCHEDULE DROP CONSTRAINT REGEX_CHECK_EXECUTION_TIME
GO
...
DROP
  TABLE MAXDAT.CC_S_TMP_CISCO_AGENT
GO
...
DROP
  TABLE MAXDAT.CC_S_ACD_INTERVAL
GO
...
DROP
  TABLE MAXDAT.CORP_ETL_JOB_STATISTICS
GO
