...
exec :start_date := '03/30/2014';

variable end_date VARCHAR2;
exec :end_date := '04/05/2014';
...
INNER JOIN CC_D_PROJECT proj on aii.D_PROJECT_ID = proj.PROJECT_ID
INNER JOIN CC_D_PROGRAM prog on aii.D_PROGRAM_ID = prog.PROGRAM_ID
...
INNER JOIN CC_D_PROJECT proj on faqi.D_PROJECT_ID = proj.PROJECT_ID
INNER JOIN CC_D_PROGRAM prog on faqi.D_PROGRAM_ID = prog.PROGRAM_ID
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(PROGRAM_NAME,0,10) PROGRAM_NAME
  --, MAX(sub.CONTACTS_OFFERED) as MAX_CONTACTS_OFFERED, SUM(CONTACTS_OFFERED) as TOTAL_CONTACTS_OFFERED
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(supaSub.PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(supaSub.PROGRAM_NAME,0,10) PROGRAM_NAME
  --, MAX(supaSub.WEEKLY_CONTACTS_OFFERED) as MAX_CONTACTS_OFFERED_BY_WEEK, supaSub.TOTAL_CONTACTS_OFFERED
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(proj.PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(prog.PROGRAM_NAME,0,10) PROGRAM_NAME
	--, SUM((TALK_TIME_TOTAL + HOLD_TIME_TOTAL + AFTER_CALL_WORK_TIME_TOTAL)) AS HANDLE_TIME, SUM(CONTACTS_HANDLED) AS CALLS_HANDLED
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(proj.PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(prog.PROGRAM_NAME,0,10) PROGRAM_NAME
	--, SUM(ANSWER_WAIT_TIME_TOTAL) AS ANSWER_WAIT_TIME, SUM(CONTACTS_HANDLED) AS CALLS_HANDLED
...
--AB_RATE
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(proj.PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(prog.PROGRAM_NAME,0,10) PROGRAM_NAME
	--, SUM(CONTACTS_ABANDONED) AS CONTACTS_ABANDONED, SUM(CONTACTS_OFFERED) AS CALLS_OFFERED
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(proj.PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(prog.PROGRAM_NAME,0,10) PROGRAM_NAME
	--, SUM(ABANDON_TIME_TOTAL) AS ABANDON_TIME, SUM(CONTACTS_ABANDONED) AS CALLS_ABANDONED
...
--OCCUPANCY
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(proj.PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(prog.PROGRAM_NAME,0,10) PROGRAM_NAME
	--, SUM(HANDLE_TIME_SECONDS) AS HANDLE_TIME, SUM(LOGIN_SECONDS) AS LOGIN_TIME
  , (SUM(HANDLE_TIME_SECONDS) / (SUM(HANDLE_TIME_SECONDS) + SUM(IDLE_SECONDS)) * 100) AS OCCUPANCY
FROM CC_F_AGENT_BY_DATE abd
INNER JOIN CC_D_PROJECT_TARGETS dpt on abd.D_PROJECT_TARGETS_ID = dpt.D_PROJECT_TARGETS_ID
INNER JOIN CC_D_PROJECT proj on dpt.PROJECT_ID = proj.PROJECT_ID
INNER JOIN CC_D_PROGRAM prog on abd.D_PROGRAM_ID = prog.PROGRAM_ID
...
--UTILIZATION
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(proj.PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(prog.PROGRAM_NAME,0,10) PROGRAM_NAME
	--, (SUM(HANDLE_TIME_SECONDS)+SUM(IDLE_SECONDS)) AS HANDLE_AND_IDLE_TIME, SUM(LOGIN_SECONDS) AS LOGIN_TIME
...
FROM (
  SELECT dd.D_DATE
    , COALESCE(pt.PROJECT_ID, 0) as D_PROJECT_ID
  ...
  LEFT JOIN CC_D_PROJECT_TARGETS pt on abd.D_PROJECT_TARGETS_ID = pt.D_PROJECT_TARGETS_ID
  ...
  GROUP BY dd.D_DATE, pt.PROJECT_ID, abd.D_PROGRAM_ID, abd.D_GEOGRAPHY_MASTER_ID
  )sub
INNER JOIN CC_D_PROJECT proj on sub.D_PROJECT_ID = proj.PROJECT_ID
INNER JOIN CC_D_PROGRAM prog on sub.D_PROGRAM_ID = prog.PROGRAM_ID
GROUP BY proj.PROJECT_NAME, prog.PROGRAM_NAME;
...
FROM (
    ...
    INNER JOIN CC_D_PROJECT proj on aabd.D_PROJECT_ID = proj.PROJECT_ID
    INNER JOIN CC_D_PROGRAM prog on aabd.D_PROGRAM_ID = prog.PROGRAM_ID
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(PROGRAM_NAME,0,10) PROGRAM_NAME
  --, COALESCE(SUM(sub.UNPLANNED_PTO_MINS),0) AS UNPLANNED_PTO_MINS, SUM(ACTIVITY_MINUTES) AS TOTAL_ACTIVITY_MINS
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(PROGRAM_NAME,0,10) PROGRAM_NAME
  --, COALESCE(SUM(sub.PLANNED_PTO_MINS),0) AS PLANNED_PTO_MINS, SUM(ACTIVITY_MINUTES) AS TOTAL_ACTIVITY_MINS
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(PROGRAM_NAME,0,10) PROGRAM_NAME
  --, COALESCE(SUM(sub.PLANNED_PTO_MINS),0) AS PLANNED_UNPAID_PTO_MINS, SUM(ACTIVITY_MINUTES) AS TOTAL_ACTIVITY_MINS
...
SELECT to_date(:start_date,'mm/dd/yyyy') as START_DATE, to_date(:end_date,'mm/dd/yyyy') as END_DATE, SUBSTR(PROJECT_NAME,0,10) PROJECT_NAME, SUBSTR(PROGRAM_NAME,0,10) PROGRAM_NAME
  --, COALESCE(SUM(sub.NOT_HANDLING_MINS),0) AS NOT_HANDLING_MINS, SUM(ACTIVITY_MINUTES) AS TOTAL_ACTIVITY_MINS
...
FROM (
  ...
  GROUP BY da.D_AGENT_ID, pt.PROJECT_ID, abd.D_PROGRAM_ID, abd.D_GEOGRAPHY_MASTER_ID, da.HIRE_DATE, da.TERMINATION_DATE
  )sub
INNER JOIN CC_D_PROJECT proj on sub.D_PROJECT_ID = proj.PROJECT_ID
INNER JOIN CC_D_PROGRAM prog on sub.D_PROGRAM_ID = prog.PROGRAM_ID
GROUP BY proj.PROJECT_NAME, prog.PROGRAM_NAME;
...
INNER JOIN CC_D_PROJECT proj on dpp.PROJECT_ID = proj.PROJECT_ID
INNER JOIN CC_D_PROGRAM prog on dpp.PROGRAM_ID = prog.PROGRAM_ID
