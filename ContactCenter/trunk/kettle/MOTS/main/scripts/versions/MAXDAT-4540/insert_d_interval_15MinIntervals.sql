...
--
-- populates the D_INTERVAL table with 15 minute intervals

DECLARE 
  DAYS_ADDED INT := 0; -- day counter
  TMP_START_DATE DATE := to_date('01/01/2018 00:00:00', 'MM/DD/YYYY HH24:MI:SS'); -- datetime (24-hour format)
