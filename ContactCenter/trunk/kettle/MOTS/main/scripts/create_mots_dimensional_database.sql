...
CREATE SEQUENCE SEQ_CC_D_DATES START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;
...
CREATE SEQUENCE SEQ_CC_D_PROD_PLANNING_TARGET START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;
...
CREATE SEQUENCE SEQ_CC_D_REGION START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_D_SITE START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_D_STATE START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_D_TARGET START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;
...
CREATE SEQUENCE SEQ_CC_F_PROJECT_BY_DATE START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_L_ERROR START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_L_PATCH_LOG START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CORP_ETL_JOB_STATS START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;
...
CREATE UNIQUE INDEX CC_D_AVAILABILITY_TYPE__IDX ON CC_D_ACTIVITY_TYPE
  ...
  ALTER TABLE CC_D_ACTIVITY_TYPE ADD CONSTRAINT CC_D_AVAILABILITY_TYPE_PK PRIMARY KEY ( D_ACTIVITY_TYPE_ID ) ;
  ALTER TABLE CC_D_ACTIVITY_TYPE ADD CONSTRAINT CC_D_ACTIVITY_TYPE__UN UNIQUE ( ACTIVITY_TYPE_NAME , RECORD_EFF_DT , D_PROJECT_ID ) ;
...
CREATE TABLE CC_D_AGENT
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_AGENT ADD CONSTRAINT CC_D_AGENT_REC_DATE_CK CHECK (RECORD_EFF_DT <= RECORD_END_DT) ;
CREATE UNIQUE INDEX CC_D_AGENT__IDX ON CC_D_AGENT ( D_AGENT_ID ASC ) TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_D_AGENT ADD CONSTRAINT CC_D_AGENT_PK PRIMARY KEY ( D_AGENT_ID ) ;
  ALTER TABLE CC_D_AGENT ADD CONSTRAINT CC_D_AGENT__UN UNIQUE ( LOGIN_ID , RECORD_EFF_DT , D_PROJECT_ID ) ;
...
CREATE TABLE CC_D_CONTACT_QUEUE
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_1_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_2_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_3_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_4_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_5_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_6_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_7_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_8_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_9_BOUND    >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( SPEED_ANSWER_PERIOD_10_BOUND   >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_1_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_2_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_3_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_4_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_5_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_6_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_7_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_8_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_9_BOUND  >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CHECK ( CALLS_ABNDONED_PERIOD_10_BOUND >= 0) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CONSTRAINT CC_D_CONTACT_QUEUE_PK PRIMARY KEY ( D_CONTACT_QUEUE_ID ) ;
ALTER TABLE CC_D_CONTACT_QUEUE ADD CONSTRAINT CC_D_CONTACT_QUEUE__UN UNIQUE ( QUEUE_NUMBER , RECORD_EFF_DT , D_PROJECT_ID ) ;
...
CREATE TABLE CC_D_DATES
  (
    ...
    FISCAL_QUARTER  VARCHAR2 (1) NOT NULL
  )
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
...
CREATE UNIQUE INDEX CC_D_DATES_D_DATE_UIX ON CC_D_DATES
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_D_DATES ADD CONSTRAINT CC_D_DATES_PK PRIMARY KEY ( D_DATE_ID ) ;
  ALTER TABLE CC_D_DATES ADD CONSTRAINT CC_D_DATES__UN UNIQUE ( D_YEAR , D_DAY_OF_YEAR ) ;
  ALTER TABLE CC_D_DATES ADD CONSTRAINT CC_D_DATES__UNv2 UNIQUE ( D_MONTH , D_DAY_OF_MONTH , D_YEAR ) ;
...
CREATE TABLE CC_D_FORECAST_NOTES
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_FORECAST_NOTES ADD CONSTRAINT CC_D_FORECAST_NOTES_PK PRIMARY KEY ( D_FORECAST_NOTES_ID ) ;
...
CREATE TABLE CC_D_GROUP
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_GROUP ADD CONSTRAINT CC_D_GROUP_REC_DATE_CK CHECK (RECORD_EFF_DT <= RECORD_END_DT) ;
CREATE UNIQUE INDEX CC_D_GROUP__IDX ON CC_D_GROUP ( D_GROUP_ID ASC ) TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_D_GROUP ADD CONSTRAINT CC_D_GROUP_PK PRIMARY KEY ( D_GROUP_ID ) ;
  ALTER TABLE CC_D_GROUP ADD CONSTRAINT CC_D_GROUP__UN UNIQUE ( GROUP_NAME , RECORD_EFF_DT , D_PROJECT_ID ) ;
...
CREATE INDEX CC_D_INTERVAL__IDXv3 ON CC_D_INTERVAL
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
ALTER TABLE CC_D_INTERVAL ADD CONSTRAINT CC_D_INTERVAL_PK PRIMARY KEY ( D_INTERVAL_ID ) ;
ALTER TABLE CC_D_INTERVAL ADD CONSTRAINT CC_D_INTERVAL__UN UNIQUE ( INTERVAL_START_DATE , INTERVAL_END_DATE ) ;
...
CREATE TABLE CC_D_IVR_SELF_SERVICE_PATH
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_IVR_SELF_SERVICE_PATH ADD CONSTRAINT CC_D_SELF_SERVICE_PATH_PK PRIMARY KEY ( D_IVR_SELF_SERVICE_PATH_ID ) ;
ALTER TABLE CC_D_IVR_SELF_SERVICE_PATH ADD CONSTRAINT CC_D_SELF_SERVICE_PATH__UN UNIQUE ( BEGIN_NODE , END_NODE , RECORD_EFF_DT , D_PROJECT_ID ) ;
...
CREATE INDEX CC_D_PROD_PLAN_D_GEO_ID_IDX ON CC_D_PRODUCTION_PLAN
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
ALTER TABLE CC_D_PRODUCTION_PLAN ADD CONSTRAINT CC_D_PRODUCTION_PLAN_PK PRIMARY KEY ( PRODUCTION_PLAN_ID ) ;
ALTER TABLE CC_D_PRODUCTION_PLAN ADD CONSTRAINT CC_D_PRODUCTION_PLAN__UN UNIQUE ( PRODUCTION_PLAN_NAME , EFFECTIVE_DATE , PROJECT_ID , PROGRAM_ID , GEOGRAPHY_MASTER_ID ) ;
...
CREATE INDEX CC_D_PP_HRZN_D_PP_ID_IDX ON CC_D_PRODUCTION_PLAN_HORIZON
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
ALTER TABLE CC_D_PRODUCTION_PLAN_HORIZON ADD CONSTRAINT CC_D_PRODUCTION_PLAN_HRZN_PK PRIMARY KEY ( PRODUCTION_PLAN_HRZN_ID ) ;
ALTER TABLE CC_D_PRODUCTION_PLAN_HORIZON ADD CONSTRAINT CC_D_PRODUCTION_PLAN_HRZN__UN UNIQUE ( PRODUCTION_PLAN_ID , HORIZON_START_DATE , HORIZON_START_HOUR , HORIZON_END_DATE , HORIZON_END_HOUR ) ;
...
CREATE TABLE CC_D_PROD_PLANNING_TARGET
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_PROD_PLANNING_TARGET ADD CONSTRAINT CC_D_PROD_PLANNING_TARGET_PK PRIMARY KEY ( D_PROD_PLANNING_TARGET_ID ) ;
ALTER TABLE CC_D_PROD_PLANNING_TARGET ADD CONSTRAINT CC_D_PROD_PLANNING_TARGET__UN UNIQUE ( D_PROJECT_ID , D_TARGET_ID , RECORD_EFF_DT ) ;
...
CREATE TABLE CC_D_PROJECT_TARGETS
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_PROJECT_TARGETS ADD CONSTRAINT D_PROJECT_REC_DATE_CK CHECK (RECORD_EFF_DT <= RECORD_END_DT) ;
CREATE UNIQUE INDEX CC_D_PROJECT__IDXv1 ON CC_D_PROJECT_TARGETS ( PROJECT_ID ASC ) TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_D_PROJECT_TARGETS ADD CONSTRAINT CC_D_PROJECT_TARGETS_PK PRIMARY KEY ( D_PROJECT_TARGETS_ID ) ;
  ALTER TABLE CC_D_PROJECT_TARGETS ADD CONSTRAINT CC_D_PROJECT_TARGETS__UN UNIQUE ( PROJECT_ID , RECORD_EFF_DT ) ;
...
CREATE TABLE CC_D_SITE
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_SITE ADD CONSTRAINT CC_D_SITE_REC_DATE_CK CHECK (RECORD_EFF_DT <= RECORD_END_DT) ;
CREATE UNIQUE INDEX CC_D_SITE__IDX ON CC_D_SITE ( D_SITE_ID ASC ) TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_D_SITE ADD CONSTRAINT CC_D_SITE_PK PRIMARY KEY ( D_SITE_ID ) ;
  ALTER TABLE CC_D_SITE ADD CONSTRAINT CC_D_SITE__UN UNIQUE ( SITE_NAME ) ;
...
CREATE TABLE CC_D_TARGET
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_TARGET ADD CONSTRAINT CC_D_TARGET_PK PRIMARY KEY ( D_TARGET_ID ) ;
...
CREATE TABLE CC_D_UNIT_OF_WORK
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_D_UNIT_OF_WORK ADD CHECK ( HOURLY_FLAG      IN ('N', 'Y')) ;
ALTER TABLE CC_D_UNIT_OF_WORK ADD CHECK ( HANDLE_TIME_UNIT IN ('Days', 'Hours', 'Minutes', 'Seconds')) ;
ALTER TABLE CC_D_UNIT_OF_WORK ADD CONSTRAINT CC_D_UNIT_OF_WORK_PK PRIMARY KEY ( UOW_ID ) ;
ALTER TABLE CC_D_UNIT_OF_WORK ADD CONSTRAINT CC_D_UNIT_OF_WORK_UK1 UNIQUE ( UNIT_OF_WORK_NAME , D_PROJECT_ID ) ;
...
CREATE INDEX CC_F_ACTUALS_IVR_INTERVAL_IDX7 ON CC_F_ACTUALS_IVR_INTERVAL
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
ALTER TABLE CC_F_ACTUALS_IVR_INTERVAL ADD CONSTRAINT CC_F_ACTUALS_IVR_INTERVAL_PK PRIMARY KEY ( F_ACTUALS_IVR_INTERVAL_ID ) ;
ALTER TABLE CC_F_ACTUALS_IVR_INTERVAL ADD CONSTRAINT CC_F_ACTUALS_IVR_INTERVAL__UN UNIQUE ( D_DATE_ID , D_PROJECT_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_UNIT_OF_WORK_ID , D_INTERVAL_ID ) ;
...
CREATE INDEX CC_F_ACTUALS_Q_INTERVAL_IDX9 ON CC_F_ACTUALS_QUEUE_INTERVAL
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
ALTER TABLE CC_F_ACTUALS_QUEUE_INTERVAL ADD CONSTRAINT CC_F_ACTUALS_QUEUE_INTERVAL_PK PRIMARY KEY ( F_CALL_CENTER_ACTLS_INTRVL_ID ) ;
ALTER TABLE CC_F_ACTUALS_QUEUE_INTERVAL ADD CONSTRAINT CC_F_ACTUALS_Q_INTERVAL__UN UNIQUE ( D_DATE_ID , D_PROJECT_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_UNIT_OF_WORK_ID , D_INTERVAL_ID , D_CONTACT_QUEUE_ID , D_AGENT_ID ) ;
...
CREATE UNIQUE INDEX CC_F_AGNT_AVL_DT_D_DT_IDX ON CC_F_AGENT_ACTIVITY_BY_DATE
  ...
  CREATE INDEX CC_F_AGNT_AVL_DT_D_PRJ_IDX ON CC_F_AGENT_ACTIVITY_BY_DATE
    ...
    TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_F_AGENT_ACTIVITY_BY_DATE ADD CONSTRAINT CC_F_AGENT_ACTVTY_BY_DATE_PK PRIMARY KEY ( F_AGENT_ACTIVITY_BY_DATE_ID ) ;
  ALTER TABLE CC_F_AGENT_ACTIVITY_BY_DATE ADD CONSTRAINT F_AGENT_ACT_BY_DATE__UN UNIQUE ( D_DATE_ID , D_AGENT_ID , D_ACTIVITY_TYPE_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_GROUP_ID , D_PROJECT_ID ) ;
...
CREATE TABLE CC_F_AGENT_BY_DATE
  (
    ...
    PAYROLL_COUNT           NUMBER (1) DEFAULT 0 NOT NULL ,
...
CREATE UNIQUE INDEX CC_F_AGNT_BY_DT_D_DT_ID_IDX ON CC_F_AGENT_BY_DATE
  ...
  CREATE INDEX CC_F_AGNT_BY_DT_D_GRP_ID_IDX ON CC_F_AGENT_BY_DATE
    ...
    TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_F_AGENT_BY_DATE ADD CONSTRAINT CC_F_AGENT_CALLS_BY_DATE_PK PRIMARY KEY ( F_AGENT_BY_DATE_ID ) ;
  ALTER TABLE CC_F_AGENT_BY_DATE ADD CONSTRAINT CC_F_AGENT_BY_DATE__UN UNIQUE ( D_DATE_ID , D_AGENT_ID , SUPERVISOR_D_AGENT_ID , MANAGER_D_AGENT_ID , D_PROJECT_TARGETS_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_GROUP_ID ) ;
...
CREATE INDEX CC_F_FORECAST_INTERVAL__IDXv5 ON CC_F_FORECAST_INTERVAL
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
ALTER TABLE CC_F_FORECAST_INTERVAL ADD CONSTRAINT CC_F_FORECAST_INTERVAL_PK PRIMARY KEY ( F_FORECAST_INTERVAL_ID ) ;
ALTER TABLE CC_F_FORECAST_INTERVAL ADD CONSTRAINT CC_F_FCST_INTERVAL__UN UNIQUE ( D_PRODUCTION_PLAN_HORIZON_ID , D_DATE_ID , D_UNIT_OF_WORK_ID , D_INTERVAL_ID , FORECAST_VERSION ) ;
...
CREATE INDEX CC_F_IVR_SLF_SVC_D_DT_ID_IDX ON CC_F_IVR_SELF_SERVICE_USAGE
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
ALTER TABLE CC_F_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT CC_F_IVR_SELF_SERVICE_USAGE_PK PRIMARY KEY ( IVR_SELF_SERVICE_USAGE_ID ) ;
ALTER TABLE CC_F_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT CC_F_IVR_SELF_SVC_USAGE__UN UNIQUE ( D_IVR_SELF_SERVICE_PATH_ID , D_PROJECT_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID , D_UNIT_OF_WORK_ID , D_INTERVAL_ID , D_DATE_ID ) ;
...
CREATE UNIQUE INDEX CC_F_PROJECT_BY_DATE__IDX2 ON CC_F_PROJECT_BY_DATE
  (
    D_DATE_ID ASC , D_PROJECT_TARGETS_ID ASC , D_PROGRAM_ID ASC , D_GEOGRAPHY_MASTER_ID ASC
  )
  TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PROJECT_BY_DATE_PK PRIMARY KEY ( F_PROJECT_BY_DATE_ID ) ;
  ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PROJECT_BY_DATE__UN UNIQUE ( D_DATE_ID , D_PROJECT_TARGETS_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID ) ;
...
CREATE TABLE CC_L_ERROR
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_L_ERROR ADD CONSTRAINT CC_L_ERROR_PK PRIMARY KEY ( ID ) ;
...
CREATE TABLE CC_L_PATCH_LOG
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_L_PATCH_LOG ADD CONSTRAINT CC_L_PATCH_LOG_PK PRIMARY KEY ( PATCH_LOG_ID ) ;
ALTER TABLE CC_L_PATCH_LOG ADD CONSTRAINT CC_L_PATCH_LOG__UN UNIQUE ( PATCH_VERSION , SCRIPT_NAME ) ;
...
CREATE UNIQUE INDEX CC_L_TRANSFORMATION_IDX1 ON CC_L_TRANSFORMATION
  ...
  CREATE INDEX CC_L_TRANSFORMATION_IDX2 ON CC_L_TRANSFORMATION
    ...
    TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_L_TRANSFORMATION ADD CONSTRAINT CC_L_TRANSFORMATION_PK PRIMARY KEY ( ID_BATCH ) ;
...
IS
  'Named Variable which will have a value stored' ;
  COMMENT ON COLUMN CORP_ETL_CONTROL.VALUE_TYPE
IS
  'Type of the named variable' ;
  COMMENT ON COLUMN CORP_ETL_CONTROL.VALUE
IS
  'Holds the value for the named variable identifier - secondary lookup value' ;
...
ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GEOGRAPHY_LKUP_NAME_UN UNIQUE ( GEOGRAPHY_NAME ) ;
ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GEOGRAPHY_MASTER__UN UNIQUE ( COUNTRY_ID , STATE_ID , PROVINCE_ID , DISTRICT_ID , REGION_ID ) ;
...
ALTER TABLE D_PROGRAM ADD CONSTRAINT D_PROGRAM_UNK UNIQUE ( PROGRAM_NAME ) ;
...
ALTER TABLE D_PROJECT ADD CONSTRAINT D_PROJECT_UNK UNIQUE ( PROJECT_NAME ) ;
...
ALTER TABLE CC_D_PROD_PLANNING_TARGET ADD CONSTRAINT CC_D_PRD_PLN_TRGT_CC_D_PRJ_FK FOREIGN KEY ( D_PROJECT_ID ) REFERENCES D_PROJECT ( D_PROJECT_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_D_PROJECT_TARGETS ADD CONSTRAINT CC_D_PRJ_TARGETS_D_PRJ_FK FOREIGN KEY ( PROJECT_ID ) REFERENCES D_PROJECT ( D_PROJECT_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_D_PRODUCTION_PLAN ADD CONSTRAINT CC_D_PROD_PLAN_D_GEO_FK FOREIGN KEY ( GEOGRAPHY_MASTER_ID ) REFERENCES D_GEOGRAPHY_MASTER ( D_GEOGRAPHY_MASTER_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_D_PRODUCTION_PLAN ADD CONSTRAINT CC_D_PROD_PLAN_D_PRG_FK FOREIGN KEY ( PROGRAM_ID ) REFERENCES D_PROGRAM ( D_PROGRAM_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_D_PRODUCTION_PLAN ADD CONSTRAINT CC_D_PROD_PLAN_D_PRJ_FK FOREIGN KEY ( PROJECT_ID ) REFERENCES D_PROJECT ( D_PROJECT_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_AGENT_BY_DATE ADD CONSTRAINT CC_F_AGENT_DATE_D_GEO_FK FOREIGN KEY ( D_GEOGRAPHY_MASTER_ID ) REFERENCES D_GEOGRAPHY_MASTER ( D_GEOGRAPHY_MASTER_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_AGENT_BY_DATE ADD CONSTRAINT CC_F_AGENT_DATE_D_PROGRAM_FK FOREIGN KEY ( D_PROGRAM_ID ) REFERENCES D_PROGRAM ( D_PROGRAM_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_AGENT_ACTIVITY_BY_DATE ADD CONSTRAINT CC_F_AGNT_ACT_D_GEO_MSTR_FK FOREIGN KEY ( D_GEOGRAPHY_MASTER_ID ) REFERENCES D_GEOGRAPHY_MASTER ( D_GEOGRAPHY_MASTER_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_AGENT_ACTIVITY_BY_DATE ADD CONSTRAINT CC_F_AGNT_ACT_D_PROGRAM_FK FOREIGN KEY ( D_PROGRAM_ID ) REFERENCES D_PROGRAM ( D_PROGRAM_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_F_AGENT_ACTIVITY_BY_DATE ADD CONSTRAINT CC_F_AGNT_ACT_D_PROJECT_FK FOREIGN KEY ( D_PROJECT_ID ) REFERENCES D_PROJECT ( D_PROJECT_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PRJ_BY_DT_CC_D_DT_FK FOREIGN KEY ( D_DATE_ID ) REFERENCES CC_D_DATES ( D_DATE_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PRJ_BY_DT_CC_D_GEO_M_FK FOREIGN KEY ( D_GEOGRAPHY_MASTER_ID ) REFERENCES D_GEOGRAPHY_MASTER ( D_GEOGRAPHY_MASTER_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PRJ_BY_DT_CC_D_PRGM_FK FOREIGN KEY ( D_PROGRAM_ID ) REFERENCES D_PROGRAM ( D_PROGRAM_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PRJ_BY_DT_CC_D_PRJ_TG_FK FOREIGN KEY ( D_PROJECT_TARGETS_ID ) REFERENCES CC_D_PROJECT_TARGETS ( D_PROJECT_TARGETS_ID ) NOT DEFERRABLE ;
...
ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GM_CC_D_COUNTRY_FK FOREIGN KEY ( COUNTRY_ID ) REFERENCES CC_D_COUNTRY ( COUNTRY_ID ) NOT DEFERRABLE ;

ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GM_CC_D_DISTRICT_FK FOREIGN KEY ( DISTRICT_ID ) REFERENCES CC_D_DISTRICT ( DISTRICT_ID ) NOT DEFERRABLE ;

ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GM_CC_D_PROVINCE_FK FOREIGN KEY ( PROVINCE_ID ) REFERENCES CC_D_PROVINCE ( PROVINCE_ID ) NOT DEFERRABLE ;

ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GM_CC_D_REGION_FK FOREIGN KEY ( REGION_ID ) REFERENCES CC_D_REGION ( REGION_ID ) NOT DEFERRABLE ;

ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GM_CC_D_STATE_FK FOREIGN KEY ( STATE_ID ) REFERENCES CC_D_STATE ( STATE_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_ACTUALS_IVR_INTERVAL ADD CONSTRAINT F_ACTLS_IVR_INTRVL_D_GEO_FK FOREIGN KEY ( D_GEOGRAPHY_MASTER_ID ) REFERENCES D_GEOGRAPHY_MASTER ( D_GEOGRAPHY_MASTER_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_ACTUALS_IVR_INTERVAL ADD CONSTRAINT F_ACTLS_IVR_INTRVL_D_PRG_FK FOREIGN KEY ( D_PROGRAM_ID ) REFERENCES D_PROGRAM ( D_PROGRAM_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_F_ACTUALS_IVR_INTERVAL ADD CONSTRAINT F_ACTLS_IVR_INTRVL_D_PRJ_FK FOREIGN KEY ( D_PROJECT_ID ) REFERENCES D_PROJECT ( D_PROJECT_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_ACTUALS_QUEUE_INTERVAL ADD CONSTRAINT F_ACTLS_Q_INTRVL_D_GEO_FK FOREIGN KEY ( D_GEOGRAPHY_MASTER_ID ) REFERENCES D_GEOGRAPHY_MASTER ( D_GEOGRAPHY_MASTER_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_ACTUALS_QUEUE_INTERVAL ADD CONSTRAINT F_ACTLS_Q_INTRVL_D_PRG_FK FOREIGN KEY ( D_PROGRAM_ID ) REFERENCES D_PROGRAM ( D_PROGRAM_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_F_ACTUALS_QUEUE_INTERVAL ADD CONSTRAINT F_ACTLS_Q_INTRVL_D_PRJ_FK FOREIGN KEY ( D_PROJECT_ID ) REFERENCES D_PROJECT ( D_PROJECT_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT F_IVR_SELF_SVC_D_GEO_FK FOREIGN KEY ( D_GEOGRAPHY_MASTER_ID ) REFERENCES D_GEOGRAPHY_MASTER ( D_GEOGRAPHY_MASTER_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_F_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT F_IVR_SELF_SVC_D_PRG_FK FOREIGN KEY ( D_PROGRAM_ID ) REFERENCES D_PROGRAM ( D_PROGRAM_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_F_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT F_IVR_SELF_SVC_D_PRJ_FK FOREIGN KEY ( D_PROJECT_ID ) REFERENCES D_PROJECT ( D_PROJECT_ID ) NOT DEFERRABLE ;
...
CREATE PUBLIC SYNONYM D_DATA_TYPE_SV FOR D_DATA_TYPE_SV ;

CREATE PUBLIC SYNONYM D_GEOGRAPHY_MASTER_SV FOR D_GEOGRAPHY_MASTER_SV ;

CREATE PUBLIC SYNONYM D_METRIC_DEFINITION_SV FOR D_METRIC_DEFINITION_SV ;

CREATE PUBLIC SYNONYM D_METRIC_PROJECT_SV FOR D_METRIC_PROJECT_SV ;

CREATE PUBLIC SYNONYM D_PROGRAM_SV FOR D_PROGRAM_SV ;

CREATE PUBLIC SYNONYM D_PROJECT_SV FOR D_PROJECT_SV ;

CREATE PUBLIC SYNONYM D_REPORTING_PERIOD_SV FOR D_REPORTING_PERIOD_SV ;

CREATE PUBLIC SYNONYM F_METRIC_SV FOR F_METRIC_SV ;
