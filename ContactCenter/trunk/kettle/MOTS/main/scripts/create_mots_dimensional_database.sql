...
ALTER TABLE CC_A_JOB_PROJECT ADD CONSTRAINT CC_A_JOB_PROJECT_PK PRIMARY KEY
(
  JOB_ID, D_PROJECT_ID, D_PROGRAM_ID, D_GEOGRAPHY_MASTER_ID
)
;
...
CREATE UNIQUE INDEX CC_D_AVAILABILITY_TYPE__IDX ON CC_D_ACTIVITY_TYPE
  ...
  (
    ACTIVITY_TYPE_NAME , RECORD_EFF_DT , D_PROJECT_ID
  )
  ;
...
CREATE UNIQUE INDEX CC_D_AGENT__IDX ON CC_D_AGENT
  ...
  (
    LOGIN_ID , RECORD_EFF_DT , D_PROJECT_ID
  )
  ;
...
(
  QUEUE_NUMBER , RECORD_EFF_DT , D_PROJECT_ID
)
;
...
CREATE UNIQUE INDEX CC_D_GROUP__IDX ON CC_D_GROUP
  ...
  (
    GROUP_NAME , RECORD_EFF_DT , D_PROJECT_ID
  )
  ;
...
(
  BEGIN_NODE , END_NODE , RECORD_EFF_DT , D_PROJECT_ID
)
;
...
(
  UNIT_OF_WORK_NAME , D_PROJECT_ID
)
;
...
CREATE UNIQUE INDEX CC_F_PROJECT_BY_DATE__IDX2 ON CC_F_PROJECT_BY_DATE
  ...
  TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PROJECT_BY_DATE_PK PRIMARY KEY
  (
    F_PROJECT_BY_DATE_ID
  )
  ;
  ALTER TABLE CC_F_PROJECT_BY_DATE ADD CONSTRAINT CC_F_PROJECT_BY_DATE__UN UNIQUE
  (
    D_DATE_ID , D_PROJECT_TARGETS_ID , D_PROGRAM_ID , D_GEOGRAPHY_MASTER_ID
  )
  ;
...
CREATE TABLE CC_L_ERROR
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_L_ERROR ADD CONSTRAINT CC_L_ERROR_PK PRIMARY KEY
(
  ID
)
;
...
CREATE TABLE CC_L_PATCH_LOG
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_L_PATCH_LOG ADD CONSTRAINT CC_L_PATCH_LOG_PK PRIMARY KEY
(
  PATCH_LOG_ID
)
;
ALTER TABLE CC_L_PATCH_LOG ADD CONSTRAINT CC_L_PATCH_LOG__UN UNIQUE
(
  PATCH_VERSION , SCRIPT_NAME
)
;
ALTER TABLE CC_L_PATCH_LOG ADD CONSTRAINT CC_L_PATCH_LOG__UNv1 UNIQUE
(
  PATCH_VERSION , SCRIPT_SEQUENCE
)
;
...
CREATE UNIQUE INDEX CC_L_TRANSFORMATION_IDX1 ON CC_L_TRANSFORMATION
  ...
  CREATE INDEX CC_L_TRANSFORMATION_IDX2 ON CC_L_TRANSFORMATION
    ...
    TABLESPACE MOTS_INDEX LOGGING ;
  ALTER TABLE CC_L_TRANSFORMATION ADD CONSTRAINT CC_L_TRANSFORMATION_PK PRIMARY KEY
  (
    ID_BATCH
  )
  ;
...
IS
  ...
  ALTER TABLE CORP_ETL_CONTROL ADD CONSTRAINT CECTL_PK PRIMARY KEY
  (
    NAME
  )
  ;
...
CREATE TABLE CORP_ETL_JOB_STATISTICS
  ...
  TABLESPACE MOTS_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CORP_ETL_JOB_STATISTICS ADD CONSTRAINT CORP_ETL_JOB_STATISTICS_PK PRIMARY KEY
(
  JOB_ID
)
;
...
;
ALTER TABLE D_GEOGRAPHY_MASTER ADD CONSTRAINT D_GEOGRAPHY_LKUP_NAME_UN UNIQUE
(
  GEOGRAPHY_NAME
)
;
...
;
ALTER TABLE D_PROGRAM ADD CONSTRAINT D_PROGRAM_UNK UNIQUE
(
  PROGRAM_NAME
)
;
...
;
ALTER TABLE D_PROJECT ADD CONSTRAINT D_PROJECT_UNK UNIQUE
(
  PROJECT_NAME
)
;
