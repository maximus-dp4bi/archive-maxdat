...
export STCODE
PATH=$MAXDAT_KETTLE_DIR:/usr/bin::/usr/X11/lib:/usr/X11/bin/:/usr/local/bin:/usr/local/git/bin:/usr/local/sbin:/ptxe4t/3rdparty:/usr/X/bin
export PATH;
#added the parameter as part of JIRA-2787
MAXDAT_MOTS_FILES=/ptxe4t/3rdparty/mots/files
export MAXDAT_MOTS_FILES
## jira 8045
export AO_ROOT="/ptxe4t/ETL_Scripts/scripts/AO"
export AO_ETL_PATH="/ptxe4t/ETL_Scripts/scripts/AO/main"
export AO_ETL_LOGS="/ptxe4t/ETL_Logs/logs/AO"
export AO_FILES_DIR="/ptxe4t/3rdparty/AO/files"
...
ksh $AO_ETL_PATH/bin/run_project_ao_extract_job_tx.sh TXEC $START_DATE $END_DATE $JOB $JOBTYPE
sleep 10
