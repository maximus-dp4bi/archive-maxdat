...
## jira 8045
export AO_ROOT="/dtxe4t/ETL_Scripts/scripts/AO"
export AO_ETL_PATH="/dtxe4t/ETL_Scripts/scripts/AO/main"
export AO_ETL_LOGS="/dtxe4t/ETL_Logs/logs/AO"
export AO_FILES_DIR="/dtxe4t/3rdparty/AO/files"
