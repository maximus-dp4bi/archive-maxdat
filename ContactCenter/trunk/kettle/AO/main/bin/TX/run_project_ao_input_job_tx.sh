...
AO_INPUT_OUT_DIR=$AO_FILES_DIR/files/Agentmap/Outbound
AO_EXTRACT_MATCH_DIR=$AO_FILES_DIR/files/Agentmap/Inbound
AO_EXTRACT_OUT_DIR=$AO_FILES_DIR/files/ACDExtract/Outbound
LOG_DIR=$AO_ETL_LOGS
...
EMAIL="18956@maximus.com 52647@maximus.com 51922@maximus.com 24065@maximus.com"
