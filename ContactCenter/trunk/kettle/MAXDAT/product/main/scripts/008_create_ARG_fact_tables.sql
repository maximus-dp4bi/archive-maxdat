...
CREATE TABLE CC_F_AGENT_RTG_GRP_INTERVAL
  (
    ...
    INTERNAL_SECONDS      NUMBER(14, 2) NOT NULL ,
    EXTERNAL_CALLS_COUNT  NUMBER(10, 0) NOT NULL ,
    EXTERNAL_SECONDS      NUMBER(14, 2) NOT NULL ,
    HOLD_SECONDS          NUMBER(14, 2) NOT NULL ,
    RING_SECONDS          NUMBER(14, 2) NOT NULL ,
    TALK_SECONDS          NUMBER(14, 2) NOT NULL ,
    WRAP_SECONDS          NUMBER(14, 2) NOT NULL ,
    LOGIN_SECONDS           NUMBER(14, 2) DEFAULT 0 NOT NULL ,
    IDLE_SECONDS            NUMBER(14, 2) DEFAULT 0 NOT NULL ,
    NOT_READY_SECONDS       NUMBER(14, 2) DEFAULT 0 NOT NULL ,
