...
CREATE TABLE CC_D_CONTACT_QUEUE
  (
    ...
    INTERVAL_MINUTES               NUMBER (2) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_1_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_2_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_3_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_4_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_5_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_6_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_7_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_8_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_9_BOUND    NUMBER (5) DEFAULT 0 NULL ,
    SPEED_ANSWER_PERIOD_10_BOUND   NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_1_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_2_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_3_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_4_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_5_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_6_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_7_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_8_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_9_BOUND  NUMBER (5) DEFAULT 0 NULL ,
    CALLS_ABNDONED_PERIOD_10_BOUND NUMBER (5) DEFAULT 0 NULL ,
    ...
    BUCKET_INTERVAL_ID  NUMBER(38,0)
  )
  TABLESPACE MAXDAT_DATA LOGGING ENABLE ROW MOVEMENT ;
...
CREATE OR REPLACE VIEW "CC_F_IVR_SURVY_BY_DATE_SV" ("SURVEY_DATE", "D_DATE_ID", "QUESTION_NUMBER", "QUESTION", "ANSWER_KEY", "ANSWER_TEXT", "ANSWER_COUNT", "D_PROJECT_ID", "D_PROGRAM_ID") AS 
  SELECT
...
CREATE OR REPLACE VIEW "CC_F_IVR_SURVY_LANG_BY_DATE_SV" ("SURVEY_DATE", "D_DATE_ID", "QUEUE_NUMBER", "SURVEY_LANGUAGE", "CALLS_COUNT", "D_PROJECT_ID", "D_PROGRAM_ID") AS 
SELECT
D.D_DATE AS SURVEY_DATE
, F.D_DATE_ID
, F.QUEUE_NUMBER
