CREATE TABLE CC_S_AGENT_RTG_GRP_INTERVAL
  (
    ...
    LOGIN_SECONDS           NUMBER(14,2) DEFAULT 0 NOT NULL ENABLE,
    EXTERNAL_SECONDS        NUMBER(14,2) DEFAULT 0 NOT NULL ENABLE,
    INTERNAL_SECONDS        NUMBER(14,2) DEFAULT 0 NOT NULL ENABLE,
    IDLE_SECONDS            NUMBER(14,2) DEFAULT 0 NOT NULL ENABLE,
    NOT_READY_SECONDS       NUMBER(14,2) DEFAULT 0 NOT NULL ENABLE,
    ACD_TALK_SECONDS        NUMBER(14,2) NOT NULL ENABLE,
    HOLD_SECONDS            NUMBER(14,2) NOT NULL ENABLE,
    AFTER_CALL_WORK_SECONDS NUMBER(14,2) NOT NULL ENABLE,
    TALK_RESERVE_SECONDS    NUMBER(14,2),
    RING_SECONDS            NUMBER(14,2) NOT NULL ENABLE,
