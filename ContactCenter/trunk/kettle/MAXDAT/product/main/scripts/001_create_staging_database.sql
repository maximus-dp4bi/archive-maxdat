...
CREATE TABLE CC_S_ACD_INTERVAL_PERIOD 
    ( 
     ...
     PERIOD_1_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_1_UPPER_BOUND >= 0) , 
     PERIOD_2_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_2_UPPER_BOUND >= 0) , 
     PERIOD_3_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_3_UPPER_BOUND >= 0) , 
     PERIOD_4_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_4_UPPER_BOUND >= 0) , 
     PERIOD_5_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_5_UPPER_BOUND >= 0) , 
     PERIOD_6_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_6_UPPER_BOUND >= 0) , 
     PERIOD_7_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_7_UPPER_BOUND >= 0) , 
     PERIOD_8_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_8_UPPER_BOUND >= 0) , 
     PERIOD_9_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_9_UPPER_BOUND >= 0) , 
     PERIOD_10_UPPER_BOUND NUMBER (5) DEFAULT 0  NULL CHECK ( PERIOD_10_UPPER_BOUND >= 0) , 
     EXTRACT_DT DATE  NOT NULL , 
     RECORD_EFF_DT DATE DEFAULT to_date('1900/01/01', 'yyyy/mm/dd')  NOT NULL , 
     RECORD_END_DT DATE DEFAULT to_date('2999/12/31', 'yyyy/mm/dd')  NOT NULL ,
     BUCKET_INTERVAL_ID INT NOT NULL ,
     ENTERPRISE_NAME varchar2(32) NOT NULL  
     ) 
        TABLESPACE MAXDAT_DATA 
        LOGGING 
;
...
CREATE TABLE CC_S_TMP_AVY_AGENTBYAPP 
    ( 
     ...
     HOLDTIME NUMBER (10) ,
     CALLSOFFERED	NUMBER(7,0) DEFAULT 0 NOT NULL,
     CALLSANSWERED	NUMBER(7,0)  DEFAULT 0 NOT NULL,
     CALLSTRANSFERRED NUMBER(7,0)  DEFAULT 0 NOT NULL,
     WAITTIME	NUMBER(7,0)  DEFAULT 0 NOT NULL,
     TALKTIME	NUMBER(7,0)  DEFAULT 0 NOT NULL,
     POSTCALLPROCESSINGTIME	NUMBER(7,0)  DEFAULT 0 NOT NULL
    ) 
        TABLESPACE MAXDAT_DATA 
        LOGGING 
;
...
CREATE TABLE CC_S_TMP_CISCO_CT_SG_INTERVAL 
    ( 
     ...
     RETURNRING NUMBER ,
     ROUTERCALLSDEQUEUED NUMBER, 
     ROUTERCALLSABANDDEQUEUED NUMBER
    ) 
        TABLESPACE MAXDAT_DATA 
        LOGGING 
;
...
CREATE TABLE CC_S_TMP_CISCO_A_SG_INTERVAL 
    ( 
     ...
     SHORTCALLS NUMBER(10,0), 
     REDIRECTNOANSCALLS NUMBER(10,0),
     AGENTROUTINGGROUPNUMBER NUMBER,
     AGENTROUTINGGROUPTYPE VARCHAR2(50)
    ) 
        TABLESPACE MAXDAT_DATA 
        LOGGING 
;
...
CREATE TABLE CC_S_TMP_ALL_AGENTS
  (
    ...
    PERIPHERALNUMBER    VARCHAR2(32 BYTE),
...
(
  AGENTLOGINID NVARCHAR2(255)
 ,AGENTFIRSTNAME VARCHAR2(100)
 ,AGENTLASTNAME VARCHAR2(100)
 ,SUPLOGINID NVARCHAR2(255)
 ,SUPFIRSTNAME VARCHAR2(100)
 ,SUPLASTNAME VARCHAR2(100)
