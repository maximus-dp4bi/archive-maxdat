ALTER TABLE CC_S_TMP_CISCO_A_SG_INTERVAL ADD (AgentOutCallsTalkTime NUMBER(19,0), AgentOutCallsOnHoldTime NUMBER(19,0));

ALTER TABLE CC_S_ACD_AGENT_ACTIVITY ADD (EXTERNAL_TALK_SECONDS NUMBER(19,0), EXTERNAL_HOLD_SECONDS NUMBER(19,0));

ALTER TABLE CC_S_AGENT_RTG_GRP_INTERVAL ADD (EXTERNAL_TALK_SECONDS NUMBER(19,0), EXTERNAL_HOLD_SECONDS NUMBER(19,0));

ALTER TABLE CC_F_AGENT_BY_DATE ADD (EXTERNAL_TALK_SECONDS NUMBER(19,0), EXTERNAL_HOLD_SECONDS NUMBER(19,0));

ALTER TABLE CC_F_AGENT_RTG_GRP_INTERVAL ADD (EXTERNAL_TALK_SECONDS NUMBER(19,0), EXTERNAL_HOLD_SECONDS NUMBER(19,0));


-- Recompile semantic views:
...
CREATE OR REPLACE FORCE VIEW CC_F_AGENT_RTG_GRP_INTERVAL_SV (F_AGENT_RTG_GRP_INTERVAL_ID, D_DATE_ID,D_INTERVAL_ID, D_AGENT_ID, AGENT_ROUTING_GROUP_ID, SUPERVISOR_D_AGENT_ID, MANAGER_D_AGENT_ID, D_PROJECT_ID, D_PROGRAM_ID, D_GEOGRAPHY_MASTER_ID, D_GROUP_ID, D_SITE_ID, HANDLE_CALLS_COUNT, HANDLE_TIME_SECONDS, INTERNAL_CALLS_COUNT, INTERNAL_SECONDS, EXTERNAL_CALLS_COUNT, EXTERNAL_SECONDS, HOLD_SECONDS, RING_SECONDS, TALK_SECONDS, WRAP_SECONDS, TALK_RESERVE_SECONDS, PREDICTIVE_TALK_SECONDS, PREVIEW_TALK_SECONDS, PREDICTIVE_CALLS_COUNT, PREVIEW_CALLS_COUNT, BREAK_TIME, CONSULTATION_TIME, WALKAWAY_TIME, BUSYONDNTIME, PAYROLL_COUNT, ATTRITED_COUNT,SHORT_CALLS,CALLS_RETURNED_TO_QUEUE,AGENT_LOGIN_ID, SUPERVISOR_AGENT_LOGIN_ID, MANAGER_AGENT_LOGIN_ID,AGENT_ROUTING_GROUP_NUMBER, AGENT_ROUTING_GROUP_NAME, AGENT_ROUTING_GROUP_TYPE, CREATE_DATE, CREATED_BY, LAST_UPDATE_DATE, LAST_UPDATE_BY
  , EXTERNAL_TALK_SECONDS, EXTERNAL_HOLD_SECONDS)
AS
SELECT CC_F_AGENT_RTG_GRP_INTERVAL.F_AGENT_RTG_GRP_INTERVAL_ID,
    ...
    CC_F_AGENT_RTG_GRP_INTERVAL.EXTERNAL_TALK_SECONDS,
    CC_F_AGENT_RTG_GRP_INTERVAL.EXTERNAL_HOLD_SECONDS
  ...
  CREATE OR REPLACE VIEW "CISCO_ENTERPRISE_CC"."CC_F_PROGRAM_BY_INTERVAL_SV" ("D_DATE_ID", "D_INTERVAL_ID", "D_PROGRAM_ID", "D_PROJECT_ID", "ABANDON_THRESHOLD", "ABANDON_TIME_TOTAL", "AFTER_CALL_WORK_TIME_TOTAL", "AGENT_ERROR_COUNT", "ANSWER_WAIT_TIME_TOTAL", "AVG_TIME_TO_ABANDON", "CALLS_ANSWERED", "CALLS_GIVEN_FORCE_DISCONNECT", "CALLS_GIVEN_ROUTE_TO", "CALLS_ON_HOLD", "CALLS_RONA", "CALLS_ROUTED_NON_AGENT", "CONTACTS_ABANDONED", "CONTACTS_BLOCKED", "CONTACTS_HANDLED", "CONTACTS_OFFERED", "RAW_CONTACTS_OFFERED", "CONTACTS_RECEIVED_FROM_IVR", "CONTACTS_TRANSFERRED", "CONTACT_INVENTORY", "CONTACT_INVENTORY_JEOPARDY", "CTVRU_TIME", "ERROR_COUNT", "HANDLE_TIME", "HEADCOUNT_AVAILABLE", "HEADCOUNT_TOTAL", "HEADCOUNT_UNAVAILABLE", "HOLD_TIME_TOTAL", "ICR_DEFAULT_ROUTED", "INCOMPLETE_CALLS", "LABOR_MINUTES_AVAILABLE", "LABOR_MINUTES_TOTAL", "LABOR_MINUTES_WAITING", "MAX_ABANDON_TIME", "MAX_CALLS_QUEUED", "MAX_SPEED_OF_ANSWER", "MEAN_HANDLE_TIME", "MEAN_SPEED_OF_ANSWER", "MEAN_SPEED_TO_HANDLE", "NETWORK_DEFAULT_ROUTED", "OUTFLOW_CONTACTS", "RETURN_BUSY", "RETURN_RELEASE", "RETURN_RING", "ROUTER_QUEUE_WAIT_TIME", "SERVICE_LEVEL_ABANDONED", "SERVICE_LEVEL_ANSWERED_COUNT", "SERVICE_LEVEL_ANSWERED_PERCENT", "SERVICE_LEVEL_CALLS", "SHORT_ABANDONS", "SHORT_CALLS", "TALK_TIME_TOTAL", "HANDLE_CALLS_COUNT", "HANDLE_TIME_SECONDS", "INTERNAL_CALLS_COUNT", "INTERNAL_SECONDS", "EXTERNAL_CALLS_COUNT", "EXTERNAL_SECONDS", "HOLD_SECONDS", "RING_SECONDS", "TALK_SECONDS", "WRAP_SECONDS", "TALK_RESERVE_SECONDS", "PREDICTIVE_TALK_SECONDS", "PREVIEW_TALK_SECONDS", "PREDICTIVE_CALLS_COUNT", "PREVIEW_CALLS_COUNT", "BREAK_TIME", "CONSULTATION_TIME", "WALKAWAY_TIME", "BUSYONDNTIME", "PAYROLL_COUNT", "ATTRITED_COUNT", "CALLS_RETURNED_TO_QUEUE", "EXTERNAL_TALK_SECONDS", "EXTERNAL_HOLD_SECONDS") AS 
...
SELECT 
       ...
       SUM(CC_F_AGENT_RTG_GRP_INTERVAL.EXTERNAL_TALK_SECONDS) as EXTERNAL_TALK_SECONDS,
       SUM(CC_F_AGENT_RTG_GRP_INTERVAL.EXTERNAL_HOLD_SECONDS) as EXTERNAL_HOLD_SECONDS
       FROM CC_F_AGENT_RTG_GRP_INTERVAL
...
,EXTERNAL_TALK_SECONDS
,EXTERNAL_HOLD_SECONDS
FROM COMBINATION;
