...
using 
 ( select 
    ...
    where aet.eventcode in (1,2) 
    --and d.d_year=2019 and d.d_month_num='11'
    and ((d.d_date between '01-NOV-19' and '05-NOV-19') 
     or (d.d_date between '08-NOV-19' and '09-NOV-19'))
    group by 
    aad.d_agent_id
    ,aad.d_date_id
...
--where d.d_year=2019 and d.d_month_num='11'
and ((d.d_date between '01-NOV-19' and '05-NOV-19') 
     or (d.d_date between '08-NOV-19' and '09-NOV-19')))t1
where not exists (
select * from 
