insert into cc_a_list_lkup (NAME,LIST_TYPE,VALUE,OUT_VAR,REF_ID,START_DATE,END_DATE,COMMENTS)
  values ('DISABLE_EMAIL_ALERTS_STARTTIME','DISABLE_EMAIL_ALERTS','DISABLE_EMAIL_ALERTS_STARTTIME','22:00',1,TO_DATE('01-JAN-1900','DD-MON-YYYY'),TO_DATE('31-DEC-2199','DD-MON-YYYY'),'Start time to disable email alerts on CC jobs');

insert into cc_a_list_lkup (NAME,LIST_TYPE,VALUE,OUT_VAR,REF_ID,START_DATE,END_DATE,COMMENTS)
  values ('DISABLE_EMAIL_ALERTS_ENDTIME','DISABLE_EMAIL_ALERTS','DISABLE_EMAIL_ALERTS_ENDTIME','23:59',1,TO_DATE('01-JAN-1900','DD-MON-YYYY'),TO_DATE('31-DEC-2199','DD-MON-YYYY'),'End time to disable email alerts on CC jobs');
