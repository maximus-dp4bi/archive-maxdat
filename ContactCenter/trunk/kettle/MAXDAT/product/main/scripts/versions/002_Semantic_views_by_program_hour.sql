CREATE OR REPLACE FORCE VIEW CC_F_PROGRAM_BY_HOUR_SV 
AS
with QUEUE_INTERVAL as 
(
SELECT 
      CC_F_ACTUALS_QUEUE_INTERVAL.D_DATE_ID as Q_D_DATE_ID,
      CC_D_INTERVAL.INTERVAL_START_HOUR as Q_INTERVAL_HOUR,
...
SELECT 
       ...
       CC_D_INTERVAL.INTERVAL_START_HOUR as ARG_INTERVAL_HOUR,
...
FULL OUTER JOIN AGENT_RTG_GRP_INTERVAL ON  QUEUE_INTERVAL.Q_D_DATE_ID = AGENT_RTG_GRP_INTERVAL.ARG_D_DATE_ID
                           AND QUEUE_INTERVAL.Q_INTERVAL_HOUR = AGENT_RTG_GRP_INTERVAL.ARG_INTERVAL_HOUR
...
,CASE WHEN Q_INTERVAL_HOUR IS NULL THEN ARG_INTERVAL_HOUR ELSE Q_INTERVAL_HOUR END INTERVAL_HOUR
...
grant select on CC_F_PROGRAM_BY_HOUR_SV to MAXDAT_READ_ONLY; 