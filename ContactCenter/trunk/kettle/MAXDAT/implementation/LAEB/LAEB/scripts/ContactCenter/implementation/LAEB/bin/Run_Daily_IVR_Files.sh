...
# $URL: svn://rcmxapp1d.maximus.com/maxdat/ContactCenter/trunk/kettle/MAXDAT/implementation/LAEB/bin/Run_Daily_IVR_Files.sh $
# $Revision: 18508 $
# $Date: 2016-10-19 14:04:17 -0700 (Wed, 19 Oct 2016) $
# $Author: pa28085 $
...
JOBS_DIR=$MAXDAT_ETL_PATH/ContactCenter/implementation/LAEB/jobs/IVR
