...
and b.project_name = 'IL EB'
and f.d_Date_id = g.d_date_id
and g.d_date < '27-NOV-17');
...
and c.project_name = 'IL EB'
and a.d_Date_id = d.d_date_id
and d.d_date < '27-NOV-17');
...
and c.project_name = 'IL EB'
and trunc(interval_date) < '27-NOV-17');
