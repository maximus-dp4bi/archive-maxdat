...
and b.project_name = 'Florida Healthy Kids'
and f.d_Date_id = g.d_date_id
and g.d_date < '17-JUL-17');
...
and c.project_name = 'Florida Healthy Kids'
and a.d_Date_id = d.d_date_id
and d.d_date < '17-JUL-17');
...
and b.queue_number = c.queue_number
and c.project_name = 'Florida Healthy Kids'
and trunc(interval_date) < '17-JUL-17');
