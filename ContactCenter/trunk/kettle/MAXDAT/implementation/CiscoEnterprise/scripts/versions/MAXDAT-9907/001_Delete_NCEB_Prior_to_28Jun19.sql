...
and b.project_name = 'NCEB'
and f.d_Date_id = g.d_date_id
and g.d_date < '28-JUN-19');
...
and c.project_name = 'NCEB'
and a.d_Date_id = d.d_date_id
and d.d_date < '28-JUN-19');
...
delete from cc_f_v2_call 
where f_v2_call_id in (select f_v2_call_id from cc_f_v2_call a, cc_c_contact_queue b, cc_d_dates c
where a.queue_number = b.queue_number
and b.project_name = 'NCEB'
and a.d_date_id = c.d_date_id
and c.d_date < '28-JUN-19');

delete from cc_s_v2_call
where s_v2_call_id in (select s_v2_call_id from cc_s_v2_call a, cc_c_contact_queue b
where a.queue_number = b.queue_number
and b.project_name = 'NCEB'
and a.d_date < '28-JUN-19');
...
and c.project_name = 'NCEB'
and trunc(interval_date) < '28-JUN-19');
