...
and b.project_name = 'Wyoming Dept of Health'
and f.d_Date_id = g.d_date_id
and g.d_date < '03-OCT-16');
...
and c.project_name = 'Wyoming Dept of Health'
and a.d_Date_id = d.d_date_id
and d.d_date < '03-OCT-16');
...
and b.queue_number = c.queue_number
and c.project_name = 'Wyoming Dept of Health'
and trunc(interval_date) < '03-OCT-16');
