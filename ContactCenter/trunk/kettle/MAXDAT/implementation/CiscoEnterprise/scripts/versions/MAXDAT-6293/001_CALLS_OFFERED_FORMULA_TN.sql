...
insert into cc_a_list_lkup     (	cc_cell_id
			...
			values (	seq_cc_cell_id.NEXTVAL
					,'CALLS_OFFERED_FORMULA'
					,'CC_S_ACD_INTERVAL-CALLS_OFFERED'
					,'TN 6th Judicial District'
