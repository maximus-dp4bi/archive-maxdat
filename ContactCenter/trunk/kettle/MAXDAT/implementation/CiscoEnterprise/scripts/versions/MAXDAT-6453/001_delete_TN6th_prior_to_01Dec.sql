...
and b.project_name = 'TN 6th Judicial District'
and f.d_Date_id = g.d_date_id
and g.d_date < '01-DEC-17');
...
and c.project_name = 'TN 6th Judicial District'
and a.d_Date_id = d.d_date_id
and d.d_date < '01-DEC-17');
...
and c.project_name = 'TN 6th Judicial District'
and trunc(interval_date) < '01-DEC-17');
