...
and b.project_name = 'LA EB'
and f.d_Date_id = g.d_date_id
and g.d_date < '01-FEB-18');
...
and c.project_name = 'LA EB'
and a.d_Date_id = d.d_date_id
and d.d_date < '01-FEB-18');
...
and c.project_name = 'LA EB'
and trunc(interval_date) < '01-FEB-18');
