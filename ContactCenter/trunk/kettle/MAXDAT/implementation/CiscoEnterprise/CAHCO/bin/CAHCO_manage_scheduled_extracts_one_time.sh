...
# $URL: svn://rcmxapp1d.maximus.com/maxdat/ContactCenter/trunk/kettle/MAXDAT/main/bin/manage_adhoc_contact_center_jobs_one_time.sh $
# $Revision: 10689 $
...
JOBS_DIR=$MAXDAT_ETL_PATH/ContactCenter/implementation/CAHCO/scripts/OneTime
JOB=CAHCO_manage_scheduled_extracts
