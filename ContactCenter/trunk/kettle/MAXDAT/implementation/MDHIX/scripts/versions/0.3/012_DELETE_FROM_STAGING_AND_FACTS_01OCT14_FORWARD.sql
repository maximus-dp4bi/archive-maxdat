...
where trunc(interval_date) >= '01-OCT-14';

commit;

delete from CC_S_ACD_AGENT_ACTIVITY
where trunc(agent_calls_dt) >= '01-OCT-14';

commit;

delete from CC_S_AGENT_WORK_DAY
where trunc(work_date) >= '01-OCT-14';

commit;

delete from CC_S_WFM_AGENT_ACTIVITY
where trunc(activity_start_time) >= '01-OCT-14';

commit;

delete from CC_S_AGENT_ABSENCE
where trunc(absence_date) >= '01-OCT-14';
