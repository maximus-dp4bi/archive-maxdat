...
where trunc(interval_date)  >= '26-SEP-15';
...
where trunc(agent_calls_dt)  >= '26-SEP-15';

delete from CC_S_AGENT_WORK_DAY
where trunc(work_date)  >= '26-SEP-15';

delete from CC_S_WFM_AGENT_ACTIVITY
where trunc(activity_start_time)  >= '26-SEP-15';

delete from CC_S_AGENT_ABSENCE
where trunc(absence_date)  >= '26-SEP-15';
