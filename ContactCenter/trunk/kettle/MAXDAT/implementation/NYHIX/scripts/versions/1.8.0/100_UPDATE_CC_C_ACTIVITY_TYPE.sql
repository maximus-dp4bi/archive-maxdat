...
'Un-Scheduled Break','Flex Time','Authorized Rep','Application Missing Information','Awaiting Validity Check','Eligibility Specialist C ','Document Problem Resolution','Idle Time');
