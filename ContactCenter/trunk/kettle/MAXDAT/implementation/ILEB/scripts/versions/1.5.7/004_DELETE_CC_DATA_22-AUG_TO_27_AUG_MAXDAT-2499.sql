...
and d.d_date between '22-AUG-15' and '27-AUG-15');
...
where trunc(interval_date) between '22-AUG-15' and '27-AUG-15';
...
where trunc(agent_calls_dt) between '22-AUG-15' and '27-AUG-15';

delete from CC_S_AGENT_WORK_DAY
where trunc(work_date) between '22-AUG-15' and '27-AUG-15';

delete from CC_S_WFM_AGENT_ACTIVITY
where trunc(activity_start_time) between '22-AUG-15' and '27-AUG-15';

delete from CC_S_AGENT_ABSENCE
where trunc(absence_date) between '22-AUG-15' and '27-AUG-15';
