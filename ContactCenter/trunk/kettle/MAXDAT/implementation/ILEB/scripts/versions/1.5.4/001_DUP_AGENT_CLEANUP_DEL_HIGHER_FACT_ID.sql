delete from cc_f_agent_activity_by_date where f_agent_activity_by_date_id in (
    ...
    driver4 as (
      select d3a.login_id, d3a.d_date_id, d3a.d_activity_type_id, d3a.d_program_id, d3a.d_project_id, min(d3a.f_agent_activity_by_date_id) f_agent_activity_by_date_id
      from driver3 d3a
...
delete from cc_f_agent_by_date where f_agent_by_date_id in (
    with driver as (
        ...
        driver4 as (
          select d3a.login_id, d3a.d_date_id,min(d3a.f_agent_by_date_id) f_agent_by_date_id
          from driver3 d3a
