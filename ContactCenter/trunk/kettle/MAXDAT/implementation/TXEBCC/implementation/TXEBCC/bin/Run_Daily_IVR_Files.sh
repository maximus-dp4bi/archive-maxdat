...
# $URL: svn://rcmxapp1d.maximus.com/maxdat/ContactCenter/trunk/kettle/MAXDAT/implementation/CiscoEnterprise/bin/Run_Daily_IVR_Files.sh $
# $Revision: 17298 $
# $Date: 2016-05-23 15:04:04 -0700 (Mon, 23 May 2016) $
# $Author: pa28085 $
...
JOBS_DIR=$MAXDAT_ETL_PATH/ContactCenter/implementation/CiscoEnterprise/jobs/IVR
