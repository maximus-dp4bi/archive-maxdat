...
BEGIN
    ...
    IF UPDATING THEN
        ...
        INSERT INTO aiu_ts_audit (
            ...
            :old.audit_call_hour_am_pm,
            :old.call_type_id,
            :old.audit_call_duration,
			:old.audit_call_duration_ss,
			:old.audit_call_duration_mm,
			:old.audit_call_duration_hh,
            ...
            :old.audit_comments,
            :old.audit_answered,
            :old.audit_call_result,
            :old.audit_customer_name,
            :old.create_by,
            :old.create_datetime,
            :old.last_updated_by,
            :old.last_updated_datetime
    ...
    INSERT INTO aiu_ts_audit (
        ...
        :new.audit_call_hour_am_pm,
        :new.call_type_id,
        :new.audit_call_duration,
		:new.audit_call_duration_ss,
		:new.audit_call_duration_mm,
		:new.audit_call_duration_hh,
        ...
        :new.audit_comments,
        :new.audit_answered,
        :new.audit_call_result,
        :new.audit_customer_name,
        :new.create_by,
        :new.create_datetime,
        :new.last_updated_by,
        :new.last_updated_datetime
...
BEGIN
    ...
    then
        ...
        INSERT INTO aiu_ts_audit_question_answer (
            ...
            :old.audit_quest_answer_max_score,
    ...
    INSERT INTO aiu_ts_audit_question_answer (
        ...
        :new.audit_quest_answer_max_score,
...
create or replace TRIGGER TRG_AIU_TS_QUEST_ANSWER_DET
AFTER INSERT OR UPDATE ON TS_QUEST_ANSWER_DETAIL 
for each row
...
BEGIN
    ...
    IF UPDATING THEN
        ...
        INSERT INTO aiu_ts_quest_answer_detail (
            record_type,
            record_action,
            transaction_date,
            audit_question_answer_id,
            ...
            :old.question_detail_id,
            :old.qa_question_id,
            :old.question_answer_detail_chk,
            :old.create_by,
            :old.create_datetime,
            :old.last_updated_by,
            :old.last_updated_datetime
    ...
    INSERT INTO aiu_ts_quest_answer_detail (
        ...
        :new.question_detail_id,
        :new.qa_question_id,
        :new.question_answer_detail_chk,
        :new.create_by,
        :new.create_datetime,
        :new.last_updated_by,
        :new.last_updated_datetime
...
create or replace TRIGGER TRG_AIU_TS_QA_SUPERVISOR
AFTER INSERT OR UPDATE ON TS_QA_SUPERVISOR 
for each row
...
BEGIN
    ...
    IF UPDATING THEN
        ...
        INSERT INTO aiu_ts_qa_supervisor (
            record_type,
            record_action,
            transaction_date,
            qa_supervisor_id,
            ...
            'delete',
            sysdate,
            :old.qa_supervisor_id,
            :old.qa_supervisor_login_id,
            :old.qa_supervisor_first_name,
            :old.qa_supervisor_middle_initial,
            :old.qa_supervisor_last_name,
            :old.qa_supervisor_active,
            :old.create_by,
            :old.create_datetime,
            :old.last_updated_by,
            :old.last_updated_datetime
    ...
    INSERT INTO aiu_ts_qa_supervisor (
        ...
        v_record_action,
        sysdate,
        :new.qa_supervisor_id,
        :new.qa_supervisor_login_id,
        :new.qa_supervisor_first_name,
        :new.qa_supervisor_middle_initial,
        :new.qa_supervisor_last_name,
        :new.qa_supervisor_active,
        :new.create_by,
        :new.create_datetime,
        :new.last_updated_by,
        :new.last_updated_datetime
