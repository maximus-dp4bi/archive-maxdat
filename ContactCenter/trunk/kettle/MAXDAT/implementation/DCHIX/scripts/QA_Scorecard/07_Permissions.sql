...
GRANT select on TS_QUEST_ANSWER_DETAIL_SV to MAXDAT_READ_ONLY;
GRANT select on TS_QA_SUPERVISOR_SV to MAXDAT_READ_ONLY;
...
GRANT execute ON TS_QUEST_ANSWER_DET_INS_UPD TO MAXDAT_MSTR_TRX_RPT; 
GRANT execute ON TS_QA_SUPERVISOR_INS_UPD TO MAXDAT_MSTR_TRX_RPT; 
...
GRANT insert, update ON TS_QUEST_ANSWER_DETAIL TO MAXDAT_MSTR_TRX_RPT;
GRANT insert, update ON TS_QA_SUPERVISOR TO MAXDAT_MSTR_TRX_RPT;