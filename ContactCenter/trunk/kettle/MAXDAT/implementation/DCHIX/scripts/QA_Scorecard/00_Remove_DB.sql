...
drop TRIGGER TRG_AIU_TS_AUDIT_QUEST_ANSWER;

drop procedure TS_AUDIT_QUEST_ANSWER_UPDATE;
...
drop TRIGGER TRG_AIU_TS_AUDIT;

drop procedure TS_AUDIT_INSERT;
drop procedure TS_AUDIT_UPDATE;
drop procedure TS_AUDIT_UPDATE_STATUS;

drop view ts_audit_sv;
drop view ts_audit_date_sv;
drop view ts_audit_date_month_sv;
drop view ts_audit_date_year_sv;
...
drop TRIGGER TRG_AIU_TS_QUESTION_DETAIL;
...
drop TRIGGER TRG_AIU_TS_QA_QUESTION;
...
------ DROP QA AGENT
drop TRIGGER TRG_AIU_TS_QA_AGENT ;
...
drop view ts_quest_det_type_lkup_sv;
...
------ DROP QUESTION TYPE LKUP
drop view TS_SCORE_TYPE_LKUP_SV;

drop table TS_SCORE_TYPE_LKUP;
