...
(
    ...
    qa_question_weight             number(10,2) not null,
...
alter table TS_QUESTION_DETAIL add constraint FK_TS_QUESTION_DETAIL_QA_QUESTION foreign key(qa_question_id) references TS_QA_QUESTION(qa_question_id);
...
(
    ...
    question_type_id            number not null,
    question_detail_type_id     number not null,
    audit_question_weight       number(10,2) not null,
...
alter table TS_AUDIT_QUESTION add constraint FK_TS_AUDIT_QUESTION_QA_QUESTION foreign key(qa_question_id) references TS_QA_QUESTION(qa_question_id);
alter table TS_AUDIT_QUESTION add constraint FK_TS_AUDIT_QUESTION_DETAIL_TYPE foreign key(question_detail_type_id) references TS_QUESTION_DETAIL_TYPE_LKUP(question_detail_type_id);
...
(
    ...
    audit_question_answer_weight    number(10,2) not null,
...
alter table TS_AUDIT_QUESTION_ANSWER add constraint FK_TS_AUDIT_QUESTION_ANSWER_DETAIL foreign key(question_detail_id, qa_question_id) references TS_QUESTION_DETAIL (question_detail_id, qa_question_id);
alter table TS_AUDIT_QUESTION_ANSWER add constraint FK_TS_AUDIT_QUESTION_ANSWER_AUDIT_QUESTION foreign key(audit_question_id) references TS_AUDIT_QUESTION (audit_question_id);
