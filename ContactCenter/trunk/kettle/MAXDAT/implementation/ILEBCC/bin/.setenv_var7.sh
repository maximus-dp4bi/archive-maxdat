...
#export STCODE=ILEBCC - moved to cronfile
...
PATH="$KETTLE_ILEBCC_HOME/.kettle/kettle.properties:.:/u01/app/appadmin/product/pdi-ce-7.1.0.0-12/data-integration:/usr/bin:$PATH"
export PATH
