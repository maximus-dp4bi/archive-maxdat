...
CREATE OR REPLACE FORCE VIEW CC_F_ACTUALS_QUEUE_INTERVAL_SV (F_CALL_CENTER_ACTLS_INTRVL_ID, D_DATE_ID, D_PROJECT_ID, D_PROGRAM_ID, D_GEOGRAPHY_MASTER_ID, D_UNIT_OF_WORK_ID, D_CONTACT_QUEUE_ID, D_INTERVAL_ID, D_AGENT_ID, CONTACTS_RECEIVED_FROM_IVR, CONTACTS_OFFERED, CONTACTS_HANDLED, CONTACTS_ABANDONED, MIN_HANDLE_TIME, MAX_HANDLE_TIME, MEAN_HANDLE_TIME, MEDIAN_HANDLE_TIME, STDDEV_HANDLE_TIME, MIN_SPEED_TO_HANDLE, MAX_SPEED_TO_HANDLE, MEAN_SPEED_TO_HANDLE, MEDIAN_SPEED_TO_HANDLE, STDDEV_SPEED_TO_HANDLE, MIN_SPEED_OF_ANSWER, MAX_SPEED_OF_ANSWER, MEAN_SPEED_OF_ANSWER, MEDIAN_SPEED_OF_ANSWER, STDDEV_SPEED_OF_ANSWER, SPEED_OF_ANSWER_PERIOD_1, SPEED_OF_ANSWER_PERIOD_2, SPEED_OF_ANSWER_PERIOD_3, SPEED_OF_ANSWER_PERIOD_4, SPEED_OF_ANSWER_PERIOD_5, SPEED_OF_ANSWER_PERIOD_6, SPEED_OF_ANSWER_PERIOD_7, SPEED_OF_ANSWER_PERIOD_8, SPEED_OF_ANSWER_PERIOD_9, SPEED_OF_ANSWER_PERIOD_10,
  ...
  CALLS_RONA, RETURN_RELEASE, CALLS_ROUTED_NON_AGENT, ERROR_COUNT, AGENT_ERROR_COUNT, RETURN_RING, INCOMPLETE_CALLS, CALLS_GIVEN_FORCE_DISCONNECT, CALLS_GIVEN_ROUTE_TO, CREATE_DATE, SHORT_CALLS, LAST_UPDATE_DATE, MAX_ABANDON_TIME, QUEUE_NUMBER, AGENT_LOGIN_ID, ABANDON_THRESHOLD, CALLS_ANSWERED)
AS
...
CREATE OR REPLACE FORCE VIEW CC_F_ACD_QUEUE_INTERVAL_SV (F_CC_ACD_QUEUE_INTRVL_ID, D_DATE_ID, D_PROJECT_ID, D_PROGRAM_ID, D_GEOGRAPHY_MASTER_ID, D_UNIT_OF_WORK_ID, D_CONTACT_QUEUE_ID, D_INTERVAL_ID, CONTACTS_RECEIVED_FROM_IVR, CONTACTS_OFFERED, CONTACTS_HANDLED, CONTACTS_ABANDONED, MIN_HANDLE_TIME, MAX_HANDLE_TIME, MEAN_HANDLE_TIME, MEDIAN_HANDLE_TIME, STDDEV_HANDLE_TIME, MIN_SPEED_TO_HANDLE, MAX_SPEED_TO_HANDLE, MEAN_SPEED_TO_HANDLE, MEDIAN_SPEED_TO_HANDLE, STDDEV_SPEED_TO_HANDLE, MIN_SPEED_OF_ANSWER, MAX_SPEED_OF_ANSWER, MEAN_SPEED_OF_ANSWER, MEDIAN_SPEED_OF_ANSWER, STDDEV_SPEED_OF_ANSWER, SPEED_OF_ANSWER_PERIOD_1, SPEED_OF_ANSWER_PERIOD_2, SPEED_OF_ANSWER_PERIOD_3, SPEED_OF_ANSWER_PERIOD_4, SPEED_OF_ANSWER_PERIOD_5, SPEED_OF_ANSWER_PERIOD_6, SPEED_OF_ANSWER_PERIOD_7, SPEED_OF_ANSWER_PERIOD_8, SPEED_OF_ANSWER_PERIOD_9, SPEED_OF_ANSWER_PERIOD_10, CALLS_ABANDONED_PERIOD_1,
  CALLS_ABANDONED_PERIOD_2, CALLS_ABANDONED_PERIOD_3, CALLS_ABANDONED_PERIOD_4, CALLS_ABANDONED_PERIOD_5, CALLS_ABANDONED_PERIOD_6, CALLS_ABANDONED_PERIOD_7, CALLS_ABANDONED_PERIOD_8, CALLS_ABANDONED_PERIOD_9, CALLS_ABANDONED_PERIOD_10, LABOR_MINUTES_TOTAL, LABOR_MINUTES_AVAILABLE, LABOR_MINUTES_WAITING, HEADCOUNT_TOTAL, HEADCOUNT_AVAILABLE, HEADCOUNT_UNAVAILABLE, CONTACT_INVENTORY, CONTACT_INVENTORY_JEOPARDY, MIN_CONTACT_INVENTORY_AGE, MAX_CONTACT_INVENTORY_AGE, MEAN_CONTACT_INVENTORY_AGE, MEDIAN_CONTACT_INVENTORY_AGE, STDDEV_CONTACT_INVENTORY_AGE, CONTACTS_TRANSFERRED, OUTFLOW_CONTACTS, ANSWER_WAIT_TIME_TOTAL, ABANDON_TIME_TOTAL, TALK_TIME_TOTAL, AFTER_CALL_WORK_TIME_TOTAL, SERVICE_LEVEL_ANSWERED_PERCENT, SERVICE_LEVEL_ANSWERED_COUNT, SERVICE_LEVEL_ABANDONED, CALLS_ON_HOLD, HOLD_TIME_TOTAL, SHORT_ABANDONS, SHORT_CALLS, CONTACTS_BLOCKED, ICR_DEFAULT_ROUTED, NETWORK_DEFAULT_ROUTED, RETURN_BUSY, CALLS_RONA
  , RETURN_RELEASE, CALLS_ROUTED_NON_AGENT, ERROR_COUNT, AGENT_ERROR_COUNT, RETURN_RING, INCOMPLETE_CALLS, CALLS_GIVEN_FORCE_DISCONNECT, CALLS_GIVEN_ROUTE_TO, CREATE_DATE, LAST_UPDATE_DATE, MAX_ABANDON_TIME, QUEUE_NUMBER, ABANDON_THRESHOLD, CALLS_ANSWERED)
AS
