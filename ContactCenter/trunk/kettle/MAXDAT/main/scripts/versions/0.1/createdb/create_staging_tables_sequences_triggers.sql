...
CREATE SEQUENCE SEQ_CC_C_CONTACT_QUEUE START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_C_FILTER START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_C_LOOKUP START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999999 MINVALUE 1 CACHE 20 ;
...
CREATE SEQUENCE SEQ_CC_S_ACD_AGENT_ACTIVITY START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;
...
CREATE SEQUENCE SEQ_CC_S_IVR_SELF_SERVICE_PATH START WITH 100 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_S_IVR_SS_USAGE START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_S_PP_HORIZON START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_S_PRODUCTION_PLAN START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;
...
CREATE SEQUENCE SEQ_CC_S_WFM_AGENT_ACTIVITY START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_CC_S_WFM_INTERVAL START WITH 1 INCREMENT BY 1 MAXVALUE 9999999999999999999 MINVALUE 1 CACHE 20 ;

CREATE SEQUENCE SEQ_JOB_ID START WITH 1 INCREMENT BY 1 MAXVALUE 99999999999999999999 MINVALUE 1 CACHE 20 ;
...
(
  DATA_VALIDATION IN ('FAILURE', 'NOT_TESTED', 'SUCCESS')
)
;
...
CREATE INDEX CC_C_FILTER__IDXv1 ON CC_C_FILTER
  ...
  TABLESPACE MAXDAT_INDX LOGGING ;
ALTER TABLE CC_C_FILTER ADD CONSTRAINT CC_C_FILTER_PK PRIMARY KEY
(
  FILTER_ID
)
;
...
CREATE TABLE CC_C_LOOKUP
  ...
  TABLESPACE MAXDAT_DATA LOGGING ;
ALTER TABLE CC_C_LOOKUP ADD CONSTRAINT CC_C_LOOKUP_PK PRIMARY KEY
(
  LOOKUP_ID
)
;
...
(
  PROJECT_NAME , PROGRAM_NAME , RECORD_EFF_DT
)
;
...
(
  UNIT_OF_WORK_NAME , RECORD_EFF_DT
)
;
...
CREATE UNIQUE INDEX CC_S_ACD_AGENT_ACTIVITY_IDX2 ON CC_S_ACD_AGENT_ACTIVITY
  ...
  TABLESPACE MAXDAT_INDX LOGGING ;
  ALTER TABLE CC_S_ACD_AGENT_ACTIVITY ADD CONSTRAINT CC_S_ACD_AGENT_ACTIVITY_PK PRIMARY KEY
  (
    ACD_AGENT_ACTIVITY_ID
  )
  ;
  ALTER TABLE CC_S_ACD_AGENT_ACTIVITY ADD CONSTRAINT CC_S_ACD_AGENT_ACTIVITY_UN UNIQUE
  (
...
CREATE TABLE CC_S_ACD_INTERVAL
  (
    ...
    CALLS_GIVEN_FORCE_DISCONNECT   NUMBER (7) DEFAULT 0 NOT NULL ,
    CALLS_GIVEN_ROUTE_TO           NUMBER (7) DEFAULT 0 NOT NULL ,
...
(
  PERIOD_TYPE , RECORD_EFF_DT , PERIOD_1_UPPER_BOUND , PERIOD_2_UPPER_BOUND , PERIOD_3_UPPER_BOUND , PERIOD_4_UPPER_BOUND , PERIOD_5_UPPER_BOUND , PERIOD_6_UPPER_BOUND , PERIOD_7_UPPER_BOUND , PERIOD_8_UPPER_BOUND , PERIOD_9_UPPER_BOUND , PERIOD_10_UPPER_BOUND
)
;
...
CREATE UNIQUE INDEX CC_S_AGENT__IDX2 ON CC_S_AGENT
  ...
  CREATE INDEX CC_S_AGENT__IDXv4 ON CC_S_AGENT
    ...
    TABLESPACE MAXDAT_INDX LOGGING ;
  ALTER TABLE CC_S_AGENT ADD CONSTRAINT CC_S_AGENT_PK PRIMARY KEY
  (
    AGENT_ID
  )
  ;
...
CREATE UNIQUE INDEX CC_S_AGENT_ABSENCE__IDX2 ON CC_S_AGENT_ABSENCE
  (
    AGENT_ID ASC , ABSENCE_END_TIME DESC
  )
  TABLESPACE MAXDAT_INDX LOGGING ;
  ALTER TABLE CC_S_AGENT_ABSENCE ADD CONSTRAINT CC_S_AGENT_ABSENCE_PK PRIMARY KEY
  (
    AGENT_ABSENCE_ID
  )
  ;
...
CREATE UNIQUE INDEX CC_S_AGENT_SUPERVISOR__IDX2 ON CC_S_AGENT_SUPERVISOR
  (
    AGENT_ID ASC , SUPERVISOR_AGENT_ID ASC , RECORD_EFF_DT DESC
  )
  TABLESPACE MAXDAT_INDX LOGGING ;
  ALTER TABLE CC_S_AGENT_SUPERVISOR ADD CONSTRAINT CC_S_AGENT_SUPERVISOR_PK PRIMARY KEY
  (
    AGENT_SUPERVISOR_ID
  )
  ;
  ...
  (
    AGENT_ID , SUPERVISOR_AGENT_ID , RECORD_EFF_DT
  )
  ;
...
CREATE TABLE CC_S_AGENT_WORK_DAY
  (
    ...
    SCHEDULED_SHIFT_MINUTES NUMBER (6,2) DEFAULT 0 ,
...
CREATE INDEX CC_S_CALL_DETAIL_AGENT_IDX ON CC_S_CALL_DETAIL
  ...
  TABLESPACE MAXDAT_INDX LOGGING ;
ALTER TABLE CC_S_CALL_DETAIL ADD CONSTRAINT CC_S_CALL_DETAIL_PK PRIMARY KEY
(
  CALL_DETAIL_ID
)
;
...
(
  SOURCE_CALL_ID , CALL_SEGMENT_ID
)
;
...
CREATE TABLE CC_S_IVR_SELF_SERVICE_PATH
  ...
  TABLESPACE MAXDAT_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_S_IVR_SELF_SERVICE_PATH ADD CONSTRAINT CC_S_SELF_SERVICE_PATH_PK PRIMARY KEY
(
...
(
  INTERVAL_ID , IVR_SELF_SERVICE_PATH_ID , PROJECT_CONFIG_ID
)
;
...
CREATE TABLE CC_S_PRODUCTION_PLAN
  ...
  TABLESPACE MAXDAT_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_S_PRODUCTION_PLAN ADD CONSTRAINT CC_C_PRODUCTION_PLAN_PK PRIMARY KEY
(
  PRODUCTION_PLAN_ID
)
;
ALTER TABLE CC_S_PRODUCTION_PLAN ADD CONSTRAINT CC_S_PRODUCTION_PLAN__UN UNIQUE
(
  PRODUCTION_PLAN_NAME , RECORD_EFF_DT
)
;
...
CREATE INDEX CC_S_TMP_AET__IDX2 ON CC_S_TMP_ACTUALEVENTTIMELINE
  ...
  TABLESPACE MAXDAT_INDX LOGGING ;
ALTER TABLE CC_S_TMP_ACTUALEVENTTIMELINE ADD CONSTRAINT CC_S_TMP_ACTUALEVENTTIMELIN_PK PRIMARY KEY
(
...
CREATE TABLE CC_S_TMP_AVY_ECSRSTAT
  (
    ...
    CCMID                          INTEGER NOT NULL ,
    ProviderContactID              VARCHAR2 (50) NOT NULL ,
    InterCallID                    INTEGER NOT NULL ,
    ContactType                    INTEGER NOT NULL ,
    ContactTypeName                VARCHAR2 (30) ,
    ContactSubType                 VARCHAR2 (50) NOT NULL ,
    ContactProximity               VARCHAR2 (50) NOT NULL ,
    Priority                       SMALLINT NOT NULL ,
    Provider                       VARCHAR2 (50) NOT NULL ,
    SiteID                         INTEGER ,
    SiteName                       VARCHAR2 (30) ,
    RemoteSiteID                   INTEGER NOT NULL ,
    RemoteSiteName                 VARCHAR2 (30) ,
    Originator                     VARCHAR2 (256) NOT NULL ,
    Address                        VARCHAR2 (255) NOT NULL ,
    RoutePoint                     VARCHAR2 (30) NOT NULL ,
    ApplicationID                  INTEGER NOT NULL ,
    ApplicationName                VARCHAR2 (30) ,
    SourceApplicationName          VARCHAR2 (30) NOT NULL ,
    ApplicationStartStamp          TIMESTAMP NOT NULL ,
    LastTreatmentID                INTEGER NOT NULL ,
    Treatment                      VARCHAR2 (50) ,
    LastTreatmentStamp             TIMESTAMP NOT NULL ,
    LastTreatmentTime              INTEGER NOT NULL ,
    SkillsetID                     INTEGER NOT NULL ,
    SkillsetName                   VARCHAR2 (30) ,
    SkillsetQueuedStamp            TIMESTAMP NOT NULL ,
    LocalUserID                    INTEGER NOT NULL ,
    AgentSurName                   VARCHAR2 (64) ,
    AgentGivenName                 VARCHAR2 (64) ,
    SupervisorSurName              VARCHAR2 (64) ,
    SupervisorGivenName            VARCHAR2 (64) ,
    AgentID                        VARCHAR2 (16) NOT NULL ,
    SupervisorID                   VARCHAR2 (16) NOT NULL ,
    OriginatedStamp                TIMESTAMP NOT NULL ,
    InitialDisposition             VARCHAR2 (50) NOT NULL ,
    ServiceStamp                   TIMESTAMP NOT NULL ,
    AppAbandonDelay                INTEGER NOT NULL ,
    AppAcceptedDelay               INTEGER NOT NULL ,
    SksAbandonDelay                INTEGER NOT NULL ,
    SksAcceptedDelay               INTEGER NOT NULL ,
    HandlingTime                   INTEGER NOT NULL ,
    ConsultTime                    INTEGER NOT NULL ,
    HoldTime                       INTEGER NOT NULL ,
    NumberOfTimesOnHold            INTEGER NOT NULL ,
    NumberOfTimesRTQ               INTEGER NOT NULL ,
    FinalDisposition               VARCHAR2 (50) NOT NULL ,
    FinalDispositionStamp          TIMESTAMP NOT NULL ,
    PresentingTime                 INTEGER NOT NULL ,
    PCPTime                        INTEGER NOT NULL ,
    PCPFirstCode                   VARCHAR2 (32) NOT NULL ,
    WaitTime                       INTEGER NOT NULL ,
    NextAddress                    VARCHAR2 (255) NOT NULL ,
    NextSegmentID                  INTEGER NOT NULL ,
    ContactOriginatedStamp         TIMESTAMP NOT NULL ,
    FinalDispositionInterval       VARCHAR2 (255) ,
    ServiceInterval                VARCHAR2 (255) ,
    OriginatedInterval             VARCHAR2 (255) ,
    DisconnectSource               VARCHAR2 (9) ,
    NumContactObserves             INTEGER NOT NULL ,
    NumContactBargeIns             INTEGER NOT NULL ,
    AnchoredMediaServer            VARCHAR2 (50) ,
    PreferredMediaServer           VARCHAR2 (50) ,
    PreferredMediaServerResult     INTEGER ,
    PreferredMediaServerResultDesc VARCHAR2 (80) NOT NULL
  )
...
CREATE TABLE CC_S_TMP_INTERVAL
  ...
  TABLESPACE MAXDAT_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_S_TMP_INTERVAL ADD CONSTRAINT CK_CC_S_TMP_INTERVAL_SECONDS CHECK
(
  INTERVAL_SECONDS IN (900, 1800, 3600)
)
;
...
CREATE INDEX CC_S_TMP_INTERVAL__IDX2 ON CC_S_TMP_INTERVAL
  ...
  TABLESPACE MAXDAT_INDX LOGGING ;
ALTER TABLE CC_S_TMP_INTERVAL ADD CONSTRAINT CC_S_TMP_INTERVAL_PK PRIMARY KEY
(
  INTERVAL_ID
)
;
ALTER TABLE CC_S_TMP_INTERVAL ADD CONSTRAINT CC_S_TMP_INTERVAL_UN UNIQUE
(
  INTERVAL_START_DATE , INTERVAL_END_DATE
)
;
...
CREATE UNIQUE INDEX CC_S_IVR_STEP_IDX ON CC_S_TMP_IVR_STEP
  ...
  COMPUTE STATISTICS ;
  ALTER TABLE CC_S_TMP_IVR_STEP ADD CONSTRAINT CC_S_IVR_STEP_PK PRIMARY KEY
  (
    ID
  )
  ;
...
CREATE TABLE CC_S_WFM_AGENT_ACTIVITY
  ...
  TABLESPACE MAXDAT_DATA LOGGING ENABLE ROW MOVEMENT ;
ALTER TABLE CC_S_WFM_AGENT_ACTIVITY ADD CONSTRAINT CC_S_AGENT_ACTIVITY_CK CHECK
(
...
CREATE UNIQUE INDEX CC_S_WFM_AGENT_ACTIVITY_IDX ON CC_S_WFM_AGENT_ACTIVITY
  ...
  CREATE INDEX CC_S_WFM_AGENT_ACTIVITY_IDX3 ON CC_S_WFM_AGENT_ACTIVITY
    ...
    TABLESPACE MAXDAT_INDX LOGGING ;
  ALTER TABLE CC_S_WFM_AGENT_ACTIVITY ADD CONSTRAINT CC_S_WFM_AGENT_ACTIVITY_PK PRIMARY KEY
  (
...
ALTER TABLE CC_S_PRODUCTION_PLAN_HORIZON ADD CONSTRAINT CC_C_HRZN_CC_C_PROD_PLN_FK FOREIGN KEY ( PRODUCTION_PLAN_ID ) REFERENCES CC_S_PRODUCTION_PLAN ( PRODUCTION_PLAN_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_S_ACD_AGENT_ACTIVITY ADD CONSTRAINT CC_S_ACD_AGT_ACT_CC_S_AGT_FK FOREIGN KEY ( AGENT_ID ) REFERENCES CC_S_AGENT ( AGENT_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_S_AGENT_ABSENCE ADD CONSTRAINT CC_S_AGENT_ABS_CC_C_ACT_TYP_FK FOREIGN KEY ( ACTIVITY_TYPE_ID ) REFERENCES CC_C_ACTIVITY_TYPE ( ACTIVITY_TYPE_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_S_WFM_AGENT_ACTIVITY ADD CONSTRAINT CC_S_AGT_ACT_CC_C_ACT_TYPE_FK FOREIGN KEY ( ACTIVITY_TYPE_ID ) REFERENCES CC_C_ACTIVITY_TYPE ( ACTIVITY_TYPE_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_S_WFM_AGENT_ACTIVITY ADD CONSTRAINT CC_S_AGT_ACT_CC_S_AGT_FK FOREIGN KEY ( AGENT_ID ) REFERENCES CC_S_AGENT ( AGENT_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_S_CONTACT_QUEUE ADD CONSTRAINT CC_S_CNTCT_Q_CC_C_UOW_FK FOREIGN KEY ( UNIT_OF_WORK_ID ) REFERENCES CC_C_UNIT_OF_WORK ( UNIT_OF_WORK_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_S_CONTACT_QUEUE ADD CONSTRAINT CC_S_CNTCT_Q_CC_S_ABN_PRIOD_FK FOREIGN KEY ( CALLS_ABANDOND_INTRVL_PRIOD_ID ) REFERENCES CC_S_ACD_INTERVAL_PERIOD ( ACD_INTERVAL_PERIOD_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_S_CONTACT_QUEUE ADD CONSTRAINT CC_S_CNTCT_Q_CC_S_ASA_PRIOD_FK FOREIGN KEY ( AVG_SPEED_ANSR_INTRVL_PRIOD_ID ) REFERENCES CC_S_ACD_INTERVAL_PERIOD ( ACD_INTERVAL_PERIOD_ID ) NOT DEFERRABLE ;
...
ALTER TABLE CC_S_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT CC_S_IVR_USAGE_C_PRJ_CNFG_FK FOREIGN KEY ( PROJECT_CONFIG_ID ) REFERENCES CC_C_PROJECT_CONFIG ( PROJECT_CONFIG_ID ) NOT DEFERRABLE ;

ALTER TABLE CC_S_IVR_SELF_SERVICE_USAGE ADD CONSTRAINT CC_S_IVR_USAGE_S_INTERVAL_FK FOREIGN KEY ( INTERVAL_ID ) REFERENCES CC_S_INTERVAL ( INTERVAL_ID ) NOT DEFERRABLE ;
