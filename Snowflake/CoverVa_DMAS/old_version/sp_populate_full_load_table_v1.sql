...
create or replace procedure SP_POPULATE_FULL_LOAD_TABLE()
  ...
  /* STEP 1: Update any records in the log where load status is Started */
  var strSQLText = "UPDATE COVERVA_DMAS.DMAS_FILE_LOG SET load_status = 'NOT PROCESSED' WHERE load_status = 'STARTED';";                 
