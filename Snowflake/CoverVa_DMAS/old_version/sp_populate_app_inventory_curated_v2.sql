  ...
  snowflake.execute( {sqlText: "BEGIN;"} );
   try {  
     ...
     strSQLText = " INSERT INTO coverva_dmas.CP_APPLICATION_INVENTORY(migrated,sr_id,sr_type,sr_create_date,sr_status,sr_status_date,app_type,business_unit,"
      +"                 tracking_number,my_workspace_date,initial_disposition_date,initial_disposition_staff,disposition,action_taken,sr_decision_source, "
      +"                 process_app_task_id,process_app_task_type,process_app_status,process_app_status_date,process_app_update_date,process_app_updated_by_id, "
      +"                 process_app_updated_by_name,process_app_assigned_to_id,process_app_assigned_to_name,process_app_disposition,channel,facility_type, "
      +"                 facility_name,substatus,reason,denial_reason,decision_source,missing_info_required,hpe_indicator,vcl_sent_date,vcl_due_date,app_signature_date, "
      +"                 app_received_date,date_received,inbound_correspondence_type,sr_due_in_days,sr_default_due_date,process_app_due_in_days,process_app_default_due_date, "
      +"                 second_vcl_sent_date,third_vcl_sent_date,vcl_exception) "
      ...
      +" LEFT JOIN (select x.task_id, $2 as exapid, $3 as dispo, $4 as apptp, $5 as decsnsrc "
      ...
      +" LEFT JOIN (select x.SRID as SRID, x.task_id, $3 as dispo, $4 as facnam, $5 as appsubstat, $6 as rsn, $7 as dnlrsn " 
      +"                 , $8 as chnl, $9 as factyp,  $10 as ats, $11 as dcsrc, $12 as mirq, $13 as hpe, $14 as cwln, $15 as cwfn "
      +"                 , $16 as locality, $17 as expedited, $18 as inbncortyp "
      +"            from (select distinct el.internal_id as SRID, td.task_id, td.task_field_id, td.selection_varchar "
      +"                  from MARSDB.MARSDB_EXTERNAL_LINKS_VW el "
      +"                  join MARSDB.MARSDB_TASKS_VW t on (el.external_ref_id = t.task_id and t.project_id = 117 and t.task_type_id = 13474) "
      +"                  join MARSDB.MARSDB_TASK_DETAIL_VW td on (td.task_id = t.task_id and td.project_id = 117 and td.task_field_id in (71,112,147,93,161,12,113,144,153,120,117,4,3,119,131,59)) "
      +"                  where el.external_ref_type = 'TASK' "
      +"                  and   el.internal_ref_type = 'SERVICE_REQUEST' "
      +"                  and   el.project_id = 117 "
      +"                  ) pivot (max(selection_varchar) for task_field_id in (71,112,147,93,161,12,113,144,153,120,117,4,3,119,131,59)) x "
      +"            ) pactd on (pactd.srid = sr.task_id) "
      +" LEFT JOIN (select x.SRID as SRID, x.task_id, $3 as appsigdt, $4 as mywsdt, $5 as appdtrcd, $6 as dtrcd, $7 as dob, $8 as vclsent, $9 as vcldue "
      ...
      +" LEFT JOIN (select x.SRID as SRID, x.task_id, $3 as apctinhshd, $4 as apprvdapct "
      ...
      +"           AND el.internal_ref_type = 'SERVICE_REQUEST' "
      +"           and el.project_id = 117  )  ) papp on (papp.srid = sr.task_id)  "
      +" LEFT JOIN (select x.SRID as SRID, x.task_id, $3 as exapid, $4 as dispo, $5 as apptp, $6 as ats "
      +"            from (select distinct el.internal_id as SRID, td.task_id, td.task_field_id, td.selection_varchar "
      +"                 from MARSDB.MARSDB_EXTERNAL_LINKS_VW el "
      +"                 join MARSDB.MARSDB_TASKS_VW t on (el.external_ref_id = t.task_id and t.project_id = 117 and t.task_type_id = 15182) "
      ...
      +"           ) pactd on (pactd.srid = sr.task_id)  "  
      +" LEFT JOIN (select x.task_id, $2 as exapid, $3 as cwln, $4 as cwfn, $5 as locality, $6 as facnam, $7 as appsubstat, $8 as inbncortyp "
      +"                 , $9 as rsn, $10 as dnlrsn, $11 as chnl, $12 as apptp, $13 as dispo, $14 as factyp, $15 as dcsrc, $16 as mirq "
      +"                 , $17 as hpe, $18 as expedited "
      +"            from (select td.task_id, td.task_field_id, td.selection_varchar "
      +"                  from MARSDB.MARSDB_TASK_DETAIL_VW td where td.task_field_id in (55,4,3,119,112,147,59,93,161,12,148,71,113,153,120,117,131)  "
      +"                  and td.project_id = 117  "
      +"                  ) pivot (max(selection_varchar) for task_field_id in (55,4,3,119,112,147,59,93,161,12,148,71,113,153,120,117,131)) x "
      +"            ) srctd on (srctd.task_id = sr.task_id) "
      +" LEFT JOIN (select x.task_id, $2 as appdtrcd, $3 as appsigdt, $4 as mywsdt, $5 as vcldue, $6 as vclsent, $7 as dtrcd, $8 as dob, $9 as mircddt "            
      ...
      +" LEFT JOIN (select x.task_id, $2 as extcaseid, $3 as apctinhshd, $4 as apprvdapct  "       
