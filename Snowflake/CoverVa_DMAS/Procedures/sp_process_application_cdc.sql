...
create or replace procedure SP_PROCESS_APPLICATION_CDC()
  ...
  var vChkErr = 0;
   ...
   /* STEP 1: Load files into permanent tables */
    strSQLText = "CALL SP_POPULATE_FULL_LOAD_TABLE(:1);";                     
    ...
    /*if ( (busDay == "Y" && timeToStart == "Y") && ((errTabCount == vChkErr && warnTabCount == vChkErr) || (errTabCount == vChkErr && (timeToRun == "Y" || byPassMissingFiles == "Y") ) ) )    */
