CREATE OR REPLACE sequence coverva_dmas.seq_rp266_data_id;

CREATE TABLE COVERVA_DMAS.RP266_DATA_FULL_LOAD(
      rp266_data_id NUMBER NOT NULL DEFAULT coverva_dmas.seq_rp266_data_id.nextval,
...
ALTER TABLE COVERVA_DMAS.RP266_DATA_FULL_LOAD ADD PRIMARY KEY (rp266_data_id);  

DELETE FROM coverva_dmas.dmas_file_load_lkup
WHERE filename_prefix IN('RP266A');
...
VALUES('RP266A','RP266_DATA_FULL_LOAD','COVERVA_DMAS','Tracking_Number,Case_Number,Applicant_Name,Application_Type,Application_Date,Days_Pending,Status,Transfer_Date,Sending_Agency,Receiving_Agency,
