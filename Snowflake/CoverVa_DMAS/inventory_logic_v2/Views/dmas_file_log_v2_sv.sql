...
SELECT file_id
  ...
  ,load_date
  ,load_status
  ,CASE WHEN cc.config_value = 'Y' THEN cdc_v2_processed ELSE cdc_processed END cdc_processed
  ,CASE WHEN cc.config_value = 'Y' THEN cdc_v2_processed_date ELSE cdc_processed_date END cdc_processed_date
  ,CASE WHEN cc.config_value = 'Y' THEN use_in_v2_inventory ELSE use_in_inventory END use_in_inventory
