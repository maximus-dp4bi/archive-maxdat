CREATE OR REPLACE VIEW PUBLIC.DMAS_APPLICATION_V2_INVENTORY_SV
AS
WITH inv AS(SELECT da.tracking_number AS t_number
  ...
  ,CASE WHEN MIN(file_inventory_date) OVER(PARTITION BY da.tracking_number) < state_app_received_date THEN state_app_received_date
