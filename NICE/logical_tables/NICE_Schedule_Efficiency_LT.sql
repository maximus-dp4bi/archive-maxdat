...
and Convert(char,Cast(switchoffset(p.c_fcstprd, tz.c_tzoffset) as date),126) >= convert(varchar, cast(cast(DATEADD(DD, 1 - DATEPART(DW, GETDATE()), GETDATE()) as varchar(12)) as datetime) -4,23)
...
and Convert(char,Cast(switchoffset(qs.c_timestamp, tz.c_tzoffset) as date), 126) >= convert(varchar, cast(cast(DATEADD(DD, 1 - DATEPART(DW, GETDATE()), GETDATE()) as varchar(12)) as datetime) -4,23)
