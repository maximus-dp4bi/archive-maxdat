...
,tot.Interval
,tot.Date
,tot.Delta * Case When sum(Orig_Required) over(partition by tot.CT,tot.Date) = 0 then 0 else 
...
,tot.Pct_Delta * Case When sum(Orig_Required) over(partition by tot.CT,tot.Date) = 0 then 0 else 
...
,round(Coalesce(sum(cast((Left(t2.c_revconttime,4)*86400)+(substring(t2.c_revconttime,6,2)*3600)+(substring(t2.c_revconttime,9,2)*60)+(cast(substring(t2.c_revconttime,12,6)as decimal)) as float)
  ...
  - round(sum(Case WHEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) AND isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0)
WHEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) and isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) 
Else ISNULL(t1.c_revmaxoccreq,0) end),2) as Delta
,case when round(sum(Case WHEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) AND isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0)
WHEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) and isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) 
Else ISNULL(t1.c_revmaxoccreq,0) end),2) = 0 then 0 else (round(Coalesce(sum(cast((Left(t2.c_revconttime,4)*86400)+(substring(t2.c_revconttime,6,2)*3600)+(substring(t2.c_revconttime,9,2)*60)+(cast(substring(t2.c_revconttime,12,6)as decimal)) as float)
  + cast((Left(t2.c_revworktime,4)*86400)+(substring(t2.c_revworktime,6,2)*3600)+(substring(t2.c_revworktime,9,2)*60)+(cast(substring(t2.c_revworktime,12,6)as decimal)) as float)
  + cast((Left(t2.c_revreadytime,4)*86400)+(substring(t2.c_revreadytime,6,2)*3600)+(substring(t2.c_revreadytime,9,2)*60)+(cast(substring(t2.c_revreadytime,12,6)as decimal)) as float))/900.0,0),2)
  - round(sum(Case WHEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) AND isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0)
WHEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) and isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) 
Else ISNULL(t1.c_revmaxoccreq,0) end),2))/round(sum(Case WHEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) AND isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0)
WHEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull((cast(t1.c_revslreq as float) * cast(t1.c_reveffsl as float)),0) and isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) > isnull(t1.c_revmaxoccreq,0) THEN isnull((cast(t1.c_revasareq as float) * cast(t1.c_reveffasa as float)),0) 
Else ISNULL(t1.c_revmaxoccreq,0) end),2) end as Pct_Delta
from (
...
('CA-FSS CT MCAP','CA-FSS CT MFP','CA-FSS CT MH','CA-FSS CT TN','CA-HCO CT Callbacks','CA-HCO CT Inbound','CA-HCO CT Overall','FL-FHK Inbound','GA-GF Atlanta Inbound','GA-GF Atlanta Outbound','GA-GF LABH Only Inbound','GA-GF LABH Only Outbound','GA-GF LARA Only Inbound','GA-GF Louisiana Only Inbound','GA-GF NH Only','GA-IES All CTs','GA-IES CTC All CTs','GA-IES HelpDesk','IL-CES CT SET GENERAL INBOUND','IL-CES CT SET GENERAL OUTBOUND','IL-CES CT SET INBOUND','IL-CES CT SET OUTBOUND','IL-CES CT SET SPEC INBOUND','IL-CES CT SET SPEC OUTBOUND SET','IL-EEV CT ALL','MA-BOS CT All','MBSHCC CT Set All','MD-HBE Glendale','MD-HBE Lord Baltimore','MI-APCC CT Set All','MI-CSCC CT Set All','MI-EBS CT Set All','MI-MSS CT Set','MO-CS All CTs','PA-EAP Inbound','SOA Custom CT Set','VA-EBS CT Set All','VA-SOA GA-GF ALL','VA-SOA LARA All','VA-SOA MAH ALL','VT-VHC Inbound','MI-WR CT Set All')
inner join nice_wfm_customer1.dbo.r_tzinfo tz on e.c_tz = tz.c_tz and p.c_fcstprd >= tz.c_begin and p.c_fcstprd < tz.c_end
and Convert(char,Cast(switchoffset(p.c_fcstprd, tz.c_tzoffset) as date),126) >=  convert(varchar, cast(cast(DATEADD(DD, 1 - DATEPART(DW, GETDATE()), GETDATE()) as varchar(12)) as datetime) -5,23)
...
and Convert(char,Cast(switchoffset(qs.c_timestamp, tz.c_tzoffset) as date), 126) >= convert(varchar, cast(cast(DATEADD(DD, 1 - DATEPART(DW, GETDATE()), GETDATE()) as varchar(12)) as datetime) -5,23)
...
,tot.Interval
,tot.Date
,tot.Delta * Case When sum(Orig_Required) over(partition by tot.CT_Set,tot.Date) = 0 then 0 else 
...
,tot.Pct_Delta * Case When sum(Orig_Required) over(partition by tot.CT_Set,tot.Date) = 0 then 0 else 
