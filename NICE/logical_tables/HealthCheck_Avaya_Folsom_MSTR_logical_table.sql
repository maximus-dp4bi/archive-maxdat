select 
  to_char(App.Dt, 'mm/dd/yyyy') as DDate, 'Folsom' as Site_Name, 'FSS' as Contact_Center,
  ...
  (select
   ...
   where
     sk.Name in (
       ...
       'AIM_Spanish_S',
       'AIM_Tran_Armenian_S',
       'AIM_Tran_Cambodian_S',
       'AIM_Tran_Cantonese_S',
       'AIM_Tran_English_S',
       'AIM_Tran_Farsi_S',
       'AIM_Tran_Hmong_S',
       'AIM_Tran_Korean_S',
       ...
       'HFP_Russian_S',
       'HFP_Russian_ovfl_S',
       'HFP_SPE_Fail_Armenian_S',
       'HFP_SPE_Fail_Cambodian_S',
       'HFP_SPE_Fail_Cantonese_S',
       'HFP_SPE_Fail_English_S',
       'HFP_SPE_Fail_Farsi_S',
       'HFP_SPE_Fail_Hmong_S',
       'HFP_SPE_Fail_Korean_S',
       'HFP_SPE_Fail_Laotian_S',
       'HFP_SPE_Fail_Russian_S',
       'HFP_SPE_Fail_Spanish_S',
       'HFP_SPE_Fail_Vietnamese_S',
       'HFP_Spanish_S',
       'HFP_Spanish_ovfl_S',
       'HFP_Tran_Armenian_S',
       ...
       'SPE_Spanish_S',
       'SPE_Tran_Armenian_S',
       'SPE_Tran_Cambodian_S',
       'SPE_Tran_Cantonese_S',
       'SPE_Tran_English_S',
       'SPE_Tran_Farsi_S',
       'SPE_Tran_Hmong_S',
       'SPE_Tran_Korean_S',
...
group by 
  to_char(App.Dt,'mm/dd/yyyy'), 'Folsom', 'FSS',
  App.Application

union

select 
  to_char(App.Dt, 'mm/dd/yyyy') as Date, 'Folsom' as Site_Name, 'HCO' as Contact_Center,
...
from
  ...
  group by Dt, Application) Ag on Ag.Dt = App.Dt and Ag.Application = App.Application
group by 
  to_char(App.Dt,'mm/dd/yyyy'), 'Folsom', 'HCO',
  App.Application