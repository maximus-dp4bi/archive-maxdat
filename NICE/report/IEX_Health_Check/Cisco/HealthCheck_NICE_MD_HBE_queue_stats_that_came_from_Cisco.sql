/* Get yesterday's NICE MD Health Benfits Exchange queue stats that originated in Cisco. */
...
where
  ...
  and cast(e.C_ID as varchar) like '15%%%' and e.C_ID not in (15020,15021,15022)
