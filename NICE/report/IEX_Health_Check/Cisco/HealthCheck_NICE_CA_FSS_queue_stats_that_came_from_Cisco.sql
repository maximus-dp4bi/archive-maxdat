/* Get yesterday's NICE CA FSS queue stats that originated in Cisco. */
...
inner join nice_wfm_customer1.dbo.R_ACD acd on q.C_ACD = acd.C_OID and acd.C_Name = 'Cisco Enterprise 2'
...
where
  ...
  and cast(e.C_ID as varchar) like '20%%%'
