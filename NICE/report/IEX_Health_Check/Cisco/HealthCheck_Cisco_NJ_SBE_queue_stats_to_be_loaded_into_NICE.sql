/* Get yesterday's Cisco NJ SBE n queue stats. */
...
where 
  cast(e.C_ID as varchar) like 18%%%'
...
where 
  si.PrecisionQueueID in (5548, 5549, 5550, 5551, 5552, 5553, 5622, 5623, 5624, 5625, 5626, 5627, 5628, 5629, 5630, 5631)	 
