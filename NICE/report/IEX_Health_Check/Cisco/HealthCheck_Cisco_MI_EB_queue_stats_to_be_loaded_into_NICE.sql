/* Get yesterday's Cisco MI Enrollment Broker queue stats. */
...
where 
  cast(e.C_ID as varchar) like '10%%%'
...
where 
  si.PrecisionQueueID in (5033,5034,5035,5036,5037,5038,5440,5441,5493,5494,5495,5496,5498)
