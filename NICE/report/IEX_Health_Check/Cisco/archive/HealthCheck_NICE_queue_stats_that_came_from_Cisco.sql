/* Get yesterday's NICE queue stats that originated in Cisco. */
...
inner join nice_wfm_customer1.dbo.R_ACD acd on q.C_ACD = acd.C_OID and acd.C_Name not in ('Boston-Avaya','Chicago Avaya','Folsom-Avaya Blue')
...
where
  ...
  and (q.C_QTAG like 'P%' and q.C_QTAG != 'Prem_Billing_s')
