/* Get yesterday's Cisco GA IES queue stats. */
...
where 
  cast(e.C_ID as varchar) like '65%%%'
...
where 
  si.PrecisionQueueID in (5119,5121,5128,5129,5131,5143,5144,5145,5146,5122,5123,5124,5125,5126,5145,5146,5383,5384)
