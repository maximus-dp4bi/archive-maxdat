/* Get Avaya Vermont Health Connect-Green Mountain Care-CSC queue stats. */
/* Avaya Burlington PRD DB URL: jdbc:Cache://10.1.219.65/CCMS_STAT */
...
inner join nice_wfm_customer1.dbo.R_ACD acd on q.C_ACD = acd.C_OID and acd.C_Name = 'Burlington-Avaya'  
where 
  cast(e.C_ID as varchar) like '75%%%'
