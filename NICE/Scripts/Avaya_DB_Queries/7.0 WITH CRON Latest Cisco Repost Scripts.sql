...
update [nice_wfm_customer1].dbo.r_swxifacejobparms set c_val='0 01 18 * * ?' where c_key='cron' and c_joboid='Symposium-Acd24-Repost';
...
update [nice_wfm_customer1].dbo.r_swxifacejobparms set c_val='2019-11-21 00:00' where c_key='intervalStart' and c_joboid='Symposium-Acd24-Repost';
update [nice_wfm_customer1].dbo.r_swxifacejobparms set c_val='2019-11-23 00:00' where c_key='intervalEnd' and c_joboid='Symposium-Acd24-Repost';

--Step 4a - check the job parameter table value
select * from [nice_wfm_customer1].dbo.r_swxifacejobparms where c_joboid='Symposium-Acd24-Repost';  
...
where c_intvl >= '2019-06-10 00:00' and c_intvl < '2019-06-15 00:00' and
...
Update [nice_wfm_customer1].dbo.r_swxifacejob set c_enabled= 'T' where c_oid= 'Symposium-Acd24-Repost'
